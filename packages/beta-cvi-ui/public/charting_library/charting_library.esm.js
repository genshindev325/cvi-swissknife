...
function s(t, e) {
  const n = new URL(`${t || ''}`, location.href).href,
    ...
    l = `\n${(function (t, e) {
      ...
      for (const d of t)
        d.endsWith('.js')
          ? i.push(`<script defer crossorigin="anonymous" src="${d}"><\/script>`)
          : r.test(d) && e === a.test(d)
          ? s.push(`<link type="text/css" href="${d}" rel="stylesheet"/>`)
          : /\.woff\d*/.test(d) && n.push(o(d))
      return [...n, ...i, ...s].join('\n')
    })(i, 'rtl' === a.dir)}\n`
  return `<!DOCTYPE html><html ${
    (h = { bundles: l, localeLanguage: r, htmlAttrs: d, libraryPath: n }).htmlAttrs
  }><head><base href="${
    h.libraryPath
  }"><meta charset="utf-8"><script>window===window.parent&&(location.href="about:blank")<\/script><script src="${
    h.localeLanguage
  }-tv-locale.3fdcc43e.js" crossorigin="anonymous"><\/script> ${
    h.bundles
...
function r() {
  return 'CL v23.043 (internal id 3fdcc43e @ 2023-01-27T06:06:31.797Z)'
}
const a = class {
  constructor(o) {
    var s
    ...
    if (
      ((null === (s = o.overrides) || void 0 === s
        ...
        delete o.overrides['mainSeriesProperties.priceAxisProperties.lockScale']),
      (this._options = t(n, o)),
      o.preset)
    ) {
      const t = e[o.preset]
    ...
    'Dark' === this._options.theme &&
      ...
      this._options.debug &&
        (i || ((i = !0), console.log('Using CL v23.043 (internal id 3fdcc43e @ 2023-01-27T06:06:31.797Z)'))),
      this._create()
  }
  setDebugMode(t) {
...
;(window.TradingView = window.TradingView || {}), (window.TradingView.version = r)
