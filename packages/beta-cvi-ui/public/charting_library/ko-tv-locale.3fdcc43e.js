...
_tv_languages.ko = {
  ...
  'Press and hold {key} while zooming to maintain the chart position':
    '줌하는 동안 {key} 를 눌러 차트 포지션을 유지하십시오',
  'Double-click any edge to reset layout grid': '레이아웃 그리드를 리셋하려면 아무 엣지나 더블 클릭하십시오',
  'Link to the chart image copied to clipboard {emoji}': '차트 이미지 링크가 클립보드에 복사됨 {emoji}',
  'Chart image copied to clipboard {emoji}': '차트 이미지가 클립보드에 복사됨 {emoji}',
  Baseline: '베이스라인',
  Units: '유닛',
  Reverse: '리버스',
  Yes: '예',
  ...
  Close: '종',
  Time: '시간',
  '{number} minute_0': '{number} 분',
  m_interval_short: '분',
  '{number} hour_0': '{number} 시간',
  h_interval_short: '시간',
  '{number} day_0': '{number} 날',
  D_interval_short: '날',
  W_interval_short: '주',
  M_interval_short: '달',
  Rename: '이름 바꾸기',
  ...
  'Specified value is more than the instrument maximum of {max}.': '지정값이 인스트루먼트 맥시멈인 {max} 보다 큽니다.',
  'Specified value is less than the instrument minimum of {min}.':
    '지정값이 인스트루먼트 미니멈인 {min} 보다 작습니다.',
  Risk: '리스크',
  Body: '바디',
  Wick: '윅',
  Right: '오른쪽',
  ...
  "The data vendor doesn't provide volume data for this symbol.":
    '데이터 벤더는 이 심볼에 대한 볼륨 데이터를 주지 않습니다.',
  ...
  'Guppy Multiple Moving Average_study': '구피 멀티플 무빙 애버리지',
  ...
  CCI_input: 'CCI',
  'Smoothing Line_input': '스무딩 라인',
  'Smoothing Length_input': '스무딩 렝쓰',
  ...
  Trigger_input: '트리거',
  Level_input: '레벨',
  'Trader EMA 1 length_input': '트레이더 EMA 1 렝쓰',
  'Trader EMA 2 length_input': '트레이더 EMA 2 렝쓰',
  'Trader EMA 3 length_input': '트레이더 EMA 3 렝쓰',
  'Trader EMA 4 length_input': '트레이더 EMA 4 렝쓰',
  'Trader EMA 5 length_input': '트레이더 EMA 5 렝쓰',
  'Trader EMA 6 length_input': '트레이더 EMA 5 렝쓰',
  'Investor EMA 1 length_input': '인베스터 EMA 1 렝쓰',
  'Investor EMA 2 length_input': '인베스터 EMA 2 렝쓰',
  'Investor EMA 3 length_input': '인베스터 EMA 3 렝쓰',
  'Investor EMA 4 length_input': '인베스터 EMA 4 렝쓰',
  'Investor EMA 5 length_input': '인베스터 EMA 5 렝쓰',
  'Investor EMA 6 length_input': '인베스터 EMA 6 렝쓰',
  HV_input: '역사적 변동성',
  ...
  Teeth_input: 'Teeth',
  Lips_input: 'Lips',
  'Jaw Offset_input': '조 오프셋',
  'Teeth Offset_input': '티쓰 오프셋',
  'Lips Offset_input': '립스 오프셋',
  ...
  Add: '넣기',
  'Save chart image': '이미지저장',
  'Copy chart image': '차트 이미지 복사',
  'Copy link to the chart image': '차트 이미지 링크 복사',
  'Open image in new tab': '새 탭에서 이미지 열기',
  'Tweet chart image': '트윗 차트 이미지',
  'adjust data for dividends': '배당금을 위한 데이터 조정',
  'adjust for contract changes': '컨트랙트 변경 조절',
  'toggle auto scale': '자동눈금토글',
  'toggle log scale': '로그눈금토글',
  'toggle percentage scale': '퍼센트 눈금 토글',
  'Take a snapshot': '스냅샷 찍기',
  'use settlement as close on daily interval': '데일리 클로즈를 청산가로 쓰기',
  ext: '확장',
  ...
  'Main symbol data is adjusted for dividends only': '메인 심볼 데이터는 디비든드에 대해서만 조정됩니다',
  'Main symbol data is adjusted for splits only': '메인 심볼 데이터는 스플릿에 대해서만 조정됩니다',
  ...
  'Number or {hotKey_0}': '넘버 또는 {hotKey_0}',
  ...
  'show alert label lines': '얼러트 라벨 선 보기',
  ...
  'pin to left scale': '왼쪽 스케일로 고정하기',
  'change earnings visibility': '어닝즈 비저빌리티 바꾸기',
  'change dividends visibility': '디비든드 비저빌리티 바꾸기',
  'change splits visibility': '스플릿 비저빌리티 바꾸기',
  'change continuous contract switch visibility': '연속 선물 스위치 비저빌리티 바꾸기',
  'show all ideas': '모든 아이디어 보기',
  'show ideas of followed users': '팔로우 하는 유저의 아이디어 보기',
  'show my ideas only': '내 아이디어만 보기',
  'change events visibility on chart': '차트에서 이벤트 비저빌리티 바꾸기',
  ...
  'lock objects': '오브젝트 잠그기',
  'unlock objects': '오브젝트 잠금 해제',
  'Add alert': '얼러트 넣기',
  'Add alert on {series}': '{series} 에 얼러트 넣기',
  'Add alert on {drawing}': '{drawing} 에 얼러트 넣기',
  'Edit {title} alert': '{title} 얼러트 편집',
  ...
  'Pinned to right scale (hidden)': '오른 스케일로 고정하기 (히든)',
  ...
  'Pin to scale {label}': '{label} 스케일로 고정하기',
  'Pin to right scale': '오른쪽 스케일로 고정하기',
  ...
  'Pin to scale (now right)': '스케일 고정 (현재 오른쪽)',
  ...
  Clone: '클론',
  Template: '템플릿',
  'Go to {lineToolName}': '{lineToolName}로 가기',
  Unlock: '잠금풀기',
  Lock: '잠금',
  'Show earnings': '어닝 보기',
  'Show dividends': '배당보기',
  'Show splits': '스플릿 보기',
  'Show continuous contract switch': '연속 선물 스위치 보기',
  'Show all ideas': '모든 아이디어 보기',
  ...
  'Add this financial metric to entire layout': '이 파이낸셜 메트릭을 전체 레이아웃에 넣기',
  'No sync': '노 싱크',
  'Sync globally': '모두 다 싱크',
  'Symbol info': '종목정보',
  Paste: '붙여넣기',
  'Copy price': '카피 프라이스',
  'By TradingView': '제공자 TradingView',
  '{symbol} financials by TradingView': '{symbol} 파이낸셜 제공 TradingView',
  'More features on tradingview.com': 'Tradingview.com 에 있는 더욱 더 많은 기능들',
  'move left': '왼쪽으로 옮기기',
  'move right': '오른쪽으로 옮기기',
  'change price to bar ratio': '프라이스를 바 레이쇼로 바꾸기',
  'toggle lock scale': '잠금 스케일 토글',
  'change series style': '시리즈 스타일 바꾸기',
  'hide {title}': '{title} 숨기기',
  'Invalid symbol': '잘못된 심볼',
  'No data here': '데이터 없음',
  'apply indicators to entire layout': '전체 레이아웃에 인디케이터 걸기',
  'sync time': '타임 싱크',
  'resize layout': '레이아웃 리사이즈',
  'reset layout sizes': '레이아웃 사이즈 리셋',
  'apply chart theme': '차트 테마 적용',
  ...
  "Couldn't copy": '카피할 수 없음',
  "Couldn't cut": '컷할 수 없음',
  "Couldn't paste": '페이스트할 수 없음',
  '{userName} published on {customer}, {date}': '{userName} 이 {customer}, {date} 에 퍼블리쉬했음',
  'Published on {customer}, {date}': '{customer}, {date} 에 퍼블리쉬했음',
  'change symbol last value visibility': '심볼 라스트 밸류 비저빌리티 바꾸기',
  'change symbol previous close value visibility': '심볼 이전 밸류 비저빌리티 바꾸기',
  'change previous close price line visibility': '이전 클로즈 프라이스 라인 비저빌티티 바꾸기',
  'change symbol labels visibility': '심볼 라벨 비저빌리티 바꾸기',
  'change indicators and financials name labels visibility': '인디케이터 및 파이낸셜 네임 라벨 비저빌리티 바꾸기',
  'change indicators name labels visibility': '인디케이터 네임 라벨 비저빌리티 바꾸기',
  'change indicators and financials value labels visibility': '인디케이터 및 파이낸셜 밸류 라벨 비저빌리티 바꾸기',
  'change indicators value labels visibility': '인디케이터 밸류 라벨 비저빌리티 바꾸기',
  'change bid and ask labels visibility': '비드/애스크 라벨 비저빌리티 바꾸기',
  'change bid and ask lines visibility': '비드/애스크 라인 비저빌리티 바꾸기',
  'change pre/post market price label visibility': '프리/포스트 마켓 프라이스 라벨 비저빌리티 바꾸기',
  'change high and low price lines visibility': '하이, 로우 프라이스 라인 가시성',
  'change high and low price labels visibility': '하이, 로우 프라이스 라벨 가시성',
  'change countdown to bar close visibility': '카운트다운 투 바 클로즈 비저빌리티 바꾸기',
  'change plus button visibility': '플러스 버튼 비저빌리티 바꾸기',
  'change price line visibility': '프라이스 라인 바꾸기',
  'unlock {title}': '{title} 잠금 해제',
  'lock {title}': '{title} 잠그기',
  'Auto (fits data to screen)': '오토 (스크린에 데이터 맞춤)',
  'Lock price to bar ratio': '바 레이쇼에 프라이스 잠금',
  'Change interval': '인터벌 바꾸기',
  'Symbol last price label': '심볼 현재가 라벨',
  'Symbol previous day close price label': '심볼 전일종가 라벨',
  'Previous day close price line': '전날 클로즈 프라이스 라인',
  'Symbol name label': '심볼네임 라벨',
  'Indicators and financials value labels': '인디케이터 및 파이낸셜 밸류 라벨',
  'Indicators value labels': '인디케이터 밸류 라벨',
  'Indicators and financials name labels': '인디케이터 및 파이낸셜 네임 라벨',
  'Indicators name labels': '인디케이터 네임 라벨',
  ...
  Mixed: '믹스트',
  'show {title}': '{title} 보이기',
  'Hide Favorite Drawing Tools Toolbar': '많이 쓰는 드로잉 툴바 숨기기',
  'Market open': '마켓 오픈',
  'Pre-market': '프리 마켓',
  'Post-market': '포스트 마켓',
  'Market closed': '마켓 클로즈드',
  'Exchange timezone': '거래소 시간대',
  Image: '이미지',
  Transparency: '투명도',
  'change symbol description visibility': '심볼 설명 비저빌리티 바꾸기',
  'change open market status visibility': '오픈 마켓 스테이터스 비저빌리티 바꾸기',
  'change OHLC values visibility': 'OHLC 밸류 비저빌리티 바꾸기',
  'change bar change visibility': '바 체인지 비저빌리티 바꾸기',
  'change indicator titles visibility': '인디케이터 타이틀 비저빌리티 바꾸기',
  'change indicator arguments visibility': '인디케이터 아규먼트 비저빌리티 바꾸기',
  'change indicator values visibility': '인디케이터 밸류 비저빌리티 바꾸기',
  'change volume values visibility': '볼륨 비저빌리티 바꾸기',
  'Open market status': '오픈 마켓 스테이터스',
  'OHLC values': '시고저종 값',
  ...
  'Show interval settings': '간격 설정 표시',
  'Flag Symbol': '플래그 심볼',
  'Unflag Symbol': '언플래그 심볼',
  'change line tool(s) font size': '라인 툴 폰트 사이즈 바꾸기',
  'change line tool(s) line style': '라인 툴 라인 스타일 바꾸기',
  'Font size': '폰트 크기',
  'Template name': '템플릿이름',
  '{hotKey_0} — drawing a straight line at angles of 45': '{hotKey_0} — 45 도 곧은 줄 긋기',
  '{hotKey_0} — circle': '{hotKey_0} — 써클',
  '{hotKey_0} — square': '{hotKey_0} — 스퀘어',
  '{hotKey_0} — fixed increments': '{hotKey_0} — 고정 증가',
  Arrow: '화살표',
  Cross: '크로스',
  Dot: '점',
  ...
  Measure: '재기',
  '{hotKey_0} + Click on the chart': '{hotKey_0} + 차트위 클릭',
  Color: '색',
  'Text color': '문자열색',
  'Double click': '더블 클릭',
  'Delete pane': '페인 지우기',
  ...
  'Manage panes': '페인 관리',
  scroll: '스크롤',
  'Lock vertical cursor line by time': '버티컬 커서 라인 타임락',
  'change no overlapping labels': '오버래핑 라벨 바꾸지 않기',
  'Merge all scales into one': '모든 스케일 하나로 머지',
  Labels: '라벨',
  'Reset price scale': '프라이스 스케일 리셋',
  Percent_scale_menu: '퍼센트',
  'Indexed to 100_scale_menu': '처음을 100 으로 잡기',
  ...
  pips: '핍스',
  ticks: '틱스',
  'Ticker and description': '티커와 설명',
  'change chart background color': '차트 백그라운드 컬러 바꾸기',
  'change chart background type': '차트 백그라운드 타입 바꾸기',
  'change vert grid lines color': '버티컬 그리드 라인 컬러 바꾸기',
  'change vert grid lines style': '버티컬 그리드 라인 스타일 바꾸기',
  'change horz grid lines color': '호리존털 그리드 라인 컬러 바꾸기',
  'change horz grid lines style': '호리존털 그리드 라인 스타일 바꾸기',
  'change sessions breaks visibility': '세션 브레이크 비저빌리티 바꾸기',
  'change sessions breaks color': '세션 브레이크 컬러 바꾸기',
  'change sessions breaks width': '세션 브레이크 너비 바꾸기',
  'change sessions breaks style': '체인지 세션 브레이크 스타일 바꾸기',
  'change scales text color': '스케일 텍스트 컬러 바꾸기',
  'change scales font size': '스케일 폰트 사이즈 바꾸기',
  'change scales lines color': '스케일 라인 컬러 바꾸기',
  'change pane separators color': '페인 나누개 컬러 바꾸기',
  'change crosshair color': '크로스헤어 컬러 바꾸기',
  'change crosshair width': '크로스헤어 너비 바꾸기',
  'change crosshair style': '크로스헤어 스타일 바꾸기',
  'change symbol watermark visibility': '심볼 워터마크 비저빌리티 바꾸기',
  'change symbol watermark color': '심볼 워터마크 컬러 바꾸기',
  'change navigation buttons visibility': '내비게이션 버튼 비저빌리티 바꾸기',
  'change pane buttons visibility': '페인 버튼 비저빌리티 바꾸기',
  'change top margin': '탑 마진 바꾸기',
  'change bottom margin': '바텀 마진 바꾸기',
  'change right margin': '오른쪽 마진 바꾸기',
  'Vert grid lines': '세로격자선',
  'Horz grid lines': '가로격자선',
  'Scales text': '스케일 텍스트',
  'Scales lines': '스케일 라인',
  'Pane separators': '페인 나누개',
  Watermark: '워터마크',
  'Top margin': '위여백',
  ...
  'Right margin': '오른여백',
  bars_unit: '바',
  'change price Y coordinate': '프라이스 Y 좌표 바꾸기',
  'change bar X coordinate': '프라이스 X 좌표 바꾸기',
  'change {title} visibility on ticks': '틱에서 {title} 비저빌리티 바꾸기',
  'change {title} visibility on seconds': '초에서 {title} 비저빌리티 바꾸기',
  'change {title} seconds from': '~로부터 {title} 초 바꾸기',
  'change {title} seconds to': '{title} 초를 ~로 바꾸기',
  'change {title} visibility on minutes': '초에서 {title} 비저빌리티 바꾸기',
  'change {title} minutes from': '~로부터 {title} 분 바꾸기',
  'change {title} minutes to': '{title} 분을 ~로 바꾸기',
  'change {title} visibility on hours': '시간에서 {title} 비저빌리티 바꾸기',
  'change {title} hours from': '~로부터 {title} 시간 바꾸기',
  'change {title} hours to': '{title} 시간을 ~로 바꾸기',
  'change {title} visibility on days': '날에서 {title} 비저빌리티 바꾸기',
  'change {title} days from': '~로부터 {title} 날 바꾸기',
  'change {title} days to': '{title} 날을 ~로 바꾸기',
  'change {title} visibility on weeks': '주에서 {title} 비저빌리티 바꾸기',
  'change {title} weeks from': '~로부터 {title} 주 바꾸기',
  'change {title} weeks to': '{title} 주를 ~로 바꾸기',
  'change {title} visibility on months': '달에서 {title} 비저빌리티 바꾸기',
  'change {title} months from': '~로부터 {title} 달 바꾸기',
  'change {title} months to': '{title} 달을 ~로 바꾸기',
  'change {title} visibility on ranges': '레인지에서 {title} 비저빌리티 바꾸기',
  Seconds: '초',
  Minutes: '분',
  Hours: '시간',
  Days: '날',
  ...
  'months to': '달을 ~으로',
  ranges: '레인지',
  'change symbol legend format': '종목 설명 포맷 변경',
  'change legend background visibility': '설명 배경 가시성 변경',
  'change legend background transparency': '설명 배경 투명도 변경',
  'change {title} price label visibility': '{title} 가격 라벨 가시성 변경',
  'change {title} extension': '{title} 익스텐션 바꾸기',
  'change {title} time label visibility': '{title} 시간 라벨 가시성 변경',
  'Price label': '가격라벨',
  'Time label': '타임 라벨',
  Extend: '확장',
  'change symbol last value mode': '심볼 라스트 밸류 모드 바꾸기',
  'change currency label visibility': '커런시 라벨 비저빌리티 바꾸기',
  'change unit label visibility': '유닛 라벨 비저빌리티 바꾸기',
  'change currency and unit labels visibility': '커런시 및 유닛 라벨 비저빌리티를 바꾸십시오',
  'change date format': '데이트 포맷 변경',
  Unit: '유닛',
  'Currency and Unit': '통화 및 단위',
  ...
  'lines style': '라인 스타일',
  'lines color': '라인 컬러',
  'backgrounds color': '백그라운드 컬러',
  'backgrounds filled': '백그라운드 채움',
  'text color': '문자열색',
  Text: '문자',
  'change {inputName} property': '{inputName} 프로퍼티 바꾸기',
  'change color bars based on previous close': '이전 클로즈에 따라 컬러 바 바꾸기',
  'change HLC bars': 'HLC 바 변경',
  'change bar up color': '바 업 컬러 바꾸기',
  'change bar down color': '바 다운 컬러 바꾸기',
  'change thin bars': '씬 바 바꾸기',
  'change line price source': '라인 프라이스 소스 바꾸기',
  'change line type': '라인 타입 바꾸기',
  'change line color': '라인 컬러 바꾸기',
  'change line width': '라인 너비 바꾸기',
  'change area price source': '에어리어 프라이스 소스 바꾸기',
  'change area line color': '에어리어 라인 컬러 바꾸기',
  'change area line width': '에어리어 라인 너비 바꾸기',
  'change area fill color': '에어리어 필 컬러 바꾸기',
  'change baseline price source': '베이스라인 프라이스 소스 바꾸기',
  'change baseline top line color': '베이스라인 탑 라인 컬러 바꾸기',
  'change baseline top line width': '베이스라인 탑 라인 너비 바꾸기',
  'change baseline bottom line color': '베이스라인 바텀 라인 컬러 바꾸기',
  'change baseline bottom line width': '베이스라인 바텀 라인 너비 바꾸기',
  'change baseline fill top area color': '베이스라인 필 탑 에어리어 컬러 바꾸기',
  'change baseline fill bottom area color': '베이스라인 필 바텀 에어리어 컬러 바꾸기',
  'change base level': '베이스 레벨 바꾸기',
  'change high-low body visibility': '하이-로우 바디 비저빌리티 바꾸기',
  'change high-low body color': '하이-로우 바디 컬러 바꾸기',
  'change high-low borders visibility': '하이-로우 보더 비저빌리티 바꾸기',
  'change high-low border color': '하이-로우 보더 컬러 바꾸기',
  'change high-low labels visibility': '하이-로우 라벨 비저빌리티 바꾸기',
  'change high-low labels color': '하이-로우 라벨 컬러 바꾸기',
  'change high-low labels font size': '하이-로우 라벨 폰트 사이즈 바꾸기',
  'change renko wick visibility': '렌코 윅 비저빌리티 바꾸기',
  'change renko wick up color': '렌코 윅 업 컬러 바꾸기',
  'change renko wick down color': '렌코 윅 다운 컬러 바꾸기',
  'change the display of real prices on price scale (instead of Heiken-Ashi price)':
    '프라이스 스케일에서 (하이키-아시 프라이스 대신) 리얼 프라이스 디스플레이 바꾸기',
  'change range thin bars': '레인지 씬 바 바꾸기',
  'change {candleType} body visibility': '{candleType} 바디 비저빌리티 바꾸기',
  'change {candleType} up color': '{candleType} 업 컬러 바꾸기',
  'change {candleType} down color': '{candleType} 다운 컬러 바꾸기',
  'change {candleType} border visibility': '{candleType} 비저빌리티 바꾸기',
  'change {candleType} up border color': '{candleType} 업 보더 컬러 바꾸기',
  'change {candleType} down border color': '{candleType} 다운 보더 컬러 바꾸기',
  'change {candleType} wick visibility': '{candleType} 윅 바꾸기',
  'change {candleType} wick up color': '{candleType} 윅 업 컬러 바꾸기',
  'change {candleType} wick down color': '{candleType} 윅 다운 컬러 바꾸기',
  'change {chartType} up color': '{chartType} 업 컬러 바꾸기',
  'change {chartType} down color': '{chartType} 다운 컬러 바꾸기',
  'change {chartType} projection bar up color': '{chartType} 프로젝션 바 업 컬러 바꾸기',
  'change {chartType} projection bar down color': '{chartType} 프로젝션 바 다운 컬러 바꾸기',
  'change {chartType} border bar up color': '{chartType} 보더 바 업 컬러 바꾸기',
  'change {chartType} border bar down color': '{chartType} 보더 바 다운 컬러 바꾸기',
  'change {chartType} projection border bar up color': '{chartType} 프로젝션 보더 바 업 컬러 바꾸기',
  'change column up color': '컬럼 업 색깔 바꾸기',
  'change column down color': '컬럼 다운 색깔 바꾸기',
  'change column price source': '컬럼 프라이스 소스 바꾸기',
  'Thin bars': '씬 (Thin) 바',
  'Top line': '탑 라인',
  'Bottom line': '바텀 라인',
  ...
  'hollow candles': '할로우캔들',
  Center: '센터',
  'change {title} middle point visibility': '{title} 미들 포인트 비저빌리티 바꾸기',
  'change {title} price labels visibility': '{title} 프라이스 라벨 비저빌리티 바꾸기',
  'change {title} price range visibility': '{title} 프라이스 레인지 비저빌리티 바꾸기',
  'change {title} bars range visibility': '{title} 바 레인지 비저빌리티 바꾸기',
  'change {title} date/time range visibility': '{title} 데이트/타임 레인지 비저빌리티 바꾸기',
  'change {title} distance visibility': '{title} 거리 비저빌리티 바꾸기',
  'change {title} angle visibility': '{title} 앵글 비저빌리티 바꾸기',
  'change {title} always show stats': '{title} 언제나 통계 보기 바꾸기',
  'change {title} stats position': '{title} 통계 포지션 바꾸기',
  'Middle point': '미들 포인트',
  'Price labels': '프라이스 라벨',
  'Stats position': '통계 포지션',
  'Price range': '가격범위',
  'Bars range': '바 레인지',
  'Date/time range': '데이트/타임 레인지',
  Distance: '거리',
  Angle: '각',
  'Always show stats': '늘 통계 보기',
  Stats: '통계',
  'change {toolName} line visibility': '{toolName} 라인 비저빌리티 바꾸기',
  'change {toolName} line width': '{toolName} 라인 너비 바꾸기',
  'change {toolName} line style': '{toolName} 라인 스타일 바꾸기',
  'change {toolName} line color': '{toolName} 라인 컬러 바꾸기',
  'change {toolName} line extending left': '{toolName} 라인 왼쪽 늘임 바꾸기',
  'change {toolName} line left end': '{toolName} 라인 왼쪽 끝 바꾸기',
  'change {toolName} line extending right': '{toolName} 라인 오른쪽 늘임 바꾸기',
  'change {toolName} line right end': '{toolName} 라인 오른쪽 끝 바꾸기',
  'Extend left line': '왼 라인 익스텐드',
  'Extend right line': '오른 라인 익스텐드',
  'change {toolName} text visibility': '{toolName} 텍스트 비저빌리티 바꾸기',
  'change {toolName} text color': '{toolName} 텍스트 컬러 바꾸기',
  'change {toolName} text font size': '{toolName} 텍스트 폰트 바꾸기',
  'change {toolName} text font bold': '{toolName} 텍스트 폰트 볼드 바꾸기',
  'change {toolName} text font italic': '{toolName} 텍스트 폰트 이탤릭 바꾸기',
  'change {toolName} text': '{toolName} 텍스트 바꾸기',
  'change {toolName} labels alignment vertical': '{toolName} 라벨 얼라인먼트 버티컬 바꾸기',
  'change {toolName} labels alignment horizontal': '{toolName} 라벨 얼라인먼트 호리존털 바꾸기',
  'change {toolName} labels direction': '{toolName} 라벨 디렉션 바꾸기',
  'change {toolName} text background visibility': '{toolName} 텍스트 백그라운드 비저빌리티 바꾸기',
  'change {toolName} text background color': '{toolName} 텍스트 백그라운드 컬러 바꾸기',
  'change {toolName} text border visibility': '{toolName} 텍스트 보더 비저빌리티 바꾸기',
  'change {toolName} text border width': '{toolName} 텍스트 보더 너비 바꾸기',
  'change {toolName} text border color': '{toolName} 텍스트 보더 컬러 바꾸기',
  'change {toolName} text wrap': '{toolName} 텍스트 줄넘김 바꾸기',
  'Text wrap': '문자열줄넘김',
  'change arrow color': '화살표 색상 변경',
  'change {title} color': '{title} 색상 변경',
  'change {title} mode': '{title} 모드 변경',
  'change {title} mirrored': '{title} 미러드 바꾸기',
  'change {title} flipped': '{title} 플립트 바꾸기',
  Mode: '모드',
  Mirrored: '거울대칭',
  Flipped: '위아래대칭',
  'HL bars': '고저봉',
  ...
  'Line - low': '라인 - 저가',
  'Line - HL/2': '라인 - HL/2',
  'change {title} background visibility': '{title} 배경 가시성 변경',
  'change {title} background color': '{title} 배경 색상 변경',
  'change {title} degree': '{title} 각도 변경',
  Wave: '웨이브',
  Degree: '각도',
  'change {title} level {index} line visibility': '{title} 레벨 {index} 라인 가시성 변경',
  'change {title} levels visibility': '{title} 레벨 가시성 변경',
  'change {title} level {index} line color': '{title} 레벨 {index} 라인 색상 변경',
  'change {title} level {index} line width': '{title} 레벨 {index} 라인 너비 변경',
  'change {title} level {index} line coeff': '{title} 레벨 {index} 라인 계수 바꾸기',
  'change {title} all lines color': '{title}의 모든 라인 색상 변경',
  'change {title} background transparency': '{title} 배경 투명도 변경',
  'change {title} coeffs as percents visibility': '{title} 계수 퍼센트 비저빌리티 바꾸기',
  'Trend line': '트렌드라인',
  'Use one color': '한가지 색만 쓰기',
  Levels: '레벨',
  'Coeffs as percents': '퍼센트로 계수',
  'change {title} reverse': '{title} 리버스 바꾸기',
  'change {title} prices visibility': '{title} 가격 가시성 변경',
  'change {title} labels alignment': '{title} 라벨 얼라인먼트 바꾸기',
  'change {title} labels font size': '{title} 라벨 폰트 사이즈 바꾸기',
  'change {title} style': '{title} 스타일 변경',
  'change {title} fib levels based on log scale': '로그 스케일을 기반으로 {title}의 피보나치 레벨 변경',
  'Levels line': '레벨 라인',
  'Extend right': '익스텐드 라이트',
  'Extend left': '익스텐드 레프트',
  'Extend lines right': '라인 오른쪽 늘리기',
  'Extend lines left': '라인 왼쪽 늘리기',
  ...
  Middle: '미들',
  Bottom: '아래',
  'change {title} full circles visibility': '{title} 풀 서클 비저빌리티 바꾸기',
  'Full circles': '동그라미',
  'change {title} left labels visibility': '{title} 왼쪽 라벨 비저빌리티 바꾸기',
  'change {title} right labels visibility': '{title} 오른쪽 라벨 비저빌리티 바꾸기',
  'change {title} top labels visibility': '{title} 탑 라벨 비저빌리티 바꾸기',
  'change {title} bottom labels visibility': '{title} 바텀 라벨 비저빌리티 바꾸기',
  'change {title} grid visibility': '{title} 그리드 비저빌리티 바꾸기',
  'change {title} grid line color': '{title} 그리드 라인 컬러 바꾸기',
  'change {title} grid line width': '{title} 그리드 라인 너비 바꾸기',
  'change {title} grid line style': '{title} 그리드 라인 스타일 바꾸기',
  'Price levels': '가격레벨',
  'Time levels': '타임 레벨',
  'Left labels': '왼쪽라벨',
  'Right labels': '오른 라벨',
  'Top labels': '탑레벨',
  'Bottom labels': '아래 라벨',
  'change {title} line color': '{title} 라인 컬러 바꾸기',
  'change {title} line width': '{title} 라인 너비 바꾸기',
  'change {title} line style': '{title} 라인 스타일 바꾸기',
  'change {title} counterclockwise': '{title} 반시계방향 바꾸기',
  Counterclockwise: '반시계 방향',
  'change {title} level {index} line style': '{title} 레벨 {index} 라인 스타일 바꾸기',
  'change {title} labels visibility': '{title} 라벨 비저빌리티 바꾸기',
  'change flag color': '플래그 컬러 바꾸기',
  'change {title} fan {index} line visibility': '{title} 팬 {index} 라인 비저빌리티 바꾸기',
  'change {title} fan {index} line color': '{title} 팬 {index} 라인 컬러 바꾸기',
  'change {title} fan {index} line width': '{title} 팬 {index} 라인 너비 바꾸기',
  'change {title} arcs {index} line visibility': '{title} 아크 {index} 라인 비저빌리티 바꾸기',
  'change {title} arcs {index} line color': '{title} 아크 {index} 라인 컬러 바꾸기',
  'change {title} arcs {index} line width': '{title} 아크 {index} 라인 너비 바꾸기',
  'Price/bar ratio': '프라이스/바 레이쇼',
  'Ranges and ratio': '레인지 및 레이쇼',
  Fans: '부채꼴',
  Arcs: '원호',
  'change {title} fans visibility': '{title} 팬 비저빌리티 바꾸기',
  'change {title} fans line color': '{title} 팬 라인 컬러 바꾸기',
  Angles: '각',
  'change {title} extend top': '{title} 익스텐드 탑 바꾸기',
  'change {title} extend bottom': '{title} 익스텐드 바텀 바꾸기',
  'change {title} extend left': '{title} 익스텐드 레프트 바꾸기',
  'Extend top': '익스텐드 탑',
  'Extend bottom': '익스텐드 바텀',
  Label: '라벨',
  'Label background': '라벨 백그라운드',
  'change {title} candle up color': '{title} 캔들 업 컬러 바꾸기',
  'change {title} candle down color': '{title} 캔들 다운 컬러 바꾸기',
  'change {title} candle border visibility': '{title} 캔들 보더 비저빌리티 바꾸기',
  'change {title} candle border up color': '{title} 캔들 보더 업 컬러 바꾸기',
  'change {title} candle border down color': '{title} 캔들 보더 다운 컬러 바꾸기',
  'change {title} candle wick visibility': '{title} 캔들 윅 비저빌리티 바꾸기',
  'change {title} candle wick color': '{title} 캔들 윅 컬러 바꾸기',
  'change {title} transparency': '{title} 투명도 바꾸기',
  'change {title} average HL value': '{title} 애버리지 HL 밸류 바꾸기',
  'change {title} variance value': '{title} 분산값 바꾸기',
  'Avg HL in minticks': '최소틱단위 평균 고저',
  Variance: '분산',
  '#1 (price)_linetool point': '#1 (프라이스)',
  '#{count} (price, bar)_linetool point': '#{count} (프라이스, 바)',
  'change {title} extending left': '{title} 익스텐딩 레프트 바꾸기',
  'change {title} extending right': '{title} 익스텐딩 롸이트 바꾸기',
  Channel: '채널',
  'change {title} extend lines': '{title} 익스텐드 라인 바꾸기',
  Median: '평균값',
  'Extend lines': '확장선',
  Original: '원본',
  Schiff: '쉬프',
  ...
  Inside: '내부',
  'change {title} source text color': '{title} 소스 텍스트 컬러 바꾸기',
  'change {title} source background color': '{title} 소스 백그라운드 컬러 바꾸기',
  'change {title} source border color': '{title} 소스 보더 컬러 바꾸기',
  'change {title} target text color': '{title} 타겟 텍스트 컬러 바꾸기',
  'change {title} target background color': '{title} 타겟 백그라운드 텍스트 컬러 바꾸기',
  'change {title} target border color': '{title} 타겟 보더 컬러 바꾸기',
  'change {title} success text color': '{title} 성공 텍스트 컬러 바꾸기',
  'change {title} success background color': '{title} 성공 백그라운드 컬러 바꾸기',
  'change {title} failure text color': '{title} 실패 텍스트 컬러 바꾸기',
  'change {title} failure background color': '{title} 실패 백그라운드 컬러 바꾸기',
  'Source text': '소스 텍스트',
  ...
  'Line color': '라인 컬러',
  'Label border': '라벨 보더',
  'change {title} background color 1': '{title} 백그라운드 컬러 1',
  'change {title} background color 2': '{title} 백그라운드 컬러 2',
  'change {title} stop color': '{title} 역지정 색상 변경',
  'change {title} target color': '{title} 목표 색상 변경',
  'change {title} compact stats mode': '{title} 컴팩트 통계 모드 바꾸기',
  'change {title} account size': '{title} 계정 규모 변경',
  'change {title} lot size': '{title} 로트 규모 변경',
  'change {title} risk': '{title} 리스크 변경',
  'change {title} risk display mode': '{title} 리스크 표시 모드 변경',
  'change {title} entry price': '{title} 진입 가격 변경',
  'change {title} profit level': '{title} 수익 레벨 변경',
  'change {title} profit price': '{title} 수익 가격 변경',
  'change {title} stop level': '{title} 역지정 레벨 변경',
  'change {title} stop price': '{title} 역지정 가격 변경',
  'Stop color': '스탑 칼라',
  'Target color': '타겟 칼라',
  ...
  'Lot size': '로트 크기',
  Cash: '캐쉬',
  'change vertical position Y coordinate': '버티컬 포지션 Y 좌표 바꾸기',
  'change {title} emoji visibility': '{title} 이모지 가시성 변경',
  'change {title} image background color': '{title} 이미지 배경 색상 변경',
  'change {title} emoji': '{title} 이모지 변경',
  '#1 (vertical position %, bar)_linetool point': '#1 (세로 포지션 %, 바)',
  'Emoji pin': '이모지 핀',
  'change angle': '앵글 바꾸기',
  '#1 (price, bar)_linetool point': '#1 (프라이스, 바)',
  '#1 (bar)_linetool point': '#1 (바)',
  'change decimal places': '소숫점 자릿수 바꾸기',
  'change extended hours color': '익스텐드 아워 컬러 바꾸기',
  'change pre market color': '프리 마켓 컬러 바꾸기',
  'change post market color': '포스트 마켓 컬러 바꾸기',
  'change price line color': '프라이스 라인 컬러 바꾸기',
  'change price line width': '프라이스 라인 너비 바꾸기',
  'change previous close price line color': '이전 클로즈 프라이스 라인 컬러 바꾸기',
  'change previous close price line width': '이전 클로즈 프라이스 라인 너비 바꾸기',
  'change pre/post market price lines visibility': '프리/포스트 마켓 프라이스 라인 비저빌리티 바꾸기',
  'change pre market line color': '프리 마켓 라인 컬러 바꾸기',
  'change post market line color': '포스트 마켓 라인 컬러 바꾸기',
  'change bid line color': '비드 라인 컬러 바꾸기',
  'change ask line color': '애스크 라인 컬러 바꾸기',
  ...
  Step: '스텝',
  Default: '기본설정',
  'change {title} base line visibility': '{title} 기본선 가시성 변경',
  'change {title} base line color': '{title} 기본선 색상 변경',
  'change {title} base line width': '{title} 기본선 너비 변경',
  'change {title} base line style': '{title} 기본선 스타일 변경',
  'change {title} up line visibility': '{title} 업 라인 비저빌리티 바꾸기',
  'change {title} up line color': '{title} 업 라인 컬러 바꾸기',
  'change {title} up line width': '{title} 업 라인 너비 바꾸기',
  'change {title} up line style': '{title} 업 라인 스타일 바꾸기',
  'change {title} down line visibility': '{title} 다운 라인 비저빌리티 바꾸기',
  'change {title} down line color': '{title} 다운 라인 컬러 바꾸기',
  'change {title} down line width': '{title} 다운 라인 너비 바꾸기',
  'change {title} down line style': '{title} 다운 라인 스타일 바꾸기',
  "change {title} show pearson's r": '{title} 피어슨 R 보기 바꾸기',
  Base: '베이스',
  Up: '업',
  Down: '다운',
  "Pearson's R": "Pearson's 상관계수",
  '#{count} (bar)_linetool point': '#{count} (바)',
  'change study overlay style': '스터디 오버레이 스타일 바꾸기',
  'change study overlay min tick': '스터디 오버레이 최소 틱 바꾸기',
  'Override min tick': 'min tick 오버라이드',
  Horizontal: '가로',
  Vertical: '세로',
  'Text alignment': '텍스트 얼라인',
  'Text orientation': '텍스트 방향',
  'change {propertyName} property': '{propertyName} 속성 변경',
  Offset: '오프셋',
  ...
  'change values visibility': '밸류 비저빌리티 바꾸기',
  ...
  'less than 1 minute': '1분 미만',
  '{days} and {hours}': '{days}와 {hours}',
  '{hours} and {minutes}': '{hours}와 {minutes}',
  'Market opens in {remainingTime}.': '{remainingTime} 뒤에 마켓이 열립니다.',
  'Market closes in {remainingTime}.': '{remainingTime} 뒤에 마켓이 닫힙니다.',
  "It'll go to post-market trading in {remainingTime}.": '{remainingTime} 뒤에는 포스트-마켓 트레이딩으로 갑니다.',
  "It'll open for pre-market trading in {remainingTime}.": '{remainingTime} 뒤에는 프리-마켓 트레이딩이 열립니다.',
  'Replay mode': '리플레이 모드',
  "You're in Replay mode. You're in Replay mode. You're in Replay mode.":
    '리플레이 모드입니다. 리플레이 모드입니다. 리플레이 모드입니다.',
  "Do you really want to delete Study Template '{name}' ?": "정말로 스터디 템플릿 '{name}' 을 지우시겠습니까?",
  'Modify Order': '오더 고치기',
  'Cancel Order': '주문 취소',
  Confirmation: '확인',
  ...
  'cut {title}': '{title} 자르기',
  'cut sources': '소스 자르기',
  'remove {title}': '{title} 지우기',
  'remove drawings group': '드로잉 그룹 지우기',
  'move scale': '스케일 옮기기',
  'stop syncing line tool(s)': '라인(들) 툴 동기화 중지',
  'zoom out': '축소',
  'zoom in': '확대',
  'move drawing(s)': '드로잉 옮기기',
  'load default drawing template': '기존 드로잉 템플릿 로드',
  'change currency': '통화 변경',
  'change unit': '유닛 바꾸기',
  'clone line tools': '라인 툴 클론',
  'merge up': '머지 업',
  'merge down': '머지 다운',
  'merge to pane': '페인으로 머지',
  'unmerge up': '언머지 업',
  'unmerge down': '언머지 다운',
  'unmerge to new bottom pane': '새 바텀 페이지로 언머지',
  'move {title} to new right scale': '{title} 을 오른 눈금으로 옮기기',
  ...
  'reset scales': '스케일 재설정',
  'create {tool}': '{tool} 만들기',
  'change {pointIndex} point': '{pointIndex} 포인트 변경',
  'paste {title}': '{title} 붙여넣기',
  'insert {title}': '{title} 넣기',
  'remove all studies': '모든 스터디 제거',
  'remove drawings': '드로잉 없애기',
  'remove all studies and drawing tools': '모든 스터디 및 드로잉 툴 없애기',
  'turn line tools sharing off': '라인 툴 셰어링 끄기',
  'share line tools in layout': '레이아웃에서 라인 툴 셰어',
  'share line tools globally': '라인 툴 글로벌 셰어',
  'apply all chart properties': '모든 차트 속성 적용',
  '{count} bars': '{count} 봉',
  Jan: '1월',
  Feb: '2월',
  Mar: '3월',
  ...
  'removing line tools group {name}': '{name} 라인 툴 그룹 없애기',
  ...
  'change {sourceTitle} title to {newSourceTitle}': '{sourceTitle} 타이틀을 {newSourceTitle} 으로 바꾸기',
  'insert source(s) after': '~뒤에 소스 넣기',
  'mirror bars pattern': '미러 바 패턴',
  'flip bars pattern': '바 패턴 뒤집기',
  'change Elliott degree': '엘리엇 각도 변경',
  ...
  Highlighter: '하이라이터',
  'Price Note': '프라이스 노트',
  'Volume Profile Fixed Range': '볼륨 프로파일 픽스 레인지',
  'Ghost Feed': '고스트피드',
  '{status} P&L: {pnl}': '{status} 손익: {pnl}',
  Open_line_tool_position: '포지션보유',
  Closed_line_tool_position: '포지션청산',
  'Risk/Reward Ratio: {ratio}': '위험/보상율: {ratio}',
  ...
  'Triangle Up': '트라이앵글 업',
  'X Cross': 'X 크로스',
  Premarket_sessions: '프리마켓',
  Postmarket_sessions: '포스트마켓',
  'Regular trading hours_sessions': '정규 거래 시간',
  'Extended trading hours_sessions': '확장거래시간',
  'Electronic trading hours_sessions': '전자 거래 시간',
  PRE_sessions: '프리',
  POST_sessions: 'POST',
  RTH_sessions: 'RTH',
  ETH_sessions: 'ETH',
  'add line tool(s) to group {group}': '{group} 에 라인 툴 넣기',
  'apply study template {template}': '{template} 스터디 템플릿 적용',
  'change pane height': '페인 높이 바꾸기',
  'change date range': '데이트 레인지 바꾸기',
  'apply toolbars theme': '툴바의 테마 적용',
  ...
  'paste drawing': '드로잉 붙여넣기',
  'paste indicator': '지표 붙여넣기',
  'scale price': '스케일 프라이스',
  'rearrange panes': '페인 재배치',
  'remove line data sources': '라인 데이터 소스 없애기',
  'restore defaults': '기본값 복원',
  'change chart layout to {title}': '차트 레이아웃을 {title}로 변경',
  'stop syncing drawing': '드로잉 동기화 중지',
  zoom: '확대',
  'bring {title} to front': '{title} 앞으로 가져오기',
  'send {title} to back': '{title} 뒤로 보내기',
  'insert {title} after {targetTitle}': '{targetTitle} 뒤에 {title} 넣기',
  'insert {title} before {targetTitle}': '{targetTitle} 앞에 {title} 넣기',
  'send group {title} backward': '{title} 그룹을 뒤로 보내기',
  'bring group {title} forward': '{title} 그룹을 앞으로 가져오기',
  ...
  "Do you really want to delete Chart Layout '{name}' ?": "정말로 차트 레이아웃 '{name}' 을 지우시겠습니까?",
  ...
  "Color Theme '{themeName}' already exists. Do you really want to replace it?":
    "'{themeName}' 칼라 테마가 이미 있습니다. 바꾸시겠습니까?",
  ...
  'Step line': '스텝 라인',
  'Step line with diamonds': '다이어몬드와 함께 발맞추기',
  Histogram: '막대그래프',
  ...
  'All sources': '모든 자료',
  'Symbol & description': '종목 & 설명',
  Sources: '자료',
  'Same % scale': '같은 % 스케일',
  'New price scale': '새 프라이스 스케일',
  'New pane': '새 페인',
  'Add to': '~에 넣기:',
  'Allow extend time scale': '타임 스케일 확장을 허용합니다',
  'No symbols here yet — why not add some?': '아직 종목이 없습니다. 종목을 추가하시겠습니까?',
  'Added symbols': '더해진 심볼들',
  'Recent symbols': '최근 심볼들',
  'Compare symbol': '심볼 견주기',
  ...
  'Hide positions & orders': '포지션 & 주문 숨기기',
  'Show all positions & orders': '모든 포지션 & 주문 보기',
  'Hide all positions & orders': '모든 포지션 & 주문 숨기기',
  'Hide all': '모두 숨기기',
  'Show all drawings, indicators, positions & orders': '모든 드로잉, 지표, 포지션 & 주문 보기',
  'Show all drawings and indicators': '모든 드로잉 및 인디케이터 보기',
  'Hide all drawings, indicators, positions & orders': '모든 드로잉, 지표, 포지션 & 주문 숨기기',
  'Hide all drawings and indicators': '모든 드로잉 및 인디케이터 숨기기',
  'remove all line tools for {symbol}': '{symbol}의 모든 줄 도구 제거',
  ...
  'show objects': '오브젝트 보이기',
  'hide objects': '오브젝트 숨기기',
  ...
  'Set the "{inputTitle}" time for "{studyShortDescription}"': '{studyShortDescription}에 대한 {inputTitle} 시간 설정',
  'Set the time for "{studyShortDescription}"': '"{studyShortDescription}" 에 대한 타임을 셋하시오',
  'Set the "{inputTitle}" price for "{studyShortDescription}"': '{studyShortDescription}에 대한 {inputTitle} 가격 설정',
  'Set the price for "{studyShortDescription}"': '"{studyShortDescription}" 에 대한 프라이스를 셋하시오',
  'Add Symbol': '심볼 넣기',
  ...
  'Apply defaults': '기본설정',
  'Apply Defaults': '기본설정',
  'apply factory defaults to selected sources': '선택한 소스에 팩토리 디폴트 값 적용',
  'Selected Drawings': '고른 드로잉',
  Solid: '솔리드',
  Gradient: '그래디언트',
