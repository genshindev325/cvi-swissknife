;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6631],
  {
    20453: e => {
      e.exports = {
        autocomplete: 'autocomplete-SY8CqC4y',
        caret: 'caret-SY8CqC4y',
        icon: 'icon-SY8CqC4y',
        suggestions: 'suggestions-SY8CqC4y',
        suggestion: 'suggestion-SY8CqC4y',
        noResults: 'noResults-SY8CqC4y',
        selected: 'selected-SY8CqC4y',
        opened: 'opened-SY8CqC4y',
      }
    },
    6539: e => {
      e.exports = {
    ...
    35256: e => {
      e.exports = { loading: 'loading-4Sqi3h6J' }
    },
    33558: e => {
      e.exports = {
        container: 'container-PqABOUJm',
        withSuggestions: 'withSuggestions-PqABOUJm',
        title: 'title-PqABOUJm',
        autocomplete: 'autocomplete-PqABOUJm',
        saveSymbol: 'saveSymbol-PqABOUJm',
        saveInterval: 'saveInterval-PqABOUJm',
        indicators: 'indicators-PqABOUJm',
        hintLabel: 'hintLabel-PqABOUJm',
        hintMark: 'hintMark-PqABOUJm',
      }
    },
    91131: e => {
      e.exports = {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        const { size: t, startIcon: n, icon: o, iconOnly: r, children: a, endIcon: c } = e,
          u = null != n ? n : o
        return s.createElement(
          s.Fragment,
          null,
          u && 'xsmall' !== t && s.createElement(i.Icon, { icon: u, className: l()['start-icon-wrap'] }),
          a && s.createElement('span', { className: l().content }, a),
          c && !r && 'xsmall' !== t && s.createElement(i.Icon, { icon: c, className: l()['end-icon-wrap'] }),
        )
      }
      var d = n(86332),
        h = n(90186)
      function p(e) {
        ...
        return { ...d, ...(0, h.filterDataProps)(e), ...(0, h.filterAriaProps)(e) }
      }
      function m(e) {
        const { reference: t, ...n } = e,
          { isGrouped: o, cellState: r, disablePositionAdjustment: i } = (0, s.useContext)(d.ControlGroupContext),
          a = c({ ...n, isGrouped: o, cellState: r, disablePositionAdjustment: i })
        return s.createElement('button', { ...p(n), className: a, ref: t }, s.createElement(u, { ...n }))
      }
      ...
      function b(e) {
        const { intent: t, size: n, appearance: s, useFullWidth: o, icon: r, ...i } = e
        return { ...i, color: f(t), size: v(n), variant: g(s), stretch: o, startIcon: r }
      }
      function C(e) {
        return s.createElement(m, { ...b(e) })
      }
    },
    84413: (e, t, n) => {
      'use strict'
      ...
      function c(e) {
        ...
        return s.createElement(
          ...
          s.createElement('span', { className: t }, s.createElement(r.Icon, { icon: i, className: l().icon })),
        )
      }
    },
    15294: (e, t, n) => {
      ...
      class c extends s.PureComponent {
        render() {
          const { inputClassName: e, labelClassName: t, ...n } = this.props,
            r = o(this.props.className, l().checkbox, {
              [l().reverse]: Boolean(this.props.labelPositionReverse),
              [l().baseline]: Boolean(this.props.labelAlignBaseline),
            }),
            a = o(l().label, t, { [l().disabled]: this.props.disabled })
          let c = null
          return (
            this.props.label &&
              (c = s.createElement('span', { className: a, title: this.props.title }, this.props.label)),
            s.createElement('label', { className: r }, s.createElement(i.CheckboxInput, { ...n, className: e }), c)
          )
        }
      }
    ...
    67029: (e, t, n) => {
      ...
      function p(e, t, n, s) {
        const {
          ...
          C = h(null != r ? r : (0, c.getGroupCellRemoveRoundBorders)(n))
        return o(
          d().container,
          d()['intent-' + a],
          d()['border-' + l],
      ...
      function m(e, t) {
        const { highlight: n, highlightRemoveRoundBorder: s } = e
        if (!n) return d().highlight
        const r = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(t))
        return o(d().highlight, d().shown, r)
      }
      const g = {
          FontSizeMedium: (0, r.ensureDefined)(d()['font-size-medium']),
          FontSizeLarge: (0, r.ensureDefined)(d()['font-size-large']),
        },
        f = { passive: !1 }
      function v(e, t) {
        const {
          ...
          { isGrouped: E, cellState: k, disablePositionAdjustment: N = !1 } = (0, s.useContext)(l.ControlGroupContext),
          O = (function (e, t = null, n) {
            const o = (0, s.useRef)(null),
              r = (0, s.useRef)(null),
              i = (0, s.useCallback)(() => {
                if (null === o.current || null === r.current) return
                const [e, t, n] = r.current
            ...
            return (0, s.useEffect)(() => ((r.current = [e, t, n]), i(), a), [e, t, n]), l
          })('wheel', x, f)
        return s.createElement(
          'span',
          {
          ...
          w,
          y,
          s.createElement('span', { className: m(e, k) }),
        )
      }
    ...
    78274: (e, t, n) => {
      'use strict'
      n.d(t, { StartSlot: () => a, MiddleSlot: () => l, EndSlot: () => c, AfterSlot: () => u })
      var s = n(59496),
        o = n(97754),
        r = n(10306),
        i = n.n(r)
      function a(e) {
        const { className: t, interactive: n = !0, icon: r = !1, children: a } = e
        return s.createElement('span', { className: o(i()['inner-slot'], n && i().interactive, r && i().icon, t) }, a)
      }
      function l(e) {
        const { className: t, children: n } = e
        return s.createElement('span', { className: o(i()['inner-slot'], i()['inner-middle-slot'], t) }, n)
      }
      function c(e) {
        const { className: t, interactive: n = !0, icon: r = !1, children: a } = e
        return s.createElement('span', { className: o(i()['inner-slot'], n && i().interactive, r && i().icon, t) }, a)
      ...
      function u(e) {
        const { className: t, children: n } = e
        return s.createElement('span', { className: o(i()['after-slot'], t) }, n)
      }
    },
    31261: (e, t, n) => {
      'use strict'
      ...
      var s = n(59496),
        ...
        g = n.n(m)
      function f(e) {
        return !(0, r.isAriaAttribute)(e) && !(0, r.isDataAttribute)(e)
      }
      function v(e) {
        const {
            id: t,
          ...
          q = (0, r.filterProps)(Y, f),
          G = {
            ...(0, r.filterAriaProps)(Y),
            ...(0, r.filterDataProps)(Y),
            id: t,
            title: n,
            role: i,
            tabIndex: a,
        ...
        return s.createElement(h.ControlSkeleton, {
          ...
          middleSlot: s.createElement(
            ...
            s.createElement('input', {
              ...G,
              className: o(g().input, R, F && g()['with-start-slot'], U && g()['with-end-slot']),
              disabled: j,
              readOnly: P,
              ref: K,
            }),
      ...
      function b(e) {
        ...
        const {
          ...
          _ = t ? void 0 : b ? -1 : o,
          w = t ? void 0 : b ? o : -1,
          { isMouseDown: y, handleMouseDown: S, handleMouseUp: x } = (0, d.useIsMouseDown)(),
          E = (0, i.createSafeMulticastEventHandler)(
            C.onFocus,
            function (e) {
              n && !y.current && (0, a.selectAllContent)(e.currentTarget)
            },
            r,
          ),
          k = (0, i.createSafeMulticastEventHandler)(C.onBlur, h),
          N = (0, s.useCallback)(
            e => {
    ...
    48027: (e, t, n) => {
      ...
      var s = n(47201),
        o = n(29202)
      function r(e) {
        const { onFocus: t, onBlur: n, intent: r, highlight: i, disabled: a } = e,
          [l, c] = (0, o.useFocus)(void 0, a),
          u = (0, s.createSafeMulticastEventHandler)(a ? void 0 : c.onFocus, t),
          d = (0, s.createSafeMulticastEventHandler)(a ? void 0 : c.onBlur, n)
        return { ...e, intent: r || (l ? 'primary' : 'default'), highlight: null != i ? i : l, onFocus: u, onBlur: d }
      }
    },
    29202: (e, t, n) => {
      'use strict'
    ...
    9745: (e, t, n) => {
      ...
      const o = s.forwardRef((e, t) => {
        const { icon: n = '', ...o } = e
        return s.createElement('span', { ...o, ref: t, dangerouslySetInnerHTML: { __html: n } })
      })
    },
    26996: (e, t, n) => {
      'use strict'
      ...
      class c extends o.PureComponent {
        ...
        render() {
          ...
          return o.createElement(
            'span',
            { className: r(l().loader, s && l().static, this._getStateClass(), e) },
    ...
    54349: (e, t, n) => {
      'use strict'
      n.d(t, { SwitchGroup: () => r, makeSwitchGroupItem: () => i })
      var s = n(59496),
        o = n(19036)
    ...
    33165: (e, t, n) => {
      'use strict'
      n.r(t), n.d(t, { StudyTemplateSaver: () => z })
      var s,
        o = n(88537),
        r = n(28353),
        i = n(59496),
      ...
      class f extends i.PureComponent {
          ...
          if (
            ...
            (this._handleChange = e => {
              const {
                  ...
                  onChange: s,
                  onSuggestionsOpen: o,
                  onSuggestionsClose: r,
                } = this.props,
                i = e.currentTarget.value
              if (t && '' === i) this.setState({ queryValue: i, isOpened: !1, active: void 0 }), r && r()
              else {
            ...
            (this._handleKeyDown = e => {
              ...
              const { allowUserDefinedValues: t, value: n, onChange: o, onSuggestionsOpen: r } = this.props,
              ...
              switch (e.which) {
                ...
                case s.Enter:
                  ...
                  t && (a && m ? this.setState(this._valueToQuery(m)) : (m = l)),
                    void 0 !== m &&
                      (this._close(), a || this._blur(), m !== n ? o && o(m) : this.setState(this._valueToQuery(m)))
              }
            }),
            ...
            (this._scrollIfNotVisible = (e, t) => {
              const n = t.scrollTop,
                ...
                o = e.offsetTop,
                r = o + e.clientHeight
              o <= n ? e.scrollIntoView(!0) : r >= s && e.scrollIntoView(!1)
            }),
        ...
        render() {
          return i.createElement(p.OutsideEvent, { handler: this._handleOutsideClick, click: !0 }, e =>
            i.createElement(
              'div',
              { className: l(m.autocomplete, { [m.opened]: this.state.isOpened }, 'js-dialog-skip-escape'), ref: e },
              i.createElement(h.InputControl, {
                ...
                endSlot: Object.keys(this._suggestions(this.state.queryValue)).length
                  ? i.createElement(
                      ...
                      i.createElement(
                        'span',
                        { className: m.caret, onClick: this._handleCaretClick },
                        i.createElement(u.ToolWidgetCaret, { className: m.icon, dropped: this.state.isOpened }),
                      ),
                    )
                  : void 0,
        ...
        _renderSuggestions() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map(t => {
              const n = l(m.suggestion, { [m.selected]: this.state.active === t })
              return i.createElement('li', { id: t, key: t, className: n, onClick: this._handleItemClick }, e[t])
            }),
            n = i.createElement('li', { className: m.noResults }, (0, r.t)('No results found'))
          return !t.length && this.props.noEmptyText
            ? null
            : i.createElement('ul', { className: m.suggestions, ref: this._setSuggestionsRef }, t.length ? t : n)
        }
        _handleKeyUpEnter(e) {
        ...
        _getActiveKeyByValue(e) {
          const { filter: t = g } = this.props,
            ...
            s = Object.keys(n)
          for (const o of s) if (t(e, n[o])) return o
          return s[0]
        }
        _valueToQuery(e) {
      ...
      function y(e) {
        ...
        return i.createElement(
          'span',
          { className: t ? w.loading : void 0 },
          (0, r.t)('Save'),
          t && i.createElement(_.Loader, { color: 'white' }),
        )
      }
      class S extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(b.AdaptiveConfirmDialog, {
            ref: this._dialogRef,
            onClose: s,
            ...
            submitButtonText: i.createElement(y, { isLoading: this.state.isLoading }),
        ...
        _renderDialogBody() {
          return () => i.createElement(C.SlotContext.Consumer, null, e => ((this._manager = e), this.props.children))
        }
      }
      var x = n(60495),
        E = n(33558)
      const k = (0, r.t)('Template name'),
        N = (0, r.t)('Saved indicators'),
        O = (0, r.t)('Remember Symbol'),
        A = (0, r.t)('Remember Interval')
      function D(e) {
        const {
            title: t,
        ...
        return (
          (0, i.useEffect)(() => {
            ;(0, o.ensureNotNull)(D.current).focus()
          }, []),
          i.createElement(
            S,
            {
              ...
              onClose: u,
              onSubmit: function (e) {
                d({ title: h, saveSymbol: m, saveInterval: b }, e)
              },
            },
            i.createElement(
              'div',
              { className: l(E.container, _ && E.withSuggestions) },
              i.createElement('div', { className: E.title }, k),
              i.createElement(
                'div',
                ...
                i.createElement(f, {
                  ...
                  onChange: p,
                  onBlur: function () {
                    ;(0, o.ensureNotNull)(y.current).focus()
                  },
                  source: a,
              ...
              i.createElement(
                ...
                i.createElement(c.Checkbox, {
                  label: i.createElement(
                    ...
                    O,
                    i.createElement(v.Icon, { icon: x, className: l(E.hintMark, 'apply-common-tooltip'), title: n }),
                  ),
                  onChange: function () {
                    g(!m), (0, o.ensureNotNull)(y.current).focus()
                  },
                  checked: m,
                }),
              ),
              i.createElement(
                ...
                i.createElement(c.Checkbox, {
                  label: i.createElement(
                    ...
                    { className: E.hintLabel },
                    A,
                    i.createElement(v.Icon, { icon: x, className: l(E.hintMark, 'apply-common-tooltip'), title: s }),
                  ),
                  onChange: function () {
                    C(!b), (0, o.ensureNotNull)(y.current).focus()
                  },
                  checked: b,
                }),
              ),
              i.createElement('div', { className: E.title }, N),
              i.createElement('div', { className: l(E.indicators, _ && E.withSuggestions) }, r),
            ),
          )
        )
      }
      ...
      class T {
        constructor(e) {
          ;(this._container = document.createElement('div')),
            ...
            (this.unmount = () => {
              M.unsubscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null),
            ...
            M.subscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null)
        }
        mount() {
          a.render(
            i.createElement(D, {
      ...
      var L = n(43007),
        ...
        R = n(35218),
        j = n(23177)
      const P = (0, r.t)('Save Indicator Template'),
        V = (0, r.t)('Selecting this option will set the {symbol} symbol on the chart when this template is applied'),
        F = (0, r.t)(
          'Selecting this option will set the {interval} interval on the chart when this template is applied',
        ),
        U = (0, r.t)("Study Template '{templateName}' already exists. Do you really want to replace it?")
      function K(e, t, n) {
        const s = () => {
          L.backend.invalidateStudyTemplatesList(), L.backend.getStudyTemplatesList().then(t)
        }
        L.backend.saveStudyTemplate(e).then(s)
      }
      class z {
        constructor(e) {
          ;(this._dialog = null),
        ...
        _prepareData(e, t, n) {
          ...
          return {
            ...
            meta_info: (0, j.createStudyTemplateMetaInfo)(this._controller, s.interval),
          }
        }
        _doSave(e, t, n) {
          const { title: s, saveSymbol: o, saveInterval: r } = t
          if (!s) return
          const i = n.manager() || void 0,
            a = this._prepareData(s, o, r)
          if (e.find(e => e.name === s)) {
            const e = e => {
              e ? K(a, this._onSave) : (n.focus(), n.dropLoading())
            }
            ;(function (e, t) {
              return new Promise(n =>
                (0, B.showConfirm)(
                  {
                    text: U.format({ templateName: e }),
        ...
        _showTemplateSaveRenameDialog(e, t, n) {
          const s = (0, j.createStudyTemplateMetaInfo)(this._controller)
          ;(this._dialog = new T({
            source: e.map(e => e.name),
            title: P,
            saveSymbolHintText: V.format({ symbol: t }),
            saveIntervalHintText: F.format({ interval: (0, R.translatedIntervalString)(n) }),
            indicatorsText: (0, j.descriptionString)(s.indicators),
    ...
    23177: (e, t, n) => {
      'use strict'
      n.d(t, { createStudyTemplateMetaInfo: () => o, descriptionString: () => r })
      var s = n(81851)
      function o(e, t) {
        return {
          indicators: e
            .orderedDataSources(!0)
            .filter(e => (0, s.isStudy)(e) && !0)
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (o(n, 'right', s() + 'px'), (t.style.paddingRight = a + s() + 'px'), (l = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && a > 0 && 0 == --a && (t.classList.remove('i-no-scroll'), l)) {
          o(n, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= s()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (l = !1)
        }
      }
    },
    50182: (e, t, n) => {
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handleKeyDown = e => {
              ...
              13 === (0, c.hashFromEvent)(e) && s && (e.preventDefault(), n || t())
            })
        }
        render() {
          const {
          ...
          return s.createElement(u.AdaptivePopupDialog, {
            ...d,
            ref: this._dialogRef,
            onKeyDown: this._handleKeyDown,
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  p &&
                    s.createElement(
                      i.Button,
                      { className: g, name: 'cancel', appearance: 'stroke', onClick: this._handleCancel },
                      null != h ? h : (0, l.t)('Cancel'),
                    ),
                  s.createElement(
                    'span',
                    ...
                    s.createElement(
                      i.Button,
                      { className: m, disabled: c, name: 'submit', onClick: u, 'data-name': 'submit-button' },
                      null != a ? a : (0, l.t)('Ok'),
                    ),
                  ),
                ),
    ...
    85457: (e, t, n) => {
      ...
      var r = n(97754),
        ...
        g = n(76422),
        f = n(9745)
      const v = s.createContext({ setHideClose: () => {} })
      var b = n(37257),
        C = n(91441)
      function _(e) {
        const {
        ...
        return s.createElement(
          ...
          s.createElement(
            'div',
            { className: i()(C.container, u, (n || d) && C.unsetAlign) },
            a,
            s.createElement(
              'div',
              { 'data-dragg-area': c, className: C.title },
              s.createElement('div', { className: C.ellipsis }, t),
              n && s.createElement('div', { className: i()(C.ellipsis, C.subtitle) }, n),
            ),
            l,
            o &&
              !h &&
              s.createElement(f.Icon, {
                className: C.close,
                icon: b,
                onClick: r,
                'data-name': 'close',
      ...
      class x extends s.PureComponent {
                ...
                switch ((this.props.onKeyDown && this.props.onKeyDown(e), (0, a.hashFromEvent)(e))) {
                  case 27:
                    ...
                    const { activeElement: n } = document,
                      s = (0, o.ensureNotNull)(this._reference)
                    if (null !== n) {
                      if (
                        (e.preventDefault(),
                      ...
                      if ((0, l.isTextEditingField)(n)) return void s.focus()
        ...
        componentDidMount() {
          var e, t
          g.subscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t
          g.unsubscribe(m.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          const {
            ...
            L = 'after' !== m ? g : void 0,
            B = 'after' === m ? g : void 0,
            R = 'string' == typeof r ? r : T || ''
          return s.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.SmallHeight }, m =>
            s.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, d =>
              s.createElement(
                c.PopupDialog,
                {
                  rounded: !(d || E) && N,
                  className: i()(w.dialog, e),
                  isOpened: o,
                ...
                s.createElement(
                  'div',
                  { className: i()(w.wrapper, t), 'data-name': a, 'data-dialog-name': R },
                  void 0 !== r &&
                    s.createElement(_, {
                      draggable: x && !(d || E),
                      onClose: this._handleClose,
                  ...
                  s.createElement(p.PopupContext.Consumer, null, e => this._renderChildren(e, d || E)),
                ),
              ),
            ),
          )
      ...
      function r(e) {
        ...
        return (
          (0, s.useLayoutEffect)(() => {
            ...
            return (0, o.addOutsideEventListener)(d.current, s, a, c, e)
          }, [t, n, r, i, a]),
          l || u
        )
      }
    ...
    1109: (e, t, n) => {
      ...
      var s = n(59496),
        ...
        r = n(91626)
      function i(e) {
        return s.createElement('div', { className: o(r.separator, e.className) })
      }
    },
    88216: (e, t, n) => {
      'use strict'
      ...
      class l extends s.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            o.createPortal(s.createElement(c.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
    ...
    10381: (e, t, n) => {
      ...
      function l(e) {
        ...
        return s.createElement(r.Icon, { className: o(n, i.icon, { [i.dropped]: t }), icon: a })
      }
    },
    49154: e => {
      e.exports =
