...
;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4707],
  {
    ...
    1633: (e, t, r) => {
      function n(e, t, r, n) {
        ...
        for (var s = Object.prototype.hasOwnProperty.bind(t), u = 0; u < i.length; u++) {
          ...
          var d = e[c],
            l = t[c]
          if (!1 === (o = r ? r.call(n, d, l, c) : void 0) || (void 0 === o && d !== l)) return !1
        }
        return !0
      }
    ...
    53408: (e, t, r) => {
      ...
      function o() {
        return (
          n || ((n = new Image()).src = 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='), n
        )
      }
    ...
    11307: (e, t, r) => {
      ...
      r.r(n), r.d(n, { FILE: () => p, HTML: () => m, TEXT: () => y, URL: () => v })
      var a = (function () {
          function e(t) {
            !(function (e, t) {
      ...
      var d = (function () {
        function e(t, r) {
          ...
          for (var a, s, u = [], c = [], d = [], l = 0; l < n - 1; l++)
            (a = t[l + 1] - t[l]), (s = r[l + 1] - r[l]), c.push(a), u.push(s), d.push(s / a)
          ...
          ;(this.xs = t), (this.ys = r), (this.c1s = f), (this.c2s = b), (this.c3s = O)
        }
        var t, r, n
        return (
          (t = e),
          (r = [
            {
              ...
              value: function (e) {
                ...
                var l = e - t[(a = Math.max(0, c))],
                  f = l * l
                return r[a] + n[a] * l + o[a] * f + i[a] * l * f
              },
            },
          ]) && c(t.prototype, r),
          n && c(t, n),
      ...
      function h(e, t, r, n, o) {
        var i,
          ...
          f =
            'IMG' === (i = t).nodeName &&
            (s() || !(null !== (a = document.documentElement) && void 0 !== a && a.contains(i))),
          h = l(f ? e : t),
          ...
          b = (function (e, t, r, n) {
            var o = e ? t.width : r,
              i = e ? t.height : n
            return (
              u() && e && ((i /= window.devicePixelRatio), (o /= window.devicePixelRatio)),
          ...
          T = 0 === w || w
        return {
          x: 0 === S || S ? S : new d([0, 0.5, 1], [g.x, (g.x / p) * O, g.x + O - p]).interpolate(y),
          y: T
            ? w
            : ((c = new d([0, 0.5, 1], [g.y, (g.y / v) * D, g.y + D - v]).interpolate(m)),
            ...
            !(function (e, t) {
              ...
              (this.endDragNativeItem = function () {
                o.isDraggingNativeItem() &&
                  (o.actions.endDrag(),
                  o.currentNativeHandle && o.registry.removeSource(o.currentNativeHandle),
                  (o.currentNativeHandle = null),
                  (o.currentNativeSource = null))
              }),
              (this.isNodeInDocument = function (e) {
                return Boolean(e && o.document && o.document.body && document.body.contains(e))
              }),
                  ...
                  if (o.monitor.isDragging()) {
                    if (n && 'function' == typeof n.setDragImage) {
                      var a = o.monitor.getSourceId(),
                        ...
                        u = o.sourcePreviewNodes.get(a) || s
                      if (u) {
                    ...
                    o.setCurrentDragSourceNode(e.target),
                      o.getCurrentSourcePreviewNodeOptions().captureDraggingState
              ...
              (this.handleTopDragEnter = function (e) {
                ...
                ;((o.dragEnterTargetIds = []), o.monitor.isDragging()) &&
                  ...
                  t.length > 0 && o.actions.hover(t, { clientOffset: f(e) }),
                  t.some(function (e) {
              ...
              (this.handleTopDropCapture = function (e) {
                ...
                ;((o.dropTargetIds = []), o.isDraggingNativeItem()) &&
                  (e.preventDefault(),
                  null === (t = o.currentNativeSource) || void 0 === t || t.loadDataTransfer(e.dataTransfer))
                ...
                value: function () {
                  ...
                  void 0 !== t &&
                    ...
                    this.asyncEndDragFrameId &&
                      (null === (e = this.window) || void 0 === e || e.cancelAnimationFrame(this.asyncEndDragFrameId)))
                },
              },
              {
    ...
    36028: (e, t, r) => {
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                ...
                get: function () {
                  var e
                  return null !== (e = this.context) && void 0 !== e && e.document
      ...
      var v =
          (p((f = {}), n.mouse, { start: 'mousedown', move: 'mousemove', end: 'mouseup', contextmenu: 'contextmenu' }),
          p(f, n.touch, { start: 'touchstart', move: 'touchmove', end: 'touchend' }),
          ...
          function e(t, r, o) {
            ...
            !(function (e, t) {
              ...
              (this.handleTopMoveStart = function (e) {
                if (s(e)) {
                  var t = c(e)
                  t && (u(e) && (a.lastTargetTouchFallback = e.targetTouches[0]), (a._mouseClientOffset = t)),
                    (a.waitingForDelay = !1)
                }
              }),
                  ...
                  if (d)
                    if (
                      ...
                      (!a.monitor.isDragging() &&
                        (function (e, t, r, n, o) {
                          if (!o) return !1
                          for (var i = (180 * Math.atan2(n - t, r - e)) / Math.PI + 180, a = 0; a < o.length; ++a)
                      ...
                      (!a.monitor.isDragging() &&
                        ...
                        (r = a._mouseClientOffset.y || 0),
                        (n = d.x),
                        (o = d.y),
                        Math.sqrt(Math.pow(Math.abs(n - t), 2) + Math.pow(Math.abs(o - r), 2)) >
                      ...
                      var l = a.sourceNodes.get(a.monitor.getSourceId())
                      ...
                      for (var p in h)
                        if (h.hasOwnProperty(p)) {
                          var v = h[p]
                          for (g.push(v); v; ) (v = v.parentElement) && -1 === g.indexOf(v) && g.push(v)
                        }
                      var y = g
                        .filter(function (e) {
                      ...
                      if (u)
                        for (var m in a.targetNodes) {
                          ...
                          if (l && b && b.contains(l) && -1 === y.indexOf(m)) {
                            y.unshift(m)
                            break
                          }
                        }
              ...
              (this._getDropTargetId = function (e) {
                for (var t = a.targetNodes.keys(), r = t.next(); !1 === r.done; ) {
                  var n = r.value
              ...
              (this.handleCancelOnEscape = function (e) {
                'Escape' === e.key &&
                  a.monitor.isDragging() &&
                  ((a._mouseClientOffset = {}), a.uninstallSourceNodeRemovalObserver(), a.actions.endDrag())
              }),
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  this.document &&
                    ((0, o.invariant)(!e.isSetUp, 'Cannot have two Touch backends at the same time.'),
                    (e.isSetUp = !0),
                    this.addEventListener(this.document, 'start', this.getTopMoveStartHandler()),
                    this.addEventListener(this.document, 'start', this.handleTopMoveStartCapture, !0),
                    this.addEventListener(this.document, 'move', this.handleTopMove),
                    this.addEventListener(this.document, 'move', this.handleTopMoveCapture, !0),
                    this.addEventListener(this.document, 'end', this.handleTopMoveEndCapture, !0),
                    ...
                    this.options.enableKeyboardEvents &&
                      this.addEventListener(this.document, 'keydown', this.handleCancelOnEscape, !0))
                },
              },
              {
                key: 'teardown',
                value: function () {
                  this.document &&
                    ((e.isSetUp = !1),
                    (this._mouseClientOffset = {}),
                    this.removeEventListener(this.document, 'start', this.handleTopMoveStartCapture, !0),
                    this.removeEventListener(this.document, 'start', this.handleTopMoveStart),
                    this.removeEventListener(this.document, 'move', this.handleTopMoveCapture, !0),
                    this.removeEventListener(this.document, 'move', this.handleTopMove),
                    this.removeEventListener(this.document, 'end', this.handleTopMoveEndCapture, !0),
                    this.options.enableMouseEvents &&
                      !this.options.ignoreContextMenu &&
                      this.removeEventListener(this.document, 'contextmenu', this.handleTopMoveEndCapture),
                    this.options.enableKeyboardEvents &&
                      this.removeEventListener(this.document, 'keydown', this.handleCancelOnEscape, !0),
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    ...
                    function () {
                      r.sourceNodes.delete(e), r.removeEventListener(t, 'start', n)
                    }
                  )
                },
              },
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  var n = function (n) {
                    if (r.document && r.monitor.isDragging()) {
                      var o
                      switch (n.type) {
                        case v.mouse.move:
                          ...
                          break
                        case v.touch.move:
                          o = { x: n.touches[0].clientX, y: n.touches[0].clientY }
                      }
                      var i = null != o ? r.document.elementFromPoint(o.x, o.y) : void 0,
                        a = i && t.contains(i)
                      return i === t || a ? r.handleMove(n, e) : void 0
                    }
                  }
                  return (
                    ...
                    function () {
                      r.document && (r.targetNodes.delete(e), r.removeEventListener(r.document.body, 'move', n))
                    }
                  )
                },
              },
    ...
    86416: (e, t, r) => {
      ...
      var m = { type: a, payload: { clientOffset: null, sourceClientOffset: null } }
      function b(e) {
        return function () {
      ...
      function E(e) {
        return function (t) {
          ...
          k(o, i, a)
          var s = i.getItemType()
          return P(o, a, s), j(o, i, a), { type: c, payload: { targetIds: o, clientOffset: n || null } }
        }
      }
      function I(e) {
      ...
      function k(e, t, r) {
        ...
        for (var n = 0; n < e.length; n++) {
          var o = e[n]
          ;(0, i.invariant)(e.lastIndexOf(o) === n, 'Expected targetIds to be unique in the passed array.')
          var a = r.getTarget(o)
      ...
      function x(e) {
        return function () {
          ...
          o.forEach(function (o, i) {
            var a = _(o, i, n, r),
              s = { type: d, payload: { dropResult: R(R({}, t), a) } }
            e.dispatch(s)
          })
        }
      }
      ...
      function _(e, t, r, n) {
        ...
        return (
          (function (e) {
            ;(0, i.invariant)(void 0 === e || v(e), 'Drop result must either be an object or undefined.')
          })(a),
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    r = (function (e) {
                      return { beginDrag: b(e), publishDragSource: T(e), hover: E(e), drop: x(e), endDrag: H(e) }
                    })(this)
      ...
      var W = { initialSourceClientOffset: null, initialClientOffset: null, clientOffset: null }
      function z() {
        ...
        switch (t.type) {
          ...
          case c:
            return X(e.clientOffset, r.clientOffset) ? e : V(V({}, e), {}, { clientOffset: r.clientOffset })
          case l:
          case d:
            return W
          default:
        ...
        switch (t.type) {
          ...
          case Z:
            return -1 === e.targetIds.indexOf(r.targetId)
              ? e
              : te(te({}, e), {}, { targetIds: p(e.targetIds, r.targetId) })
          case d:
            return te(te({}, e), {}, { dropResult: r.dropResult, didDrop: !0, targetIds: [] })
          case l:
            return te(
              te({}, e),
              {},
      ...
      function ge() {
        ...
        return {
          dirtyHandlerIds: ce(e.dirtyHandlerIds, {
            type: t.type,
            payload: fe(fe({}, t.payload), {}, { prevTargetIds: g(e, 'dragOperation.targetIds', []) }),
          }),
            ...
            (r = [
                  ...
                  var o = this.store.getState().stateId,
                    a = function () {
                      var r = t.store.getState(),
                        i = r.stateId
                      try {
                        i === o || (i === o + 1 && !ue(r.dirtyHandlerIds, n)) || e()
                      } finally {
                        o = i
                      }
                    }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (0, i.invariant)(t, 'Expected to find a valid source. sourceId='.concat(e)),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (0, i.invariant)(t, 'Expected to find a valid target. targetId='.concat(e)),
                    !(!this.isDragging() || this.didDrop()) &&
                      C(this.registry.getTargetType(e), this.getItemType()) &&
                      t.canDrop(this, e)
                  )
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ...
                    n && o && i ? pe(((r = i), { x: (t = n).x + r.x, y: t.y + r.y }), o) : null
                  )
                  var e, t, r, n, o, i
                },
              },
      ...
      function Ee() {
        for (; Ce < Te.length; ) {
          ...
          if (((Ce += 1), Te[e].call(), Ce > 1024)) {
            for (var t = 0, r = Te.length - Ce; t < r; t++) Te[t] = Te[t + Ce]
            ;(Te.length -= Ce), (Ce = 0)
          }
        }
        ;(Te.length = 0), (Ce = 0), !1
      ...
      function qe(e) {
        switch (e[0]) {
          ...
          case 'T':
            return ye.TARGET
          default:
            ;(0, i.invariant)(!1, 'Cannot parse handler ID: '.concat(e))
        }
      }
      function Xe(e, t) {
        var r = e.entries(),
          ...
          (r = [
            {
              ...
              value: function (e, t) {
                ...
                return (
                  this.store.dispatch(
                    (function (e) {
                      return { type: $, payload: { sourceId: e } }
                    })(r),
                  ),
                  r
                )
            ...
            },
            {
              ...
              value: function (e, t, r) {
                ...
                return (
                  this.types.set(n, t),
                  e === ye.SOURCE ? this.dragSources.set(n, r) : e === ye.TARGET && this.dropTargets.set(n, r),
                  n
                )
              },
            },
      ...
      function Ve(e) {
        ...
        return (0, B.createStore)(ge, e && t && t({ name: 'dnd-core', instanceId: 'dnd-core' }))
      }
      var Ke = r(89742)
      function We(e, t) {
        return (
      ...
      var Qe = 0,
        ...
        Ze = (0, o.memo)(function (e) {
              ...
              (function (e) {
                ...
                var t = (function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : et(),
                      ...
                      o = t
                    o[Je] || (o[Je] = { dragDropManager: Ye(e, t, r, n) })
                    return o[Je]
          ...
          return (
            ...
            (0, n.jsx)(Ke.DndContext.Provider, Object.assign({ value: i }, { children: t }), void 0)
          )
        })
      function et() {
    ...
    53614: (e, t, r) => {
      ...
      function O(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
        return (
          (0, d.checkDecoratorArguments)('DragLayer', 'collect[, options]', e, t),
          (0, a.invariant)(
            'function' == typeof e,
          ...
          function (r) {
            var s = r,
              ...
              b = (function (t) {
                ...
                function u() {
                  ...
                  return (
                    f(this, u),
                    ((e = r.apply(this, arguments)).isCurrentlyMounted = !1),
                    (e.ref = (0, o.createRef)()),
                ...
                return (
                  g(u, [
                    ...
                    },
                    {
                      ...
                      value: function (e, t) {
                        return !v(e, this.props) || !(0, i.shallowEqual)(t, this.state)
                      },
                    },
                    {
                      ...
                      value: function () {
                        ;(this.isCurrentlyMounted = !1),
                          this.unsubscribeFromOffsetChange &&
                            (this.unsubscribeFromOffsetChange(), (this.unsubscribeFromOffsetChange = void 0)),
                                  ...
                                  e.isCurrentlyMounted
                                    ? (0, n.jsx)(
                                        ...
                                        Object.assign({}, e.props, e.state, {
                                          ref: (0, d.isRefable)(s) ? e.ref : null,
                                        }),
                                        void 0,
                                      )
                                    : null)
            ...
            return (b.displayName = 'DragLayer('.concat(m, ')')), (b.DecoratedComponent = r), u()(b, r)
          }
        )
      }
    },
    61625: (e, t, r) => {
            ...
            (this.hooks = (0, o.wrapConnectorHooks)({
              dragSource: function (e, t) {
                r.clearDragSource(),
                  ...
                  (0, i.isRef)(e) ? (r.dragSourceRef = e) : (r.dragSourceNode = e),
                  r.reconnectDragSource()
              },
              dragPreview: function (e, t) {
                r.clearDragPreview(),
                  (r.dragPreviewOptions = t || null),
                  (0, i.isRef)(e) ? (r.dragPreviewRef = e) : (r.dragPreviewNode = e),
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    return (d = !0), this.internalMonitor.canDragSource(this.sourceId)
                  } finally {
                    d = !1
                  }
                },
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  this.props &&
                    this.spec.endDrag &&
                    this.spec.endDrag(this.props, this.monitor, (0, g.getDecoratedComponent)(this.ref))
                },
              },
            ]) && v(t.prototype, r),
            n && v(t, n),
      ...
      function D(e, t, r) {
        ...
        ;(0, g.checkDecoratorArguments)('DragSource', 'type, spec, collect[, options]', e, t, r, o)
        var i = e
        'function' != typeof e &&
          ((0, n.invariant)(
            (0, g.isValidType)(e),
    ...
    35126: (e, t, r) => {
              ...
              (this.hooks = (0, u.wrapConnectorHooks)({
                dropTarget: function (e, t) {
                  r.clearDropTarget(),
                    ...
                    (0, c.isRef)(e) ? (r.dropTargetRef = e) : (r.dropTargetNode = e),
                    r.reconnect()
                },
              })),
              (this.handlerId = null),
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  return !(0, s.shallowEqual)(this.lastConnectedDropTargetOptions, this.dropTargetOptions)
                },
              },
              {
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  this.spec.hover &&
                    this.props &&
                    this.spec.hover(this.props, this.monitor, (0, h.getDecoratedComponent)(this.ref))
                },
              },
              {
                key: 'drop',
      ...
      function b(e, t, r) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}
        ;(0, h.checkDecoratorArguments)('DropTarget', 'type, spec, collect[, options]', e, t, r, o)
        var i = e
        'function' != typeof e &&
          ((0, n.invariant)(
            (0, h.isValidType)(e, !0),
    ...
    57227: (e, t, r) => {
      ...
      var f = (function () {
        function e(t) {
          c(this, e), (this.isDisposed = !1), (this.action = (0, u.isFunction)(t) ? t : u.noop)
        }
        return (
          l(
            e,
            ...
            [
              {
                key: 'isDisposable',
                value: function (e) {
                  return Boolean(e && (0, u.isFunction)(e.dispose))
                },
              },
              {
                key: '_fixup',
          ...
          return (
            l(e, [
              ...
              },
              {
                ...
                value: function () {
                  if (!this.isDisposed) {
                    for (var e = this.disposables.length, t = new Array(e), r = 0; r < e; r++)
      ...
      function C(e) {
          ...
          I = (function (e) {
            ...
            function I(e) {
              ...
              return (
                ...
                ((t = w.call(this, e)).decoratedRef = (0, o.createRef)()),
            ...
            return (
              ...
              (p = [
                ...
                },
                {
                  key: 'shouldComponentUpdate',
                  value: function (e, t) {
                    return !T(e, this.props) || !(0, i.shallowEqual)(t, this.state)
                  },
                },
                {
                  key: 'componentDidMount',
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
                      ...
                      var o = this.manager.getMonitor().subscribeToStateChange(this.handleChange, { handlerIds: [r] })
                      this.disposable.setDisposable(new h(new f(o), new f(n)))
                    }
                  },
                },
                {
                ...
                },
                {
                  key: 'getCurrentState',
                  value: function () {
                    return this.handlerConnector ? b(this.handlerConnector.hooks, this.handlerMonitor, this.props) : {}
                  },
                },
                {
                  key: 'render',
                          ...
                          return (
                            ...
                            (0, n.jsx)(
                              ...
                              Object.assign({}, e.props, e.getCurrentState(), {
                                ref: (0, u.isRefable)(C) ? e.decoratedRef : null,
                              }),
                              void 0,
                            )
                          )
        ...
        return (I.DecoratedComponent = t), (I.displayName = ''.concat(p, '(').concat(E, ')')), v()(I, t)
      }
    },
    59885: (e, t, r) => {
      function n(e) {
        ...
        return (
          ...
          (function (e) {
            ...
            return (
              ...
              (null == r || null === (t = r.$$typeof) || void 0 === t ? void 0 : t.toString())
            )
          })(e)
        )
        var t
