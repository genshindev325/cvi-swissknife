  ...
  [2306],
  {
    66783: t => {
      ...
      t.exports = function (t, i) {
        ...
        for (var r = 0; r < n.length; r++) if (!e.call(i, n[r]) || !o(t[n[r]], i[n[r]])) return !1
        return !0
      }
    },
    62632: () => {},
    ...
    24429: t => {
      t.exports = { hue: 'hue-oQv2KoOx', pointer: 'pointer-oQv2KoOx', pointerContainer: 'pointerContainer-oQv2KoOx' }
    },
    15381: t => {
      t.exports = {
    ...
    88440: t => {
      t.exports = { saturation: 'saturation-lJHGRPyu', pointer: 'pointer-lJHGRPyu' }
    },
    24590: t => {
      t.exports = {
    ...
    94720: (t, e, o) => {
      ...
      function d(t) {
        const { size: e, startIcon: o, icon: n, iconOnly: s, children: a, endIcon: c } = t,
          d = null != o ? o : n
        return i.createElement(
          i.Fragment,
          null,
          d && 'xsmall' !== e && i.createElement(r.Icon, { icon: d, className: l()['start-icon-wrap'] }),
          a && i.createElement('span', { className: l().content }, a),
          c && !s && 'xsmall' !== e && i.createElement(r.Icon, { icon: c, className: l()['end-icon-wrap'] }),
        )
      }
      var h = o(86332),
        p = o(90186)
      function u(t) {
        ...
        return { ...h, ...(0, p.filterDataProps)(t), ...(0, p.filterAriaProps)(t) }
      }
      function g(t) {
        const { reference: e, ...o } = t,
          { isGrouped: n, cellState: s, disablePositionAdjustment: r } = (0, i.useContext)(h.ControlGroupContext),
          a = c({ ...o, isGrouped: n, cellState: s, disablePositionAdjustment: r })
        return i.createElement('button', { ...u(o), className: a, ref: e }, i.createElement(d, { ...o }))
      }
      ...
      function w(t) {
        const { intent: e, size: o, appearance: i, useFullWidth: n, icon: s, ...r } = t
        return { ...r, color: m(e), size: v(o), variant: _(i), stretch: n, startIcon: s }
      }
      function y(t) {
    ...
    14593: (t, e, o) => {
      ...
      const a = i.forwardRef((t, e) => {
        ...
        return i.createElement(s.ToolWidgetButton, { 'data-name': a, ...l, ref: e, className: n(o, r.button) })
      })
    },
    56588: (t, e, o) => {
      'use strict'
      ...
      class _ extends n.FloatingToolbar {
        ...
        _onFavoriteRemoved(t) {
          this.removeWidget(this._linetoolsWidgets[t]),
            ...
            0 === s.LinetoolsFavoritesStore.favoritesCount() && (this._canBeShownValue.setValue(!1), this.hide())
        }
        _onFavoriteMoved() {
        ...
        _attachHandlers() {
          s.LinetoolsFavoritesStore.favoriteAdded.subscribe(this, this._onFavoriteAdded),
            s.LinetoolsFavoritesStore.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
            s.LinetoolsFavoritesStore.favoriteMoved.subscribe(this, this._onFavoriteMoved),
            ...
            this.onWidgetsReordered().subscribe(this, (t, e) => {
              if (
                (s.LinetoolsFavoritesStore.favoriteMoved.unsubscribe(this, this._onFavoriteMoved),
                !s.LinetoolsFavoritesStore.moveFavorite(s.LinetoolsFavoritesStore.favorite(t), e))
              )
    ...
    95952: (t, e, o) => {
      'use strict'
      o.d(e, { FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => S, FloatingToolbar: () => T })
      var i = o(59064),
        n = o(32563),
        s = o(68587),
        r = o(56840),
      ...
      class y {
        ...
        _getEventTarget() {
          return v.CheckMobile.iOS() || ((0, v.isMac)() && n.touch) ? window.document.documentElement : this._handle
        }
        _dispatchEvent(t) {
          switch (t.type) {
      ...
      class T {
        constructor(t) {
          ;(this._widget = document.createElement('div')),
            ...
            (this._reactWidgetsContainer = this._widget.getElementsByClassName(S).item(0)),
        ...
        _getSavedPosition() {
          ...
          } else e = null !== (t = (0, r.getJSON)(this._options.positionSettingsKey)) && void 0 !== t ? t : null
        ...
        _savePosition() {
          ...
          else (0, r.setJSON)(this._options.positionSettingsKey, { left: t.left, top: t.top })
        }
        _init() {
          this._loadPosition(),
    ...
    36052: (t, e, o) => {
      ...
      function S(t) {
        ...
        return a && a.length
                        ...
                        n.map((o, n) => {
                          ...
                          return s
                            ? o.showForSmallScreen
                              ...
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: C })
                        }),
                    ),
                ),
            )
          : l()
        function l() {
          return null === e ? null : i.createElement(e.component, { ...e.props, isDrawingFinished: s, className: C })
        }
      }
      var x = o(51768),
        T = o(14593),
      ...
      function I(t) {
        ...
        return i.createElement(L.ToolButton, { className: k(e, B.button), tooltipPosition: 'horizontal', ...o })
      }
      var N = o(28358),
        M = o(56717)
      function A(t) {
        ...
        const r = n[0].properties().frozen,
          a = (0, E.useProperty)(r),
          l = a ? { title: (0, s.t)('Unlock'), icon: N } : { title: (0, s.t)('Lock'), icon: M }
      ...
      var R = o(9745),
        ...
        X = o(48111)
      function J(t) {
        const { title: e, activeChartWidget: n, isSmallScreen: r, className: a } = t,
          l = n.model(),
                      ...
                      e = (function () {
                        ...
                        i.length > 0 &&
                          t.push(
                            new H.Action({
                              ...
                              name: 'clone',
                              icon: o(16788),
                              shortcutHint: z.humanReadableModifiers(O.Modifiers.Mod) + e + ' Drag',
                              label: (0, s.t)('Clone'),
                              onExecute: () => {
                                l.cloneLineTools(i, !1), (0, x.trackEvent)('GUI', 'Context action on drawings', 'Clone')
                              },
                            }),
                          )
                        ...
                        if (r.length > 0) {
                          const o = {
                            ...
                            name: 'copy',
                            label: (0, s.t)('Copy'),
                            shortcutHint: z.humanReadableModifiers(O.Modifiers.Mod) + e + ' C',
                            onExecute: () => {
                              n.chartWidgetCollection().clipboard.uiRequestCopy(r)
                            },
                          }
                        ...
                        if (
                          ...
                          return t
                        return t.push(...(0, G.createSyncDrawingActions)(n, c)), t
                      })()
                ...
                ? function (t) {
                    u.contextMenuActionsForSources(c).then(e => {
                      window.matchMedia(f.DialogBreakpoints.TabletSmall).matches
                        ? Y.ContextMenuManager.showMenu(Z(e), t, { mode: 'drawer', 'data-name': 'more-menu' })
                        : h(Z(e))
                    })
                  }
                : void 0,
      ...
      var Q = o(95936),
        ...
        ot = o(56326)
      function it(t) {
        const { property: e, propertyApplier: o, title: n, undoText: r, className: a } = t,
          l = (0, E.useProperty)(e),
          c = (0, i.useMemo)(
            () => [
              new H.Action({
      ...
      function rt(t) {
        const { property: e, propertyApplier: o, title: n, undoText: s, className: r } = t,
          a = (0, E.useProperty)(e),
          l = st.map(
            t =>
              new H.Action({
      ...
      class ct extends b.FloatingToolbar {
        ...
        addGroupedWidget(t, e = {}) {
          ;(0, g.assert)(
            t.states.length > 0 && -1 !== ct._getStateIndexById(t, t.currentStateId),
        ...
        setGroupedWidgetState(t, e) {
          const o = this._ensuredGetWidgetDataForId(t)
          ;(0, g.assert)(-1 !== ct._getStateIndexById(o.statedWidget, e), `Unknown stateId (${e})`),
        ...
        _createPopup(t) {
          ...
          t.statedWidget.states.forEach((i, n) => {
            ...
            s.addEventListener('click', r),
              ...
              s.classList.add('tv-grouped-floating-toolbar__sub-widget--slide-left-' + (o - n + 1)),
        ...
        _updateWidgetPreview(t) {
          ...
          ;(0, g.assert)(-1 !== e, 'Unknown state id: ' + t.statedWidget.currentStateId)
          ...
          t.toolbarWidget.firstChild
            ...
            : (t.toolbarWidget.appendChild(o), t.toolbarWidget.appendChild(ct._createCaret()))
        }
      ...
      var dt = o(18387),
        ...
        pt = o(44159),
        ut = o(46627)
      const gt = new r.TranslatedString('change line tool(s) font size', (0, s.t)('change line tool(s) font size')),
        _t = new r.TranslatedString('change line tool(s) line style', (0, s.t)('change line tool(s) line style')),
        mt = (0, s.t)('Settings'),
        vt = (0, s.t)('Remove'),
        wt = (0, s.t)('More'),
        yt = (0, s.t)('Style'),
      ...
      class ft {
        constructor(t) {
          ;(this._isDrawingFinished = new (c())(!0)),
            ...
            (this._floatingToolbar = new ct({
              defaultPosition: { top: dt.HEADER_TOOLBAR_HEIGHT_EXPANDED + 15, left: window.innerWidth / 2 },
        ...
        hide() {
          ...
          this._updateVisibilityTimeout && clearTimeout(this._updateVisibilityTimeout),
            ...
            null === (t = this._lineToolsDoNotAffectChartInvalidation) || void 0 === t || t.destroy(),
        ...
        _createSettingsButton() {
          const t = { component: W, props: { title: mt, activeChartWidget: this.activeChartWidget() } }
          this._addCommonButton(t)
        }
        _createLockButton() {
          const t = { component: A, props: { title: 'Lock', activeChartWidget: this.activeChartWidget() } }
          this._addCommonButton(t)
        }
        _createRemoveButton() {
          const t = {
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new v(new u.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ...
              : new w.CollectibleColorPropertyDirectWrapper(new u.MultipleLineColorsProperty([t]))
        }
    ...
    87805: (t, e, o) => {
      ...
      var c = o(58912),
        ...
        u = new n('change line tool(s) background color', i('change line tool(s) background color')),
        g = new n('change line tool(s) text color', i('change line tool(s) text color')),
        _ = new n('change line tool(s) line width', i('change line tool(s) line width')),
        m = i('Color'),
      ...
      class B extends s {
        ...
        _createWidthsButton(t, e) {
          if (
            (this._lineWidthsProperty && (this._lineWidthsProperty.destroy(), (this._lineWidthsProperty = null)),
            (this._lineWidthsProperty = this._createProperty(t, e, 'linesWidths', _)),
        ...
        _createColorsButton(t, e) {
          return (
            this._lineColorsProperty && (this._lineColorsProperty.destroy(), (this._lineColorsProperty = null)),
            (this._lineColorsProperty = this._createProperty(t, e, 'linesColors', p)),
        ...
        _createBackgroundsButton(t, e) {
          return (
            ...
            (this._backgroundsProperty = this._createProperty(t, e, 'backgroundsColors', u)),
        ...
        _createTextColorsButton(t, e) {
          return (
            ...
            (this._textColorsProperty = this._createProperty(t, e, 'textsColors', g)),
        ...
        showPropertiesOf(t, e, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var n = {}, s = 0; s < i.length; s++) {
              for (var r = i[s], l = e, c = r.name.split('.'), d = 0; d < c.length; ++d) l = l && l[c[d]]
              var h = r.showIf
        ...
        _defaultToolProperties() {
          return [
            ...
            { name: 'linesWidths', inputType: 'combobox', factory: B.prototype._createWidthsButton },
            { name: 'linestyle', title: C, inputType: 'combobox', factory: B.prototype._createLineStyleButton },
          ]
        }
        _regressionToolExceptionCases() {
          return [{ name: 'linesWidths', inputType: 'combobox', factory: B.prototype._createWidthsButton }]
        }
        _pathExceptionCases() {
          return [
            {
        ...
        _textPropertiesExceptionCases() {
          return [
            { name: 'color', title: w, inputType: 'colorPicker', iconSvgCode: h, dataName: 'text-color', undoText: g },
            {
              name: 'backgroundColor',
              title: b,
              inputType: 'colorPicker',
            ...
            { name: 'fontsize', title: S, inputType: 'combobox', factory: B.prototype._createFontSizeButton },
          ]
        }
    ...
    88451: (t, e, o) => {
      'use strict'
      o.d(e, { CollectibleColorPropertyUndoWrapper: () => a, CollectibleColorPropertyDirectWrapper: () => l })
      var i = o(88537),
        n = o(2015),
        s = o.n(n)
      class r extends s() {
    ...
    70114: (t, e, o) => {
      ...
      var i = o(59496),
        ...
        _ = o(69124)
      function m(t) {
        const { property: e, icon: o, propertyApplier: n, title: m, undoText: v, className: w } = t,
          y = (0, g.useProperty)(e),
          b = (0, i.useRef)(null),
        ...
        return i.createElement(
          ...
          i.createElement(h.ColorPicker, {
            ...
            onColorChange: function (t, e) {
              const o = y ? (0, c.alphaToTransparency)((0, l.parseRgba)(y)[3]) : 0
              E((0, c.generateColor)(String(t), o, true)), e || (0, r.ensureNotNull)(b.current).close()
            },
    ...
    61259: (t, e, o) => {
      ...
      function y(t) {
        const { multipleProperty: e, title: o, undoText: d, propertyApplier: h, className: p, isSmallScreen: u } = t,
        ...
        return i.createElement(
          a.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              ...
              null,
              y
                ? i.createElement('div', { className: m.multiWidth }, i.createElement(r.Icon, { icon: _ }))
                : i.createElement(
                    'div',
                    { className: m.buttonWrap },
                    !u && i.createElement(r.Icon, { icon: b }),
                    i.createElement('div', { className: n(!u && m.buttonLabel) }, g + 'px'),
                  ),
            ),
          },
    ...
    27797: (t, e, o) => {
          ...
          b &&
            i.createElement(
              d.PopupMenu,
              {
                ...
                onClose: f,
                position: function () {
                  const t = (0, l.ensureNotNull)(y.current).getBoundingClientRect()
      ...
      class S extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement('div', { className: C.pointer, style: { left: 100 * o + '%', top: 100 * (1 - n) + '%' } }),
          )
        }
      }
      var x = o(24429)
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: x.pointer, style: { top: 100 * e + '%' } }),
            ),
          )
        }
      }
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement('input', { type: 'text', className: P.input, value: o, onChange: this._handleInput }),
              ),
              i.createElement(
                'div',
            ...
            i.createElement(
              ...
              i.createElement(S, { className: P.saturation, hsv: e, onChange: this._handleHSV }),
              i.createElement(T, { className: P.hue, hsv: e, onChange: this._handleHSV }),
            ),
          )
        }
      }
      ...
      class I extends i.PureComponent {
        ...
        render() {
          ...
          return l
            ? i.createElement(E, { color: t, onSelect: this._handleSelectColor, onAdd: this._handleAddColor })
            : i.createElement(
                'div',
                { className: k.container },
                i.createElement(v, { colors: u.basic, color: t, onSelect: this._handleSelectColor }),
                i.createElement(v, { colors: u.extended, color: t, onSelect: this._handleSelectColor }),
                ...
                n &&
                  i.createElement(
                    ...
                    i.createElement(w.Opacity, { color: t, opacity: c, onChange: this._handleOpacity }),
                  ),
              )
        }
        _onToggleCustom(t) {
    ...
    6914: (t, e, o) => {
      ...
      const n = i.colorsPalette['color-white'],
        ...
        r = [200, 300, 400, 500, 600, 700, 800, 900].map(t => 'color-cold-gray-' + t)
    ...
    56512: (t, e, o) => {
      ...
      function l() {
        ...
        r('add_new_custom_color', o => e(c(o, t))), r('remove_custom_color', o => e(d(o, t)))
        const o = (0, i.useCallback)(
            e => {
              const o = e ? (0, a.parseRgb)(e) : null
              t.some(t => null !== t && null !== o && (0, a.areEqualRgb)((0, a.parseRgb)(t), o)) ||
                (s.emit('add_new_custom_color', e), (0, n.setJSON)('pickerCustomColors', c(e, t)))
            },
            [t],
          ),
          l = (0, i.useCallback)(
            e => {
              ;(e >= 0 || e < t.length) &&
                (s.emit('remove_custom_color', e), (0, n.setJSON)('pickerCustomColors', d(e, t)))
            },
            [t],
          )
        return [t, o, l]
