      ...
      const s = (() => {
        ...
        return () => {
          ...
          if (void 0 === e) {
            ...
            null === (t = n.parentNode) || void 0 === t || t.removeChild(n), (e = r - o)
          }
          return e
        }
      })()
      ...
      function c(e) {
        ...
        if (e && 1 == ++l) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (r(n, 'right', s() + 'px'), (t.style.paddingRight = l + s() + 'px'), (a = !0)),
      ...
      class g extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = ({ callback: e, forceRecalcPosition: t } = {}) => {
              ...
              const f = u.height > m
              if (f) {
                ;((0, o.ensureNotNull)(this._scrollWrapRef).style.overflowY = 'scroll'), (u = c.getBoundingClientRect())
              }
              const { width: _, height: g } = u,
                v = 'function' == typeof a ? a(_, g, d) : a,
                y = h - (null !== (s = v.overrideWidth) && void 0 !== s ? s : _) - 0,
                x = (0, l.clamp)(v.x, 0, Math.max(0, y)),
                C = 0 + p,
                w = d - (null !== (r = v.overrideHeight) && void 0 !== r ? r : g) - 0
              let M = (0, l.clamp)(v.y, C, Math.max(C, w))
              if (
                (v.forbidCorrectYCoord && M < v.y && ((m -= v.y - M), (M = v.y)),
                t && void 0 !== this.props.closeOnScrollOutsideOffset && v.y <= this.props.closeOnScrollOutsideOffset)
              )
                return void this._handleGlobalClose(!0)
              const b = null !== (i = v.overrideHeight) && void 0 !== i ? i : f ? m : void 0
              this.setState(
                {
                  appearingMenuHeight: t ? this.state.appearingMenuHeight : b,
                  appearingMenuWidth: t ? this.state.appearingMenuWidth : v.overrideWidth,
        ...
        render() {
          const {
            ...
            { appearingMenuHeight: w, appearingMenuWidth: M, appearingPosition: b, isMeasureValid: S } = this.state
              ...
              s.createElement(
                ...
                s.createElement(
                  'div',
                  {
                    ...
                    style: { height: w, left: b && b.x, minWidth: l, position: 'fixed', top: b && b.y, width: M },
                  ...
                  s.createElement(
                    'div',
                    {
                      ...
                      style: { overflowY: void 0 !== w ? 'scroll' : 'auto', maxHeight: h },
            ...
            onMouseOver: function (e) {
              if (
                !(
                  ...
                  ((s = e.target), null === (r = n.current) || void 0 === r ? void 0 : r.contains(s))
                )
              )
                return
              var s, r
