;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    75193: e => {
      e.exports = { container: 'container-bD7VSobf', separator: 'separator-bD7VSobf', section: 'section-bD7VSobf' }
    },
    61936: e => {
      e.exports = {
        ...
        action__favoriteIcon_active: 'action__favoriteIcon_active-cwmjKW8F',
          ...
          const d = (0, a.ensureNotNull)(e).getBoundingClientRect(),
            {
              ...
              matchButtonAndListboxWidths: f = c.matchButtonAndListboxWidths,
            } = t,
            C = u === o.Top ? -1 * g : g,
            E = m === i.Right ? d.right : d.left,
            w = u === o.Top ? d.top : d.bottom,
            x = { x: E - (p === s.FromRightToLeft ? n : 0) + v, y: w - (h === r.FromBottomToTop ? l : 0) + C }
    ...
    11507: (e, t, n) => {
      ...
      function a(e, t, n) {
        ...
        const a = [],
          ...
          u = t.baseCurrencies,
          h = t.displayedValues,
          m = s.favoriteCurrencyUnitConversionService.get().currencies,
          p = { id: 'first_section', actions: [] }
        if (d.size > 1) {
          const e = (0, r.createAction)('Mixed', (0, i.t)('Mixed'), void 0, void 0, null === t.selectedCurrency, () =>
            c(null),
          )
          p.actions.push(e)
        }
        ...
        if (null !== l) {
          const e = (0, o.ensureNotNull)(v.item(l)),
            t = (0, r.createAction)(
              ...
              () => {},
              m.has(l),
              () => s.favoriteCurrencyUnitConversionService.toggle('currencies', l),
            )
          p.actions.push(t)
        }
        ...
        return (E.length > 0 || C.length > 0) && a.push({ id: 'second_section', actions: C.concat(E) }), a
      }
    },
    19868: (e, t, n) => {
      'use strict'
    ...
    53997: (e, t, n) => {
      ...
      function a(e, t, n) {
        ...
        if (d.size > 1) {
          const e = (0, r.createAction)('Mixed', (0, i.t)('Mixed'), void 0, void 0, null === t.selectedUnit, () =>
            c(null),
          )
          p.actions.push(e)
        }
        ...
        if (null !== l) {
          const e = (0, r.createAction)(
            ...
            () => {},
            m.has(l),
            () => s.favoriteCurrencyUnitConversionService.toggle('units', l),
          )
          p.actions.push(e)
        }
        ...
        ;(f.length > 0 || C.length > 0) &&
          p.actions.push(...C.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ...f),
          p.actions.length > 0 && a.push(p)
        ...
        if (null !== E)
          for (const e of g) {
            ...
            t.length > 0 && a.push({ id: e.name, name: e.name, actions: t })
          }
        for (const e of g) {
          if (e.name === E) continue
          const t = []
    ...
    82629: (e, t, n) => {
      ...
      function o(e, t, n, o, i, r, s, a) {
        return { id: e, label: t, icon: n, description: o, isActive: i, onClick: r, isFavorite: s, onFavoriteClick: a }
      }
    ...
    85457: (e, t, n) => {
      ...
      function w(e) {
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { className: s()(E.container, d, (n || u) && E.unsetAlign) },
            a,
            o.createElement(
              'div',
              { 'data-dragg-area': l, className: E.title },
              o.createElement('div', { className: E.ellipsis }, t),
              n && o.createElement('div', { className: s()(E.ellipsis, E.subtitle) }, n),
            ),
            c,
            i &&
              !h &&
      ...
      class D extends o.PureComponent {
                ...
                switch ((this.props.onKeyDown && this.props.onKeyDown(e), (0, a.hashFromEvent)(e))) {
                  case 27:
                    ...
                    const { activeElement: n } = document,
                      o = (0, i.ensureNotNull)(this._reference)
                    if (null !== n) {
                      if (
                        (e.preventDefault(),
        ...
        componentDidMount() {
          var e, t
          v.subscribe(p.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t
          v.unsubscribe(p.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          ...
          return o.createElement(h.MatchMedia, { rule: u.DialogBreakpoints.SmallHeight }, p =>
            o.createElement(h.MatchMedia, { rule: u.DialogBreakpoints.TabletSmall }, u =>
              o.createElement(
                l.PopupDialog,
                {
                  rounded: !(u || S) && N,
                ...
                o.createElement(
                  'div',
                  { className: s()(x.wrapper, t), 'data-name': a, 'data-dialog-name': U },
                  void 0 !== r &&
                    o.createElement(w, {
                      draggable: D && !(u || S),
                  ...
                  C && o.createElement(d.Separator, { className: x.separator }),
                  o.createElement(m.PopupContext.Consumer, null, e => this._renderChildren(e, u || S)),
                ),
              ),
            ),
          )
    ...
    71834: (e, t, n) => {
      ...
      const D = o.memo(
        function (e) {
          ...
          return o.createElement(
            'div',
            { className: h()(b.action, l && b.active, E, p && b.withDescription, u && b.selected), onClick: C, ref: m },
            v &&
              (void 0 !== n
                ? o.createElement(x, { logoUrl: n, size: p ? 'xsmall' : 'xxsmall', className: h()(b.icon, E) })
                : o.createElement('span', { className: h()(b.fakeIcon, E) })),
            o.createElement(
              'div',
              { className: h()(b.labelAndDescription, E) },
              o.createElement('span', { className: h()(b.label, E) }, D(t)),
              p && o.createElement('br', null),
              p && o.createElement('span', { className: h()(b.description, E) }, s ? D(s) : ''),
            ),
            void 0 !== g &&
              o.createElement(
                'div',
                { className: h()(b.action__favoriteIcon, g && b.action__favoriteIcon_active) },
      ...
      function O(e) {
        const {
          ...
          [x, y] = (0, o.useState)(() => n.reduce((e, t, n) => (t.name && (e[t.id] = !0), e), {}))
        function b(e) {
          const { id: t, ...n } = e
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              o.createElement(p.Icon, { icon: S, className: N.icon }),
          ...
          a
            ...
            : n.map((e, t) =>
                o.createElement(
                  o.Fragment,
                  { key: e.id },
                  Boolean(t) && o.createElement(C.PopupMenuSeparator, null),
                  e.name
                    ? o.createElement(
        ...
        return o.createElement(F.AdaptivePopupDialog, {
          ...
          render: function () {
            return o.createElement(
              o.Fragment,
              null,
              o.createElement(M.DialogSearch, { placeholder: (0, m.t)('Search'), onChange: v, reference: u }),
              o.createElement(
                'div',
                ...
                a
                  ...
                  : i.map((e, t) =>
                      o.createElement(
                        o.Fragment,
                        { key: e.id },
                        e.name && o.createElement('div', { className: z.section }, e.name),
                        e.actions.map((c, l) => {
                          const { id: u, ...m } = c,
                          ...
                          return o.createElement(
                            ...
                            o.createElement(D, {
                              ...
                              onClose: n,
                              isSelected: u === r,
                              selectedRef: u === r ? s : void 0,
                              hasIcons: h,
                              hasDescriptions: p,
                              ...m,
                            }),
                            !g && v && o.createElement('div', { className: z.separator }),
                          )
                        }),
                      ),
                    ),
      ...
      function U(e) {
        const { element: t, ...n } = e,
          ...
          { activeIdx: g, setActiveIdx: f } = (function (e, t, n, i = 'keydown') {
            ...
            return (
              ...
              (0, o.useEffect)(() => {
                ...
                const o = e => {
                  var o
                  e.repeat || (13 === (0, c.hashFromEvent)(e) && n(null !== (o = t[r]) && void 0 !== o ? o : null, e))
                }
                return (
        ...
        return o.createElement(s.MatchMedia, { rule: l.DialogBreakpoints.TabletSmall }, e =>
          e
            ? o.createElement(L, { ...n, ...C })
            : o.createElement(O, { ...n, ...C, position: (0, d.getPopupPositioner)(t, I), doNotCloseOn: t }),
        )
        function E() {
          ...
          ;(this._rootElem = document.createElement('div')),
            (this.close = () => {
              null !== this._rootElem &&
                ...
                r.favoriteCurrencyUnitConversionService.getOnChange().unsubscribe(this, this._render),
                (this._rootElem = null))
            }),
    ...
    36189: (e, t, n) => {
      ...
      var o = n(28353),
        ...
        c = n(55783),
        l = n(16842)
      const d = { add: (0, o.t)('Add to favorites'), remove: (0, o.t)('Remove from favorites') }
      function u(e) {
        const { className: t, isFilled: n, isActive: o, onClick: u, ...h } = e
        return i.createElement(s.Icon, {
          ...h,
          className: r(l.favorite, 'apply-common-tooltip', n && l.checked, o && l.active, t),
          icon: n ? a : c,
          onClick: u,
              ...
              n.forEach(e => {
                ...
                return (
                  ...
                  t && t.toLowerCase() === i.toLowerCase()
                    ? ((d = 3), void (l = null === (n = t.match(h)) || void 0 === n ? void 0 : n.index))
                    : (0, o.isString)(t) && h.test(t)
                    ? ((d = 2), void (l = null === (s = t.match(h)) || void 0 === s ? void 0 : s.index))
                    : (0, o.isString)(r) && h.test(r)
                    ? ((d = 1), void (l = null === (a = r.match(h)) || void 0 === a ? void 0 : a.index))
                    : void (
                        (0, o.isString)(r) &&
                        u.test(r) &&
                        ((d = 1), (l = null === (c = r.match(u)) || void 0 === c ? void 0 : c.index))
                      )
                )
              }),
            ...
            ? a
                ...
                .map((e, t) =>
                  o.createElement(
                    ...
                    { key: t },
                    l[t]
                      ? o.createElement('span', { className: i(s.highlighted, c) }, e)
    ...
    1109: (e, t, n) => {
      ...
      var o = n(59496),
        ...
        r = n(91626)
      function s(e) {
        return o.createElement('div', { className: i(r.separator, e.className) })
      }
    },
    51613: (e, t, n) => {
      'use strict'
