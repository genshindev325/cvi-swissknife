;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5093],
  {
    14684: e => {
      e.exports = {
        'animation-minimize-corner-left-top': 'animation-minimize-corner-left-top-WclZ64zB',
        'animation-minimize-corner-right-top': 'animation-minimize-corner-right-top-WclZ64zB',
        'animation-minimize-corner-right-bottom': 'animation-minimize-corner-right-bottom-WclZ64zB',
        'animation-minimize-corner-left-bottom': 'animation-minimize-corner-left-bottom-WclZ64zB',
        'animation-maximize-corner-left-top': 'animation-maximize-corner-left-top-WclZ64zB',
        'animation-maximize-corner-right-top': 'animation-maximize-corner-right-top-WclZ64zB',
        'animation-maximize-corner-right-bottom': 'animation-maximize-corner-right-bottom-WclZ64zB',
        'animation-maximize-corner-left-bottom': 'animation-maximize-corner-left-bottom-WclZ64zB',
      }
    },
    34451: e => {
      e.exports = {
    ...
    27514: e => {
      e.exports = {
        ...
        'maximize-animation-up-bracket': 'maximize-animation-up-bracket-xhmpRg2i',
        'maximize-animation-down-bracket': 'maximize-animation-down-bracket-xhmpRg2i',
        'minimize-animation-up-bracket': 'minimize-animation-up-bracket-xhmpRg2i',
        'minimize-animation-down-bracket': 'minimize-animation-down-bracket-xhmpRg2i',
        up: 'up-xhmpRg2i',
    ...
    6968: e => {
      e.exports = { blockHidden: 'blockHidden-cdtqi65y', 'pane-button': 'pane-button-cdtqi65y' }
    },
    5752: e => {
      e.exports = {
    ...
    62101: (e, t, s) => {
      ...
      const E = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
        ...
        T = (0, h.hotKeySerialize)({ keys: [E, 'Click', E, 'Enter'], text: '{0} + {1}, {2} + {3}' }),
        ...
        B = (0, h.hotKeySerialize)({ keys: [E, k, S], text: '{0} + {1} + {2}' }),
        D = (0, l.t)('Zoom Out'),
        P = (0, l.t)('Zoom In'),
        ...
        U = u.CheckMobile.any(),
        X = { zoomInOut: !0, maximize: !0, scrollLeftRight: !0, resetScale: !0, goToRealtime: !0 }
      class q {
        constructor(e, t, s) {
          ;(this._widget = (0, i.ensureNotNull)((0, d.parseHtml)(F).querySelector('.control-bar-wrapper'))),
            (this._controlBar = (0, i.ensureNotNull)(this._widget.querySelector('.control-bar'))),
            (this._back = (0, i.ensureNotNull)((0, d.parseHtml)(Y).querySelector('.control-bar__btn--back-present'))),
        ...
        _init() {
          if (u.CheckMobile.any()) for (const e of this._btnGroups) e.classList.add('js-hidden')
          ;(this._buttons = {
    ...
    74335: (e, t, s) => {
      ...
      class M {
        constructor(e, t, s) {
          ;(this._el = null),
            ...
            (this._updateLoadingState = (e = this._loading.value()) => {
              if (null !== this._el) {
                ...
                t.toggle(S.eyeLoading, e && !this._disabled.value()), t.toggle(S.loading, e)
              }
          ...
          ;(this._withActions = s.withActions),
            ...
            null !== this._valuesParentEl && (this._loader = new v(this._valuesParentEl, { className: S.loader })),
        ...
        destroy() {
          ...
          if (
            ...
            ;(0, i.ensureNotNull)(this._el.parentNode).removeChild(this._el), (this._el = null)
          }
        }
        getHeight() {
        ...
        _render() {
          this._renderTitle(),
            ...
            this._firstBlockWrapper.appendChild((0, i.ensureNotNull)(this._titleParentEl)),
        ...
        _renderTitle() {
          null === this._titleParentEl &&
            ((this._titleParentEl = document.createElement('div')), this._titleParentEl.classList.add(S.titleWrapper))
          ...
          for (let t = 0; t < this._titlesSpawns.length; t++) {
            ...
            l.classList.add(S.title, i, 'apply-overflow-tooltip'),
              ...
              s.length > 0
                ? (l.appendChild(document.createTextNode(s)), l.classList.add(S.withDot))
        ...
        _renderActions() {
          ...
          for (const s of this._model.actions()) {
            const i = (0, _.createActionElement)(s, S.button, S.buttonIcon, g.blockHidden, t)
            e.appendChild(i)
          }
        }
        _isWidthButtonsMode() {
        ...
        _updateTitlesHandler(e, t) {
          const s = (0, i.ensureNotNull)(this._titleElements[e]),
            l = 0 === t.length
          s.classList.toggle(g.blockHidden, l), s.classList.toggle(S.withDot, !l), w(s, t)
        }
        _updateStates(e) {
        ...
        _updateValuesHTMLElHandler(e, t) {
          w((0, i.ensure)(this._valuesElements[e].value), t), this._updateShowValues()
        }
        _updateValueColorHandler(e, t = '') {
          ;(0, i.ensure)(this._valuesElements[e].value).style.color = t
        }
        _updateValueVisibleHandler(e, t) {
          const s = (0, i.ensure)(this._valuesElements[e].value).closest('.' + S.valueItem)
        ...
        _addStatusesWidget(e, t, s) {
          ;(this._statusesWrapper = document.createElement('div')),
            ...
            (0, i.ensureNotNull)(this._firstBlockWrapper).appendChild(this._statusesWrapper),
        ...
        _hideActions() {
          null !== this._el &&
            ...
            null !== this._valuesParentEl && this._valuesParentEl.classList.remove(S.withTail),
            this._updateTitleMaxWidth())
        }
        ...
        _updateDisabledOnIntervalState() {
          ...
          null === (e = this._el) ||
            void 0 === e ||
            e.classList.toggle(S.disabledOnInterval, this._disabledOnInterval.value())
        }
        ...
        _updateShowTitles() {
          null !== this._titleParentEl &&
            (this._titleParentEl.classList.toggle(g.blockHidden, this._isTitleHidden.value()),
            null !== this._actionsParentEl &&
        ...
        _updateActionTitle(e) {
          ...
          null !== this._actionsParentEl &&
            null !== t &&
            this._actionsParentEl.querySelectorAll('.' + S.button)[e].setAttribute('title', t.value())
        }
        _updateCustomTextColor() {
          const e = this._customTextColor.value() || ''
          for (const t of this._titleElements) null !== t && (t.style.color = e)
          const t = (0, i.ensureNotNull)(this._valuesParentEl).querySelectorAll('.' + S.valueTitle)
          for (let s = 0; s < t.length; s++) t[s].style.color = e
          ;(0, i.ensureNotNull)(this._el).classList.toggle(S.withCustomTextColor, Boolean(e))
        }
      ...
      class f extends M {
        ...
        _render() {
          ...
          e.classList.add(S.item, S.series),
            e.classList.toggle(S.onlyOneButtonCanBeStick, this._model.isOneButtonCanBeStick()),
        ...
        _renderValues() {
          null === this._valuesParentEl &&
            ...
            this._valuesAdditionalWrapperEl.classList.add(S.valuesAdditionalWrapper),
        ...
        _updateFlaggedState() {
          ...
          ;(0, i.ensureNotNull)(this._el).classList.toggle(S.flagged, Boolean(this._flagged.value())),
            this._updateTitleMaxWidth()
        }
      }
      ...
      class E extends M {
        ...
        _render() {
          super._render()
          const e = (0, i.ensureNotNull)(this._el)
          e.classList.add(S.item, S.study), (e.dataset.name = 'legend-source-item')
        }
        _createTitlesSpawns() {
          const e = this._model.titles()
          this._titlesSpawns = [
        ...
        _renderValues() {
          ...
          for (const s of t) {
            const t = document.createElement('div')
            t.classList.add(S.valueItem), t.classList.toggle(g.blockHidden, !s.visible.value())
            const i = document.createElement('div')
        ...
        _update5ButtonsStyles(e) {
          null !== this._el && (this._el.classList.toggle(S.has5Buttons, e), this._updateAllButtonsWidth())
        }
        _onWheelClicked(e) {
      ...
      class P {
        ...
        _updateObjectTreeVisibility(e) {
          ;(0, i.ensureNotNull)(this._el).classList.toggle(S.objectsTreeCanBeShown, e)
        }
      }
      var O = s(38780),
        I = s(39640)
      ...
      class j {
        constructor(e, t) {
          ;(this._renderToggler = null),
            ...
            this._parentEl.classList.toggle(S.noWrap, !u.trackingModeIsAvailable),
            this._parentEl.classList.toggle(S.noActions, !this._options.withActions),
            this._parentEl.classList.toggle(S.touchMode, u.trackingModeIsAvailable),
        ...
        addMainDataSource(e, t) {
          this._renderMainDataSourceEl(),
            (this._mainDataSourceRenderer = new f(e, (0, i.ensureNotNull)(this._mainDataSourceEl), {
        ...
        updateMode(e) {
          ...
          const s = !this._hideAllExceptFirstLine.value() && (u.trackingModeIsAvailable || e < 542)
          this._parentEl.classList.toggle(S.directionColumn, s),
            this._parentEl.classList.toggle(S.hideUniportantValueItems, !h.CheckMobile.any() && e <= 272)
        }
        getMainSourceHeight() {
        ...
        _renderToggle(e) {
          this._options.showToggleButton &&
            (this._renderToggler = new P(e, this._options.themedColor, this._togglerOptions))
        }
        ...
        _addOutsideEventForHideTooltip() {
          null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(),
            (this._outsideEventForCollapsedTooltip = (0, I.addOutsideEventListener)(
              new CustomEvent('timestamp').timeStamp,
              this._collapsedDataSourcesWrapperEl,
              () => {
                null !== this._outsideEventForCollapsedTooltip && this._outsideEventForCollapsedTooltip(), (0, O.hide)()
              },
              window.document,
              { touchEnd: !0 },
            ))
      ...
      const J = new X.TranslatedString('show {title}', (0, k.t)('show {title}')),
      ...
      class se {
        constructor(e, t, s, i, l) {
          ;(this._values = new (o())([])),
            ...
            (this._disabledOnInterval = new (o())(this._getDisabledOnIntervalState())),
            ...
            (0, K.combine)(() => ({}), this._isTitleHidden, this._isValuesHidden, this._disabled).subscribe(
        ...
        onToggleDisabled() {
          ...
          this._model.setProperty(
            e,
            t,
            (t ? J : Q).format({ title: new X.TranslatedString(this._source.name(), this._source.title()) }),
          ),
        ...
        _calcNewPosition(e) {
          ...
          if (e.hasOwnProperty('touches') && e.touches.length > 0)
            ...
            t = { clientX: (0, $.isRtl)() ? s.right : s.left, clientY: s.top + s.height + 3 }
          } else {
            const s = e
      ...
      class _e extends se {
        constructor(e, t, s, i, l) {
          ...
          const a = this._model.model().properties().childs().paneProperties.childs().legendProperties.childs()
        ...
        onShowSettings() {
          this._source.userEditEnabled() && this._callbacks.showGeneralChartProperties(ie.TabNames.symbol)
        }
        ...
        _updateTitles() {
          var e
          const t = (0, i.ensureNotNull)(this._source.statusView()).getSplitTitle()
          this._titles.title.setValue((0, F.clean)(t.title, !0)),
            ...
            this._titles.branding.setValue((0, F.clean)(null !== (e = t.branding) && void 0 !== e ? e : '', !0))
        }
        _updateValues() {
        ...
        _getMarkerTitle() {
          return null !== this._symbolMarker ? (this._symbolMarker.isMarked() ? he : de) : ''
        }
      ...
      const Ce = (0, k.t)('Settings'),
        ...
        ke = (0, k.t)('Remove'),
        Ve = (0, k.t)('More'),
        xe = ((0, k.t)('Error'), (0, k.t)('Could not get Pine source code.'), (0, k.t)('Show interval settings')),
        Te = (d.enabled('study_buttons_in_legend'), d.enabled('show_hide_button_in_legend')),
      ...
      class He extends se {
            ...
            (this._source.hasChildren()
              ? ((e = this._model.removeSource.bind(this._model, this._source, !1)),
                (0, me.showConfirm)({
                  ...
                  text: (0, k.t)("Do you really want to delete study and all of it's children?"),
        ...
        _updateTitles() {
          const e = (0, i.ensureNotNull)(this._source.statusView()).getSplitTitle()
        ...
        _getDisabledOnIntervalState() {
          return (
            !(!(0, pe.isStudy)(this._source) && !(0, pe.isStudyStub)(this._source)) && !this._source.isActualInterval()
          )
        }
        _getValuesHiddenValue() {
        ...
        _isSymbolLikeStudy() {
          return this._source instanceof Me.study_Overlay || this._source instanceof fe.StudyCompare
        }
          ...
          if (!this._options.readOnlyMode) {
            if (
              ...
              const t = {
                ...
                action: (0, m.wrapHandlerWithPreventEvent)(this.onShowSettings.bind(this, ie.TabNames.visibility)),
                visible: new (o())(this._getDisabledOnIntervalState()),
            ...
            We &&
              ...
              (!(0, pe.isStudy)(this._source) ||
                new ge.MetaInfoHelper(this._source.metaInfo()).hasUserEditableOptions()) &&
              this._actions.push({
                iconMap: new Map([
                  ['large', ve],
                  ['small', ve],
      ...
      const Re = new X.TranslatedString(
        ...
        Fe = new X.TranslatedString('change OHLC values visibility', (0, k.t)('change OHLC values visibility')),
        Ye = new X.TranslatedString('change bar change visibility', (0, k.t)('change bar change visibility')),
        ...
        Ge = new X.TranslatedString('change volume values visibility', (0, k.t)('change volume values visibility')),
        $e = (0, k.t)('Symbol'),
      ...
      function _t(e, t) {
        const s = ut(t)
        return 0 === e[s].entries.length ? _t(e, s) : { dayIndex: s, entries: e[s].entries }
      }
      function pt(e, t) {
        const s = ct(t)
        return 0 === e[s].entries.length ? pt(e, s) : { dayIndex: s, entries: e[s].entries }
      }
      function mt(e) {
        for (; e > dt.minutesPerDay; ) e -= dt.minutesPerDay
        const t = e % 60,
          s = (e - t) / 60
        return (0, at.numberToStringWithLeadingZero)(s, 2) + ':' + (0, at.numberToStringWithLeadingZero)(t, 2)
      }
      const gt = {
        [rt.WeekDays.MONDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.MONDAY], isActive: !1, entries: [] },
        [rt.WeekDays.TUESDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.TUESDAY], isActive: !1, entries: [] },
        [rt.WeekDays.WEDNESDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.WEDNESDAY], isActive: !1, entries: [] },
        [rt.WeekDays.THURSDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.THURSDAY], isActive: !1, entries: [] },
        [rt.WeekDays.FRIDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.FRIDAY], isActive: !1, entries: [] },
        [rt.WeekDays.SATURDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.SATURDAY], isActive: !1, entries: [] },
        [rt.WeekDays.SUNDAY]: { title: nt.weekDaysShortNames[rt.WeekDays.SUNDAY], isActive: !1, entries: [] },
      }
      function bt(e, t) {
        ...
        for (const i of t) {
          ...
          for (let l = 0; l < n.length; l++) {
            const o = n[l],
              ...
              h = (0, lt.lowerbound)(e[t].entries, d, (e, t) => e.start.value < t),
              u = {
                start: { value: d, title: mt(a), isFirstOrLastPoint: a === i.start() },
                end: { value: r / dt.minutesPerDay, title: mt(r), isFirstOrLastPoint: n.length - 1 === l },
                type: s,
                tooltip: wt(i),
      ...
      class Mt {
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime
            ? -1
            : dt.get_minutes_from_midnight(this._todayInExchangeTime) / dt.minutesPerDay
        }
        timezone() {
          ...
          const s = this._createSubSessionSpecs(e),
            l =
              (o =
                ...
                new Date().getDay()) < rt.WeekDays.SATURDAY
                ? o + 1
                : rt.WeekDays.SUNDAY
          var o
          ...
          !(function (e) {
            ...
            for (const o of Object.keys(e)) {
              ...
              for (let e = 0; e < p; e++) {
                ...
                const r = o ? c.entries[c.entries.length - 1] : (0, i.ensureNotNull)(l),
                  d = {
                    start: {
                      value: o ? 0 : n[e - 1].end.value,
                      title: o ? t : n[e - 1].end.title,
                      isFirstOrLastPoint: !(o && h.length > 0) || 1 === h[h.length - 1].end.value,
                    },
            ...
            (function (e) {
              for (const i of Object.keys(e)) {
                ...
                r.start.isFirstOrLastPoint ||
                  (r.showStartForLastEntry = ((t = o), (s = e[a].entries), bt(t[t.length - 1], s[s.length - 1]))),
                  d.end.isFirstOrLastPoint || (d.showEndForFirstEntry = vt(o, e[n].entries))
              }
              var t, s
            })(n),
        ...
        _createSubSessionSpecs(e) {
          ...
          if (void 0 === e.subsessions)
            return new Map([[0, new ht.SessionSpec(e.timezone, e.session, e.session_holidays, e.corrections)]])
        ...
        _updateTodayWithOffsets(e) {
          ...
          this._todayInExchangeTime = dt.get_cal_from_unix_timestamp_ms(dt.get_timezone(e.timezone), Date.now() + t)
        }
      }
      var ft = s(59496),
        Ct = s(97754),
      ...
      function Tt(e) {
        return xt.has(e) || xt.set(e, (0, kt.randomHash)()), (0, i.ensureDefined)(xt.get(e))
      }
      const Wt = new Map([
          [0, Vt.green],
          [1, Vt.orange],
      ...
      function Ht(e) {
        const { segment: t, forceStart: s, forceEnd: i } = e,
          ...
          r = (function (e, t) {
            return `<div class="${Vt.tooltip}">\n\t\t<span class="${Wt.get(t)}">${Lt.get(t)}</span>\n\t\t<span class="${
              Vt.time
            }">${e}</span>\n\t</div>`
          })(t.tooltip, t.type)
        return ft.createElement('div', { className: n, style: a, 'data-tooltip': r })
      }
      function Bt(e) {
      ...
      function Dt(e) {
        ...
        const r = i.map(e => ft.createElement('div', { key: Tt(e), className: Vt.timeMark }, e.title)),
        ...
        return ft.createElement(
          ...
          ft.createElement(
            ...
            ft.createElement('div', { className: h, style: { left: 100 * i[0].value + '%', width: d + '%' } }, r),
          ),
        )
      }
      class Pt {
        ...
        renderer(e, t) {
          return (function (e) {
            const { key: t, className: s, now: i, timezone: l } = e,
              o = (0, Et.useWatchedValueReadonly)({ watchedValue: e.sessionDays }),
            ...
            return ft.createElement(
              ...
              ft.createElement(
                ...
                ft.createElement(
                  ...
                  ft.createElement('div', { className: Vt.now, style: { left: 100 * i + '%' } }),
                ),
              ),
      ...
      class Nt {
        ...
        _updateIconClassName(e) {
          null !== e ? this._iconClassNames.setValue([zt.statusItem, e]) : this._iconClassNames.setValue(null)
        }
      }
      var Rt = s(56840)
      const jt = []
      ...
      function Ut(e) {
        ...
        t.includes(e) || (t.push(e), Rt.setJSON('tv.alreadyBlinkedStatuses', t), Yt.setValue(Ft()))
      }
      ...
      const es = (0, be.getLogger)('Chart.LegendWidget'),
        ...
        hs = (0, It.htmlEscape)((0, k.t)('{symbolName} data is delayed by {time} minutes.')),
        us = (0, It.htmlEscape)((0, k.t)('{listedExchange} real-time data is available for free to registered users.')),
        cs = (0, It.htmlEscape)(
          (0, k.t)('To get real-time data for {description}, please buy the real-time data package.'),
        ),
        _s = (0, It.htmlEscape)(
          (0, k.t)('Real-time data for {description} is not supported right now. We may support it in the future.'),
        ),
        ps = (0, It.htmlEscape)((0, k.t)('Data is updated once a day.')),
        ms = (0, It.htmlEscape)(
          (0, k.t)('Data on our Basic plan is updated once per second, even if there are more updates on the market.'),
        ),
        gs = (0, It.htmlEscape)(
          (0, k.t)('Data is updated once per second, even if there are more updates on the market.'),
        ),
        bs = (0, It.htmlEscape)((0, k.t)('Paid plans feature faster data updates.')),
        vs = (0, It.htmlEscape)((0, k.t)('Real-time data for {symbolName} is provided by {exchange} exchange.')),
        ws = (0, It.htmlEscape)(
          (0, k.t)(
      ...
      class Ms extends Nt {
        ...
        setModel(e) {
          if ((this._dataUpdatedMode.destroy(), null === e))
            return (this._model = e), void (this._dataUpdatedMode = new (o())(null).spawn())
        ...
        async _getHtmls() {
          ...
          try {
            ...
            es.logError("Can't get exchange description, reason: " + (0, qt.errorToString)(e))
          }
          for (const o of e)
            if (
              ((t[o] = []),
              ['DelayToRealtime', 'DelayNoRealtime', 'DelayWithoutMarketAgreement', ...ts].includes(o) &&
                (t[o].push(hs.format({ symbolName: s, time: this._model.time().toString() })),
                this._options.subscriptionFullInfo &&
                  null !== i &&
                  'DelayToRealtime' === o &&
                  t[o].push(cs.format({ description: `<b>${i}</b>` })),
                null !== i && 'DelayNoRealtime' === o && t[o].push(_s.format({ description: `<b>${i}</b>` })),
                'DelayWithoutMarketAgreement' === o &&
                  t[o].push(ys.format({ listedExchange: this._model.listedExchange() })),
                this._options.subscriptionFullInfo &&
                  ts.includes(o) &&
                  t[o].push(us.format({ listedExchange: this._model.listedExchange() }))),
              'EOD' === o && (t[o] = [ps]),
              'TickByTick' === o &&
              ...
              0, t[o].push(vs.format({ symbolName: s, exchange: l }), '' !== e ? Ss.format({ exchange: e }) : ws)
            }
        ...
        _getShortTexts() {
          ...
          for (const i of t)
            if (
              (['DelayToRealtime', 'DelayNoRealtime', ...ts, 'DelayWithoutMarketAgreement'].includes(i) && (s[i] = os),
              'EOD' === i && (s[i] = as),
              'TickByTick' === i && (s[i] = ns),
              'BATSToRealtime' === i)
            ) {
              let t = null !== (e = this._model.firstReplacedByBatsExchange()) && void 0 !== e ? e : ''
              0, (s[i] = '' !== t ? ds.format({ exchange: t, originalExchange: rs }) : rs)
            }
      ...
      class Ls extends Nt {
        constructor(e, t, s) {
          super({ iconMap: ks, classNameMap: Vs, tooltipMap: xs, titleMap: Ts, titleColorMap: Ws, size: t }),
      ...
      class Os extends Nt {
        constructor(e, t) {
          super({ tooltipMap: Ds, iconMap: Hs, classNameMap: Bs, titleMap: Ds, titleColorMap: Ps, size: t }),
      ...
      class Is extends Nt {
        constructor(e, t) {
          super(t), (this._booleanStatus = new (o())(!1).spawn()), this.updateStatus(e)
        }
        destroy() {
      ...
      class Zs {
        constructor(e, t, s, i) {
          ...
          const l = [zt.statuses, 'apply-common-tooltip', 'common-tooltip-wide']
      ...
      const ai = (0, k.t)('Market open'),
        ...
        xi = { market: ui, pre_market: ci, post_market: _i, out_of_session: pi, holiday: mi }
      function Ti(e) {
        return (0, k.t)('{number} minute', { plural: '{number} minutes', count: e }).format({ number: e.toString() })
      }
      function Wi(e) {
        return (0, k.t)('{number} hour', { plural: '{number} hours', count: e }).format({ number: e.toString() })
      }
      function Li(e) {
        ...
        return 0 === t && 0 === s && 0 === i
          ...
          ? bi.format({
              days:
                ((l = t),
                (0, k.t)('{number} day', { plural: '{number} days', count: l }).format({ number: l.toString() })),
              hours: Wi(s),
            })
          : s > 0
      ...
      const Ai = {
          market: e => ('post_market' === e.status ? yi : Si).format({ remainingTime: Li(e.remainingSeconds) }),
          pre_market: e => wi.format({ remainingTime: Li(e.remainingSeconds) }),
          post_market: e => Si.format({ remainingTime: Li(e.remainingSeconds) }),
          out_of_session: e => ('pre_market' === e.status ? Mi : wi).format({ remainingTime: Li(e.remainingSeconds) }),
          holiday: e => ('pre_market' === e.status ? Mi : wi).format({ remainingTime: Li(e.remainingSeconds) }),
        },
        Hi = new Map([
          ['market', null],
          ['pre_market', null],
      ...
      class Bi extends Nt {
        constructor(e, t) {
          super({
            ...
            this.setModel(e),
            Pe.showMarketOpenStatusProperty.subscribe(this, this._showMarketOpenStatusPropertyChanged)
        }
        destroy() {
        ...
        setModel(e) {
          if ((this._marketStatus.destroy(), this._sessionEdge.destroy(), null === e))
            return (this._marketStatus = new (o())(null).spawn()), void (this._sessionEdge = new (o())(null).spawn())
          ;(this._model = e),
      ...
      class Di {
        constructor(e, t) {
          ...
          ;(this.visibleWidgetsCount = new (o())(0)),
            ...
            (this._renderer = new Zs(this._size, this.visibleWidgetsCount, this._tooltips, {
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            ...
            if (null === this._dataSourceErrorStatusViewModel) {
              ;(this._dataSourceErrorStatusViewModel = new Ls(this._source, this._size, this._options.sourceStatuses)),
                (this._dataSourceHasErrorVisible = (0, K.combine)(
                  () =>
                    this._dataSourceErrorCanBeShown.value() &&
                    (0, i.ensureNotNull)(this._dataSourceErrorStatusViewModel).visible().value(),
            ...
            if (null === this._marketStatusViewModel) {
              ...
              const e = (0, K.combine)(
                () =>
                  ...
                  (0, i.ensureNotNull)(this._marketStatusViewModel).visible().value(),
              ...
              null !== t &&
                ((this._sessionWidget = new Pt(this._source)), (s.additionalWidgets = [this._sessionWidget])),
          ...
          if (this._options.dataUpdateModeEnabled) {
            ...
            if (null === this._dataUpdatedModeViewModel) {
              this._dataUpdatedModeViewModel = new Ms(e, this._size, this._options.dataUpdateMode)
              const t = (0, K.combine)(
                () =>
                  this._dataUpdatedModeCanBeShown.value() &&
                  (0, i.ensureNotNull)(this._dataUpdatedModeViewModel).visible().value(),
            ...
            if (null === this._dataProblemViewModel) {
              ...
              const t = (0, K.combine)(
                () =>
                  ...
                  (0, i.ensureNotNull)(this._dataProblemViewModel).visible().value(),
        ...
        _updateDropdownMenu() {
          Promise.all([s.e(5514), s.e(2e3), s.e(3466), s.e(4102), s.e(1075), s.e(8643)])
            .then(s.bind(s, 4872))
            .then(e => {
              e.render(
                this._menuOpened,
      ...
      class Oi {
        constructor(e, t) {
          ...
          this._dataSourceErrorStatus = (0, Pi.createWVFromGetterAndSubscriptions)(
      ...
      const zi = (0, k.t)('Replay mode'),
        Ni = (0, k.t)("You're in Replay mode. You're in Replay mode. You're in Replay mode.")
      new Map([
        [
          !0,
          new Map([
      ...
      const Yi = {
        ...
        Ui = (d.enabled('hide_legend_by_default'), d.enabled('fundamental_widget')),
      ...
      class Gi {
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          return (function (e, t, s, i, l, o) {
            ...
            if (void 0 !== n) {
              const e = n.get(1)
              void 0 !== e && e.length > 0 && (a.push(...e), a.push(new Be.Separator()))
            }
            ...
            if (
              (e
                .model()
                .priceDataSources()
                .some(e => !(0, Ie.isActingAsSymbolSource)(e) && e.showInObjectTree()) &&
                (a.push(
                  new Be.Action({
            ...
            return (
              t.settings &&
                (a[a.length - 1] instanceof Be.Separator || a.push(new Be.Separator()),
                a.push(
                  new Be.Action({
              ...
              De.ContextMenuManager.showMenu(a, l, void 0, { menuName: 'LegendPropertiesContextMenu' }, o)
            )
          ...
          s > -1
            ? (e.splice(s, 1),
              Ui ||
                ...
                (this._mainSeriesStatusWidget = new Ri(t, this._model.model(), this._options.statusesWidgets)),
          ...
          if (0 === a)
            for (let t = e.length - 1; t >= 0; t--)
              l.push(
                ...
                o.push(new Di(new Oi(e[t], this._model.model()), this._options.statusesWidgets))
          else {
            let t = 0
            for (let s = e.length - 1; s >= 0; s--)
              this._dataSourceViewModels[t]
                ? (this._dataSourceViewModels[t].updateSource(e[s]),
                  this._dataSourcesStatusesWidgets[t].updateSource(new Oi(e[s], this._model.model())))
                : (l.push(
                    new He(
                      this._model,
                      e[s],
                  ...
                  o.push(new Di(new Oi(e[s], this._model.model()), this._options.statusesWidgets))),
                t++
            ...
            for (; this._dataSourcesStatusesWidgets.length > t; )
              (0, i.ensureDefined)(this._dataSourcesStatusesWidgets.pop()).destroy()
          }
          0 !== l.length &&
          ...
          if (this._availableHeight > 0 && e > 2) {
            ...
            if (null !== i) {
              ...
              if (e > a + 1) {
                ...
                return this._collapsedDataSourcesTitle.setValue(s), void this._collapsedDataSourcesCount.setValue(e - a)
              }
            }
          }
            ...
            for (let t = o.length; t < a.length; t++) {
              ...
              0 === e &&
                ...
                s.setGlobalVisibility(
                  (0, K.combine)((e, t) => !e && !t, this._hideNotMainSources, this._hideAllExceptFirstLine),
                ),
                o.push(s),
    ...
    20648: (e, t, s) => {
      ...
      class p {
        constructor(e, t, s) {
          ...
          this._render(),
            ...
            this._updateThemedColor(this._themedColor.value()),
            this._parentEl.classList.toggle(c.touchMode, h.trackingModeIsAvailable),
        ...
        _updateWidgetMode() {
          ...
          s.classList.toggle(_.blockHidden, e || t),
            i.classList.toggle(_.blockHidden, e || !t || !this._actions.more.visible.value())
        }
        _render() {
          this._renderActions(), this._parentEl.classList.add(c.paneControls), this._wrapEl.append(this._parentEl)
        }
        _renderActions() {
          ...
          for (const e of Object.keys(this._listActionsElements))
            (0, r.ensureNotNull)(this._listActionsElements[e]).classList.add(c.newButton)
          this._parentEl.append(this._listActionsElements.more)
        }
        _updateActionVisibilities(e, t) {
          ;(0, r.ensureNotNull)(this._listActionsElements[e]).classList.toggle(_.blockHidden, !t)
        }
        _updateActionTitle(e, t) {
          ;(0, r.ensureNotNull)(this._listActionsElements[e]).setAttribute('title', t)
        }
        ...
        _updatePaneControlsWidgetVisibility() {
          ...
          this._parentEl.classList.toggle(c.hidden, !e),
            this._parentEl.classList.toggle(c.forceHidden, !this._globalVisibility.value() || t)
        }
        _updateThemedColor(e) {
          if (e.length > 0) {
            const [t, s, i] = (0, d.parseRgb)(e)
            this._parentEl.style.color = (0, d.rgbaToString)([t, s, i, (0, d.normalizeAlphaComponent)(0.8)])
      ...
      const z = i.mobiletouch,
        ...
        $ = (0, T.hotKeySerialize)({ keys: [(0, o.humanReadableModifiers)(o.Modifiers.Mod, !1)], text: '{0} + ' + q })
      class K {
        constructor(e, t, s, i, l) {
          ;(this._actions = {}),
            (this._moreCMShown = !1),
            ...
            (this._upButtonVisibility = new (V())(this._getUpButtonVisibility())),
            (this._downButtonVisibility = new (V())(this._getDownButtonVisibility())),
            (this._maximizeButtonVisibility = new (V())(this._getMaximizeButtonVisibility())),
            (this._minimizeButtonVisibility = new (V())(this._getMinimizeButtonVisibility())),
            (this._collapseButtonVisibility = new (V())(this._getCollapseButtonVisibility())),
            (this._restoreButtonVisibility = new (V())(this._getRestoreButtonVisibility())),
            this._createActions(),
            ...
            (this._visibilityType = new (V())(this._visibilityTypeProperty.value())),
        ...
        _getCloseButtonVisibility() {
          ...
          let t = !1
          return (
            e.containsMainSeries() || e.maximized().value() || z || (t = e.dataSources().some(e => (0, n.isStudy)(e))),
            t
          )
        }
        _onCloseButton() {
        ...
        _getUpButtonVisibility() {
          const e = this._paneWidget.state()
          return this._model.model().panes().indexOf(e) > 0 && !e.maximized().value() && !z
        }
        ...
        _getMaximizeButtonVisibility() {
          const e = this._paneWidget.state()
          return this._model.model().panes().length > 1 && !e.maximized().value() && !z
        }
          ...
          e.preventDefault(),
            this._moreCMShown ||
              (function (e, t, s) {
                ...
                const l = (0, r.ensureNotNull)(t.target).getBoundingClientRect()
