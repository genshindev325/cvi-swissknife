;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3030],
  {
                    ...
                    ;(r = [].concat(e(r), [p])),
                      ...
                      (t.ontouchmove = function (e) {
                        ...
                        1 === e.targetTouches.length &&
                          ((o = t),
                          (r = (n = e).targetTouches[0].clientY - l),
                          !a(n.target) &&
                            ((o && 0 === o.scrollTop && 0 < r) ||
                  ...
                  ;(m = o),
                    setTimeout(function () {
                      if (void 0 === u) {
                        ...
                        t &&
                          0 < e &&
                          ((u = document.body.style.paddingRight), (document.body.style.paddingRight = e + 'px'))
                      }
    ...
    52932: t => {
      t.exports = { separator: 'separator-s5VT2kNH', scrollable: 'scrollable-s5VT2kNH' }
    },
    70589: (t, e, n) => {
      'use strict'
      ...
      function m(t) {
        ...
        return (
          (0, i.useEffect)(() => {
            if (!p.CheckMobile.any() && S && 'symbol' === m && C.current) {
    ...
    73339: (t, e, n) => {
      ...
      async function l(t, e, n, i, l) {
            ...
            if ((0, s.isInputInlines)(t)) {
              ...
              if (e) {
                const { time: n, price: o } = e,
                  s = n.inline
                    ? (0, r.t)('Set the "{inputInline}" time and price for "{studyShortDescription}"', {
                        replace: { inputInline: n.inline, studyShortDescription: i },
                      })
                    : (0, r.t)('Set the time and price for "{studyShortDescription}"', {
                        replace: { studyShortDescription: i },
                      }),
                  l = f(t.id)
                await p(t, 'all', null != l ? l : s, n.id, o.id)
        ...
        async function d(t) {
          const e = 'time' === t.type,
            ...
            o = (function () {
              ...
              const n = t.name
                  ? (0, r.t)('Set the "{inputTitle}" time for "{studyShortDescription}"', {
                      replace: { inputTitle: t.name, studyShortDescription: i },
                    })
                  : (0, r.t)('Set the time for "{studyShortDescription}"', { replace: { studyShortDescription: i } }),
                o = t.name
                  ? (0, r.t)('Set the "{inputTitle}" price for "{studyShortDescription}"', {
                      replace: { inputTitle: t.name, studyShortDescription: i },
                    })
                  : (0, r.t)('Set the price for "{studyShortDescription}"', { replace: { studyShortDescription: i } })
              return e ? n : o
            })(),
            s = e ? t.id : void 0,
            l = e ? void 0 : t.id
        ...
        async function p(e, i, r, s, l) {
          const u = await t.requestSelectPoint({ pointType: i, pane: c, lineColor: void 0 }, r)
          void 0 === c && (c = u.pane)
          const a = n.childs().inputs
          a &&
            (s && (0, o.ensureDefined)(a.child(s)).setValue(1e3 * (u.point.time || 0)),
            l && (0, o.ensureDefined)(a.child(l)).setValue(u.point.price))
        }
        function f(t) {
          let e
          return (
