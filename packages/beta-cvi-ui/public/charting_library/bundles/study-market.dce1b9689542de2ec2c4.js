;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456],
  {
    ...
    14541: e => {
      e.exports = { container: 'container-sfMizuTb' }
    },
    48722: e => {
      e.exports = {
    ...
    27103: e => {
      e.exports = { container: 'container-upe4c4Dt' }
    },
    6621: e => {
      e.exports = {
        'tablet-small-breakpoint': 'screen and (max-width: 428px)',
    ...
    94720: (e, t, n) => {
      ...
      function d(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: o, children: a, endIcon: c } = e,
          d = null != n ? n : r
        return i.createElement(
          i.Fragment,
          null,
          d && 'xsmall' !== t && i.createElement(s.Icon, { icon: d, className: l()['start-icon-wrap'] }),
          a && i.createElement('span', { className: l().content }, a),
          c && !o && 'xsmall' !== t && i.createElement(s.Icon, { icon: c, className: l()['end-icon-wrap'] }),
        )
      }
      var u = n(86332),
        h = n(90186)
      function p(e) {
        ...
        return { ...u, ...(0, h.filterDataProps)(e), ...(0, h.filterAriaProps)(e) }
      }
      function m(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: o, disablePositionAdjustment: s } = (0, i.useContext)(u.ControlGroupContext),
          a = c({ ...n, isGrouped: r, cellState: o, disablePositionAdjustment: s })
        return i.createElement('button', { ...p(n), className: a, ref: t }, i.createElement(d, { ...n }))
      }
      ...
      function y(e) {
        const { intent: t, size: n, appearance: i, useFullWidth: r, icon: o, ...s } = e
        return { ...s, color: v(t), size: f(n), variant: g(i), stretch: r, startIcon: o }
      }
      function w(e) {
        return i.createElement(m, { ...y(e) })
      }
    },
    86332: (e, t, n) => {
      'use strict'
    ...
    9745: (e, t, n) => {
      ...
      const r = i.forwardRef((e, t) => {
        const { icon: n = '', ...r } = e
        return i.createElement('span', { ...r, ref: t, dangerouslySetInnerHTML: { __html: n } })
      })
    },
    90186: (e, t, n) => {
      'use strict'
      ...
      function c(e) {
        ...
        if (e && 1 == ++a) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (r(n, 'right', i() + 'px'), (t.style.paddingRight = a + i() + 'px'), (l = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && a > 0 && 0 == --a && (t.classList.remove('i-no-scroll'), l)) {
          r(n, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= i()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (l = !1)
        }
      }
    },
    24437: (e, t, n) => {
    ...
    85457: (e, t, n) => {
      ...
      var o = n(97754),
        ...
        g = n(76422),
        v = n(9745)
      const f = i.createContext({ setHideClose: () => {} })
      var y = n(37257),
        w = n(91441)
      function _(e) {
        const {
        ...
        return i.createElement(
          ...
          i.createElement(
            'div',
            { className: s()(w.container, d, (n || u) && w.unsetAlign) },
            a,
            i.createElement(
              'div',
              { 'data-dragg-area': c, className: w.title },
              i.createElement('div', { className: w.ellipsis }, t),
              n && i.createElement('div', { className: s()(w.ellipsis, w.subtitle) }, n),
            ),
            l,
            r &&
              !h &&
      ...
      class k extends i.PureComponent {
                ...
                switch ((this.props.onKeyDown && this.props.onKeyDown(e), (0, a.hashFromEvent)(e))) {
                  case 27:
                    ...
                    const { activeElement: n } = document,
                      i = (0, r.ensureNotNull)(this._reference)
                    if (null !== n) {
                      if (
                        (e.preventDefault(),
                      ...
                      if ((0, l.isTextEditingField)(n)) return void i.focus()
        ...
        render() {
          const {
            ...
            M = 'after' !== m ? g : void 0,
            R = 'after' === m ? g : void 0,
            O = 'string' == typeof o ? o : K || ''
          return i.createElement(h.MatchMedia, { rule: u.DialogBreakpoints.SmallHeight }, m =>
            i.createElement(h.MatchMedia, { rule: u.DialogBreakpoints.TabletSmall }, u =>
              i.createElement(
                c.PopupDialog,
                {
                  rounded: !(u || x) && N,
                  className: s()(b.dialog, e),
                  isOpened: r,
                ...
                i.createElement(
                  'div',
                  { className: s()(b.wrapper, t), 'data-name': a, 'data-dialog-name': O },
                  void 0 !== o &&
                    i.createElement(_, {
                      draggable: k && !(u || x),
                  ...
                  y && i.createElement(d.Separator, { className: b.separator }),
                  i.createElement(p.PopupContext.Consumer, null, e => this._renderChildren(e, u || x)),
                ),
              ),
            ),
          )
    ...
    69654: (e, t, n) => {
      ...
      function d(e) {
        ...
        return i.createElement(
          ...
          t,
          i.createElement(a.Icon, { className: c.icon, icon: l }),
          r && i.createElement('div', { className: c.cancel, onClick: r }, (0, s.t)('Cancel')),
        )
      }
      function u(e) {
        const {
    ...
    22265: (e, t, n) => {
      'use strict'
      n.d(t, { DialogSidebarContainer: () => d, DialogSidebarWrapper: () => u, DialogSidebarItem: () => h })
      var i = n(59496),
        r = n(97754),
        o = n.n(r),
        s = n(9745),
      ...
      function d(e) {
        const { mode: t, className: n, ...r } = e,
          { isMobile: s, isTablet: a } = c(t),
          d = o()(l.container, a && l.isTablet, s && l.isMobile, n)
        return i.createElement('div', { ...r, className: d, 'data-role': 'dialog-sidebar' })
      }
      function u(e) {
      ...
      function h(e) {
        const { mode: t, title: n, icon: r, isActive: d, onClick: u, ...h } = e,
          { isMobile: p, isTablet: m } = c(t)
        return i.createElement(
          'div',
          { ...h, className: o()(l.tab, m && l.isTablet, p && l.isMobile, d && l.active), onClick: u },
          i.createElement(s.Icon, { className: l.icon, icon: r }),
          !m &&
            i.createElement(
              'span',
              { className: l.title },
              i.createElement('span', { className: l.titleText }, n),
              p && i.createElement(s.Icon, { className: l.nested, icon: a }),
            ),
        )
      }
    },
    54127: (e, t, n) => {
      'use strict'
      n.r(t), n.d(t, { IndicatorsLibraryContainer: () => J })
      var i = n(59496),
        r = n(87995),
        o = n(28353),
        s = n(85733),
      ...
      function p(e) {
        ...
        const {
          ...
          p = (null == u ? void 0 : u.isAuto) ? 'auto-java' : l().getPackageName(n)
        return {
          id: n,
          title: s || (0, o.t)(i, { context: 'study' }),
          shortDescription: r,
          shortTitle: r,
          ...
          isFundamental: !1,
          studyData: { id: n, version: d, descriptor: { type: 'java', studyId: e.id }, packageName: p },
          isGrayed: h,
        }
      }
      var m = n(97754),
      ...
      function C(e) {
        ...
        return i.createElement('div', { ref: t, className: g()(b.container, n), ...r, 'data-role': 'dialog-content' })
      }
      var E = n(48722)
      function k(e) {
        const { children: t, className: n, disabled: r } = e
        return i.createElement('span', { className: g()(E.title, r && E.disabled, n) }, t)
      }
      ...
      function K(e) {
        const t = (0, i.useContext)(x),
          ...
          { isFavorite: y, isLocked: w, public: _, editorsPick: b } = s,
          C = void 0 !== y,
          E = M(v, s),
          F = (0, i.useCallback)(e => e.stopPropagation(), []),
          K = (null == t ? void 0 : t.toggleFavorite) ? M(t.toggleFavorite, s) : void 0,
          R = (0, N.useWatchedValueReadonly)({ watchedValue: D.watchedTheme }) === I.StdTheme.Dark ? L.dark : L.light,
          O = g()(L.container, s.isGrayed && L.disabled, h && L.selected, p && L.highlighted, p && R)
        return i.createElement(
          'div',
          {
            ref: m,
          ...
          i.createElement(
            'div',
            { className: g()(L.main, !C && L.paddingLeft) },
            C &&
              i.createElement(P.FavoriteButton, {
            ...
            i.createElement(
              k,
              { disabled: s.isGrayed },
              i.createElement(S.HighlightedText, { queryString: a, rules: l, text: s.title }),
            ),
            !1,
            c && i.createElement(BadgeIndicator, { type: 'beta', className: L.badge }),
            d && i.createElement(BadgeIndicator, { type: 'new', className: L.badge }),
            u && i.createElement(BadgeIndicator, { type: 'updated', className: L.badge }),
            b &&
              i.createElement(BadgeIndicator, { type: 'ep', className: L.badge, tooltip: (0, o.t)("Editors' picks") }),
          ),
          _ &&
            i.createElement(
              'a',
              { href: _.authorLink, className: L.author, target: '_blank', onClick: F },
              _.authorName,
            ),
          'mobile' !== r && _ && i.createElement('span', { className: L.likes }, _.likesCount),
          !1,
        )
      }
      function M(e, t) {
        return n => {
          const i = 0 === (0, F.modifiersFromEvent)(n) && 0 === n.button
      ...
      function z(e) {
        ...
        return i.createElement('div', { style: t, className: A.container }, n)
      }
      var V = n(9745),
        T = n(94720),
        B = n(53608)
      function j(e) {
        const { className: t, icon: n, title: r, description: o, buttonText: s, buttonAction: a } = e
        return i.createElement(
          'div',
          { className: g()(B.container, t) },
          n && i.createElement(V.Icon, { icon: n, className: B.image }),
          r && i.createElement('h3', { className: B.title }, r),
          o && i.createElement('p', { className: B.description }, o),
          s && a && i.createElement(T.Button, { onClick: a, className: B.button }, s),
        )
      }
      function W(e) {
      ...
      var G = n(19785),
        H = n(6621)
      function Y(e) {
        const { reference: t, data: n, isOpened: r, onClose: s, applyStudy: a } = e,
          [l, c] = (0, i.useState)(''),
          d = (0, i.useMemo)(() => (0, G.createRegExpList)(l, h), [l]),
          u = (0, i.useMemo)(
            () =>
              l
                ? (0, G.rankedSearch)({
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  40 === (0, F.hashFromEvent)(e) && (e.preventDefault(), h(), g(i))
                  38 === (0, F.hashFromEvent)(e) && (e.preventDefault(), p(), g(t))
                  if (13 === (0, F.hashFromEvent)(e) && d) {
                    if (!n) return
                    n(d), a(d)
                  }
                },
        ...
        return (
          (0, i.useEffect)(() => {
            var e
            r || c(''), y.CheckMobile.any() || null === (e = k.current) || void 0 === e || e.focus()
          }, [r]),
          i.createElement(f.AdaptivePopupDialog, {
            isOpened: r,
            onClose: s,
            onClickOutside: s,
            className: g()(H.dialogLibrary),
            render: function () {
              return i.createElement(
                i.Fragment,
                null,
                i.createElement(w.DialogSearch, {
                  reference: k,
                ...
                i.createElement(
                  ...
                  i.createElement(
                    C,
                    { reference: E, className: H.scroll },
                    N
                      ...
                      ? i.createElement(
                          i.Fragment,
                          null,
                          i.createElement(z, null, i.createElement(O, { title: (0, o.t)('Script name') })),
                          u.map(e => {
                            const t = (null == m ? void 0 : m.id) === e.id
                            return i.createElement(K, {
                              ...
                              isSelected: (null == m ? void 0 : m.id) === e.id,
                              isHighlighted: (null == p ? void 0 : p.id) === e.id,
                            })
                          }),
                        )
                      : i.createElement(j, {
                          className: H.noContentBlock,
      ...
      class J extends class {
        ...
        _applyStudy(e, t) {
          var n, i
          e.isGrayed
            ? Z.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
            : (y.CheckMobile.any() || null === (n = this._searchInputRef.current) || void 0 === n || n.select(),
        ...
        _render() {
          ...
          r.render(i.createElement(Y, { ...e }), t)
        }
      }
    },
    36189: (e, t, n) => {
    ...
    19785: (e, t, n) => {
      'use strict'
      n.d(t, { rankedSearch: () => r, createRegExpList: () => o, getHighlightedChars: () => s })
      var i = n(80643)
      function r(e) {
        const {
          data: t,
              ...
              n.forEach(e => {
                ...
                return (
                  ...
                  t && t.toLowerCase() === r.toLowerCase()
                    ? ((d = 3), void (c = null === (n = t.match(h)) || void 0 === n ? void 0 : n.index))
                    : (0, i.isString)(t) && h.test(t)
                    ? ((d = 2), void (c = null === (s = t.match(h)) || void 0 === s ? void 0 : s.index))
                    : (0, i.isString)(o) && h.test(o)
                    ? ((d = 1), void (c = null === (a = o.match(h)) || void 0 === a ? void 0 : a.index))
                    : void (
                        (0, i.isString)(o) &&
                        u.test(o) &&
                        ((d = 1), (c = null === (l = o.match(u)) || void 0 === l ? void 0 : l.index))
                      )
                )
              }),
        ...
        return e && n
          ? (n.forEach(e => {
              ...
              if (((e.fuzzyHighlight = !s), a))
                ...
                } else for (let e = 0; e < a[0].length; e++) i[a.index + e] = !0
            }),
            i)
          : i
      }
    ...
    24637: (e, t, n) => {
      ...
      function a(e) {
        const { queryString: t, rules: n, text: a, className: l } = e,
          c = (0, i.useMemo)(() => (0, o.getHighlightedChars)(t, a, n), [t, n, a])
        return i.createElement(
          i.Fragment,
          null,
          c.length
            ? a
                ...
                .map((e, t) =>
                  i.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? i.createElement('span', { className: r(s.highlighted, l) }, e)
    ...
    58095: (e, t, n) => {
      ...
      function o(e) {
        const {
          ...
          d = (0, i.useRef)(null),
          u = (0, i.useRef)(new CustomEvent('timestamp').timeStamp)
        return (
          (0, i.useLayoutEffect)(() => {
            const e = { click: t, mouseDown: n, touchEnd: o, touchStart: s },
    ...
    1109: (e, t, n) => {
      ...
      var i = n(59496),
        ...
        o = n(91626)
      function s(e) {
        return i.createElement('div', { className: r(o.separator, e.className) })
      }
    },
    88216: (e, t, n) => {
      'use strict'
      ...
      class l extends i.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            r.createPortal(i.createElement(c.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
    ...
    61074: (e, t, n) => {
      ...
      function s(e) {
        ...
        return i.createElement('div', { className: t, style: e.style, role: 'progressbar' })
      }
    },
    30360: e => {
      e.exports =
