;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    32713: e => {
      e.exports = { dialog: 'dialog-W0U3ul53', button: 'button-W0U3ul53' }
    },
    41223: e => {
      e.exports = {
    ...
    48247: e => {
      e.exports = { wrap: 'wrap-gUfy4kTJ', space: 'space-gUfy4kTJ', tree: 'tree-gUfy4kTJ' }
    },
    30608: e => {
      e.exports = { button: 'button-IulLF4sY', disabled: 'disabled-IulLF4sY' }
    },
    86332: (e, t, n) => {
      'use strict'
    ...
    67029: (e, t, n) => {
      'use strict'
      n.d(t, { ControlSkeleton: () => _, InputClasses: () => g })
      var o = n(59496),
        r = n(97754),
        s = n(88537),
        i = n(66092),
      ...
      function p(e, t, n, o) {
        const {
          ...
          b = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(n))
        return r(
          u().container,
          u()['intent-' + l],
          u()['border-' + a],
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: I, cellState: E, disablePositionAdjustment: M = !1 } = (0, o.useContext)(a.ControlGroupContext),
          x = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((s.current = [e, t, n]), i(), l), [e, t, n]), a
          })('wheel', T, m)
        return o.createElement(
          ...
          y,
          C,
          o.createElement('span', { className: f(e, E) }),
        )
      }
      v.displayName = 'ControlSkeleton'
      const _ = o.forwardRef(v)
    },
    78274: (e, t, n) => {
      'use strict'
      n.d(t, { StartSlot: () => l, MiddleSlot: () => a, EndSlot: () => c, AfterSlot: () => d })
      var o = n(59496),
        r = n(97754),
        s = n(10306),
        i = n.n(s)
      function l(e) {
        const { className: t, interactive: n = !0, icon: s = !1, children: l } = e
        return o.createElement('span', { className: r(i()['inner-slot'], n && i().interactive, s && i().icon, t) }, l)
      }
      function a(e) {
        const { className: t, children: n } = e
        return o.createElement('span', { className: r(i()['inner-slot'], i()['inner-middle-slot'], t) }, n)
      }
      function c(e) {
        const { className: t, interactive: n = !0, icon: s = !1, children: l } = e
        return o.createElement('span', { className: r(i()['inner-slot'], n && i().interactive, s && i().icon, t) }, l)
      ...
      function d(e) {
        const { className: t, children: n } = e
        return o.createElement('span', { className: r(i()['after-slot'], t) }, n)
      }
    },
    31261: (e, t, n) => {
      'use strict'
        ...
        return o.createElement(h.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement('input', {
              ...Z,
              className: r(g().input, R, z && g()['with-start-slot'], V && g()['with-end-slot']),
              disabled: F,
              readOnly: P,
              ref: H,
            }),
      ...
      function _(e) {
        ...
        const {
          ...
          S = t ? void 0 : _ ? -1 : r,
          y = t ? void 0 : _ ? r : -1,
          { isMouseDown: C, handleMouseDown: w, handleMouseUp: T } = (0, u.useIsMouseDown)(),
          I = (0, i.createSafeMulticastEventHandler)(
            b.onFocus,
            function (e) {
          ...
          E = (0, i.createSafeMulticastEventHandler)(b.onBlur, h),
          M = (0, o.useCallback)(
            e => {
        ...
        return o.createElement(v, {
          ...
          onContainerFocus: function (e) {
            m.current === e.target && null !== g.current && g.current.focus()
          },
          onFocus: I,
          onBlur: E,
          reference: M,
          containerReference: (0, a.useMergedRefs)([m, f]),
          onMouseDown: w,
          onMouseUp: T,
        })
      }
    ...
    48027: (e, t, n) => {
      ...
      var o = n(47201),
        r = n(29202)
      function s(e) {
        const { onFocus: t, onBlur: n, intent: s, highlight: i, disabled: l } = e,
        ...
        return { ...e, intent: s || (a ? 'primary' : 'default'), highlight: null != i ? i : a, onFocus: d, onBlur: u }
      }
    },
    29202: (e, t, n) => {
      'use strict'
    ...
    14593: (e, t, n) => {
      ...
      const l = o.forwardRef((e, t) => {
        ...
        return o.createElement(s.ToolWidgetButton, { 'data-name': l, ...a, ref: t, className: r(n, i.button) })
      })
    },
    94250: (e, t, n) => {
      'use strict'
      n.d(t, { ManageDrawings: () => C })
      var o = n(59496),
        r = n(88537),
        s = n(9745),
        i = n(26843),
        ...
        m = n(70029),
        v = n(9267)
      ;(0, d.getLogger)('Chart.ManageDrawings')
      const _ = new c.TranslatedString(
          'remove all line tools for {symbol}',
          (0, a.t)('remove all line tools for {symbol}'),
        ),
        b = e =>
          (0, a.t)('{drawingsCount} drawing', { plural: '{drawingsCount} drawings', count: e }).format({
            drawingsCount: e.toString(),
          }),
        S = (0, a.t)('Remove all drawings for this symbol'),
        y = (0, a.t)('No drawings yet')
      class C extends o.PureComponent {
        constructor(e) {
          super(e),
              ...
              if (this._model && this._symbolDrawingsMap) {
                ...
                if (t) {
                  const n = Array.from(t)
                    .map(e => (0, r.ensureNotNull)(this._model).model().dataSourceForId(e))
                    .filter(p.notNull)
                  n.length > 0 && this._model.removeSources(n, !1, _.format({ symbol: e })), this._updateItems()
                }
              }
            }),
            ...
            (this._updateTheme = () => {
              const e = l.watchedTheme.value()
              this.setState({ theme: e })
            }),
            (this.state = { currentSymbol: null, items: null, theme: l.watchedTheme.value() })
        }
        componentDidMount() {
          this.props.chartWidget.withModel(this, async () => {
            ...
            l.watchedTheme.subscribe(this._updateTheme)
        }
        componentWillUnmount() {
          l.watchedTheme.unsubscribe(this._updateTheme),
            null !== this._model &&
        ...
        render() {
          const { isMobile: e } = this.props,
            ...
            r = this._symbolDrawingsMap ? this._symbolDrawingsMap.size : 0,
            s = `${
              ((i = r),
              (0, a.t)('{symbolsCount} symbol', {
                plural: '{symbolsCount} symbols',
                context: 'symbols_and_drawings_count',
                count: i,
              }).format({ symbolsCount: i.toString() }))
            } ${(e =>
              (0, a.t)('with {drawingsCount} drawing', {
          ...
          return o.createElement(
            o.Fragment,
            null,
            n && n.length > 0 && o.createElement('div', { className: v.title }, s),
            null === n || 0 === n.length
        ...
        _renderEmptyContent() {
          const { theme: e } = this.state,
            t = e === i.StdTheme.Dark ? m : g
          return null === this._symbolDrawingsMap
            ? o.createElement(f.Spinner, { className: v.spinner })
            : o.createElement(
                'div',
                { className: v.empty },
                o.createElement(s.Icon, { className: v.image, icon: t }),
    ...
    49469: (e, t, n) => {
      'use strict'
      n.r(t), n.d(t, { ObjectTreeDialogRenderer: () => Jo })
      var o = n(59496),
        r = n(87995)
      ...
      var k = n(14593),
        ...
        P = n(51768)
      function j(e) {
        const { viewModel: t } = (0, I.ensureNotNull)((0, o.useContext)(N)),
          n = (0, L.useForceUpdate)(),
          r = t.selection()
        ;(0, o.useEffect)(() => {
          const e = {}
          return (
        ...
        return o.createElement(
          o.Fragment,
          null,
          o.createElement('div', { className: E(F.title, F.withoutIcon) }, (0, v.t)('Object tree'), !1),
          o.createElement(
            'div',
            { className: F.buttons },
            o.createElement(k.ToolWidgetIconButton, {
              ...
              isDisabled: !c,
              title: (0, v.t)('Create a group of drawings'),
              'data-name': 'group-button',
            }),
            o.createElement(
              A.ToolWidgetMenu,
              {
                className: E(F.button, a && F.disabled),
                isDisabled: a,
                content: o.createElement(x.Icon, { icon: O }),
                title: (0, v.t)('Clone, Copy'),
                arrow: !1,
                isShowTooltip: !0,
            ...
            o.createElement(
              A.ToolWidgetMenu,
              {
                className: E(F.button, s && F.disabled),
                isDisabled: s,
                content: o.createElement(x.Icon, { icon: B }),
                title: (0, v.t)('Move to'),
                arrow: !1,
                isShowTooltip: !0,
      ...
      var z = n(54773),
        ...
        G = n(36028),
        W = n(86416)
      const U = ((K = 'OBJECT_TREE'), e => K + '__' + e)
      var K
      const Z = U('SET_NODES'),
        Q = U('SYNC_NODES'),
        X = U('UPDATE_NODE'),
        $ = U('UPDATE_NODES'),
        q = U('RESET_TREE'),
        J = U('SET_SELECTED_IDS'),
        Y = U('DROP_SELECTION'),
        ee = U('SELECT_PREVIOUS'),
        te = U('SELECT_NEXT'),
        ne = U('MULTI_SELECT_PREVIOUS'),
        oe = U('MULTI_SELECT_NEXT'),
        re = U('PROCESS_DROP_TARGET'),
        se = U('UPDATE_DROP_TARGET'),
        ie = U('HIDE_DROP_TARGET'),
        le = U('START_MULTI_SELECT'),
        ae = U('STOP_MULTI_SELECT'),
        ce = (U('REMOVE_NODE'), U('SET_FOCUSED_NODE')),
        de = U('SCROLL_TO_ID'),
        ue = U('SET_IS_SELECTED'),
        he = U('SET_IS_EXPANDED'),
        pe = U('SET_DISABLED_NODES'),
        fe = U('MOVE_NODES'),
        ge = (U('START_DRAG'), U('END_DRAG')),
        me = () => ({ type: ee }),
        ve = () => ({ type: te }),
        _e = () => ({ type: ne }),
        be = () => ({ type: oe }),
        ...
        ye = () => ({ type: Y }),
        Ce = e => ({ type: J, ids: e }),
        we = (e, t, n) => ({ type: fe, ids: e, targetId: t, dropType: n }),
        Te = () => ({ type: le }),
        Ie = () => ({ type: ae }),
        Ee = e => ({ type: ce, nodeId: e }),
        Me = e => ({ type: de, nodeId: e }),
        xe = (e, t, n = 0) => ({ type: ue, nodeId: e, isSelected: t, mode: n }),
        De = (e, t) => ({ type: he, nodeId: e, isExpanded: t }),
        Ae = e => ({ type: pe, ids: e }),
        Le = () => ({ type: ge })
      var Ne = n(77145)
      const ke = e => e.nodes,
        ...
        Fe = e => e.scrollToId,
        Pe = (e, t) => t,
        je = (0, Ne.createSelector)([ke, Pe], (e, t) => e[t]),
        ze = (0, Ne.createSelector)([Oe, Pe], (e, t) => e.ids.includes(t)),
        Ve = (0, Ne.createSelector)([Re, Pe], (e, t) => e.includes(t)),
        He = (0, Ne.createSelector)([e => e.disabled, Oe, Pe], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
        Ge = (0, Ne.createSelector)(ke, e => Object.keys(e)),
        We = (0, Ne.createSelector)(Oe, ({ ids: e }) => e),
        Ue = (0, Ne.createSelector)(Oe, ({ lastFocusedNodeId: e }) => e),
        Ke = (0, Ne.createSelector)(Oe, ({ isMultiSelecting: e }) => e),
        Ze = (0, Ne.createSelector)([ke, We], (e, t) => t.map(t => e[t])),
        Qe = (0, Ne.createSelector)(ke, e => Object.values(e).filter(e => 0 === e.level)),
        Xe = (0, Ne.createSelector)([ke, Qe], (e, t) =>
      ...
      const qe = (0, Ne.createSelector)([ke, Qe, Re], (e, t, n) => {
          const o = new Set(n)
          return t.reduce((t, n) => [...t, ...Ye(e, (0, I.ensureDefined)(n), o)], [])
        }),
        Je = (0, Ne.createSelector)([ke, We, Re], (e, t, n) => {
          const o = new Set(n)
      ...
      function* et(e) {
        ...
        yield (0, w.put)((e => ({ type: Z, nodes: e }))(o)), yield (0, w.put)(Ce(t))
        !Ue(yield (0, w.select)()) && t.length > 0 && (yield (0, w.put)(Ee(t[0])), yield (0, w.put)(Me(t[0])))
      }
      function* tt(e) {
        for (;;) {
          if ((yield (0, w.take)([le, ae])).type === le) {
            const t = Ge(yield (0, w.select)()).filter(t => !e(t))
            yield (0, w.put)(Ae(t))
          } else yield (0, w.put)(Ae([]))
        }
      }
      function* nt() {
        for (;;) {
          const { type: e } = yield (0, w.take)([oe, ne]),
            t = yield (0, w.select)(),
            n = Xe(t),
            o = n.length,
            r = Ue(t),
            s = [...We(t)],
            i = 1 === s.length && s[0] !== r,
            l = n.findIndex(e => e.id === (i ? s[0] : r))
          if ((e === ne && 0 === l) || (e === oe && l === o - 1)) continue
          const a = ct(t, e === oe ? 'next' : 'previous', n, l),
            { id: c } = a
          s.includes(c) && r
            ? (yield (0, w.put)(xe(r, !1, 1)), yield (0, w.put)(Ee(c)))
            : yield (0, w.put)(xe(c, !0, 1)),
            yield (0, w.put)(Me(c))
        }
      }
      function* ot(e, t) {
        for (;;) {
          const { type: n } = yield (0, w.take)([te, ee]),
            o = yield (0, w.select)(),
            r = Xe(o),
            s = Ze(o),
            i = Ue(o)
          if (1 === s.length && s[0].id !== i && !i) {
            if (n === te) {
              yield (0, w.put)(Ee(s[0].id))
              continue
            }
            if (n === ee) {
              const e = r.findIndex(e => e.id === s[0].id),
                t = ct(o, 'previous', r, e)
              yield (0, w.put)(Ee(t.id))
              continue
            }
          }
          const l = r.findIndex(e => e.id === i),
            a = n === te ? 'next' : 'previous',
            c = ct(o, a, r, l),
            { id: d } = c
          e ? e([d], a) : yield (0, w.put)(Ce([d])), t && t(d), yield (0, w.put)(Ee(d))
        }
      }
      function* rt(e, t = () => !0) {
        for (;;) {
          const { mode: n, nodeId: o, isSelected: r } = yield (0, w.take)(ue)
          let s = [...We(yield (0, w.select)())]
          const i = Xe(yield (0, w.select)())
          if (1 === n) r ? s.push(o) : s.splice(s.indexOf(o), 1)
          else if (2 === n && s.length > 0) {
            const e = Ue(yield (0, w.select)())
            let n = i.findIndex(t => t.id === e)
            ;-1 === n && (n = i.reduce((e, t, n) => (s.includes(t.id) ? n : e), -1))
          ...
          const l = new Set(s)
          ;(s = i.reduce((e, t) => (l.has(t.id) && e.push(t.id), e), [])),
            e ? e(s) : yield (0, w.put)(Ce(s)),
            yield (0, w.put)(Ee(o))
        }
      }
      function* st(e = () => !0, t) {
        const { dropTarget: n, dropType: o, isHoveredLeft: r, boundBox: s, isLastChild: i } = t,
          l = Be(yield (0, w.select)()),
          a = je(yield (0, w.select)(), (0, I.ensureDefined)(n.parentId)),
          c = i && 'after' === o,
          d = Ze(yield (0, w.select)()),
          u = !c || (!r && e(d, n, o)) ? n : a,
          h = (l.node && l.node.id !== u.id) || l.dropType !== o
        d.map(e => e.id).includes(u.id)
          ? yield (0, w.put)({ type: ie })
          : h &&
            e(d, u, o) &&
            (yield (0, w.put)(((e, t, n) => ({ type: se, node: e, dropType: t, boundBox: n }))(u, o, s)))
      }
      function* it(e) {
        yield (0, w.throttle)(0, re, st, e)
      }
      function* lt(e) {
        for (;;) {
          yield (0, w.take)(Y)
          const t = Ze(yield (0, w.select)()),
          ...
          if (n && o) {
            ...
            if ((e && e(r), !r.defaultPrevented)) {
              const e = We(yield (0, w.select)())
              yield (0, w.put)(we(e, n.id, o))
            }
          }
        }
      }
      ...
      function ct(e, t, n, o) {
        ...
        ;-1 === o && 'previous' === t && (o = r)
        let i = 0
        for (; !s || (Math.abs(i) < r && (l = s).level > 1 && !Ve(e, (0, I.ensureDefined)(l.parentId))); )
          (i += 'next' === t ? 1 : -1), (s = n[(o + i + r) % r])
        var l
        return s
      }
      function* dt(e = {}) {
        const {
          ...
          c = [(0, w.fork)(it, o), (0, w.fork)(lt, n), (0, w.fork)(rt, s, a), (0, w.fork)(ot, s, i), (0, w.fork)(nt)]
        for (t && c.push((0, w.fork)(t)), r && c.push((0, w.fork)(at, r)), a && c.push((0, w.fork)(tt, a)); ; ) {
          l && (yield (0, w.call)(et, l))
          ...
          switch (t.type) {
            ...
            case Q: {
              ...
              for (const e of n) {
                ...
                if (r.hasOwnProperty(t)) {
                  !(0, ht.deepEquals)(r[t].children, e.children)[0] && (r[t] = { ...r[t], children: [...e.children] })
                } else {
                  r[t] = e
                  const { parentId: n } = e
            ...
            case fe: {
              const { ids: n, targetId: o, dropType: r } = t,
                s = (0, I.ensureDefined)(e[o].parentId),
                i = e[s],
                l = {}
              for (const t of n) {
                const n = e[t]
                ...
                l[t] = { ...n, parentId: s, level: i.level + 1 }
              }
              const a = i.children.filter(e => !n.includes(e))
              return (
                a.splice(
                  ((e, t, n) => {
                    switch (n) {
                ...
                (l[s] = { ...e[s], children: a, isExpanded: !0 }),
                { ...e, ...l }
              )
            }
            default:
      ...
      var St = n(61625),
        ...
        wt = n(47201),
        Tt = n(70412)
      const It = o.createContext({ size: 0, smallSizeTreeNodeAction: 1 }),
        Et = { [Ct.Modifiers.Mod]: 1, [Ct.Modifiers.Shift]: 2 }
      var Mt = n(88142),
        xt = n(91069)
      const Dt = () => {}
          ...
          super(...arguments),
            ...
            (this._handleRef = e => {
              ...
              ;(0, I.ensureDefined)(n)(this._ref),
                ...
                (0, I.ensureDefined)(o)((0, yt.getEmptyImage)(), { captureDraggingState: !0 })
            }),
            (this._handleTouchStart = e => {
              const t = (e, t) => {
                  ...
                  return new TouchEvent(e, { bubbles: !0, changedTouches: o, touches: r, targetTouches: s })
                },
                n = e.target
      ...
      const Lt = e => {
          const {
            ...
            { size: v, smallSizeTreeNodeAction: _ } = (0, o.useContext)(It),
            b = (0, o.useRef)(null),
            S = (0, wt.createSafeMulticastEventHandler)(e => (b.current = e), h)
          let [y, C] = (0, Tt.useHover)()
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) && ((y = n), (C = { onMouseOut: Dt, onMouseOver: Dt })),
            o.createElement(
              'div',
              {
                className: E(xt.wrap, n && xt.selected, m && xt.childOfSelected, l && xt.disabled, s && xt.expandable),
                onClick:
                  1 === v && 0 === _
                    ? w
                    : function (e) {
                        if (e.defaultPrevented) return
                        const o = Et[(0, Ct.modifiersFromEvent)(e)] || 0
                        !l && i && i(t, !n, o)
                        c && 0 === o && c(e, t)
                      },
                onContextMenu: w,
              ...
              s &&
                o.createElement(x.Icon, {
                  icon: Mt,
                  className: E(xt.expandHandle, a && xt.expanded),
                  onClick: function (e) {
                    e.preventDefault(), s && u(t, !a)
                  },
      ...
      function kt(e, t) {
        ...
        let s = !1,
          i = o.parentId
        for (; i && !s; ) (s = ze(e, i)), (i = je(e, i).parentId)
        return {
          ...o,
          isSelected: r,
          isChildOfSelected: s,
      ...
      const Bt = (0, St.DragSource)(
          'node',
          {
            beginDrag: e => {
              const { id: t, isDisabled: n, isSelected: o } = e
        ...
        Ft = (0, V.connect)(kt, Ot, null, { context: Nt })(Bt(Rt(At))),
        Pt = (0, V.connect)(kt, Ot, null, { context: Nt })(Lt)
      var jt = n(35749),
        zt = n(53614),
        Vt = n(65718)
      function Ht(e) {
        const t = e(),
          n = (0, o.useRef)(t)
        n.current = t
        const [r, s] = (0, o.useState)(n.current),
          i = (0, o.useRef)(null)
        return (
          (0, o.useEffect)(() => {
            null === i.current &&
      ...
      function Gt(e) {
        ...
        const { x: o, y: r } = t,
          s = n && t ? n.y - t.y : 0,
          i = `translate(${o + (n && t ? n.x - t.x : 0)}px, ${r + s}px)`
      ...
      const Ut = (0, zt.DragLayer)(function (e) {
        return {
        ...
        (0, V.connect)(
          ...
          const { items: t, isDragging: n, nodeRenderer: r, dragPreviewRenderer: s } = e
          return Ht(function () {
            return n
              ? o.createElement(
                  Vt.Portal,
      ...
      var Kt = n(3085),
        Zt = n(33127)
      const Qt = o.forwardRef((e, t) => {
          const n = (0, o.useRef)(null)
          return (
            e.connectDropTarget(n),
            (0, o.useImperativeHandle)(t, () => ({ getNode: () => (0, I.ensureNotNull)(n.current) }), []),
            ...
            hover: (e, t, n) => {
              ...
              if ('last' === e.type) {
                const t = o.x - s.left < 48,
                  n = r[r.length - 1],
                  l = t && 2 === n.level ? (0, I.ensureDefined)(r.find(e => e.id === n.parentId)) : n,
                  a = {
                    top: s.top - i.top,
                    left: s.left - i.left,
                    bottom: s.top - i.top,
                ...
                e.processDropTarget(l, 'after', t, a, !1)
              }
            },
          },
          e => ({ connectDropTarget: e.dropTarget() }),
      ...
      function Jt(e) {
        const { dropType: t, boundBox: n } = e,
          { top: o, bottom: r, left: s } = (0, I.ensureDefined)(n)
        return [s, 'before' === t || 'inside' === t ? o : r]
      }
      const Yt = (0, zt.DragLayer)(function (e) {
          ...
          (0, V.connect)(
            ...
            const { dropType: t, boundBox: n, isDragging: r, level: s, transform: i = Jt } = e
            return Ht(function () {
              if (!r || !t || !n) return null
              const l = { [qt.dropTarget]: 'inside' !== t, [qt.dropTargetInside]: 'inside' === t },
                { width: a, height: c } = n,
                [d, u] = i(e),
        ...
        en = o.forwardRef((e, t) => {
          const n = (0, o.useContext)($t)
          return o.createElement(
            'div',
            { ...e, ref: t },
            e.children,
            n.isOver && o.createElement(Yt, { transform: n.transform }),
          )
        })
      var tn = n(62820),
        nn = n(34244)
      const on = 38 + Ct.Modifiers.Shift,
        rn = 40 + Ct.Modifiers.Shift
      const sn = o.forwardRef(function (e, t) {
          ...
          ;(0, o.useEffect)(() => {
            const e = e => {
                ;[Ct.Modifiers.Mod, Ct.Modifiers.Shift].includes((0, Ct.modifiersFromEvent)(e)) && i()
              },
              t = e => {
                l && ![Ct.Modifiers.Mod, Ct.Modifiers.Shift].includes((0, Ct.modifiersFromEvent)(e)) && s()
              }
            return (
                  ...
                  const n = (0, I.ensureNotNull)(e.current),
                    o = e => {
                      if (e.target instanceof Element) {
                        const n = (0, I.ensureNotNull)(e.target.closest('[draggable]'))
          ...
          const L = (0, o.useCallback)(() => (0, I.ensureNotNull)(U.current), []),
            k = (0, o.useCallback)(() => r, [r]),
            O = (0, o.useMemo)(() => {
              const e = h ? Pt : Ft,
                t = []
              let n
              ...
              for (let s = 0; s < r.length; s++) {
                ...
                1 === i.level &&
                  (void 0 !== n &&
                    ...
                    t.push({
                      type: 'separator',
                      node: o.createElement('div', { key: n + '_separator', className: nn.separator }),
                    }),
                  (n = i.parentId)),
                  t.push({
                    type: 'node',
          ...
          const R = (0, o.useCallback)(e => {
              ...
              const { index: n } = e
              return (
                n === B.current.length - 1 && ((t = { ...t, bottom: 0, minHeight: t.height }), delete t.height),
            ...
            P = (0, o.useCallback)(e => (0, I.ensure)(B.current[e].node.key), []),
            j = (0, o.useMemo)(
              () => (null === m ? { index: -1 } : { index: B.current.findIndex(e => e.node.key === m.id) }),
              [m],
            )
          u(A)
          const [z, V, H, G] = (0, Zt.useOverlayScroll)(),
            W = (0, o.useRef)(null)
          ;(0, o.useEffect)(() => (0, I.ensureNotNull)(W.current).resetAfterIndex(0, !0), [O]),
            (0, o.useEffect)(() => (0, I.ensureNotNull)(W.current).scrollToItem(j.index), [j])
          const U = (0, o.useRef)(null),
            K = (0, o.useMemo)(() => ({ isOver: E, transform: f }), [E, f]),
            Z = (0, o.useRef)(null),
            Q = (0, o.useRef)({
              startScroll(e) {
                const t = () => {
                  null !== H.current && ((Z.current = requestAnimationFrame(t)), H.current.scrollBy({ top: e }))
                }
                this.stopScroll(), t()
              },
              stopScroll() {
              ...
              getListElement: () => H.current,
            })
          return (
            (0, o.useImperativeHandle)(t, () => Q.current, []),
            (0, o.useEffect)(() => () => Q.current.stopScroll(), [E]),
            o.createElement(
              $t.Provider,
              { value: K },
              o.createElement(
                ...
                {
                  ...V,
                  className: M()(nn.tree, d),
                  ref: A,
                  tabIndex: -1,
                  onKeyDown: function (e) {
                    const t = (0, Ct.hashFromEvent)(e)
                    if (e.defaultPrevented || (0, jt.isNativeUIInteraction)(t, e.target)) return
                    D || t !== on || (e.preventDefault(), _())
                    D || t !== rn || (e.preventDefault(), b())
                    ;(38 === t || (void 0 !== n && 'previous' === n[t])) && (e.preventDefault(), y())
                    ;(40 === t || (void 0 !== n && 'next' === n[t])) && (e.preventDefault(), S())
                    if ((8 === t || 46 === t) && D) {
                      const { viewModel: e } = D,
                        t = e.selection(),
                        n = t.selected()
                ...
                o.createElement(Kt.OverlayScrollContainer, { ...z, className: nn.overlayScrollWrap }),
        ...
        ln = (0, vt.DropTarget)(
          ...
          {
            drop: (e, t, n) => {
              ;('touch' === e.drag || bt.isFF) && n.stopScroll(), t.getItem().dropSelection()
            },
            hover: (e, t, n) => {
                ...
                ;(l = i > 20 && i <= 40),
                  ...
                  (a = s > 20 && s <= 40) || l
                    ? 'touch' === e.drag
                      ? n.startScroll(a ? -5 : 5)
                      : n.startScroll(a ? -2 : 2)
                    : (c || d) && ('touch' === e.drag ? n.startScroll(c ? -10 : 10) : n.startScroll(c ? -5 : 5))
              })(o.y, s.bottom, s.top)
            },
          },
          (e, t) => ({ connectDropTarget: e.dropTarget(), isOver: t.isOver() }),
        )(sn)
      const an = (0, V.connect)(
          function (e) {
            return {
              renderList: qe(e),
              orderedNodes: Xe(e),
            ...
            return (0, ut.bindActionCreators)(
              {
                ...
                setFocusedNode: Ee,
                processDropTarget: Se,
                onMoveCursorToNext: ve,
                onMoveCursorToPrevious: me,
                onMultiSelectPrevious: _e,
      ...
      function dn(e) {
        ...
        return (
          ...
          (0, o.useEffect)(
            () => (
              null !== m && a && (p && (p.current = performance.now()), m.dispatch((e => ({ type: Q, nodes: e }))(a))),
              () => {}
            ),
            [m, a],
          ),
          (0, o.useEffect)(() => {
            null !== m && c && m.dispatch(Ce(c))
          }, [m, c]),
          (0, o.useEffect)(() => {
            null !== m && (null == h ? void 0 : h.id) && m.dispatch(Ee(h.id))
          }, [m, h]),
          null === m ? null : o.createElement(un, { store: m, scrollToId: f, ...g })
        )
      }
      const un = o.memo(function (e) {
        const { store: t, scrollToId: n, ...r } = e,
          s = 'touch' === e.drag ? G.TouchBackend : H.HTML5Backend
        return (
          (0, o.useEffect)(() => {
            var e
            t.dispatch(Me(null !== (e = null == n ? void 0 : n.id) && void 0 !== e ? e : null))
          }, [n]),
          o.createElement(
            W.DndProvider,
            { backend: s, options: cn },
            o.createElement(V.Provider, { store: t, context: Nt }, o.createElement(an, { ...r })),
          )
        )
      })
      function hn(e, t) {
        ;(0, P.trackEvent)('Object Tree', e, t)
      }
      function pn(e) {
      ...
      function* gn() {
        for (;;) yield (0, w.take)([te, ee]), hn('Select', 'Arrow')
      }
      function* mn() {
        for (;;) {
          const { mode: e } = yield (0, w.take)(ue)
          1 === e && hn('Multi select', 'Ctrl'), 2 === e && hn('Multi select', 'Shift')
        }
      }
      function* vn(e) {
        for (;;) {
      ...
      function* _n(e) {
        yield (0, w.fork)(gn), yield (0, w.fork)(mn), yield (0, w.fork)(vn, e)
      }
      function* bn(e) {
        yield (0, w.fork)(_n, e)
        const t = yield (0, w.call)(fn, e)
        pt.logNormal('Opened object tree data source channel')
        try {
          for (;;) {
          ...
          pt.logNormal('Closed object tree data source channel'), t.close()
        }
      }
      ...
      var yn = n(54475),
        Cn = n(898),
        wn = n(48247)
      const Tn = T.mobiletouch ? 'touch' : 'native'
      function In(e) {
        const { viewModel: t, showHeader: n = !0, nodeRenderer: r, isDialog: s = !1 } = e,
          i = (0, o.useRef)(null),
          l = (function (e) {
          ...
          [a, c] = (0, Cn.useDimensions)(),
          [d, u] = (0, o.useState)(null),
          h = (0, o.useMemo)(() => ({ isTouch: T.touch, isDialog: s }), [s])
        return o.createElement(
          Sn.Provider,
          { value: h },
          o.createElement(
            ...
            o.createElement(
              'div',
              { className: wn.wrap, onContextMenu: yn.preventDefaultForContextMenu },
              ...
              o.createElement(
                ...
                o.createElement(
                  'div',
                  {
                    ...
                    onClick: function (e) {
                      if (e.defaultPrevented) return
                      if (!(e.target instanceof Element) || null === i.current) return
                      e.target === i.current && t.selection().set([])
                    },
                  },
                  null !== c &&
                    o.createElement(dn, {
      ...
      function An(e) {
        ...
        return o.createElement(x.Icon, { className: M()(Dn.button, n && Dn.disabled, t), ...r })
      }
      var Ln = n(77975),
        Nn = n(73591),
        kn = n(73366),
      ...
      function jn(e) {
        const { id: t } = e,
          ...
          s = r.entity(t)
        return null === s ? null : o.createElement(zn, { ...e, entity: s })
      }
      function zn(e) {
        const {
            id: t,
          ...
          u = (0, o.useContext)(N),
          { viewModel: h } = (0, I.ensureNotNull)(u),
          p = (0, o.useContext)(Sn),
          { size: f } = (0, o.useContext)(It),
          [g, m] = (0, o.useState)(!1),
          _ = (0, o.useRef)(null),
          [b, S] = (0, o.useState)(c.title()),
          [y, C] = (0, o.useState)(c.isLocked()),
          [w, T] = (0, o.useState)(c.isVisible()),
          [M, D] = (0, o.useState)(c.isActualInterval()),
          [A, L] = (0, o.useState)(c.getDrawingSyncState()),
          [k, O] = (0, o.useState)(!1),
          [B, R] =
            ((0, Ln.useWatchedValueReadonly)({
        ...
        ;(0, o.useEffect)(() => {
          const e = {}
          c.onLockChanged().subscribe(e, () => C(c.isLocked())),
            c.onVisibilityChanged().subscribe(e, () => T(c.isVisible()))
          const t = c.onTitleChanged()
          return (
            t && t.subscribe(e, () => S(c.title())),
            c.onIsActualIntervalChange().subscribe(e, () => D(c.isActualInterval())),
            c.onSyncStateChanged().subscribe(e, () => L(c.getDrawingSyncState())),
            () => {
              c.onIsActualIntervalChange().unsubscribeAll(e),
                c.onLockChanged().unsubscribeAll(e),
                c.onVisibilityChanged().unsubscribeAll(e),
                c.onSyncStateChanged().unsubscribeAll(e),
          ...
          (0, o.useEffect)(() => {
            g && _.current && (_.current.focus(), _.current.setSelectionRange(0, b.length))
          }, [g]),
          (0, o.useEffect)(() => {
            const e = {}
            return (
          ...
          (0, o.useEffect)(() => {
            h.setHoveredObject(l ? t : null)
          }, [l]),
          (0, o.useEffect)(() => {
            !s && F.current && (clearTimeout(F.current), (F.current = null)), m(!1)
          }, [s])
        const P = c.getIcon(),
          j = {}
        if (a) {
          const e = h.entity(a)
          e && (j['data-parent-name'] = e.title()), (j['data-type'] = c.hasChildren() ? 'group' : 'data-source')
        }
        const z = c.title(),
          V = l || k,
          H = g && s,
          ...
          U = M && w ? Rn : Fn,
          K = c.hasChildren()
            ? (0, v.t)('Group is hidden on current interval')
            : (0, v.t)('Drawing is hidden on current interval')
        return o.createElement(
          'span',
          {
            className: E(
              ...
              s && Pn.selected,
              n && Pn.offset,
              i && Pn.childOfSelected,
              k && !r && !s && !i && Pn.hover,
              W && !r && !s && !i && Pn.dialog,
            ),
            onMouseDown: function (e) {
              g && !(0, I.ensureNotNull)(_.current).contains(e.target) && R(!0)
            },
            onClick:
              1 === f
                ? Z
                : function (e) {
                    if (e.defaultPrevented) return
                    if (0 !== (0, Ct.modifiersFromEvent)(e)) return
                    if (F.current)
                      e.preventDefault(), clearTimeout(F.current), (F.current = null), h.openProperties(c), R(!1)
                    else {
                      const e = h.selection().selected()
                      F.current = setTimeout(() => {
                        ;(F.current = null), s && !B && 1 === e.length && h.rename(c, () => m(!0)), R(!1)
                      }, 500)
                    }
                  },
            onContextMenu: G ? void 0 : Z,
          },
          !H &&
            o.createElement(
              o.Fragment,
              null,
              P && P.type === Mn.Svg && o.createElement(x.Icon, { icon: P.content || '', className: Pn.icon }),
              P && P.type === Mn.Text && o.createElement('span', { className: E(Pn.icon, Pn.textIcon) }, P.content),
              !1,
              o.createElement(
                'span',
                { className: E(Pn.title, h.isMain(c) && Pn.main, (!c.isVisible() || !M) && Pn.disabled), ...j },
                z,
              ),
              o.createElement(
                'span',
                { className: Pn.rightButtons },
                c.canBeLocked() &&
                  o.createElement(An, {
                    icon: y ? On : Bn,
                    className: E(Pn.button, (V || y) && Pn.visible),
                    onClick: function (e) {
                      if (e.defaultPrevented) return
                      e.preventDefault(), h.setIsLocked(t, !c.isLocked())
                    },
                    'data-role': 'button',
                    'data-name': 'lock',
                    'data-active': y,
                ...
                o.createElement(An, {
                  icon: U,
                  className: E(Pn.button, !M && [Pn.warn, 'apply-common-tooltip'], (V || !w || !M) && Pn.visible),
                  onClick: M
                    ? function (e) {
                        if (e.defaultPrevented) return
                        e.preventDefault(), h.setIsVisible(t, !c.isVisible())
                      }
                    : function (e) {
                        if (e.defaultPrevented) return
                        e.preventDefault(), h.openProperties(c, Nn.TabNames.visibility)
                      },
                  title: M ? void 0 : K,
                  'data-role': 'button',
                  'data-name': 'hide',
                ...
                c.canBeRemoved() &&
                  o.createElement(An, {
                    icon: kn,
                    className: E(Pn.button, (G || V) && Pn.visible),
                    onClick: function (e) {
                      if (e.defaultPrevented) return
          ...
          H &&
            o.createElement(xn.InputControl, {
              value: b,
              onChange: function (e) {
                S(e.currentTarget.value)
              },
              onClick: yn.preventDefault,
              className: Pn.renameInput,
              onKeyDown: function (e) {
                27 === (0, Ct.hashFromEvent)(e)
                  ? (e.preventDefault(), S(c.title()), m(!1))
                  : 13 === (0, Ct.hashFromEvent)(e) && (e.preventDefault(), Q())
              },
        ...
        function Z(e) {
          e.defaultPrevented ||
            g ||
            !c.fullyConstructed() ||
            (e.preventDefault(), e.persist(), h.openContextMenu(c, () => m(!0), e))
        }
        function Q() {
          '' !== b && c.setName(b), S(c.title()), m(!1)
        }
        function X(e) {
          if (c.hasChildren() && !d) {
            const t = null !== e && c.childrenIds().has(e)
            O(t)
          } else O(t === e)
        }
      }
      ...
      class Hn extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._renderChildren = e => o.createElement(Gn, { isSmallTablet: e, viewModel: this.props.viewModel })),
            ...
            (this._matchMedia = window.matchMedia(b.DialogBreakpoints.TabletSmall)),
        ...
        render() {
          return o.createElement(
            o.Fragment,
            null,
            o.createElement(m.MatchMedia, { rule: b.DialogBreakpoints.TabletSmall }, e =>
            ...
            o.createElement(
              ...
              this.state.showDrawer &&
                o.createElement(
                  ...
                  o.createElement(S.ManageDrawings, {
      ...
      function Gn(e) {
        ...
        return o.createElement(
          It.Provider,
          { value: r },
          o.createElement(In, { nodeRenderer: jn, showHeader: !1, viewModel: n, isDialog: !0 }),
        )
      }
      var Wn = n(16216),
        Un = n(54427),
      ...
      class qn {
        constructor(e) {
          ;(this._onChange = new (Zn())()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map(e => Xn(e.id, e.instanceId())),
            ...
            (this._model = e),
            (this._selectionApi = new Qn.SelectionApi(this._model)),
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map(e => $n(e).persistentId)),
            (this._selected = n),
            this._onChange.fire(this._selected)
        }
        ...
        buildTree() {
          ...
          for (const t of this._controller.model().panes()) {
            ...
            for (const n of this._groupModel.groups()) {
              const o = Xn(n.id, n.instanceId()),
                r = (0, I.ensureNotNull)(this._facade.getObjectById(o))
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  .sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1))
                  .map(e => Xn(e.id(), e.instanceId()))
                ;(e[r.id()] = Yn(r.id(), 1, t.id(), o)), e[t.id()].children.push(r.id())
                for (const t of o) e[t] = Yn(t, 2, r.id())
              }
            }
            for (const o of n) {
              const n = Xn(o.id(), o.instanceId())
              e[n] || ((e[n] = Yn(n, 1, t.id())), e[t.id()].children.push(n))
            }
            e[t.id()].children.sort((e, t) => {
              ...
              return (0, I.ensureNotNull)(o.zOrder()) - (0, I.ensureNotNull)(n.zOrder())
            })
          }
      ...
      var eo = n(24980),
        ...
        co = n(28337),
        uo = n(46627)
      const ho = new eo.TranslatedString('show {title}', (0, v.t)('show {title}')),
        po = new eo.TranslatedString('hide {title}', (0, v.t)('hide {title}')),
        fo = new eo.TranslatedString('lock {title}', (0, v.t)('lock {title}')),
        go = new eo.TranslatedString('unlock {title}', (0, v.t)('unlock {title}')),
        mo = new eo.TranslatedString(
          'change {sourceTitle} title to {newSourceTitle}',
          (0, v.t)('change {sourceTitle} title to {newSourceTitle}'),
        ),
        vo = new eo.TranslatedString('insert source(s) after', (0, v.t)('insert source(s) after'))
      function _o(e, t) {
        return t.every(t => !(t.pane() !== e && !t.allowsMovingbetweenPanes()))
      }
      function bo(e) {
        return e instanceof oo.DataSource && e.showInObjectTree() ? Xn(e.id(), e.instanceId()) : null
      }
      function So(e) {
        return new eo.TranslatedString(e.name(), e.title())
      }
      const yo = new (Zn())()
      class Co {
        constructor(e, t) {
          ;(this._syncStateChanged = new (Zn())()),
            (this._lineToolsAffectChartInvalidation = new uo.FeatureToggleWatchedValue(
              'do_not_invalidate_chart_on_changing_line_tools',
              !1,
            )),
            (this._updateSyncState = () => {
              this._syncStateChanged.fire((0, I.ensureNotNull)(this.getDrawingSyncState()))
            }),
            (this._undoModel = e),
            (this._dataSource = t),
            (0, to.isLineTool)(this._dataSource) &&
          ...
          null !== n && n === t && n.isSynchronizable() && io.isToolCreatingNow.subscribe(this._updateSyncState)
        }
        destroy() {
          ;(0, to.isLineTool)(this._dataSource) &&
            (this._dataSource.linkKey().unsubscribe(this._updateSyncState),
            this._dataSource.sharingMode().unsubscribe(this._updateSyncState)),
            io.isToolCreatingNow.unsubscribe(this._updateSyncState)
        }
        id() {
          return Xn(this._dataSource.id(), this._dataSource.instanceId())
        }
        title() {
          const e = this._dataSource
          return (0, to.isLineTool)(e)
            ? e.properties().title.value() || e.translatedType()
            : (0, ro.isSeries)(e) && this._undoModel.mainSeries() === e
            ? e.symbolTitle(void 0, void 0, (0, bt.onWidget)() ? 'exchange' : 'listed_exchange')
            : e.title()
        }
        gaLabel() {
          return (0, no.isStudy)(this._dataSource)
            ? 'Study'
            : (0, to.isLineTool)(this._dataSource)
            ? 'Drawing'
            : 'Symbol'
        ...
        canBeLocked() {
          return (0, to.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled()
        }
        canBeRemoved() {
        ...
        canBeRenamed() {
          return (0, to.isLineTool)(this._dataSource)
        }
        fullyConstructed() {
        ...
        isActualInterval() {
          return (
            (!(0, to.isLineTool)(this._dataSource) && !(0, no.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          )
        }
        onIsActualIntervalChange() {
          return (0, to.isLineTool)(this._dataSource) || (0, no.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : yo
        }
        isLocked() {
          return !!(0, to.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners()
        }
        onLockChanged() {
          return (0, to.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : yo
        }
        getIcon() {
          const e = c,
            t = this._dataSource.getSourceIcon(),
            n = (0, no.isStudyStrategy)(this._dataSource)
          let o = { type: Mn.Svg, content: n ? lo : ao }
          if (e && t)
            if ('loadSvg' === t.type) {
              const [n, r] = t.svgId.split('.'),
                s = 'linetool' === n ? e.linetool[r] : e.series[Number(r)]
              o = { type: Mn.Svg, content: s || ao }
            } else 'text' === t.type && (o = { type: Mn.Text, content: t.text })
          return o
        }
        setVisible(e) {
          const t = (e ? ho : po).format({ title: So(this._dataSource) })
          this._undoModel.setProperty(this._dataSource.properties().visible, e, t)
        }
        setLocked(e) {
          if ((0, to.isLineTool)(this._dataSource)) {
        ...
        setName(e) {
          if ((0, to.isLineTool)(this._dataSource)) {
            const t = mo.format({
              sourceTitle: this._dataSource.properties().title.value() || So(this._dataSource),
              newSourceTitle: e,
            })
        ...
        pane() {
          return (0, I.ensureNotNull)(this._undoModel.model().paneForSource(this._dataSource))
        }
        allowsMovingbetweenPanes() {
          return !(0, to.isLineTool)(this._dataSource)
        }
        canBeAddedToGroup() {
          return (0, to.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol()
        }
        ...
        canBeSyncedInLayout() {
          return (0, to.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable()
        }
        onSyncStateChanged() {
        ...
        doNotAffectChartInvalidation() {
          return (0, to.isLineTool)(this._dataSource) && this._lineToolsAffectChartInvalidation.value()
        }
        _canInsertBeforeOrAfter(e) {
          const t = this._undoModel.model()
          if (!_o(this.pane(), e)) return !1
          if ((0, to.isLineTool)(this._dataSource)) {
            if (
          ...
          if ((0, to.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, I.assert)(!e.some(e => e.hasChildren())),
                s.forEach(e => {
                  ;(0, to.isLineTool)(e) && (t.containsLineTool(e) || o.addLineToolToGroup(t, e))
                }))
              : r()
          } else r()
      ...
      class wo {
        constructor(e, t) {
          ;(this._onTitleChanged = new (Zn())()),
            (this._onVisibilityChanged = new (Zn())()),
            (this._onLockChanged = new (Zn())()),
            (this._onIsActualIntervalChanged = new (Zn())()),
            (this._syncStateChanged = new (Zn())()),
            ...
            (this._paneId = (0, I.ensureNotNull)(e.model().paneForSource(this._lineTools[0])).id())
          const n = () => {
        ...
        id() {
          return Xn(this._group.id, this._group.instanceId())
        }
        title() {
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map(e => Xn(e.id(), e.instanceId())))
        }
        hasChildren() {
          return !0
        }
      ...
      class To {
        constructor(e) {
          ;(this._hoveredObjectChanged = new (Zn())()),
        ...
        getObjectById(e) {
          if (this._entitiesCache.has(e)) return (0, I.ensureDefined)(this._entitiesCache.get(e))
        ...
        canBeGroupped(e) {
          ...
          const t = []
          if ((e.forEach(e => e.addSourcesToArray(t)), t.some(e => !(0, to.isLineTool)(e) || !e.boundToSymbol())))
            return !1
          const n = this._undoModel.model(),
        ...
        contextMenuActions(e, t, n) {
          const o = new so.ActionsProvider(e, n),
            r = []
        ...
        hoveredObjectId() {
          return bo(this._undoModel.model().hoveredSource())
        }
        hoveredObjectChanged() {
          return this._hoveredObjectChanged
        }
        _onModelHoveredSourceChanged(e) {
          this._hoveredObjectChanged.fire(bo(e))
        }
        _createObjectById(e) {
          const t = $n(e).persistentId,
            n = this._undoModel.model(),
            o = n.dataSourceForId(t)
          if (null !== o) return new Co(this._undoModel, o)
          const r = n.lineToolsGroupModel().groupForId(t)
          return null !== r ? new wo(this._undoModel, r) : null
        }
      }
      var Io = n(22932),
        Eo = n(97056),
        ...
        Oo = n(94669),
        Bo = n(78679)
      const Ro = (0, l.getLogger)('Platform.GUI.ObjectTree')
      const Fo = new eo.TranslatedString('move objects', (0, v.t)('move objects')),
        Po = new eo.TranslatedString('lock objects', (0, v.t)('lock objects')),
        jo = new eo.TranslatedString('unlock objects', (0, v.t)('unlock objects')),
        zo = new eo.TranslatedString('show objects', (0, v.t)('show objects')),
        Vo = new eo.TranslatedString('hide objects', (0, v.t)('hide objects')),
        Ho = new eo.TranslatedString('remove objects', (0, v.t)('remove objects')),
        Go = (0, v.t)('Create a group of drawings'),
        Wo = (0, v.t)('Rename'),
        Uo = (0, v.t)('Unlock'),
        Ko = (0, v.t)('Lock'),
        Zo = (0, v.t)('Hide'),
      ...
      class $o {
        constructor(e) {
          ;(this._nodes = {}),
            ...
            (this._isContextMenuOpened = new (Do())(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._groupModel = this._model.lineToolsGroupModel()),
                (this._facade = new To(this._controller)),
                (this._subscriptions = [
                ...
                (this._selection = new qn(this._model)),
                this._update())
            }),
            (this._update = () => {
              null === this._timeout &&
            ...
            (this._ensuredEntity = e => (0, I.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init()
        }
        destroy() {
        ...
        insertSelection(e, t) {
          const n = this._facade,
            ...
            [r, s] = this._normalizeTargetAndDropType(e, t)
          this._controller.withMacro(Fo, () => {
            switch (s) {
              case 'before':
                n.insertBefore(o, r)
                break
        ...
        isMain(e) {
          return $n(e.id()).persistentId === this._controller.mainSeries().id()
        }
        selection() {
        ...
        openProperties(e, t) {
          const n = this._model.dataSourceForId($n(e.id()).persistentId)
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ...
                  : ((0, to.isLineTool)(n) || (0, no.isStudy)(n)) &&
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities()
          return 1 === e.length && this.canNodeWithIdBeUnmerged($n(e[0].id()).persistentId)
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e)
          return null !== t && (0, Io.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t)
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e => (0, I.ensureNotNull)(this._model.dataSourceForId($n(e.id()).persistentId)))
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), hn('Copy', pn(e))
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map(e => (0, I.ensureNotNull)(this._model.dataSourceForId($n(e.id()).persistentId)))
          t.every(to.isLineTool) && (this._controller.cloneLineTools([...t], !1), hn('Clone', pn(e)))
        }
        rename(e, t) {
          const n = this._getObjectsToModify(e.id())
          1 === n.length && n.some(e => e.canBeRenamed()) && (t(), hn('Rename', pn(n)))
        }
        async openContextMenu(e, t, n) {
          ...
          let s
          if (this._objects.some(e => e.hasChildren())) s = this._getActionsForGroupItem(e, t, r)
          else {
            const e = await this._facade.contextMenuActions(this._chart.value(), this._objects, this._options)
            if (
              ((s = Array.from(e).filter(
          ...
          if (s.length > 0) {
            ...
            const t = $n(e.id()).persistentId,
              r = this._model.dataSourceForId(t),
              i = r instanceof ro.Series,
            ...
            ;(a = i
              ...
              Eo.ContextMenuManager.showMenu(s, n, { takeFocus: !0, returnFocus: !0 }, a, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            (null === (t = s.pane().mainDataSource()) || void 0 === t ? void 0 : t.id()) === o &&
          ...
          const i = (0, I.ensureDefined)(n.find(e => e.id === r.parentId)).children
          return 1 === i.length ? this.getNextNodeIdAfterRemove(r.parentId) : this._takeNextOrPrevElement(i, e)
        }
        isContextMenuOpened() {
        ...
        _getRenameAction(e) {
          return new Mo.Action({
            ...
            icon: Oo,
            onExecute: () => {
              e(), hn('Context menu rename', pn(this._objects))
            },
          })
        }
        _getActionsForGroupItem(e, t, n) {
          ...
          const r = []
          1 === this._objects.length && r.unshift(this._getRenameAction(t), new Mo.Separator()),
            n && r.unshift(this._getGroupAction(), new Mo.Separator())
          const s = (0, so.createSyncDrawingActions)(this._chart.value(), o.filter(to.isLineTool))
          return (
            s.length && (s.shift(), s.push(new Mo.Separator()), r.push(...s)),
            r.push(
              new Mo.Action({
                actionId: 'ObjectsTree.ToggleItemLocked',
                label: e.isLocked() ? Uo : Ko,
                icon: e.isLocked() ? Ao : Lo,
                onExecute: () => this.setIsLocked(e.id(), !e.isLocked()),
              }),
              new Mo.Action({
                actionId: 'ObjectsTree.ToggleItemVisibility',
                label: e.isVisible() ? Zo : Qo,
                icon: e.isVisible() ? No : ko,
              ...
              new Mo.Action({
                ...
                hotkeyHash: Ct.isMacKeyboard ? 8 : 46,
              }),
              new Mo.Separator(),
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, I.ensureNotNull)(this._model.dataSourceForId($n(n.id()).persistentId))
          if (!(0, Io.isPriceDataSource)(o)) throw new Error('Entity is not IPriceDataSource')
          ;(0 === e ? this._controller.unmergeSourceUp : this._controller.unmergeSourceDown).call(this._controller, o)
          hn(0 === e ? 'New pane above' : 'New pane below', pn([n]))
        }
        _recalculateTree() {
          const e = new Jn(this._controller, this._facade)
        ...
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              Ro.logWarn('Detected dangling sources in selection. They will be ignored: ' + JSON.stringify(t)),
            e
          )
        }
        _getEntityById(e) {
      ...
      var qo = n(22729)
      class Jo extends qo.DialogRenderer {
        constructor() {
          super(),
            (this._handleClose = () => {
          ...
          const e = (0, Wn.service)(Un.CHART_WIDGET_COLLECTION_SERVICE)
          ;(this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new $o(e.activeChartWidget))
        }
        hide() {
          this._handleClose()
        }
