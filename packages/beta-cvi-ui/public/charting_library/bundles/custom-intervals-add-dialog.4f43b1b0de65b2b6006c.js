;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4013],
  {
    ...
    22169: e => {
      e.exports = {
        scrollable: 'scrollable-fejnDJJf',
        content: 'content-fejnDJJf',
        row: 'row-fejnDJJf',
        title: 'title-fejnDJJf',
        control: 'control-fejnDJJf',
      }
    },
    91131: e => {
      e.exports = {
    ...
    79756: e => {
      e.exports = { placeholder: 'placeholder-fKHYe1Lk' }
    },
    91626: e => {
    ...
    94720: (e, t, n) => {
      ...
      function c(e) {
        ...
        return r(
          ...
          g,
          h && a().grouped,
          h && !f && a()['adjust-position'],
          h && m.isTop && a()['first-row'],
          h && m.isLeft && a()['first-col'],
        )
      }
      function u(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: l, children: i, endIcon: c } = e,
          u = null != n ? n : r
        return o.createElement(
          o.Fragment,
          null,
          u && 'xsmall' !== t && o.createElement(s.Icon, { icon: u, className: a()['start-icon-wrap'] }),
          i && o.createElement('span', { className: a().content }, i),
          c && !l && 'xsmall' !== t && o.createElement(s.Icon, { icon: c, className: a()['end-icon-wrap'] }),
        )
      }
      var d = n(86332),
        p = n(90186)
      function h(e) {
        ...
        return { ...d, ...(0, p.filterDataProps)(e), ...(0, p.filterAriaProps)(e) }
      }
      function m(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: l, disablePositionAdjustment: s } = (0, o.useContext)(d.ControlGroupContext),
          i = c({ ...n, isGrouped: r, cellState: l, disablePositionAdjustment: s })
        return o.createElement('button', { ...h(n), className: i, ref: t }, o.createElement(u, { ...n }))
      }
      ...
      function v(e) {
        ...
        return { ...s, color: g(t), size: b(n), variant: f(o), stretch: r, startIcon: l }
      }
      function C(e) {
        return o.createElement(m, { ...v(e) })
      }
    },
    86332: (e, t, n) => {
      'use strict'
    ...
    67029: (e, t, n) => {
      ...
      function h(e, t, n, o) {
        const {
          ...
          C = p(null != l ? l : (0, c.getGroupCellRemoveRoundBorders)(n))
        return r(
          d().container,
          d()['intent-' + i],
          d()['border-' + a],
      ...
      function m(e, t) {
        ...
        const l = p(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(t))
      ...
      function b(e, t) {
        const {
          ...
          { isGrouped: k, cellState: N, disablePositionAdjustment: _ = !1 } = (0, o.useContext)(a.ControlGroupContext),
          A = (function (e, t = null, n) {
        ...
        return o.createElement(
          ...
          S,
          E,
          o.createElement('span', { className: m(e, N) }),
        )
      }
    ...
    78274: (e, t, n) => {
      'use strict'
      n.d(t, { StartSlot: () => i, MiddleSlot: () => a, EndSlot: () => c, AfterSlot: () => u })
      var o = n(59496),
        r = n(97754),
        l = n(10306),
        s = n.n(l)
      function i(e) {
        ...
        return o.createElement('span', { className: r(s()['inner-slot'], n && s().interactive, l && s().icon, t) }, i)
      }
      function a(e) {
    ...
    31261: (e, t, n) => {
      ...
      function b(e) {
        const {
          ...
          G = (0, l.filterProps)(W, g),
          U = {
            ...(0, l.filterAriaProps)(W),
            ...(0, l.filterDataProps)(W),
            id: t,
            title: n,
            role: s,
            tabIndex: i,
        ...
        return o.createElement(p.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement('input', {
              ...U,
              className: r(f().input, z, V && f()['with-start-slot'], T && f()['with-end-slot']),
              disabled: K,
              readOnly: F,
              ref: H,
            }),
      ...
      function v(e) {
        ...
        const {
          ...
          w = t ? void 0 : v ? -1 : r,
          S = t ? void 0 : v ? r : -1,
          { isMouseDown: E, handleMouseDown: x, handleMouseUp: y } = (0, d.useIsMouseDown)(),
          k = (0, s.createSafeMulticastEventHandler)(
            C.onFocus,
            function (e) {
              n && !E.current && (0, i.selectAllContent)(e.currentTarget)
            },
            l,
          ),
          N = (0, s.createSafeMulticastEventHandler)(C.onBlur, p),
          _ = (0, o.useCallback)(
            e => {
        ...
        return o.createElement(b, {
          ...
          onBlur: N,
          reference: _,
          containerReference: (0, a.useMergedRefs)([g, m]),
          onMouseDown: x,
          onMouseUp: y,
        })
      }
    ...
    48027: (e, t, n) => {
      ...
      function l(e) {
        ...
        return { ...e, intent: l || (a ? 'primary' : 'default'), highlight: null != s ? s : a, onFocus: u, onBlur: d }
      }
    },
    29202: (e, t, n) => {
      'use strict'
    ...
    21317: (e, t, n) => {
      ...
      function h(e) {
        const { onAdd: t, onClose: n, onUnmount: h } = e,
          [m, f] = (0, o.useState)(u.INTERVALS[0].name),
          [g, b] = (0, o.useState)('1')
        return (
          (0, o.useEffect)(
            () => () => {
          ...
          o.createElement(l.AdaptiveConfirmDialog, {
            ...
            title: (0, r.t)('Add custom time interval'),
            isOpened: !0,
            onSubmit: function () {
              t(g, m), n()
            },
            ...
            render: () =>
              o.createElement(
                ...
                { className: d.scrollable, onScroll: C },
                o.createElement(
                  'div',
                  { className: d.content },
                  o.createElement(
                    'div',
                    { className: d.row },
                    o.createElement('div', { className: d.title }, (0, r.t)('Type')),
                  ...
                  o.createElement(
                    'div',
                    { className: d.row },
                    o.createElement('div', { className: d.title }, (0, r.t)('Interval')),
    ...
    85457: (e, t, n) => {
      ...
      var l = n(97754),
        ...
        f = n(76422),
        g = n(9745)
      const b = o.createContext({ setHideClose: () => {} })
      var v = n(37257),
        C = n(91441)
      function w(e) {
        const {
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { className: s()(C.container, u, (n || d) && C.unsetAlign) },
            i,
            o.createElement(
              'div',
              { 'data-dragg-area': c, className: C.title },
              o.createElement('div', { className: C.ellipsis }, t),
              n && o.createElement('div', { className: s()(C.ellipsis, C.subtitle) }, n),
            ),
            a,
            r &&
              !p &&
      ...
      class y extends o.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleKeyDown = e => {
              ...
              if (!e.defaultPrevented)
                switch ((this.props.onKeyDown && this.props.onKeyDown(e), (0, i.hashFromEvent)(e))) {
                  case 27:
                    ...
                    if (null !== n) {
                      ...
                      if (o.contains(n)) return void this._handleClose()
                    }
                }
            }),
            (this._requestResize = () => {
        ...
        render() {
          const {
            ...
            M = 'after' !== m ? f : void 0,
            B = 'after' === m ? f : void 0,
            z = 'string' == typeof l ? l : I || ''
          return o.createElement(p.MatchMedia, { rule: d.DialogBreakpoints.SmallHeight }, m =>
            o.createElement(p.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, d =>
              o.createElement(
                c.PopupDialog,
                {
                  rounded: !(d || k) && _,
                ...
                o.createElement(
                  'div',
                  { className: s()(S.wrapper, t), 'data-name': i, 'data-dialog-name': z },
                  void 0 !== l &&
                    o.createElement(w, {
                      draggable: y && !(d || k),
                      onClose: this._handleClose,
                  ...
                  v && o.createElement(u.Separator, { className: S.separator }),
                  o.createElement(h.PopupContext.Consumer, null, e => this._renderChildren(e, d || k)),
                ),
              ),
            ),
          )
    ...
    46059: (e, t, n) => {
      ...
      const p = JSON.parse('{"size-header-height":"64px"}'),
        h = parseInt(p['size-header-height'])
      function m(e) {
        const {
            button: t,
            popupChildren: n,
      ...
      function v(e) {
        const { isDropped: t } = e
        return o.createElement(f.Icon, { className: l()(b.icon, t && b.dropped), icon: g })
      }
      function C(e) {
        const { className: t, disabled: n, isDropped: r } = e
        return o.createElement(
          'span',
          { className: l()(b.button, n && b.disabled, t) },
          o.createElement(v, { isDropped: r }),
        )
      }
      var w = n(66230)
      const S = o.forwardRef((e, t) => {
        const {
            ...
            disabled: h,
            isOpened: f,
            scrollWrapReference: g,
            repositionOnScroll: b,
            closeOnHeaderOverlap: v,
            listboxReference: S,
            size: E = 'medium',
            onClose: x,
            onOpen: y,
          ...
          I = (0, o.useRef)(null),
          M = !d && o.createElement(a.EndSlot, null, o.createElement(C, { isDropped: f, disabled: h, className: D }))
        return o.createElement(m, {
          ...
          button: o.createElement(i.ControlSkeleton, {
            ...
            'data-role': 'listbox',
            disabled: h,
            className: l()(w.button, r),
            size: E,
            ref: (0, s.useMergedRefs)([I, t]),
            middleSlot: o.createElement(
              a.MiddleSlot,
              null,
              o.createElement('span', { className: l()(w['button-children'], d && w.hiddenArrow) }, A),
            ),
            endSlot: M,
          }),
          popupChildren: O,
      ...
      function c(e) {
        const { intent: t, highlight: n, ...c } = e,
          { isFocused: u, ...d } = (function (e) {
            const { id: t, disabled: n, buttonTabIndex: c = 0, onFocus: u, onBlur: d, onClick: p } = e,
              [h, m] = (0, o.useState)(!1),
              [f, g] = (0, l.useFocus)(),
              b = f || h,
              v = void 0 !== t ? (0, i.createDomId)(t, 'listbox') : void 0,
              C = (0, o.useRef)(null),
              w = (0, o.useCallback)(e => (0, r.ensureNotNull)(C.current).focus(e), [C]),
              S = (0, o.useRef)(null),
              E = (0, o.useCallback)(() => (0, r.ensureNotNull)(S.current).focus(), [S]),
              x = (0, o.useCallback)(() => m(!0), [m]),
              y = (0, o.useCallback)(
                (e = !1) => {
                  m(!1)
                  const { activeElement: t } = document
                  ;(t && (0, a.isTextEditingField)(t)) || w({ preventScroll: e })
                },
                [m, w],
              ),
              k = (0, o.useCallback)(() => {
              ...
              _ = n ? [] : [d, g.onBlur],
              A = n ? [] : [p, k],
              O = (0, s.createSafeMulticastEventHandler)(...N),
              D = (0, s.createSafeMulticastEventHandler)(..._),
              R = (0, s.createSafeMulticastEventHandler)(...A)
            return {
              listboxId: v,
              isOpened: h,
              isFocused: b,
              ...
              toggle: k,
              onOpen: E,
              buttonFocusBindings: { onFocus: O, onBlur: D },
              onButtonClick: R,
              buttonRef: C,
              listboxRef: S,
              buttonAria: { 'aria-controls': h ? v : void 0, 'aria-expanded': h, 'aria-disabled': n },
            }
          })(c)
        return { ...d, isFocused: u, highlight: null != n ? n : u, intent: null != t ? t : u ? 'primary' : 'default' }
      }
    },
    26597: (e, t, n) => {
      'use strict'
    ...
    45685: (e, t, n) => {
        ...
        if (
          ...
          const t = (function (e) {
            ...
            (function (e, t, n, o = 0) {
              ...
              return { start: t[r.start] - n[r.start] - o, middle: l - s, end: t[r.end] - n[r.end] + o }
            })(e, o, r, l.additionalScroll),
          )
          a = void 0 !== t ? s[t.key] : 0
        }
        return (function (e) {
          const {
          ...
          ;(c = null != c ? c : l.getBoundingClientRect()), (u = null != u ? u : s.getBoundingClientRect())
          ...
          return (
            (f = window.requestAnimationFrame(function e(t) {
              let l
              if ((m ? (l = t - m) : ((l = 0), (m = t)), l >= n)) return (s[p] = h + d), void (r && r())
              const i = h + d * o(l / n)
              ;(s[p] = Math.floor(i)), (f = window.requestAnimationFrame(e))
            })),
            function () {
              window.cancelAnimationFrame(f), r && r()
            }
          )
        })({ ...l, target: t, targetRect: o, wrap: n, wrapRect: r, additionalScroll: a, direction: e })
      }
      class p {
        constructor(e = null) {
      ...
      function h(e, t) {
        const n = (0, o.useRef)(null),
          ...
          l = (function (e) {
            ...
            return (
              (0, o.useEffect)(() => ((t.current = new p(e)), () => (0, s.ensureNotNull)(t.current).destroy()), []), t
            )
          })(n.current),
          i = (0, o.useCallback)(() => {
            null !== l.current &&
        ...
        return (0, o.useEffect)(() => u(e, t), [u, e]), [a, c, u]
      }
      var m = n(16396),
        f = n(4889),
        g = n(43370)
      ...
      const _ = o.forwardRef((e, t) => {
        const {
          ...
          onClick: R,
          onChange: j,
          repositionOnScroll: I = !0,
          ...M
        } = e
        let { items: B } = e
        if (b && x) {
          B = [{ value: void 0, content: b, id: (0, r.createDomId)(n, 'placeholder') }, ...B]
        }
        const {
            listboxId: z,
            isOpened: K,
          ...
          [ee, te, ne] = h(Z),
          oe = (0, r.joinDomIds)(A, n),
          re = oe.length > 0 ? oe : void 0,
          le = (0, o.useMemo)(
            () => ({ role: 'listbox', 'aria-labelledby': A, 'aria-activedescendant': k(n, Z) }),
            [A, Z],
          ),
          se = (0, o.useCallback)(e => e.value === _, [_]),
          ie = (0, o.useCallback)(e => j && j(e.value), [j]),
          ae = (function (e, t, n, r = !0, l = {}) {
            const s = (0, o.useCallback)(() => {
                const o = e.findIndex(t)
                if (o === e.length - 1 && !r) return
                const l = C(o + 1, e.length)
                n && n(e[l])
              }, [e, t, n, r]),
              i = (0, o.useCallback)(() => {
                const o = e.findIndex(t)
              ...
              { next: u = w.next, previous: d = w.previous, first: p = w.first, last: h = w.last } = l
            return (0, v.useComposedKeyboardActionHandlers)(
              (0, v.useKeyboardActionHandler)(u, s),
              (0, v.useKeyboardActionHandler)(d, i),
              (0, v.useKeyboardActionHandler)(p, a),
              (0, v.useKeyboardActionHandler)(h, c),
            )
          })(X, se, ie, !1, { next: [40], previous: [38] }),
          ce = (0, v.useKeyboardToggle)(G),
          ue = (0, v.useKeyboardClose)(K, W),
          de = (0, v.useKeyboardOpen)(K, P),
          pe = (0, v.useKeyboardEventHandler)(ce, ue, de),
          he = (0, v.useKeyboardEventHandler)(ae, ce, ue),
          me = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
            ...
            void 0 !== n && j && (t.stopPropagation(), K || P(), j(n.value))
          })
        return o.createElement(
          S.ControlDisclosureView,
          {
            ...
            buttonChildren: o.createElement(N, { selectedItem: Z, placeholder: b }),
            repositionOnScroll: I,
          },
          B.map((e, t) => {
            var r
    ...
    1109: (e, t, n) => {
      ...
      var o = n(59496),
        ...
        l = n(91626)
      function s(e) {
        return o.createElement('div', { className: r(l.separator, e.className) })
      }
    },
    86656: (e, t, n) => {
      'use strict'
      ...
      var o = n(59496),
        ...
        s = n(49483)
      function i(e) {
        const { reference: t, children: n, ...l } = e,
          i = (0, o.useRef)(null),
          c = (0, o.useCallback)(
            e => {
              t && (t.current = e),
                s.CheckMobile.iOS() &&
                  ...
                  (i.current = e),
                  null !== i.current && (0, r.disableBodyScroll)(i.current, { allowTouchMove: a(i) }))
            },
            [t],
          )
        return o.createElement('div', { ref: c, ...l }, n)
      }
      function a(e) {
        return t => {
