  ...
  [9505],
  {
      ...
      function l(e, t) {
        return (o, l) => {
          const d = (0, a.ensureNotNull)(e).getBoundingClientRect(),
            ...
            b = { x: D - (m === s.FromRightToLeft ? o : 0) + v, y: E - (u === i.FromBottomToTop ? l : 0) + g }
          ...
          const {
            ...
            O =
              ...
              ('string' == typeof o
                ...
                : r.cloneElement(o, { className: n(w.icon, o.props.className) }))
          return r.createElement(
            'div',
            { ...b, ref: t, 'data-role': 'button', className: C, onClick: d ? void 0 : h, title: f, 'data-name': E },
            v && m && r.createElement('div', { className: n('js-button-text', w.text) }, m),
            O,
            !v && m && r.createElement('div', { className: n('js-button-text', w.text) }, m),
          )
        })
          ...
          return r.createElement(
            ...
            t &&
              r.createElement(
                'div',
                { className: v.arrow },
                r.createElement('div', { className: v.arrowWrap }, r.createElement(s.ToolWidgetCaret, { dropped: w })),
              ),
            this.state.isOpened &&
              (f ? r.createElement(p.MatchMedia, { rule: f }, e => this._renderContent(e)) : this._renderContent(c)),
          )
        }
        close() {
        ...
        _renderContent(e) {
          ...
          return m
            ? r.createElement(
                c.DrawerManager,
                null,
                r.createElement(l.Drawer, { onClose: this._handleClose, position: a, 'data-name': t }, v),
              )
            : r.createElement(
                i.PopupMenu,
                {
    ...
    41590: (e, t, o) => {
      ...
      var r = o(59496),
        ...
        u = o(66998)
      function h(e) {
        const { position: t = 'Bottom', onClose: o, children: h, className: m, theme: v = u } = e,
          ...
          (0, r.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                d.CheckMobile.iOS() && (0, s.enableBodyScroll)(e), 0 === t && (0, a.setFixedBodyState)(!1)
              }
            )
          }, []),
          r.createElement(
            ...
            r.createElement(
              ...
              w === f.currentDrawer && r.createElement('div', { className: u.backdrop, onClick: o }),
              r.createElement(
                'div',
                {
    ...
    16396: (e, t, o) => {
      'use strict'
      o.d(t, { DEFAULT_POPUP_MENU_ITEM_THEME: () => l, PopupMenuItem: () => u })
      var r = o(59496),
        n = o(97754),
        i = o(59064),
        s = o(51768),
      ...
      function u(e) {
        ...
        return r.createElement(
          d,
          {
            ...
            role: o,
            'aria-selected': l,
            className: n(u, M.item, g && M.withIcon, { [M.isActive]: D, [M.isDisabled]: E || C, [M.hovered]: b }),
            title: h,
            href: T,
            target: x,
            rel: N,
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: r, onClickArg: n, trackEventObject: a } = e
              if (E) return
          ...
          void 0 !== g && r.createElement('div', { className: M.icon, dangerouslySetInnerHTML: { __html: g } }),
          r.createElement(
            'div',
            { className: n(M.labelRow, m) },
            r.createElement('div', { className: n(M.label, v) }, O),
          ),
          (void 0 !== f || w) && r.createElement('div', { className: M.shortcut }, (H = f) && H.split('+').join(' + ')),
          void 0 !== A &&
            r.createElement('div', { onClick: B ? p : void 0, className: n(M.toolbox, { [M.showOnHover]: k }) }, A),
        )
        var H
      }
    },
    ...
    10381: (e, t, o) => {
      ...
      function c(e) {
        ...
        return r.createElement(i.Icon, { className: n(o, s.icon, { [s.dropped]: t }), icon: a })
      }
    },
    81268: e => {
      e.exports =
