  ...
  [607],
  {
    96457: (e, t, i) => {
      ...
      const a = new o.TranslatedString(
        ...
        p = new o.TranslatedString('change {title} base line color', (0, n.t)('change {title} base line color')),
        c = new o.TranslatedString('change {title} base line width', (0, n.t)('change {title} base line width')),
        u = new o.TranslatedString('change {title} base line style', (0, n.t)('change {title} base line style')),
        y = new o.TranslatedString('change {title} up line visibility', (0, n.t)('change {title} up line visibility')),
        d = new o.TranslatedString('change {title} up line color', (0, n.t)('change {title} up line color')),
        h = new o.TranslatedString('change {title} up line width', (0, n.t)('change {title} up line width')),
        f = new o.TranslatedString('change {title} up line style', (0, n.t)('change {title} up line style')),
        _ = new o.TranslatedString(
          'change {title} down line visibility',
          (0, n.t)('change {title} down line visibility'),
        ),
        m = new o.TranslatedString('change {title} down line color', (0, n.t)('change {title} down line color')),
        S = new o.TranslatedString('change {title} down line width', (0, n.t)('change {title} down line width')),
        g = new o.TranslatedString('change {title} down line style', (0, n.t)('change {title} down line style')),
        P = new o.TranslatedString('change {title} extend lines', (0, n.t)('change {title} extend lines')),
        v = new o.TranslatedString("change {title} show pearson's r", (0, n.t)("change {title} show pearson's r")),
        b = (0, n.t)('Base'),
        D = (0, n.t)('Up'),
        w = (0, n.t)('Down'),
        I = (0, n.t)("Pearson's R"),
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs().styles.childs(),
            ...
            C = (0, s.createLinePropertyDefinition)(
              {
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, r.visible, a.format({ title: n })),
                ...
                width: (0, s.convertToDefinitionProperty)(this._propertyApplier, r.linewidth, c.format({ title: n })),
                style: (0, s.convertToDefinitionProperty)(this._propertyApplier, r.linestyle, u.format({ title: n })),
              },
            ...
            k = (0, s.createLinePropertyDefinition)(
              {
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, M.visible, y.format({ title: n })),
                color: (0, s.getColorDefinitionProperty)(
                  this._propertyApplier,
                  M.color,
                  e.transparency,
                ...
                width: (0, s.convertToDefinitionProperty)(this._propertyApplier, M.linewidth, h.format({ title: n })),
                style: (0, s.convertToDefinitionProperty)(this._propertyApplier, M.linestyle, f.format({ title: n })),
              },
              { id: i + 'UpLine', title: D },
            ),
            A = e.downLine.childs()
          return {
            definitions: [
              ...
              (0, s.createLinePropertyDefinition)(
                {
                  checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, A.visible, _.format({ title: n })),
                  color: (0, s.getColorDefinitionProperty)(
                    this._propertyApplier,
                    A.color,
                    e.transparency,
                  ...
                  width: (0, s.convertToDefinitionProperty)(this._propertyApplier, A.linewidth, S.format({ title: n })),
                  style: (0, s.convertToDefinitionProperty)(this._propertyApplier, A.linestyle, g.format({ title: n })),
                },
          ...
          return {
            definitions: [
              (0, r.createStudyInputsPropertyDefinition)(
                ...
                {
                  id: 'StudyInputs',
                  inputs: new a.MetaInfoHelper(this._source.metaInfo()).getUserEditableInputs(),
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return (
            e.forEach((e, o) => {
              const s = t[o].childs()
              if (!s) return
              const l = (0, p.getCoordinateXMetaInfo)(this._propertyApplier, s)
              i.push(
                (0, r.createCoordinatesPropertyDefinition)(
                  { x: l.property },
                  {
                    id: (0, c.removeSpaces)(`${this._source.name()}Point${o}`),
                    title: (0, n.t)('#{count} (bar)', { context: 'linetool point' }).format({
                      count: (o + 1).toString(),
                    }),
                    ...l.info,
                  },
    ...
    55976: (e, t, i) => {
      ...
      var n = i(28353),
        ...
        c = i.n(p),
        u = i(80054)
      const y = new o.TranslatedString('change {inputName} property', (0, n.t)('change {inputName} property'))
      function d(e, t) {
        const i = e.id
        return (
      ...
      function h(e) {
        return e.name || (0, u.capitalizeFirstLetterInWord)(e.id.toLowerCase())
      }
      function f(e) {
      ...
      const v = (0, n.t)('Style'),
        b = (0, n.t)('Inputs'),
        D = (0, n.t)('Visibility'),
        w = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(e => ({
          value: e,
          title: (0, g.getTranslatedResolutionModel)(e).hint,
        }))
      var I = i(16717),
        T = i(37667)
      const C = new o.TranslatedString('change study overlay style', (0, n.t)('change study overlay style')),
        M = new o.TranslatedString('change price line visibility', (0, n.t)('change price line visibility')),
        k = new o.TranslatedString('change study overlay min tick', (0, n.t)('change study overlay min tick')),
        A = (0, n.t)('Bars'),
        V = (0, n.t)('Candles'),
      ...
      class H extends class {
        ...
        _createInputsPropertyPage() {
          ...
          return null !== e ? (0, a.createPropertyPage)(e, 'inputs', b) : null
        }
        _inputsPropertyDefinitions() {
          const e = this._sortInputs(this._source.metaInfo().inputs),
            t = this._source.properties().childs().inputs.childs()
          return (
            null !== this._sourceInput && (this._inputSourceItems = new (c())(this._getInputSourceItems())),
            (function (e, t, i, r, a) {
              const p = []
              for (const u of t) {
                if (!d(u, r)) continue
                ...
                if ('resolution' === u.type)
                  g = (0, l.createOptionsPropertyDefinition)(
                    { option: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
                    { id: _, title: m, options: new (c())(a.resolutionItems) },
                  )
                  ...
                  g = (0, l.createOptionsPropertyDefinition)(
                    { option: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
                    { id: _, title: m, options: new (c())(t) },
                  )
                } else if ('symbol' === u.type) {
                  const t = i[u.id],
                    n = (0, s.ensure)(a.getSymbolInfoBySymbol),
                    o = (0, s.ensure)(a.onSymbolsInfosChanged)
                  ...
                  g = (0, l.createSessionPropertyDefinition)(
                    { session: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
                    { id: _, title: m },
                  )
                else if ('bool' === u.type)
                  g = (0, l.createCheckablePropertyDefinition)(
                    { checked: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
                    { id: _, title: m },
                  )
                else if ('integer' === u.type || 'float' === u.type || 'price' === u.type) {
                  const t = {
                    id: _,
                    title: m,
                  ...
                  void 0 !== u.min && (t.min = new (c())(u.min)),
                    void 0 !== u.max && (t.max = new (c())(u.max)),
                    void 0 !== u.step && isFinite(u.step) && u.step > 0 && (t.step = new (c())(u.step)),
                    (g = (0, l.createNumberPropertyDefinition)(
                      { value: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
                      t,
                    ))
                } else
                  g = (0, l.createTextPropertyDefinition)(
                    { text: (0, l.convertToDefinitionProperty)(e, i[u.id], y.format({ inputName: S })) },
        ...
        _getInputSourceItems() {
          ...
          if (this._source && this._source.isChildStudy()) {
            const i = this._source.parentSource(),
              n = i.title(),
              o = S().getChildSourceInputTitles(t, i.metaInfo(), n)
            for (const t of Object.keys(o)) e.push({ id: t, value: t, title: o[t] })
          }
          if (
            r.enabled('study_on_study') &&
            this._source &&
            (this._source.isChildStudy() || S().canBeChild(this._source.metaInfo()))
          ) {
              ...
              .forEach(t => {
                ...
                if (1 === l.length) e.push({ id: n, value: n, title: i })
                  ...
                  const t = l.reduce((e, t, o) => {
                    if (!S().canPlotBeSourceOfChildStudy(t.type)) return e
                    let l
                    try {
                      l = (0, s.ensureDefined)((0, s.ensureDefined)(r)[t.id]).title
                    } catch (e) {
                      l = t.id
                    }
                    return { ...e, [`${n}$${o}`]: `${i}: ${l}` }
            ...
            this._source
              ...
              .style.subscribe(this, e => {
                ...
                null !== this._stylesPropertyPage &&
                  ((0, l.destroyDefinitions)(this._stylesPropertyPage.definitions.value()),
        ...
        _stylePropertyDefinitions() {
          void 0 === this._availableStylesWV &&
            ((this._availableStylesWV = new (c())(this._availableStyles())),
          ...
          const e = this._source.properties().childs(),
            t = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.style, C) },
              { id: 'StudyOverlayStyle', title: R, options: this._availableStylesWV },
            ),
            i = (0, l.createCheckablePropertyDefinition)(
              { checked: (0, l.convertToDefinitionProperty)(this._undoModel, e.showPriceLine, M) },
              { id: 'StudyOverlayPriceLine', title: E },
            ),
            n = (0, l.createOptionsPropertyDefinition)(
              { option: (0, l.convertToDefinitionProperty)(this._undoModel, e.minTick, k) },
              { id: 'StudyOverlayMinTick', title: W, options: new (c())((0, _.seriesPrecisionValues)()) },
            ),
        ...
        _getSeriesStylesDefinitions() {
          ...
          return (0, I.getSeriesStylePropertiesDefinitions)(
            ...
            e,
            e.style.value(),
            { seriesPriceSources: _.basePriceSources, lineStyleTypes: _.lineStyleTypes, isJapaneseChartsAvailable: !1 },
            'mainSeries',
          )
        }
        _availableStyles() {
          ...
          return $.map(t =>
            t.readonly
              ...
              : {
                  ...
                  value: t.value,
                  title: t.title,
                  disabled: (0, T.isCloseBasedSymbol)(e) && !(0, T.isSingleValueBasedStyle)(t.value),
                },
          )
        }
      }
