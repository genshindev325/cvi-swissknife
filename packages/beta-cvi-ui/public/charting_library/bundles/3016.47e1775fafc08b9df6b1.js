;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3016],
  {
    ...
    63016: (t, e, i) => {
      ...
      class d extends s.PureComponent {
        ...
        render() {
          const {
            ...
            c = o(r, h.dialog, t && h.rounded, e && h.shadowed, i && h.fullscreen, n && h.darker),
          ...
          if (this._isFullscreen)
            ...
            if (this._calculateDialogPosition) {
              ...
              ;(this._dialog.style.top = '0px'),
                ...
                (this._dialog.style.height = o < s.height ? o + 'px' : this._initialHeight)
            }
          }
        }
        destroy() {
      ...
      class M extends s.PureComponent {
        ...
        render() {
          return s.createElement(
            ...
            { value: this },
            s.createElement(u.OutsideEvent, { mouseDown: !0, touchStart: !0, handler: this.props.onClickOutside }, t =>
              s.createElement(
                'div',
                {
                  ref: t,
        ...
        componentDidMount() {
          ...
          if (t) {
            ...
            t && t instanceof HTMLElement && (this._drag = new v(s, t, { boundByScreen: Boolean(e), onDragStart: i }))
          }
      ...
      ;(M.contextType = x.PortalContext), (M.defaultProps = { boundByScreen: !0, draggable: !0, centeredOnMount: !0 })
