;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 3718],
  {
                    ...
                    ;(s = [].concat(t(s), [u])),
                      ...
                      (e.ontouchmove = function (t) {
                        ...
                        1 === t.targetTouches.length &&
                          ...
                          !h(a.target) &&
                            ((n && 0 === n.scrollTop && 0 < s) ||
                            ((i = n) && i.scrollHeight - i.scrollTop <= i.clientHeight && s < 0)
                              ? d(a)
                              : a.stopPropagation()))
                      }),
                      o || (document.addEventListener('touchmove', d, a ? { passive: !1 } : void 0), (o = !0))
                  }
                } else {
                  ;(v = n),
                    setTimeout(function () {
                ...
                (e.clearAllBodyScrollLocks = function () {
                  i
                    ? (s.forEach(function (e) {
                      ...
                      o && (document.removeEventListener('touchmove', d, a ? { passive: !1 } : void 0), (o = !1)),
                      (s = []),
                      (l = -1))
                    : (u(), (s = []))
                }),
                (e.enableBodyScroll = function (e) {
                  if (i) {
                    ...
                    ;(e.ontouchstart = null),
                      ...
                      o &&
                        0 === s.length &&
                        (document.removeEventListener('touchmove', d, a ? { passive: !1 } : void 0), (o = !1))
                  } else
    ...
    50789: e => {
      e.exports = { summary: 'summary-hk3Mmxts', hovered: 'hovered-hk3Mmxts', caret: 'caret-hk3Mmxts' }
    },
    28857: e => {
      e.exports = {
    ...
    39592: e => {
      e.exports = { button: 'button-Rsu8YfBx', withText: 'withText-Rsu8YfBx', withoutText: 'withoutText-Rsu8YfBx' }
    },
    64547: e => {
    ...
    936: e => {
      e.exports = { button: 'button-2Vex9IkU', first: 'first-2Vex9IkU', last: 'last-2Vex9IkU' }
    },
    82832: e => {
    ...
    4050: e => {
      e.exports = { button: 'button-mEQw2hrh', isDisabled: 'isDisabled-mEQw2hrh', text: 'text-mEQw2hrh' }
    },
    96141: e => {
      e.exports = {
    ...
    72597: e => {
      e.exports = { button: 'button-TTaQ4aBF', text: 'text-TTaQ4aBF', logo: 'logo-TTaQ4aBF' }
    },
    67397: e => {
      e.exports = {
    ...
    4039: e => {
      e.exports = { buttonUndo: 'buttonUndo-6VeYguKu', buttonRedo: 'buttonRedo-6VeYguKu' }
    },
    96746: e => {
      e.exports = {
    ...
    26996: (e, t, a) => {
      ...
      class c extends i.PureComponent {
        ...
        render() {
          const { className: e, color: t = 'black', size: a = 'medium', staticPosition: n } = this.props,
            o = s(r().item, r()[t], r()[a])
          return i.createElement(
            'span',
            { className: s(r().loader, n && r().static, this._getStateClass(), e) },
      ...
      function r(e) {
        return n.createElement(
          ...
          n.createElement(
            ...
            e.summary,
            n.createElement(o.ToolWidgetCaret, { className: l.caret, dropped: Boolean(e.open) }),
          ),
          e.open && e.children,
        )
      }
    ...
    84096: (e, t, a) => {
      'use strict'
      a.d(t, { DEFAULT_MENU_ITEM_SWITCHER_THEME: () => m, MenuItemSwitcher: () => v })
      var n = a(59496),
        i = a(97754),
        s = a.n(i)
      const o = (0, n.createContext)({ enablePointerOnHover: !0, enableActiveStateStyles: !0 })
      var l = a(26390),
        r = a.n(l)
      function c(e) {
      ...
      function h(e) {
        ...
        return n.createElement(
          'div',
          { className: c(e) },
          n.createElement('input', { ...s, type: 'checkbox', className: r().input, ref: t }),
          n.createElement(
            'div',
    ...
    14593: (e, t, a) => {
      ...
      const l = n.forwardRef((e, t) => {
        ...
        return n.createElement(s.ToolWidgetButton, { 'data-name': l, ...r, ref: t, className: i(a, o.button) })
      })
    },
    53374: (e, t, a) => {
      'use strict'
    ...
    79389: (e, t, a) => {
      ...
      class F extends i.PureComponent {
        constructor(e, t) {
          ...
          this.state = { activeStyle: i, favorites: o, styles: (0, T.commonChartStyles)(), japaneseStyles: l }
        }
        componentDidMount() {
        ...
        render() {
          const { isShownQuicks: e, displayMode: t = 'full', id: a } = this.props,
            { activeStyle: n, favorites: s, styles: o, japaneseStyles: l, lastSelectedNotFavorite: h } = this.state,
            u = 'small' !== t && e && 0 !== s.length,
            v = [...s]
          v.includes(n) ? void 0 !== h && v.push(h) : v.push(n)
          const p = u && v.length > 1
          return i.createElement(f.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, e => {
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                {
                  arrow: Boolean(p),
                  content: p ? void 0 : i.createElement(b, null, i.createElement(d.Icon, { icon: c.SERIES_ICONS[n] })),
      ...
      function P(e) {
        const { text: t, className: a, displayMode: n, collapseWhen: s = z, ...o } = e,
          l = !s.includes(n)
        return i.createElement(S.ToolWidgetButton, {
          ...o,
          text: l ? t : void 0,
      ...
      var D = a(51768),
        L = a(37669),
        W = a(2323)
      const O = { compare: (0, o.t)('Compare'), compareOrAddSymbol: (0, o.t)('Compare or Add Symbol') },
      ...
      class B extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, E.validateRegistry)(t, { chartWidgetCollection: s.any.isRequired }),
        ...
        render() {
          ...
          return i.createElement(P, {
            ...
            collapseWhen: L.hasNewHeaderToolbarStyles ? ['full', 'medium', 'small'] : void 0,
          })
        }
      }
      B.contextType = U
      ...
      function ee(e, t) {
        ...
        return (
          ...
          Promise.all(a).then(
            e => ($.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), [])),
          )
        )
      }
      var te = a(14291),
      ...
      function se(e) {
        const { className: t } = e
        return i.createElement('div', { className: p()(ie.spinnerWrap, t) }, i.createElement(ne.Loader, null))
      }
      var oe = a(49466),
        le = a(76422),
        re = a(60373),
      ...
      class me extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, E.validateRegistry)(t, { favoriteScriptsModel: s.any, chartWidgetCollection: s.any.isRequired })
        ...
        render() {
          const { isActive: e, favorites: t, favoriteFundamentals: a, isLoading: n } = this.state,
          ...
          return i.createElement(
            ...
            i.createElement(
              b,
              { id: r, onMouseEnter: this._handleMouseEnter, onClick: this._handleWrapClick },
              i.createElement(P, {
                displayMode: l,
                className: s,
                icon: re,
              ...
              Boolean(t.length > 0 || (null == a ? void 0 : a.size)) &&
                i.createElement(f.MatchMedia, { rule: 'screen and (max-width: 428px)' }, e =>
                  i.createElement(
                    m.ToolWidgetMenu,
                    {
                            ...
                            ? this.state.infos.map(t =>
                                i.createElement(u.PopupMenuItem, {
                                  ...
                                  label: i.createElement(
                                    'span',
                                    {
                                      className: p()(!e && ce.label, e && ce.smallWidthLabel, 'apply-overflow-tooltip'),
                                    },
                                    ve(t),
                                  ),
                                }),
      ...
      function ve(e) {
        return e.info.localizedName || (0, o.t)(e.info.name, { context: 'study' })
      }
      me.contextType = ue
      var pe = a(9315),
        ge = a(29823),
        be = a(87906)
      function Se(e) {
        return i.createElement('div', { className: v(be.value, { [be.selected]: e.isSelected }) }, e.value, e.metric)
      }
      var Ce = a(50628),
        _e = a(10381),
        we = a(53374),
      ...
      class fe extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this.state = { inputValue: '1', isOpenedMenu: !1, selectedIntervalSuffix: we.INTERVALS[0].name })
        }
        render() {
          const { inputValue: e, isOpenedMenu: t, menuWidth: a, selectedIntervalSuffix: n } = this.state
          return i.createElement(
            'div',
            ...
            i.createElement(
              'div',
              { className: ye.menu, onClick: this._toggleMenu, ref: this._setMenuRef },
              we.INTERVALS.find(e => e.name === n).label,
              i.createElement(_e.ToolWidgetCaret, { dropped: t }),
            ),
            i.createElement('div', { className: ye.add, onClick: this._handleClickAdd }, (0, o.t)('Add')),
            i.createElement(
              Ce.PopupMenu,
              {
                doNotCloseOn: this,
            ...
            i.createElement(u.PopupMenuItem, {
              ...
              toolbox: (function () {
                const { isRemovable: t, isFavoritingAllowed: a } = e,
                  ...
                  r = i.createElement(h.FavoriteButton, { key: 'favorite', isActive: n, isFilled: o, onClick: _ })
                return [t && l, !s && a && r]
              })(),
      ...
      const Ie = {
        [ge.ResolutionKind.Ticks]: (0, o.t)('Ticks', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Seconds]: (0, o.t)('Seconds', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Minutes]: (0, o.t)('Minutes', { context: 'interval_group_name' }),
        [ge.SpecialResolutionKind.Hours]: (0, o.t)('Hours', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Days]: (0, o.t)('Days', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Weeks]: (0, o.t)('Weeks', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Months]: (0, o.t)('Months', { context: 'interval_group_name' }),
        [ge.ResolutionKind.Range]: (0, o.t)('Ranges', { context: 'interval_group_name' }),
      ...
      var Re = a(26005),
        ...
        ze = a(59064),
        Pe = a(6500)
      const De = { openDialog: (0, o.t)('Open Interval Dialog'), timeInterval: (0, o.t)('Time Interval') },
        Le = (0, G.hotKeySerialize)({ keys: [','], text: (0, o.t)('Number or {hotKey_0}') }),
      ...
      class Ve extends i.PureComponent {
        constructor(e, t) {
          ...
          const h = l.linking.interval.value(),
            ...
            v = c.get()
          ;(this._defaultIntervals = a.defaultResolutions().filter(Be).map(pe.normalizeIntervalString)),
            (this.state = {
              isOpenedFormMenu: !1,
              activeInterval: d,
              favorites: u,
        ...
        render() {
          ...
          ;(void 0 !== a ? d.concat(a) : d).filter(pe.isAvailable).forEach(e => (h[e] = !0))
          const u = void 0 !== a ? (0, pe.getTranslatedResolutionModel)(a) : null
          return i.createElement(
            b,
            { id: t },
            c &&
            ...
            i.createElement(f.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, e =>
              i.createElement(
                i.Fragment,
                null,
                i.createElement(
                  ...
                  i.createElement(
                    ...
                    i.createElement('div', { className: Pe.dropdown }, this._renderChildren(d, e)),
                  ),
                ),
                e &&
                  o &&
        ...
        _createMenuItems(e, t) {
          ...
          return (function (e) {
            ...
            return e.filter((e, a, n) => {
              let i = !0
              return (
                e.type === y.PopupMenuSeparator && ((0 !== a && a !== n.length - 1) || (i = !1), t && (i = !1)),
        ...
        _createIntervalForm(e) {
          if (this._customIntervals) {
            const t = e
              ? i.createElement(
                  'div',
                  { key: 'add-dialog', className: Pe.addCustomInterval, onClick: this._handleOpenAddIntervalDialog },
            ...
            return [i.createElement(y.PopupMenuSeparator, { key: 'custom-interval-separator' }), t]
          }
          return []
        }
        _renderResolutionsGroup(e, t = !1, a) {
          ...
          if (t) n.push(...s)
            ...
            const t = i.createElement(
              'div',
              { key: e.id },
              i.createElement('div', { className: Pe.smallTabletSectionTitle }, e.name),
              s,
            )
            n.push(t)
          } else {
          ...
          return (
            (!e.mayOmitSeparator || e.items.length > 1) &&
              (n.unshift(i.createElement(y.PopupMenuSeparator, { key: 'begin-' + e.name })),
              n.push(i.createElement(y.PopupMenuSeparator, { key: 'end-' + e.name }))),
            n
          )
        }
      ...
      var $e = a(25760),
        ...
        tt = a(68587),
        at = a(49473)
      const nt = 'M21.5 21.5h-14a5 5 0 1 1 .42-9.983 7.5 7.5 0 0 1 14.57 2.106 4.002 4.002 0 0 1-.99 7.877z',
      ...
      class lt extends i.PureComponent {
        ...
        componentDidMount() {
          'saved' === this.props.state ? this.setState(ot) : this._goToNextState(this.props.state)
        }
        componentWillUnmount() {
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('path', { className: at.arrowGap, d: 'M11 20h6v5h-6z' }),
              i.createElement(
                'g',
      ...
      const pt = n.enabled('widget'),
        ...
        bt = (0, rt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: mt.shortcut }),
        St = {
          copy: (0, o.t)('Copy'),
          makeCopy: (0, o.t)('Make a Copy'),
          newChartLayout: (0, o.t)('New Chart Layout'),
          loadChartLayout: (0, dt.appendEllipsis)((0, o.t)('Load Chart Layout')),
      ...
      class wt extends i.PureComponent {
              ...
              t
                ...
                : i.createElement(
                    ...
                    i.createElement(P, {
                      ...
                      displayMode: a,
                      icon: i.createElement(lt, { size: 28, state: g, isHovered: u }),
                      isDisabled: (o && !l) || n,
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            void 0 !== n &&
              (e || f.push(i.createElement(y.PopupMenuSeparator, { key: 'existing-chart-section-begin' })),
              f.push(
                i.createElement(u.PopupMenuItem, {
                  key: 'rename',
                  label: St.rename,
            ...
            f.push(i.createElement(y.PopupMenuSeparator, { key: 'platform-section-begin' })),
            f.push(
              i.createElement(u.PopupMenuItem, {
                key: 'load-chart',
      ...
      class ft extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          t
            ...
            : (i.getOnChange().subscribe(this, this._onChangeHasChanges),
              ...
              this._hotkeys.add({ desc: (0, o.t)('Load Chart Layout'), handler: this._handleHotkey, hotkey: 190 }),
        ...
        render() {
          ...
          return i.createElement(f.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, e =>
            i.createElement(wt, { ...u, isTabletSmall: e }),
          )
        }
        _onLoginStateChange() {
      ...
      var kt = a(20301),
        Mt = a(95792),
        Et = a(82029)
      const Tt = new Mt.DateTimeFormatter({ dateTimeSeparator: '_', timeFormat: '%h-%m-%s' }),
      ...
      function zt(e) {
        ...
        return i.createElement(
          ...
          i.createElement('span', { className: a }, i.createElement(ne.Loader, null)),
        )
      }
      var Pt = a(76974),
        Dt = a(60498),
      ...
      function Gt(e) {
        const { serverSnapshot: t, clientSnapshot: n } = e,
          ...
          p = (0, i.useCallback)(async () => {
            ...
            try {
              await (0, Nt.writePromiseUsingApi)(a, 'image/png'), le.emit('onClientScreenshotCopiedToClipboard')
            } catch (a) {
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await b(a)
                  ...
                  await (0, Nt.writePromiseUsingApi)(e, 'text/plain'), le.emit('onServerScreenshotCopiedToClipboard')
                }
                return !0
              } catch (e) {
                return b(a), !0
          ...
          C = (0, i.useCallback)(async () => {
            d(!0)
            const [e, n] = await Promise.all([a.e(4665).then(a.bind(a, 2679)), t()])
            e.Twitter.shareSnapshotInstantly(n.symbol, n.imageUrl), m.current && (d(!1), (0, ze.globalCloseMenu)())
          }, [t])
        return i.createElement(
          i.Fragment,
          null,
          i.createElement(u.PopupMenuItem, {
            ...
            icon: Wt,
            onClick: g,
            shortcut: (0, Z.humanReadableHash)(Z.Modifiers.Mod + Z.Modifiers.Alt + 83),
            theme: Vt,
          }),
          i.createElement(u.PopupMenuItem, {
            ...
            icon: Lt,
            onClick: p,
            shortcut: (0, Z.humanReadableHash)(Z.Modifiers.Mod + Z.Modifiers.Shift + 83),
            theme: Vt,
          }),
          i.createElement(u.PopupMenuItem, {
            'data-name': 'copy-link-to-the-chart-image',
            label: i.createElement(zt, { isLoading: s }, (0, o.t)('Copy link to the chart image')),
            icon: Ot,
            onClick: () => {
              l(!0), S(!1)
            },
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            label: i.createElement(zt, { isLoading: r }, (0, o.t)('Open image in new tab')),
            icon: Ut,
            onClick: () => {
              c(!0), S(!0)
            },
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            label: i.createElement(zt, { isLoading: h }, (0, o.t)('Tweet chart image')),
            icon: Dt,
            onClick: C,
            dontClosePopup: !0,
            isDisabled: h,
      ...
      class ia extends i.PureComponent {
        constructor(e) {
          super(e),
                    ...
                    await new ea().show({
                      ...
                      footer: Ee.mobiletouch
                        ...
                        : i.createElement(
                            ...
                            null,
                            (0, o.t)('Simply start typing while on the chart to pull up this search box'),
                          ),
                    })
                } catch (e) {}
            ...
            (this.state = { symbol: l.linking.symbol.value(), shortName: sa() })
        }
        componentDidMount() {
        ...
        render() {
          ...
          return i.createElement(S.ToolWidgetButton, {
            id: e,
            className: p()(t, n.enabled('uppercase_instrument_names') && ta.uppercase, ta.largeLeftPadding),
            theme: na,
            icon: void 0,
      ...
      class la extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: v(e, oa.item, 'apply-common-tooltip'), onClick: this._handleClick, title: t.name },
            i.createElement('div', { className: oa.round }, t.name.length > 0 ? t.name[0].toUpperCase() : ' '),
          )
        }
      }
      var ra = a(23177),
        ca = a(75668)
      function ha(e) {
        return i.createElement('div', { className: v(ca.description, e.className) }, e.children)
      }
      var da = a(14621)
      const ua = (0, rt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        va = (0, rt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: da.item }),
        pa = (0, rt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: da.itemTabletSmall })
      function ga(e) {
        const {
            item: t,
            onApply: a,
        ...
        return i.createElement(
          'div',
          { ...d, className: da.wrap, 'data-name': t.name, 'data-id': t.id, 'data-is-default': Boolean(t.is_default) },
          i.createElement(u.PopupMenuItem, {
            theme: g,
            label: t.name,
            ...
            toolbox: i.createElement(
              i.Fragment,
              null,
              !t.is_default && i.createElement(ke.RemoveButton, { key: 'remove', hidden: !Ee.touch && !c, onClick: C }),
              Boolean(s) &&
                l &&
                i.createElement(h.FavoriteButton, { key: 'favorite', isFilled: Boolean(o), onClick: _ }),
            ),
          }),
          v &&
            i.createElement(u.PopupMenuItem, {
              theme: b,
              label: i.createElement(ha, { className: p()(da.description, r && da.descriptionTabletSmall) }, v),
              onClick: S,
              isHovered: c,
            }),
        )
      ...
      const Ca = (0, rt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, Sa),
        _a = { text: (0, dt.appendEllipsis)((0, o.t)('Save Indicator template')) }
      function wa(e) {
      ...
      function Ea(e) {
        ...
        return i.createElement(
          ...
          c &&
            i.createElement(i.Fragment, null, i.createElement(y.PopupMenuSeparator, null), i.createElement(se, null)),
          !c &&
            (r
              ? i.createElement(Ta, { defaults: h, customs: d, render: b })
              : i.createElement(xa, { defaults: h, customs: d, render: b, state: m })),
        )
      }
      function Ta(e) {
        ...
        return i.createElement(
          ...
          a.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(y.PopupMenuSeparator, null),
              i.createElement(oe.ToolWidgetMenuSummary, { className: Ma.menuItemHeader }, (0, o.t)('My templates')),
              a.map(n),
            ),
          a.length > 0 &&
            t.length > 0 &&
      ...
      class Ra {
        constructor(e, t) {
          ...
          ;(this._state = new (Aa())({ isLoading: !1, studyTemplatesList: o, favorites: s })),
      ...
      var Na = a(36257),
        Fa = a(73887)
      const Ha = { title: (0, o.t)('Templates'), tooltip: (0, o.t)('Indicator Templates') },
      ...
      class Pa extends i.PureComponent {
        constructor(e, t) {
          ...
          ;(this._model = new Ra(n, a)), (this.state = { ...this._model.state().value(), isActive: !1 })
        }
        componentDidMount() {
      ...
      function Da(e) {
        const {
          ...
          u = p()(a, Fa.wrap, { [Fa.full]: 'full' === n, [Fa.medium]: 'medium' === n }),
          v = o.filter(e => s.includes(e.name)),
          g = 'small' !== n && h && v.length > 0
        return i.createElement(
          b,
          { id: t, className: u },
          i.createElement(f.MatchMedia, { rule: k.DialogBreakpoints.TabletSmall }, t =>
            i.createElement(
              m.ToolWidgetMenu,
              {
                onOpen: e.onMenuOpen,
        ...
        return i.createElement(
          ...
          e.favorites.map((t, a, n) =>
            i.createElement(la, {
              ...
              className: p()({ [Fa.first]: 0 === a, [Fa.last]: a === n.length - 1 }),
            }),
          ),
        )
      }
      ...
      var Wa = a(4039),
        ...
        Ba = a(17717),
        Va = a(76294)
      const Ga = { undoHint: (0, o.t)('Undo {hint}'), redoHint: (0, o.t)('Redo {hint}') },
        Za = {
        ...
        Ya = (0, rt.weakComposeClasses)(Ua, Wa, { buttonUndo: 'button', buttonRedo: 'button' }),
      ...
      function sn() {
        return {
          ...
          OpenPopup: qe,
          Properties: n.enabled('header_settings') && n.enabled('show_chart_property_page') ? Xe : void 0,
    ...
    55402: (e, t, a) => {
      'use strict'
      a.d(t, { validateRegistry: () => l, RegistryProvider: () => r, registryContextType: () => c })
      var n = a(59496),
        i = a(19036),
        s = a.n(i)
    ...
    36189: (e, t, a) => {
      ...
      var n = a(28353),
        ...
        r = a(55783),
        c = a(16842)
      const h = { add: (0, n.t)('Add to favorites'), remove: (0, n.t)('Remove from favorites') }
      function d(e) {
        const { className: t, isFilled: a, isActive: n, onClick: d, ...u } = e
        return i.createElement(o.Icon, {
          ...u,
          className: s(c.favorite, 'apply-common-tooltip', a && c.checked, n && c.active, t),
          icon: a ? l : r,
          onClick: d,
    ...
    96040: (e, t, a) => {
      ...
      function h(e) {
        ...
        return i.createElement(o.Icon, {
          ...v,
          'data-name': m,
          className: s(r.button, 'apply-common-tooltip', a && r.active, u && r.hidden, t),
          icon: l,
          onClick: n,
          onMouseDown: h,
          title: d || c.remove,
