  ...
  [6780],
  {
    ...
    34290: (e, t, s) => {
      ...
      class m extends i.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e ? i.createElement(r.Icon, { className: d.defaultsButtonIcon, icon: u }) : h.defaults
        }
      }
    },
    95275: (e, t, s) => {
      ...
      function u(e) {
        return e.isTabletWidth
          ? i.createElement(n.Icon, { className: l.themesButtonIcon, icon: c })
          : i.createElement(i.Fragment, null, (0, o.t)('Template'))
      }
      function d(e) {
        return i.createElement(a.MatchMedia, { rule: 'screen and (max-width: 768px)' }, t =>
          i.createElement(
            r.ControlDisclosure,
            {
              className: !t && l.themesButtonText,
              hideArrowButton: t,
              buttonChildren: i.createElement(u, { isTabletWidth: t }),
            },
            e.children,
          ),
        )
      ...
      function c(e) {
        ...
        return i.createElement(
          ...
          i.createElement(o.PopupMenuItem, {
            ...
            label: t,
            onClick: h,
            toolbox: s && i.createElement(n.RemoveButton, { hidden: !a.mobiletouch && !u, onClick: m }),
          }),
        )
      }
    },
          ...
          i.createElement(
            ...
            t &&
              i.createElement(
                a.PropertyTable,
                { reference: s, key: c },
                t.definitions.value().map(e => i.createElement(l.Section, { key: e.id, definition: e })),
              ),
          ),
        )
      }
      ...
      class D extends o.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._lineToolsAffectChartInvalidation = new P.FeatureToggleWatchedValue(
            ...
            (this._setTitle = e => {
              ...
              s.setProperty(t.properties().title, e, i, this._lineToolsAffectChartInvalidation.value())
            }),
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, _.isLineTool)(e)
                ? o.createElement(p.FooterMenu, { source: e, model: t })
                : o.createElement(
                    T.MatchMedia,
                    { rule: 'screen and (max-width: 428px)' },
                    s =>
                      (0, b.isStudy)(e) &&
                      o.createElement(g.StudyDefaultsManager, { model: t, source: e, mode: s ? 'compact' : 'normal' }),
                  )
            }),
            (this._subscribe = e => {
          ...
          const { pages: t } = this.props
          let s
          if (this._getActionPageById(this.props.activePageId)) s = (0, a.ensureDefined)(this.props.activePageId)
          else {
            const e = u().getValue(this._getActiveTabSettingsName(), ''),
              i = this._getActionPageById(e)
            s = i ? i.id : t[0].id
          }
          ;(this.state = { activePageId: s, tableKey: Date.now(), isRenaming: !1 }),
        ...
        render() {
          ...
          const { onCancel: t, source: s } = this.props,
            ...
            r = (null === (e = s.properties().title) || void 0 === e ? void 0 : e.value()) || s.title(),
            a = o.createElement(B.Title, {
              isRenaming: n,
              onChangeMode: this._handleChangeMode,
              setTitle: this._setTitle,
              defaultTitle: r,
              canBeRenamed: (0, _.isLineTool)(s) && !I.enabled('widget'),
            })
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: s } = this.props,
              i = { allIds: s.map(e => e.id), byId: s.reduce((e, t) => ({ ...e, [t.id]: { title: t.title } }), {}) },
              n = s.find(t => t.id === e)
            return o.createElement(
              o.Fragment,
              null,
              o.createElement(m.DialogTabs, { activeTabId: e, onSelect: this._handleSelectPage, tabs: i }),
              o.createElement(
                f.TouchScrollContainer,
                { className: M.scrollable, onScroll: this._handleScroll },
      ...
      class k extends R.DialogRenderer {
        ...
        show() {
          n.render(
            ...
            r.emit('drawings_settings_dialog', { objectType: 'drawing', scriptTitle: this._source.title() })
        }
    ...
    68495: (e, t, s) => {
      ...
      var i = s(59496),
        ...
        d = s(88401)
      function h(e) {
        const { isRenaming: t, onChangeMode: s, setTitle: h, defaultTitle: m, canBeRenamed: p } = e,
          f = (0, i.useRef)(null),
          [_, g] = (0, i.useState)(m),
          [b, v] = (0, i.useState)(m)
        return (
          (0, i.useEffect)(() => {
            t && f.current && (f.current.focus(), f.current.setSelectionRange(0, _.length))
          }, [t]),
          i.createElement(
            i.Fragment,
            null,
            i.createElement(
              ...
              i.createElement('span', { className: d.ellipsis }, ' ', b),
              p &&
                i.createElement(
                  i.Fragment,
                  null,
                  i.createElement(r.Icon, {
                    ...
                    icon: u,
                    onClick: function () {
                      ;(0, c.trackEvent)('GUI', 'Rename', 'Drawing settings'), g(b), s(!0)
                    },
                    'data-name': 'edit',
                    'data-role': 'button',
                  }),
                  i.createElement('div', { className: o(d.empty, !t && d.hideEmpty) }),
                ),
            ),
            p &&
              i.createElement(
                'div',
                { className: o(!t && d.hideInput), 'data-disable-drag': !0 },
                i.createElement(n.InputControl, {
                  ...
                  onKeyDown: function (e) {
                    27 === (0, l.hashFromEvent)(e) && (e.preventDefault(), g(m), s(!1))
                    13 === (0, l.hashFromEvent)(e) && (e.preventDefault(), C())
                  },
                  'data-disable-drag': !0,
                  stretch: !0,
                }),
    ...
    66512: (e, t, s) => {
      ...
      function b(e) {
        const {
          ...
          T = b && t.filter(e => e.id === b).length > 0 ? b : t[0].id,
          ...
          E = !!(
            ...
            v.every(e => {
              ...
              return (
                (null == w ? void 0 : w.id) ===
                (null === (t = C.model().lineToolsGroupModel().groupForLineTool(e)) || void 0 === t ? void 0 : t.id)
              )
            })
          ),
          [P, B] = (0, i.useState)(T),
          ...
          R = (0, i.useMemo)(
            () => ({ allIds: t.map(e => e.id), byId: t.reduce((e, t) => ({ ...e, [t.id]: { title: t.title } }), {}) }),
            [t],
          )
        ...
        return i.createElement(u.AdaptiveConfirmDialog, {
          ...
          footerLeftRenderer: function () {
            return i.createElement(d.FooterMenu, null, i.createElement(h.TemplateMenuItem, { onClick: r, name: _ }))
          },
          render: function () {
            ...
            return i.createElement(
              i.Fragment,
              null,
              i.createElement(l.DialogTabs, { activeTabId: P, onSelect: B, tabs: R }),
              i.createElement(
                c.TouchScrollContainer,
                null,
                i.createElement(m.PropertiesEditorTab, { page: e, tableKey: P }),
              ),
            )
          },
          submitOnEnterKey: !1,
      ...
      class p extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            ...
            !t && i.createElement('div', { className: e.headerBottomSeparator }),
            i.createElement(
              n,
              {
              ...
              i.createElement(
                ...
                i.createElement(m, { className: o(e.tabs, t && e.withoutBorder) }, r),
              ),
            ),
          )
        }
        _generateDialogTabs() {
          const { activeTabId: e, tabs: t, theme: s = h } = this.props
          return t.allIds.map(r => {
            ...
            return i.createElement(
              n.SliderItem,
              {
                key: r,
                value: r,
                className: o(s.tab, !a && s.withHover, l && d.withBadge),
                isActive: a,
    ...
    39440: (e, t, s) => {
      ...
      function p(e) {
        return i.createElement('div', { className: o(h.fadeLeft, e.className, { [h.isVisible]: e.isVisible }) })
      }
      function f(e) {
        return i.createElement('div', {
          className: o(h.fadeRight, e.className, { [h.isVisible]: e.isVisible }),
        })
      }
      function _(e) {
      ...
      function b(e) {
        return i.createElement(
          'div',
          { className: o(e.className, { [h.isVisible]: e.isVisible }), onClick: e.onClick },
          i.createElement('div', { className: h.iconWrap }, i.createElement(a.Icon, { icon: d, className: h.icon })),
        )
      }
          ...
          ((d = class extends i.PureComponent {
              ...
              super(e),
                ...
                (this._checkButtonsVisibility = () => {
                  ...
                  s || e
                    ...
                    i || t
                      ? i && t && this.setState({ isVisibleRightButton: !1 })
            ...
            currentPosition() {
              return this._scroll.current
                ? (0, u.isRtl)()
                  ? (0, u.getLTRScrollLeft)(this._scroll.current)
            ...
            isAtRight() {
              return (
                ...
                this.currentPosition() + this.state.widthWrap >=
                  this.state.widthContent - (0, r.ensureDefined)(this.props.hideButtonsFrom)
              )
            }
            animateTo(e, t = c.dur) {
              const s = this._scroll.current
              s &&
                ((0, u.isRtl)() && (e = (0, u.getLTRScrollLeftOffset)(s, e)),
                t <= 0
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: v, isVisibleLeftButton: C } = this.state,
                S = m && p
              return i.createElement(
                n,
                {
                ...
                i.createElement(
                  'div',
                  { className: h.wrapOverflow, onMouseOver: f, onMouseOut: _ },
                  i.createElement(
                    'div',
                    { className: o(h.wrap, S ? h.wrapWithArrowsOuting : '') },
                    i.createElement(
                      'div',
                      {
                        className: o(h.scrollWrap, g, { [h.noScrollBar]: !l }),
                    ...
                    c && i.createElement(s, { isVisible: C, className: b }),
                    c && i.createElement(a, { isVisible: v, className: b }),
                    u && i.createElement(e, { onClick: this._handleScrollLeft, isVisible: C }),
                    u && i.createElement(t, { onClick: this._handleScrollRight, isVisible: v }),
                  ),
                ),
              )
            }
    ...
    64205: (e, t, s) => {
      ...
      c(function (e) {
        return i.createElement('div', { className: r.slider, ref: e.reference })
      })
    },
    33086: e => {
      e.exports =
