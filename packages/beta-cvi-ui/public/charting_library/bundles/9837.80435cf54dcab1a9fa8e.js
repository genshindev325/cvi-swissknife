        ...
        _ = function (e, t) {
          var n,
            ...
            c =
              ...
              f(a, { x: r, y: o, width: i, height: s, top: o, right: r + i, bottom: s + o, left: r }),
              a)
                    ...
                    oneOf: function (e) {
                      return Array.isArray(e)
                        ? p(function (t, n, r, o, i) {
                            for (var s = t[n], u = 0; u < e.length; u++) if (f(s, e[u])) return null
                            return new l(
                              'Invalid ' +
                                o +
                                ' `' +
            ...
            e.exports = (function () {
              ...
              : function (e, t) {
                  for (var s, u, a = n(e), c = 1; c < arguments.length; c++) {
                    for (var f in (s = Object(arguments[c]))) o.call(s, f) && (a[f] = s[f])
                    if (r) {
                      u = r(s)
                      for (var l = 0; l < u.length; l++) i.call(s, u[l]) && (a[u[l]] = s[u[l]])
                    }
                  }
                  return a
                }
                  ...
                  for (var l in e)
                    if (e.hasOwnProperty(l)) {
                      ...
                      if (
                        ...
                        u[p.message] = !0
                        var d = f ? f() : ''
                        i(!1, 'Failed %s type: %s%s', a, p.message, null != d ? d : '')
                      }
                    }
              }
            }.call(t, n(4)))
            ...
            Object.defineProperty(t, '__esModule', { value: !0 }),
              (t.default = function (e) {
                ...
                return (
                  ...
                  t.margin
                    ? ((o = s.left + n.width + s.right), (i = s.top + n.height + s.bottom))
