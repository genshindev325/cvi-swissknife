;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    94720: (e, t, n) => {
      ...
      function u(e) {
        const { size: t, startIcon: n, icon: r, iconOnly: i, children: a, endIcon: c } = e,
          u = null != n ? n : r
        return o.createElement(
          o.Fragment,
          null,
          u && 'xsmall' !== t && o.createElement(s.Icon, { icon: u, className: l()['start-icon-wrap'] }),
          a && o.createElement('span', { className: l().content }, a),
          c && !i && 'xsmall' !== t && o.createElement(s.Icon, { icon: c, className: l()['end-icon-wrap'] }),
        )
      }
      var d = n(86332),
        m = n(90186)
      function p(e) {
        ...
        return { ...d, ...(0, m.filterDataProps)(e), ...(0, m.filterAriaProps)(e) }
      }
      function h(e) {
        const { reference: t, ...n } = e,
          { isGrouped: r, cellState: i, disablePositionAdjustment: s } = (0, o.useContext)(d.ControlGroupContext),
          a = c({ ...n, isGrouped: r, cellState: i, disablePositionAdjustment: s })
        return o.createElement('button', { ...p(n), className: a, ref: t }, o.createElement(u, { ...n }))
      }
      ...
      function w(e) {
        const { intent: t, size: n, appearance: o, useFullWidth: r, icon: i, ...s } = e
        return { ...s, color: f(t), size: v(n), variant: g(o), stretch: r, startIcon: i }
      }
      function C(e) {
    ...
    67029: (e, t, n) => {
      ...
      function p(e, t, n, o) {
        const {
          ...
          C = m(null != i ? i : (0, c.getGroupCellRemoveRoundBorders)(n))
        return r(
          d().container,
          d()['intent-' + a],
          d()['border-' + l],
      ...
      function h(e, t) {
        ...
        const i = m(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(t))
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: k, cellState: _, disablePositionAdjustment: M = !1 } = (0, o.useContext)(l.ControlGroupContext),
          D = (function (e, t = null, n) {
            ...
            return (0, o.useEffect)(() => ((i.current = [e, t, n]), s(), a), [e, t, n]), l
          })('wheel', x, f)
        return o.createElement(
          'span',
          {
    ...
    78274: (e, t, n) => {
      ...
      var o = n(59496),
        ...
        s = n.n(i)
      function a(e) {
        const { className: t, interactive: n = !0, icon: i = !1, children: a } = e
        return o.createElement('span', { className: r(s()['inner-slot'], n && s().interactive, i && s().icon, t) }, a)
      }
      function l(e) {
    ...
    31261: (e, t, n) => {
        ...
        return o.createElement(m.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement('input', {
              ...G,
              className: r(g().input, O, P && g()['with-start-slot'], V && g()['with-end-slot']),
              disabled: L,
              readOnly: Y,
              ref: K,
            }),
      ...
      function w(e) {
        ...
        const {
          ...
          b = t ? void 0 : w ? -1 : r,
          y = t ? void 0 : w ? r : -1,
          { isMouseDown: E, handleMouseDown: S, handleMouseUp: x } = (0, d.useIsMouseDown)(),
    ...
    48027: (e, t, n) => {
      ...
      var o = n(47201),
        r = n(29202)
      function i(e) {
        const { onFocus: t, onBlur: n, intent: i, highlight: s, disabled: a } = e,
        ...
        return { ...e, intent: i || (l ? 'primary' : 'default'), highlight: null != s ? s : l, onFocus: u, onBlur: d }
      }
    },
    29202: (e, t, n) => {
      'use strict'
    ...
    26996: (e, t, n) => {
      ...
      class c extends r.PureComponent {
        ...
        render() {
          const { className: e, color: t = 'black', size: n = 'medium', staticPosition: o } = this.props,
            s = i(l().item, l()[t], l()[n])
    ...
    70493: (e, t, n) => {
      'use strict'
      n.r(t),
        n.d(t, { confirmModule: () => R, renameModule: () => I, showSimpleDialog: () => O, warningModule: () => B })
      var o = n(59496),
        r = n(28353),
        i = n(97754),
        s = n(9745),
        ...
        v = n(76974),
        w = n(50655)
      const C = o.createContext({ isSmallTablet: !1, dialogCloseHandler: () => {} })
      var b = n(41227)
      function y(e) {
        const { disabled: t, name: n, title: r, appearance: s, intent: a, handler: l, reference: c } = e,
          { isSmallTablet: u, dialogCloseHandler: d } = (0, o.useContext)(C),
        ...
        return o.createElement(
          ...
          o.createElement('span', { className: i(y && b.hiddenTitle) }, r),
      ...
      function x(e) {
        ...
        ;(0, o.useEffect)(
          () => (
            a.subscribe(d.CLOSE_POPUPS_AND_DIALOGS_COMMAND, n, null),
            () => {
              a.unsubscribe(d.CLOSE_POPUPS_AND_DIALOGS_COMMAND, n, null)
            }
          ),
          [n],
        )
        const [w, b] = (0, o.useState)(!0),
          x = (0, o.useRef)(null)
        return o.createElement(u.MatchMedia, { rule: m.DialogBreakpoints.TabletSmall }, a =>
          o.createElement(
            C.Provider,
            ...
            o.createElement(
              ...
              o.createElement(
                ...
                o.createElement(
                  ...
                  o.createElement('div', { className: i(S.title, a && S.small) }, t),
                  (function (t) {
                    if ('html' in e)
                      return o.createElement(p.TouchScrollContainer, {
                    ...
                    if ('content' in e)
                      return o.createElement(
                        ...
                        { className: i(S.content, t && S.small) },
                        e.content,
                      )
                    return null
                  })(a),
                  r &&
                    ...
                    o.createElement(
                      'div',
                      { className: i(S.footer, a && S.small) },
                      r.map((e, t) => o.createElement(y, { ...e, key: e.name, reference: 0 === t ? x : void 0 })),
                    ),
                ),
      ...
      var _ = n(31261),
        M = n(36045)
      function D(e) {
        const { maxLength: t, value: n, placeholder: r, onValueChange: i, nameInputRef: s } = e,
        ...
        return (
          ...
          o.createElement(
            ...
            null,
            (function () {
              if ('content' in e) return o.createElement('div', { className: M.label }, e.content)
              if ('html' in e)
                return o.createElement('div', { className: M.label, dangerouslySetInnerHTML: { __html: e.html } })
              return null
            })(),
      ...
      const R = function (e) {
          ...
          return o.createElement(x, {
            ...
            onClose: n,
            actions: [
              { name: 'yes', title: i || (0, r.t)('Yes'), intent: s || 'success', handler: c },
              {
                name: 'no',
                title: a || (0, r.t)('No'),
                appearance: 'stroke',
            ...
            actions: [
              {
                ...
                handler: ({ dialogClose: e, innerManager: t }) =>
                  m({ newValue: h, focusInput: C, dialogClose: e, innerManager: t }),
              },
              {
                name: 'cancel',
        ...
        B = function (e) {
          const { title: t, closeOnOutsideClick: n, onClose: i = () => {} } = e,
            s = k(e)
          return o.createElement(x, {
            ...s,
        ...
        O = function (e, t, n) {
          ...
          if (A.isOpened(i)) return (0, f.ensureDefined)(A.getDialogPayload(i)).closeHandler
          const s = document.createElement('div'),
            a = () => {
              var t
              null === (t = e.onClose) || void 0 === t || t.call(e), N.unmountComponentAtNode(s), A.setAsClosed(i)
            }
          return (
            N.render(
              o.createElement(w.SlotContext.Provider, { value: n || null }, o.createElement(t, { ...e, onClose: a })),
              s,
            ),
