;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3005],
  {
    ...
    71747: e => {
      e.exports = { 'css-value-header-toolbar-height': '38px', wrap: 'wrap-7mUBPdQo' }
    },
    85291: e => {
      e.exports = {
    ...
    9745: (e, t, s) => {
      ...
      const r = a.forwardRef((e, t) => {
        const { icon: s = '', ...r } = e
        return a.createElement('span', { ...r, ref: t, dangerouslySetInnerHTML: { __html: s } })
      })
    },
    53374: (e, t, s) => {
      'use strict'
    ...
    53335: (e, t, s) => {
      ...
      function g(e) {
        ...
        return a.createElement(
          ...
          S.hasNewHeaderToolbarStyles &&
            !c &&
            a.createElement('div', { className: f.separatorWrap }, a.createElement('div', { className: f.separator })),
          a.createElement(
            'div',
            {
      ...
      class L extends a.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = e => {
              ;(0, N.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 })
            }),
            (this._handleMouseOut = e => {
              ;(0, N.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 })
            }),
              ...
              return e.map(e =>
                a.createElement(
                  ...
                  (e => {
                    switch (e.type) {
                      case 'Button':
                        return a.createElement(r.Custom, { ...e.params, isFake: t })
                      case 'TradingViewStyledButton':
                        return a.createElement(r.CustomTradingViewStyledButton, {
                          ...e.params,
                          className: F.button,
                          displayMode: s,
                        })
                      case 'Dropdown':
                        return a.createElement(r.Dropdown, { displayMode: s, params: e.params })
                      default:
                        return null
                    }
                  })(e),
        ...
        render() {
          ...
          return a.createElement(
            ...
            a.createElement(
              m,
              { onMeasure: this._handleMeasureAvailableSpace, whitelist: ['width'], shouldMeasure: !u },
              a.createElement(
                T.HorizontalScroll,
                {
                ...
                a.createElement(
                  ...
                  a.createElement(
                    b,
                    { onWidthChange: this._handleInnerResize, shouldMeasure: u },
                    a.createElement(
                      v.FragmentMap,
                      ...
                      !o &&
                        a.Children.toArray([
                          ...
                          e.DateRange && a.createElement(g, { key: 'range' }, a.createElement(e.DateRange, null)),
                          e.Intervals &&
                            a.createElement(
                              g,
                              { key: 'intervals' },
                          ...
                          e.AlertReferral &&
                            a.createElement(
                              g,
                              { key: 'alert-referral' },
                              a.createElement(e.AlertReferral, { className: F.button, displayMode: s }),
                            ),
                          !S.hasNewHeaderToolbarStyles &&
                            e.Replay &&
                            a.createElement(
                          ...
                          !S.hasNewHeaderToolbarStyles &&
                            ...
                            a.createElement(
                              g,
                              { key: 'undo-redo' },
                              a.createElement(e.UndoRedo, { id: u ? void 0 : k.UndoRedo }),
                            ),
                          e.ScalePercentage &&
                            a.createElement(g, { key: 'percentage' }, a.createElement(e.ScalePercentage, null)),
                          e.ScaleLogarithm &&
                            a.createElement(g, { key: 'logarithm' }, a.createElement(e.ScaleLogarithm, null)),
                          ...w,
                        ]),
                      (function (e) {
                        const t = e.findIndex(
                          e => a.isValidElement(e) && !!e.key && -1 !== e.key.toString().indexOf('view-only-badge'),
                        )
                        return (
                          [t]
                            .filter(e => e >= 0)
                        ...
                        a.Children.toArray([
                          o &&
                            a.createElement(
                              g,
                              { key: 'view-only-badge', removeSeparator: S.hasNewHeaderToolbarStyles },
                          ...
                          (!o || S.hasNewHeaderToolbarStyles) &&
                            ...
                            a.createElement(
                              g,
                              { key: 'layout', removeSeparator: S.hasNewHeaderToolbarStyles && o },
                              !o && a.createElement(e.Layout, { id: u ? void 0 : k.Layouts }),
                              S.hasNewHeaderToolbarStyles &&
                                e.SaveLoad &&
                          ...
                          e.SaveLoadReferral &&
                            a.createElement(
                              ...
                              a.createElement(e.SaveLoadReferral, { isReadOnly: o, displayMode: s }),
                            ),
                          t.showLaunchInPopupButton &&
                            e.OpenPopup &&
                            a.createElement(g, { key: 'popup' }, a.createElement(e.OpenPopup, null)),
                          (!o || S.hasNewHeaderToolbarStyles) &&
                            e.Properties &&
                            a.createElement(
                              g,
                              { key: 'properties', removeSeparator: S.hasNewHeaderToolbarStyles && o },
                              !o &&
                              ...
                              S.hasNewHeaderToolbarStyles &&
                                a.createElement(
                                  ...
                                  !o &&
                                    e.Fullscreen &&
                                    a.createElement(e.Fullscreen, { id: u ? void 0 : k.Fullscreen }),
                                  e.Screenshot &&
                          ...
                          !S.hasNewHeaderToolbarStyles &&
                            ...
                            a.createElement(
                              g,
                              { key: 'screenshot' },
                              a.createElement(e.Screenshot, { id: u ? void 0 : k.Screenshot, className: F.iconButton }),
                            ),
                          !o &&
                            e.Publish &&
                            a.createElement(
                              ...
                              a.createElement(e.Publish, { id: u ? void 0 : k.PublishMobile }),
                            ),
                          ..._,
                        ]),
                      ),
            ...
            e.Publish && !o && !u && a.createElement(e.Publish, { id: k.PublishDesktop, className: F.desktopPublish }),
          )
        }
        _onLoginStateChange() {
          0
      ...
      class Z {
        constructor(e) {
          ;(this._customIntervalsService = G),
            ...
            O.linking.supportedResolutions.subscribe(this._fireSupportedIntervalsMayChange),
        ...
        destroy() {
          O.linking.supportedResolutions.unsubscribe(this._fireSupportedIntervalsMayChange),
            O.linking.range.unsubscribe(this._fireSupportedIntervalsMayChange),
            O.linking.seconds.unsubscribe(this._fireSupportedIntervalsMayChange),
            O.linking.ticks.unsubscribe(this._fireSupportedIntervalsMayChange),
            O.linking.intraday.unsubscribe(this._fireSupportedIntervalsMayChange)
        }
        getDefaultIntervals() {
          return null === this._chartApiInstance
            ? []
            : this._chartApiInstance.defaultResolutions().map(P.normalizeIntervalString)
        }
        getCustomIntervals() {
        ...
        add(e, t, s) {
          ...
          return this._isIntervalDefault(a) || r.includes(a)
            ? null
            : (this._customIntervalsService.set((0, P.sortResolutions)([...r, a])), a)
        }
        remove(e) {
      ...
      class se {
        ...
        addFavorite(e) {
          const t = this.favId(e)
          this._favorites.push(re(t)), this._favoritesChanged.fire(), this._saveFavs()
        }
        removeFavorite(e) {
          const t = this.favId(e),
        ...
        favId(e) {
          return (0, Y.isPineIdString)(e) ? e : (0, Y.extractPineId)(e) || (0, j.extractStudyId)(e)
        }
        favorites() {
        ...
        _saveFavs() {
          ...
          this._settings.setJSON('studyMarket.favorites', e, { forceFlush: !0 }),
            Q.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: e }))
        }
        _stateToSave() {
      ...
      function re(e) {
        return (0, Y.isPineIdString)(e) ? { type: 'pine', pineId: e } : { type: 'java', studyId: e }
      }
      var ie = s(29823)
      const ne = {
      ...
      function ue(e = []) {
        return (0, P.mergeResolutions)(e, d.enabled('star_some_intervals_by_default') ? de : [])
      }
      ...
      class fe extends a.PureComponent {
        constructor(e) {
          ...
          this._favoriteChartStylesService = u || new B(Q.TVXWindowEvents, U, w)
          const _ = ue(this.props.defaultFavoriteIntervals)
          ;(this._favoriteIntervalsService = h || new z(Q.TVXWindowEvents, U, _)),
            (this._intervalsMenuViewStateService = new oe(Q.TVXWindowEvents, U)),
        ...
        componentDidUpdate(e, t) {
          ...
          s !== t.isVisible && (h.emit('toggle_header', s), this._negotiateResizer()), a || this._setDisplayMode()
        }
        render() {
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                'div',
                { className: n(ve.toolbar, { [ve.isHidden]: !o }), onClick: this.props.onClick },
                a.createElement(
                  'div',
        ...
        updateDropdown(e, t) {
          const s = t => 'Dropdown' === t.type && t.id === e,
            a = this.state.leftCustomElements.find(s) || this.state.rightCustomElements.find(s)
          void 0 !== a &&
            ((a.params = { ...a.params, ...t }),
            this.setState({
        ...
        _negotiateResizer() {
          this.props.resizerBridge.negotiateHeight(
            this.state.isVisible ? $.HEADER_TOOLBAR_HEIGHT_EXPANDED : $.HEADER_TOOLBAR_HEIGHT_COLLAPSED,
          )
        }
        _setDisplayMode() {
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const s = new (H())(0),
            a = (0, pe.parseHtmlElement)(`<div class="apply-common-tooltip ${ve.customButton}">`),
            r = { type: 'Button', id: e, params: { key: Number(new Date()), element: a, width: s } }
      ...
      class ge {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            r.render(a.createElement(fe, { ...t, ref: this._handleRef }), this._container)
        }
        destroy() {
    ...
    55402: (e, t, s) => {
      'use strict'
      s.d(t, { validateRegistry: () => o, RegistryProvider: () => l, registryContextType: () => c })
      var a = s(59496),
        r = s(19036),
        i = s.n(r)
    ...
    70412: (e, t, s) => {
      'use strict'
      s.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => n, useHover: () => r })
      var a = s(59496)
      function r() {
    ...
    39440: (e, t, s) => {
      ...
      var a = s(59496),
        ...
        h = s(33086),
        u = s(41814)
      const m = { isVisibleScrollbar: !0, shouldMeasure: !0, hideButtonsFrom: 1 }
      function p(e) {
        return a.createElement('div', { className: r(u.fadeLeft, e.className, { [u.isVisible]: e.isVisible }) })
      }
      function v(e) {
        return a.createElement('div', { className: r(u.fadeRight, e.className, { [u.isVisible]: e.isVisible }) })
      }
      function S(e) {
      ...
      function g(e) {
        return a.createElement(
          'div',
          { className: r(e.className, { [u.isVisible]: e.isVisible }), onClick: e.onClick },
          a.createElement('div', { className: u.iconWrap }, a.createElement(o.Icon, { icon: h, className: u.icon })),
        )
      }
      const y = (function (e = S, t = f, s = p, o = v) {
        ...
        return (
          ((h = class extends a.PureComponent {
            ...
            isAtLeft() {
              return !this._isOverflowed() || this.currentPosition() <= (0, n.ensureDefined)(this.props.hideButtonsFrom)
            }
            isAtRight() {
              return (
                !this._isOverflowed() ||
                this.currentPosition() + this.state.widthWrap >=
                  this.state.widthContent - (0, n.ensureDefined)(this.props.hideButtonsFrom)
              )
            }
            animateTo(e, t = c.dur) {
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: y, isVisibleLeftButton: b } = this.state,
                w = m && p
              return a.createElement(
                i,
                {
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    d && a.createElement(e, { onClick: this._handleScrollLeft, isVisible: b }),
                    d && a.createElement(t, { onClick: this._handleScrollRight, isVisible: y }),
                  ),
                ),
              )
            }
