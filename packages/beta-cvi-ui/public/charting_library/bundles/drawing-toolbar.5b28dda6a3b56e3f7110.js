;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2878],
  {
    ...
    48214: e => {
      e.exports = { buttonIcon: 'buttonIcon-OGj1N2Ml', button: 'button-OGj1N2Ml' }
    },
    60306: e => {
      e.exports = {
        wrap: 'wrap-GVak88eE',
    ...
    26862: (e, t, o) => {
      ...
      class L extends i.PureComponent {
        ...
        render() {
          const {
            ...
            { heightContent: l, heightWrap: c, isVisibleBotButton: d, isVisibleTopButton: h } = this.state
          return i.createElement(
            ...
            i.createElement(
              ...
              o && i.createElement('div', { className: r()(M.fadeTop, { [M.isVisible]: h && l > c }) }),
              o && i.createElement('div', { className: r()(M.fadeBot, { [M.isVisible]: d && l > c }) }),
              n &&
                i.createElement(
                  'div',
                  { className: r()(M.scrollTop, { [M.isVisible]: h && l > c }), onClick: this._handleScrollTop },
                  i.createElement(
                    'div',
              ...
              n &&
                i.createElement(
                  'div',
                  { className: r()(M.scrollBot, { [M.isVisible]: d && l > c }), onClick: this._handleScrollBot },
                  i.createElement(
                    'div',
                    { className: M.iconWrap },
                    i.createElement(S.Icon, { icon: D, className: M.icon }),
      ...
      const F = [
        ...
        61785, 61786, 61845, 61440, 61442, 61444, 61445, 61446, 61447, 61452, 61453, 61454, 61457, 61458, 61459, 61461,
        61463, 61466, 61467, 61470, 61473, 61476, 61488, 61504, 61505, 61507, 61510, 61523, 61524, 61525, 61526, 61527,
        61528, 61529, 61530, 61531, 61532, 61533, 61534, 61540, 61541, 61542, 61543, 61544, 61545, 61546, 61547, 61548,
        61550, 61552, 61553, 61554, 61557, 61558, 61559, 61560, 61565, 61566, 61568, 61572, 61578, 61601, 61602, 61603,
        61604, 61605, 61606, 61607, 61609, 61610, 61611, 61654, 61655, 61656, 61657, 61658, 61667, 61669, 61671, 61675,
        61683, 61698, 61699, 61700, 61701, 61702, 61703, 61708, 61712, 61713, 61714, 61715, 61720, 61721, 61722, 61731,
        61732, 61736, 61737, 61738, 61749, 61751, 61753, 61754, 61757, 61760, 61768, 61769, 61770, 61813, 61814, 61815,
        61816, 61817, 61820, 61827, 61829, 61830, 61832, 61842,
      ]
      var x = o(50628),
        V = o(90186),
        O = o(41590),
      ...
      class R extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: l(G.dropdown, { [G.isGrayed]: h, [G.isActive]: d, [G.isOpened]: g }),
              onClick: h ? u : void 0,
            },
            i.createElement(
              'div',
              ...
              i.createElement(
                'div',
                {
                  ...
                  className: l(G.buttonWrap, { 'apply-common-tooltip common-tooltip-vertical': Boolean(n || s) }),
              ...
              !h &&
                ...
                i.createElement(
                  'div',
                  {
                    className: l(G.arrow, a && 'apply-common-tooltip common-tooltip-vertical'),
                    title: a,
            ...
            !h &&
              (p
                ? g && i.createElement(O.Drawer, { onClose: this._handleClose, position: 'Bottom' }, r)
                : i.createElement(
                    x.PopupMenu,
                    {
                      doNotCloseOn: this,
      ...
      class z extends i.Component {
          ...
          super(e),
            (this._renderItem = (e, t) => {
              const { isSmallTablet: o } = this.props,
                n = l(U.item, o && U.smallTablet, t && o && this.state.isActive && e === this.state.current && U.active)
              return i.createElement(
                'div',
                {
                  className: n,
          ...
          return i.createElement(
            ...
            o &&
              i.createElement(
                i.Fragment,
                null,
                e && i.createElement('div', { className: U.title }, (0, a.t)('Recently used')),
                i.createElement(
                  'div',
                  { className: n },
                  o.map(e => this._renderItem(e, !0)),
                ),
                i.createElement(H.PopupMenuSeparator, { className: l(e && U.separator) }),
              ),
            i.createElement(
              'div',
              { key: 'all', className: n },
        ...
        _isActive() {
          var e
          return u.tool.value() === (null !== (e = this.props.toolName) && void 0 !== e ? e : 'LineToolIcon')
        }
        _onSyncSettings() {
          this.setState({ recents: (0, d.getJSON)('linetoolicon.recenticons') })
        }
      }
      var j = o(48214)
      ...
      class J extends i.Component {
        constructor(e) {
          super(e),
            ...
            (this.state = { current: (0, P.defaults)('linetoolicon').icon, isActive: this._isActive() })
        }
        componentDidMount() {
          u.tool.subscribe(this._onChangeDrawingStateTool), u.iconTool.subscribe(this._onChangeDrawingStateIcon)
        }
        componentWillUnmount() {
          u.tool.unsubscribe(this._onChangeDrawingStateTool), u.iconTool.unsubscribe(this._onChangeDrawingStateIcon)
        }
        render() {
          ...
          return i.createElement(
            R,
            {
              ...
              buttonIcon: i.createElement('div', { className: j.buttonIcon }, String.fromCharCode(n || F[0])),
              buttonTitle: q.icon,
              ...
              onClickWhenGrayed: () =>
                (0, p.emit)('onGrayedObjectClicked', { type: 'drawing', name: T.lineToolsInfo[t].localizedName }),
          ...
          super(e),
            (this._handleClick = () => {
              ...
              this.props.property.setValue(e),
                this.props.saveDefaultOnChange && (0, K.saveDefaultProperties)(!1),
      ...
      class Y extends i.PureComponent {
        constructor(e) {
          super(e),
            (this._handleClick = () => {
              var e, t
              u.tool.setValue(this.props.toolName), null === (t = (e = this.props).onClick) || void 0 === t || t.call(e)
            }),
            (this._onChange = () => {
      ...
      class oe extends i.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleGrayedClick = e => {
              ;(0, p.emit)('onGrayedObjectClicked', { type: 'drawing', name: T.lineToolsInfo[e].localizedName })
            }),
        ...
        componentDidMount() {
          u.tool.subscribe(this._onChangeDrawingState),
            Q.LinetoolsFavoritesStore.favoriteAdded.subscribe(null, this._onAddFavorite),
            Q.LinetoolsFavoritesStore.favoriteRemoved.subscribe(null, this._onRemoveFavorite),
            Q.LinetoolsFavoritesStore.favoritesSynced.subscribe(null, this._onSyncFavorites)
        }
        componentWillUnmount() {
          u.tool.unsubscribe(this._onChangeDrawingState),
            Q.LinetoolsFavoritesStore.favoriteAdded.unsubscribe(null, this._onAddFavorite),
            Q.LinetoolsFavoritesStore.favoriteRemoved.unsubscribe(null, this._onRemoveFavorite),
            Q.LinetoolsFavoritesStore.favoritesSynced.unsubscribe(null, this._onSyncFavorites)
        }
        componentDidUpdate(e, t) {
      ...
      const be = {
        ...
        all: { active: he.drawingToolsIcons.hideAllDrawingsActive, inactive: he.drawingToolsIcons.hideAllDrawings },
      }
      function ve(e) {
        ...
        const l = T.lineToolsInfo.hideAllDrawings,
          { trackLabel: r, tooltip: c, dataName: d } = (0, s.ensureDefined)((0, ue.getHideOptions)().get(n)),
        ...
        return i.createElement(
          ...
          i.createElement(
            ...
            Array.from((0, ue.getHideOptions)()).map(([e, o]) =>
              i.createElement(ge, { key: e, hideMode: e, option: o, isSmallTablet: t, onClick: m }),
            ),
          ),
        )
        function m(e, t) {
          Te((0, s.ensureDefined)((0, ue.getHideOptions)().get(e)).trackLabel, t)
        }
      }
      function Te(e, t) {
        ;(0, ie.trackEvent)('GUI', 'Chart Left Toolbar', `${e} ${t ? 'on' : 'off'}`)
      }
      function _e(e) {
        0
      }
      ...
      class fe extends i.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = (0, s.ensureNotNull)((0, Ce.getFavoriteDrawingToolbarPromise)()))
          e.then(t => {
            this._promise === e &&
              ((this._instance = t),
      ...
      const Fe = (0, ne.mergeThemes)(Ne, Pe),
        xe = { hide: (0, a.t)('Hide Drawings Toolbar'), show: (0, a.t)('Show Drawings Toolbar') }
      class Ve extends i.PureComponent {
        constructor() {
          super(...arguments),
            (this._toggleVisibility = () => {
              k.isDrawingToolbarVisible.setValue(!k.isDrawingToolbarVisible.value())
            })
        }
        render() {
          ...
          return i.createElement(
            'div',
            {
              className: l(Fe.toggleButton, 'apply-common-tooltip common-tooltip-vertical', !e && Fe.collapsed),
              onClick: this._toggleVisibility,
              title: e ? xe.hide : xe.show,
              'data-name': t,
              'data-value': e ? 'visible' : 'collapsed',
            },
            i.createElement(Be, { direction: e ? 'left' : 'right', theme: e ? void 0 : Fe }),
          )
        }
      }
      var Oe = o(37558),
      ...
      const ze = h.enabled('right_toolbar'),
        ...
        qe = { weakMagnet: (0, a.t)('Weak Magnet'), strongMagnet: (0, a.t)('Strong Magnet') },
        Je = (0, v.onWidget)(),
        Ke = new (b())(),
      ...
      function Ze() {
        ...
        Ye('magnet mode', e), ot('magnet mode', e ? 'on' : 'off'), (0, m.setIsMagnetEnabled)(e)
      }
      function Qe() {
        ;(0, ie.trackEvent)('GUI', 'Magnet mode', 'Weak'), (0, m.setMagnetMode)(Ee.MagnetMode.WeakMagnet)
      }
      function $e() {
        ;(0, ie.trackEvent)('GUI', 'Magnet mode', 'Strong'), (0, m.setMagnetMode)(Ee.MagnetMode.StrongMagnet)
      }
      function et() {
        ot('magnet mode', 'menu')
      }
      class tt extends i.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleObjectsTreeClick = () => {
              this._activeChartWidget().showObjectsTreeDialog(), ot('object tree')
            }),
            (this._handleMouseOver = e => {
              ;(0, ye.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 })
            }),
            (this._handleMouseOut = e => {
              ;(0, ye.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 })
            }),
            ...
            (this._filteredLineTools = w
              .map(e => ({
                id: e.id,
                title: e.title,
                items: e.items.filter(e => this._toolsFilter.isToolEnabled(T.lineToolsInfo[e.name].localizedName)),
                trackLabel: e.trackLabel,
              }))
              .filter(e => 0 !== e.items.length)),
            this._filteredLineTools.forEach(e =>
              e.items.forEach(e => {
                this._grayedTools[e.name] = this._toolsFilter.isToolGrayed(T.lineToolsInfo[e.name].localizedName)
              }),
            ),
            (this.state = {
              isHovered: !1,
        ...
        render() {
          const { bgColor: e, chartWidgetCollection: t, readOnly: o } = this.props,
            { isHovered: n, isVisible: s, magnet: a, magnetMode: r } = this.state,
            d = { backgroundColor: e && '#' + e }
          let m
          m = i.createElement(Ve, { toolbarVisible: s, 'data-name': 'toolbar-drawing-toggle-button' })
          const p = () => !!this._features.tools && !(!h.enabled('show_object_tree') || (je && !ze))
          return i.createElement(
            He.RegistryProvider,
            ...
            i.createElement(
              ...
              i.createElement(
                Oe.DrawerManager,
                null,
                i.createElement(Ge.MatchMedia, { rule: We.DialogBreakpoints.TabletSmall }, e =>
                  i.createElement(
                    'div',
                    {
                      id: 'drawing-toolbar',
                      ...
                      i.createElement(
                        ...
                        !o &&
                          i.createElement(
                            'div',
                            { className: Ue.group, style: d },
                            i.createElement(Y, { toolName: 'measure', onClick: this._handleMeasureClick }),
                            i.createElement(Y, { toolName: 'zoom', onClick: this._handleZoomInClick }),
                          ...
                          i.createElement(
                            ...
                            i.createElement(
                              R,
                              {
                                ...
                                buttonTitle: T.lineToolsInfo.magnet.localizedName,
                                isActive: a,
                                onClickButton: Ze,
                              ...
                              i.createElement(ee.PopupMenuItem, {
                                ...
                                isActive: a && r !== Ee.MagnetMode.StrongMagnet,
                                label: qe.weakMagnet,
                                onClick: Qe,
                              }),
                              i.createElement(ee.PopupMenuItem, {
                            ...
                            this._features.tools && i.createElement(ve, { isSmallTablet: e }),
                            !1,
                          ),
                        !o &&
                          this._features.tools &&
                        ...
                        i.createElement('div', { className: Ue.fill, style: d }),
                        !o &&
                          (this._features.tools || !1) &&
                          i.createElement(
                            'div',
                            { className: l(Ue.group, Ue.lastGroup), style: d },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              i.createElement(fe, { id: Se.FavoriteDrawings }),
                            p() &&
                              i.createElement(B, {
                                id: Se.ObjectTree,
        ...
        _negotiateResizer() {
          ...
          this.props.resizerBridge.negotiateWidth(this.state.isVisible ? De.TOOLBAR_WIDTH_EXPANDED : e)
        }
        _handleGlobalClose() {
          Ke.fire()
        }
      ...
      class it {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            n.render(i.createElement(tt, { ...t, ref: this._handleRef }), this._container)
        }
        destroy() {
    ...
    55402: (e, t, o) => {
      'use strict'
      o.d(t, { validateRegistry: () => l, RegistryProvider: () => r, registryContextType: () => c })
      var i = o(59496),
        n = o(19036),
        s = o.n(n)
    ...
    41590: (e, t, o) => {
      ...
      var i = o(59496),
        ...
        u = o(66998)
      function m(e) {
        const { position: t = 'Bottom', onClose: o, children: m, className: p, theme: g = u } = e,
        ...
        return (
          ...
          i.createElement(
            ...
            i.createElement(
              ...
              v === b.currentDrawer && i.createElement('div', { className: u.backdrop, onClick: o }),
              i.createElement(
                'div',
                {
    ...
    70412: (e, t, o) => {
      'use strict'
      o.d(t, { hoverMouseEventFilter: () => s, useAccurateHover: () => a, useHover: () => n })
      var i = o(59496)
      function n() {
      ...
      function u(e) {
        ...
        return i.createElement(
          d,
          {
            ...
            role: o,
            'aria-selected': c,
            className: n(u, B.item, T && B.withIcon, { [B.isActive]: _, [B.isDisabled]: C || k, [B.hovered]: w }),
            title: m,
            href: S,
            target: y,
            rel: M,
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: i, onClickArg: n, trackEventObject: l } = e
              if (C) return
            ...
            onContextMenu: function (t) {
              ...
              o && i && (0, a.trackEvent)(o.category, o.event, o.label + '_rightClick')
            },
            onMouseUp: function (t) {
              const { trackEventObject: o, trackMouseWheelClick: i } = e
              if (1 === t.button && S && o) {
                let e = o.label
                i && (e += '_mouseWheelClick'), (0, a.trackEvent)(o.category, o.event, e)
              }
            },
            onMouseOver: N,
            onMouseOut: A,
          },
          void 0 !== T && i.createElement('div', { className: B.icon, dangerouslySetInnerHTML: { __html: T } }),
          i.createElement(
            'div',
            { className: n(B.labelRow, p) },
            i.createElement('div', { className: n(B.label, g) }, f),
          ),
          (void 0 !== b || v) && i.createElement('div', { className: B.shortcut }, (x = b) && x.split('+').join(' + ')),
          void 0 !== D &&
            i.createElement('div', { onClick: I ? h : void 0, className: n(B.toolbox, { [B.showOnHover]: E }) }, D),
        )
        var x
      }
    },
