...
_tv_languages.zh = {
  ...
  'Press and hold {key} while zooming to maintain the chart position':
    '当您希望放大您鼠标聚焦的点位时，请按住{key} 键。',
  'Double-click any edge to reset layout grid': '双击任意边缘以重置布局网格',
  ...
  m_interval_short: '分',
  '{number} hour_0': '{number} 小时',
  h_interval_short: '小时',
  '{number} day_0': '{number} 天',
  D_interval_short: '天',
  W_interval_short: '周',
  M_interval_short: '月',
  Rename: '重命名',
  ...
  "The data vendor doesn't provide volume data for this symbol.": '数据供应商不提供此商品的成交量数据。',
  ...
  'Session Volume HD_study': '时段成交量HD',
  ...
  'Lower Band_input': '下轨',
  CCI_input: 'CCI',
  'Smoothing Line_input': '平滑线',
  'Smoothing Length_input': '平滑长度',
  ...
  'adjust for contract changes': '调整合同变更',
  'toggle auto scale': '切换自动坐标',
  'toggle log scale': '切换对数坐标',
  'toggle percentage scale': '切换百分比坐标',
  'Take a snapshot': '生成快照',
  'use settlement as close on daily interval': '使用结算价作为每日周期的收盘价',
  ext: '延时',
  ...
  adj_adjustments: '调整',
  'Adjust data for dividends': '调整股息数据',
  'Main symbol data is adjusted for dividends only': '主要商品数据仅针对股息进行调整',
  'Main symbol data is adjusted for splits only': '主要商品数据仅针对拆分进行调整',
  'b-adj_adjustments': 'b-调整',
  'Adjust for contract changes': '调整合同变更',
  set_adjustments: '清算价',
  'Use settlement as close on daily interval': '使用结算价作为每日周期的收盘价',
  'Date Range': '日期范围',
  'change session': '更改交易时段',
  Session: '时段',
  Sessions: '交易时段',
  'Weak Magnet': '弱磁铁',
  'Strong Magnet': '强磁铁',
  ...
  'Show Favorite Drawing Tools Toolbar': '显示收藏的绘图工具栏',
  Icon: '图标',
  Icons: '图标',
  ...
  Favorites: '收藏',
  'Favorite Indicators': '收藏指标',
  'You have no Favorites Indicators yet': '你目前没有收藏的指标',
  ...
  Ranges_interval_group_name: '范围',
  'Sync in layout': '同步到所有图表',
  Crosshair: '十字线',
  ...
  'change earnings visibility': '更改收益可见性',
  'change dividends visibility': '更改股息可见性',
  'change splits visibility': '更改拆分可见性',
  'change continuous contract switch visibility': '更改连续合约转换可见性',
  'show all ideas': '显示所有观点',
  'show ideas of followed users': '显示关注用户的观点',
  'show my ideas only': '仅显示我的观点',
  'change events visibility on chart': '更改图表上的事件可见性',
  'add this symbol to entire layout': '将此商品添加到整个布局',
  'add this indicator to entire layout': '将此指标添加到整个布局',
  'add this strategy to entire layout': '将此策略添加到整个布局',
  'add this financial metric to entire layout': '将此财务指标添加到整个布局',
  ...
  'Pinned to right scale (hidden)': '固定至右侧坐标（隐藏）',
  ...
  'Show dividends': '显示股利',
  'Show splits': '显示拆分',
  'Show continuous contract switch': '显示连续合约转换',
  'Show all ideas': '显示所有观点',
  'Show ideas of followed users': '显示关注用户的观点',
  ...
  'move left': '向左移动',
  'move right': '向右移动',
  'change price to bar ratio': '更改价格K线比',
  'toggle lock scale': '切换锁定坐标',
  'change series style': '更改系列样式',
  'hide {title}': '隐藏{title}',
  'Invalid symbol': '无效的商品代码',
  'No data here': '这里没有数据',
  'apply indicators to entire layout': '将指标应用于整个布局',
  'sync time': '同步时间',
  'resize layout': '调整布局大小',
  'reset layout sizes': '重置布局大小',
  'apply chart theme': '应用图表主题',
  'Please give us a clipboard writing permission in your browser or press {keystroke}':
    '请在您的浏览器中向我们提供剪贴板写入权限，或按{keystroke}',
  "Couldn't copy": '无法复制',
  "Couldn't cut": '无法剪切',
  "Couldn't paste": '无法粘贴',
  '{userName} published on {customer}, {date}': '{userName}发表于{customer}，{date}',
  'Published on {customer}, {date}': '发表于{customer}，{date}',
  'change symbol last value visibility': '更改商品最后一个值的可见性',
  'change symbol previous close value visibility': '更改商品前一个收盘价的可见性',
  'change previous close price line visibility': '更改前一个收盘价线的可见性',
  'change symbol labels visibility': '更改商品标签可见性',
  'change indicators and financials name labels visibility': '更改指标和财务名称标签可见性',
  'change indicators name labels visibility': '更改指标名称标签可见性',
  'change indicators and financials value labels visibility': '更改指标和财务值标签可见性',
  'change indicators value labels visibility': '更改指标值标签可见性',
  'change bid and ask labels visibility': '更改bid和ask标签的可见性',
  'change bid and ask lines visibility': '更改bid和ask线的可见性',
  'change pre/post market price label visibility': '更改盘前/盘后价格标签的可见性',
  'change high and low price lines visibility': '更改高低价线的可见性',
  'change high and low price labels visibility': '更改高低价标签的可见性',
  'change countdown to bar close visibility': '更改倒计时到K线关闭的可见性',
  'change plus button visibility': '更改加号按钮的可见性',
  'change price line visibility': '更改价格线可见性',
  'unlock {title}': '解锁{title}',
  'lock {title}': '锁定{title}',
  ...
  'Indicators and financials value labels': '指标和财务值标签',
  'Indicators value labels': '指标值标签',
  'Indicators and financials name labels': '指标和财务名称标签',
  'Indicators name labels': '指标名称标签',
  ...
  Mixed: '混合的',
  'show {title}': '显示{title}',
  'Hide Favorite Drawing Tools Toolbar': '隐藏收藏的绘图工具栏',
  'Market open': '开市',
  'Pre-market': '盘前时段',
  'Post-market': '盘后时段',
  'Market closed': '休市',
  'Exchange timezone': '交易所时区',
  Image: '图片',
  Transparency: '透明度',
  'change symbol description visibility': '更改商品描述可见性',
  'change open market status visibility': '更改开市状态可见性',
  'change OHLC values visibility': '更改OHLC值的可见性',
  'change bar change visibility': '更改K线涨跌可见性',
  'change indicator titles visibility': '更改指标标题可见性',
  'change indicator arguments visibility': '更改指标参数可见性',
  'change indicator values visibility': '更改指标值的可见性',
  'change volume values visibility': '更改成交量值的可见性',
  'Open market status': '开市状态',
  'OHLC values': '开高低收',
  ...
  'Show interval settings': '显示周期设置',
  'Flag Symbol': '标记代码',
  'Unflag Symbol': '未标记代码',
  'change line tool(s) font size': '更改线条工具字体大小',
  'change line tool(s) line style': '更改线条工具的线条样式',
  'Font size': '字体大小',
  'Template name': '模板名称',
  ...
  'Manage panes': '管理窗格',
  scroll: '滚动',
  'Lock vertical cursor line by time': '按时间锁定垂直光标线',
  'change no overlapping labels': '更改不重叠的标签',
  ...
  'Invert scale_scale_menu': '翻转坐标',
  'Status line': '状态行',
  Appearance: '外观',
  money: '资金',
  pips: '点数',
  'Ticker and description': '商品和描述',
  'change chart background color': '更改图表背景颜色',
  'change chart background type': '更改图表背景类型',
  'change vert grid lines color': '更改垂直网格线颜色',
  'change vert grid lines style': '更改垂直网格线样式',
  'change horz grid lines color': '更改水平网格线颜色',
  'change horz grid lines style': '更改水平网格线样式',
  'change sessions breaks visibility': '更改交易时段分隔可见性',
  'change sessions breaks color': '更改交易时段分隔颜色',
  'change sessions breaks width': '更改交易时段分隔宽度',
  'change sessions breaks style': '更改交易时段分隔样式',
  'change scales text color': '更改坐标文本颜色',
  'change scales font size': '更改坐标字体大小',
  'change scales lines color': '更改坐标线条颜色',
  'change pane separators color': '更改窗格分隔符颜色',
  'change crosshair color': '更改十字准线颜色',
  'change crosshair width': '更改十字准线宽度',
  'change crosshair style': '更改十字准线样式',
  'change symbol watermark visibility': '更改商品水印可见性',
  'change symbol watermark color': '更改商品水印颜色',
  'change navigation buttons visibility': '更改导航按钮可见性',
  'change pane buttons visibility': '更改窗格按钮可见性',
  'change top margin': '更改上边距',
  'change bottom margin': '更改下边距',
  'change right margin': '更改右边距',
  'Vert grid lines': '垂直网格线',
  'Horz grid lines': '水平网格线',
  'Scales text': '坐标文字',
  'Scales lines': '坐标线',
  'Pane separators': '窗格分隔符',
  Watermark: '水印',
  'Top margin': '上边距',
  ...
  'Right margin': '右边距',
  bars_unit: '根K线',
  'change price Y coordinate': '更改价格Y坐标',
  'change bar X coordinate': '更改K线X坐标',
  'change {title} visibility on ticks': '更改{title}在tick图上的可见性',
  'change {title} visibility on seconds': '更改{title}在秒图上的可见性',
  'change {title} seconds from': '更改{title}秒图从',
  'change {title} seconds to': '更改{title}秒图到',
  'change {title} visibility on minutes': '更改{title}在分钟图上的可见性',
  'change {title} minutes from': '更改{title}分钟图从',
  'change {title} minutes to': '更改{title}分钟图到',
  'change {title} visibility on hours': '更改{title}在小时图上的可见性',
  'change {title} hours from': '更改{title}小时图从',
  'change {title} hours to': '更改{title}小时图到',
  'change {title} visibility on days': '更改{title}在日图上的可见性',
  'change {title} days from': '更改{title}日图从',
  'change {title} days to': '更改{title}日图到',
  'change {title} visibility on weeks': '更改{title}在周图上的可见性',
  'change {title} weeks from': '更改{title}周图从',
  'change {title} weeks to': '更改{title}周图到',
  'change {title} visibility on months': '更改{title}在月图上的可见性',
  'change {title} months from': '更改{title}月图从',
  'change {title} months to': '更改{title}月图到',
  'change {title} visibility on ranges': '更改{title}在范围图上的可见性',
  Seconds: '秒',
  Minutes: '分钟',
  Hours: '小时',
  Days: '日',
  ...
  'months to': '月到',
  ranges: '范围',
  'change symbol legend format': '更改商品图例格式',
  'change legend background visibility': '更改图例背景可见性',
  'change legend background transparency': '更改图例背景透明度',
  'change {title} price label visibility': '更改{title}价格标签可见性',
  'change {title} extension': '更改{title}扩展名',
  'change {title} time label visibility': '更改{title}时间标签可见性',
  'Price label': '价格标签',
  'Time label': '时间标签',
  Extend: '延伸',
  'change symbol last value mode': '更改商品最新值模式',
  'change currency label visibility': '更改货币标签可见性',
  'change unit label visibility': '更改单位标签可见性',
  'change currency and unit labels visibility': '更改货币和单位标签的可见性',
  'change date format': '更改日期格式',
  Unit: '单位',
  'Currency and Unit': '货币和单位',
  ...
  'lines style': '线条样式',
  'lines color': '线条颜色',
  'backgrounds color': '背景颜色',
  'backgrounds filled': '背景填充',
  'text color': '文字颜色',
  Text: '内容',
  'change {inputName} property': '更改{inputName}属性',
  'change color bars based on previous close': '根据前一个收盘价更改K线颜色',
  'change HLC bars': '更改美国线',
  'change bar up color': '更改上涨K线颜色',
  'change bar down color': '更改K线下跌颜色',
  'change thin bars': '更改细K线',
  'change line price source': '更改线条价格来源',
  'change line type': '更改线条类型',
  'change line color': '更改线条颜色',
  'change line width': '更改线条宽度',
  'change area price source': '更改面积价格来源',
  'change area line color': '更改面积线条颜色',
  'change area line width': '更改面积线条宽度',
  'change area fill color': '更改面积填充颜色',
  'change baseline price source': '更改基准线价格来源',
  'change baseline top line color': '更改基准线顶线颜色',
  'change baseline top line width': '更改基准线顶线宽度',
  'change baseline bottom line color': '更改基准线底线颜色',
  'change baseline bottom line width': '更改基准线底线宽度',
  'change baseline fill top area color': '更改基准线填充顶部区域颜色',
  'change baseline fill bottom area color': '更改基准线填充底部区域颜色',
  'change base level': '更改基础水平',
  'change high-low body visibility': '更改高-低实体可见性',
  'change high-low body color': '更改高-低实体颜色',
  'change high-low borders visibility': '更改高-低边框可见性',
  'change high-low border color': '更改高-低边框颜色',
  'change high-low labels visibility': '更改高-低标签可见性',
  'change high-low labels color': '更改高-低标签颜色',
  'change high-low labels font size': '更改高-低标签字体大小',
  'change renko wick visibility': '更改renko影线的可见性',
  'change renko wick up color': '更改renko下影线颜色',
  'change renko wick down color': '更改renko下影线颜色',
  'change the display of real prices on price scale (instead of Heiken-Ashi price)':
    '更改价格坐标上的实际价格显示（而不是Heiken-Ashi价格）',
  'change range thin bars': '更改范围细K线',
  'change {candleType} body visibility': '更改{candleType}实体可见性',
  'change {candleType} up color': '更改{candleType}上涨颜色',
  'change {candleType} down color': '更改{candleType}向下颜色',
  'change {candleType} border visibility': '更改{candleType}边框可见性',
  'change {candleType} up border color': '更改{candleType}上边框颜色',
  'change {candleType} down border color': '更改{candleType}下边框颜色',
  'change {candleType} wick visibility': '更改{candleType}影线的可见性',
  'change {candleType} wick up color': '更改{candleType}上影线颜色',
  'change {candleType} wick down color': '更改{candleType}下影线颜色',
  'change {chartType} up color': '更改{chartType}上涨颜色',
  'change {chartType} down color': '更改{chartType}向下颜色',
  'change {chartType} projection bar up color': '更改{chartType}投影K线上涨颜色',
  'change {chartType} projection bar down color': '更改{chartType}投影K线下跌颜色',
  'change {chartType} border bar up color': '更改{chartType}边框K线上涨颜色',
  'change {chartType} border bar down color': '更改{chartType}边框K线下跌颜色',
  'change {chartType} projection border bar up color': '更改{chartType}投影边框K线上涨颜色',
  'change column up color': '更改向上列的颜色',
  'change column down color': '更改向下列的颜色',
  'change column price source': '更改列价格来源',
  'Thin bars': '细K线',
  'Top line': '上边框线',
  'Bottom line': '下边框线',
  'Fill top area': '上填充色',
  'Fill bottom area': '下填充色',
  'Real prices on price scale (instead of Heikin-Ashi price)': '价格坐标上的实际价格（而不是Heikin-Ashi价格）',
  'Base level': '基准位',
  candle: '蜡烛',
  range_0: '范围',
  'hollow candles': '空心K线图',
  Center: '中心',
  'change {title} middle point visibility': '更改{title}中点可见性',
  'change {title} price labels visibility': '更改{title}价格标签可见性',
  'change {title} price range visibility': '更改{title}价格范围可见性',
  'change {title} bars range visibility': '更改{title}K线范围可见性',
  'change {title} date/time range visibility': '更改{title}日期/时间范围可见性',
  'change {title} distance visibility': '更改{title}距离可见性',
  'change {title} angle visibility': '更改{title}角度可见性',
  'change {title} always show stats': '更改{title}总是显示统计信息',
  'change {title} stats position': '更改{title}统计信息位置',
  'Middle point': '中点',
  'Price labels': '价格标签',
  'Stats position': '统计位置',
  'Price range': '价格范围',
  ...
  Stats: '统计数据',
  'change {toolName} line visibility': '更改{toolName}线条可见性',
  'change {toolName} line width': '更改{toolName}线条宽度',
  'change {toolName} line style': '更改{toolName}线条样式',
  'change {toolName} line color': '更改{toolName}线条颜色',
  'change {toolName} line extending left': '更改{toolName}线条向左延伸',
  'change {toolName} line left end': '更改{toolName}线条左端',
  'change {toolName} line extending right': '更改{toolName}线条向右延伸',
  'change {toolName} line right end': '更改{toolName}线条右端',
  'Extend left line': '延伸左边线条',
  'Extend right line': '延伸右边线条',
  'change {toolName} text visibility': '更改{toolName}文本可见性',
  'change {toolName} text color': '更改{toolName}文本颜色',
  'change {toolName} text font size': '更改{toolName}文本字体大小',
  'change {toolName} text font bold': '更改{toolName}文本字体加粗',
  'change {toolName} text font italic': '更改{toolName}文本字体斜体',
  'change {toolName} text': '更改{toolName}文本',
  'change {toolName} labels alignment vertical': '更改{toolName}标签垂直对齐',
  'change {toolName} labels alignment horizontal': '更改{toolName}标签水平对齐',
  'change {toolName} labels direction': '更改{toolName}标签方向',
  'change {toolName} text background visibility': '更改{toolName}文本背景可见性',
  'change {toolName} text background color': '更改{toolName}文本背景颜色',
  'change {toolName} text border visibility': '更改{toolName}文本边框可见性',
  'change {toolName} text border width': '更改{toolName}文本边框宽度',
  'change {toolName} text border color': '更改{toolName}文本边框颜色',
  'change {toolName} text wrap': '更改{toolName}文本换行',
  'Text wrap': '文本换行',
  'change arrow color': '更改箭头颜色',
  'change {title} color': '更改{title}颜色',
  'change {title} mode': '更改{title}模式',
  'change {title} mirrored': '更改{title}镜像',
  'change {title} flipped': '更改{title}翻转',
  Mode: '模式',
  Mirrored: '镜像',
  Flipped: '翻转',
  'HL bars': 'HL Bars',
  ...
  'Line - high': 'Line - High',
  'Line - low': 'Line - Low',
  'change {title} background visibility': '更改{title}背景可见性',
  'change {title} background color': '更改{title}背景颜色',
  'change {title} degree': '更改{title}角度',
  Wave: '波浪',
  Degree: '级别',
  'change {title} level {index} line visibility': '更改{title}水平{index}线可见性',
  'change {title} levels visibility': '更改{title}水平可见性',
  'change {title} level {index} line color': '更改{title}水平{index}线颜色',
  'change {title} level {index} line width': '更改{title}水平{index}线宽度',
  'change {title} level {index} line coeff': '更改{title}水平{index}线系数',
  'change {title} all lines color': '更改{title}所有线条颜色',
  'change {title} background transparency': '更改{title}背景透明度',
  'change {title} coeffs as percents visibility': '更改{title}系数为百分比可见性',
  'Trend line': '趋势线',
  'Use one color': '使用一种颜色',
  Levels: '水平位',
  'Coeffs as percents': 'Coeffs As Percents',
  'change {title} reverse': '更改{title}翻转',
  'change {title} prices visibility': '更改{title}价格可见性',
  'change {title} labels alignment': '更改{title}标签对齐方式',
  'change {title} labels font size': '更改{title}标签字体大小',
  'change {title} style': '更改{title}样式',
  'change {title} fib levels based on log scale': '在对数坐标上更改{title}斐波那契水平',
  'Levels line': '水平线',
  'Extend right': '向右延伸',
  'Extend left': '向左延伸',
  ...
  Middle: '中间',
  Bottom: '底部',
  'change {title} full circles visibility': '更改{title}完整圆圈的可见性',
  'Full circles': '完整圆圈',
  'change {title} left labels visibility': '更改{title}左侧标签可见性',
  'change {title} right labels visibility': '更改{title}右侧标签可见性',
  'change {title} top labels visibility': '更改{title}顶部标签可见性',
  'change {title} bottom labels visibility': '更改{title}底部标签可见性',
  'change {title} grid visibility': '更改{title}网格可见性',
  'change {title} grid line color': '更改{title}网格线颜色',
  'change {title} grid line width': '更改{title}网格线宽度',
  'change {title} grid line style': '更改{title}网格线样式',
  'Price levels': '价格位',
  'Time levels': '时间水平',
  'Left labels': '左标签',
  'Right labels': '右标签',
  'Top labels': '顶标签',
  'Bottom labels': '底标签',
  'change {title} line color': '更改{title}线条颜色',
  'change {title} line width': '更改{title}线条宽度',
  'change {title} line style': '更改{title}线条样式',
  'change {title} counterclockwise': '更改{title}逆时针',
  Counterclockwise: '逆时针方向',
  'change {title} level {index} line style': '更改{title}水平{index}线样式',
  'change {title} labels visibility': '更改{title}标签可见性',
  'change flag color': '更改标志颜色',
  'change {title} fan {index} line visibility': '更改{title}扇形{index}线条可见性',
  'change {title} fan {index} line color': '更改{title}扇形{index}线条颜色',
  'change {title} fan {index} line width': '更改{title}扇形{index}线条宽度',
  'change {title} arcs {index} line visibility': '更改{title}弧形{index}线条可见性',
  'change {title} arcs {index} line color': '更改{title}弧形{index}线条颜色',
  'change {title} arcs {index} line width': '更改{title}弧形{index}线条宽度',
  'Price/bar ratio': '价格K线比',
  'Ranges and ratio': '范围和比例',
  Fans: '扇形',
  Arcs: '弧形',
  'change {title} fans visibility': '更改{title}扇形可见性',
  'change {title} fans line color': '更改{title}扇形线颜色',
  Angles: '角度',
  'change {title} extend top': '更改{title}延长顶部',
  'change {title} extend bottom': '更改{title}延长底部',
  'change {title} extend left': '更改{title}延长左边',
  'Extend top': '向上延伸',
  'Extend bottom': '向下延伸',
  Label: '标签',
  'Label background': '标签背景',
  'change {title} candle up color': '更改{title}K线上涨颜色',
  'change {title} candle down color': '更改{title}K线下跌颜色',
  'change {title} candle border visibility': '更改{title}K线边框可见性',
  'change {title} candle border up color': '更改{title}K线边框上涨颜色',
  'change {title} candle border down color': '更改{title}K线边框下跌颜色',
  'change {title} candle wick visibility': '更改{title}K线影线的可见性',
  'change {title} candle wick color': '更改{title}K线影线颜色',
  'change {title} transparency': '更改{title}透明度',
  'change {title} average HL value': '更改{title}平均HL值',
  'change {title} variance value': '更改{title}方差值',
  'Avg HL in minticks': '最小刻度的高低平均价',
  Variance: '方差',
  '#1 (price)_linetool point': '#1(价格)',
  '#{count} (price, bar)_linetool point': '#{count}（价格，K线）',
  'change {title} extending left': '更改{title}向左延伸',
  'change {title} extending right': '更改{title}向右延伸',
  Channel: '通道',
  'change {title} extend lines': '更改{title}延长线',
  Median: '中线',
  'Extend lines': '延长线',
  Original: '原始',
  Schiff: '希夫',
  ...
  Inside: '内部',
  'change {title} source text color': '更改{title}源文本颜色',
  'change {title} source background color': '更改{title}源背景颜色',
  'change {title} source border color': '更改{title}源边框颜色',
  'change {title} target text color': '更改{title}目标文本颜色',
  'change {title} target background color': '更改{title}目标背景颜色',
  'change {title} target border color': '更改{title}目标边框颜色',
  'change {title} success text color': '更改{title}成功文本颜色',
  'change {title} success background color': '更改{title}成功背景颜色',
  'change {title} failure text color': '更改{title}失败文本颜色',
  'change {title} failure background color': '更改{title}失败背景颜色',
  'Source text': '来源文字',
  ...
  'Line color': '线条颜色',
  'Label border': '标签边框',
  'change {title} background color 1': '更改{title}背景颜色1',
  'change {title} background color 2': '更改{title}背景颜色2',
  'change {title} stop color': '更改{title}止损颜色',
  'change {title} target color': '更改{title}目标颜色',
  'change {title} compact stats mode': '更改{title}紧凑统计模式',
  'change {title} account size': '更改{title}帐户大小',
  'change {title} lot size': '更改{title}手数大小',
  'change {title} risk': '更改{title}风险',
  'change {title} risk display mode': '更改{title}风险显示模式',
  'change {title} entry price': '更改{title}入场价格',
  'change {title} profit level': '更改{title}止盈水平',
  'change {title} profit price': '更改{title}止盈价格',
  'change {title} stop level': '更改{title}止损水平',
  'change {title} stop price': '更改{title}止损价格',
  'Stop color': '止损颜色',
  'Target color': '目标颜色:',
  ...
  'Lot size': '手数',
  Cash: '现金',
  'change vertical position Y coordinate': '更改垂直位置Y坐标',
  'change {title} emoji visibility': '更改{title}表情符号可见性',
  'change {title} image background color': '更改{title}图像背景颜色',
  'change {title} emoji': '更改{title}表情符号',
  '#1 (vertical position %, bar)_linetool point': '#1（垂直位置%，K线）',
  'Emoji pin': '表情符号',
  'change angle': '更改角度',
  '#1 (price, bar)_linetool point': '#1(价格, K线)',
  '#1 (bar)_linetool point': '#1 (K线)',
  'change decimal places': '更改小数位',
  'change extended hours color': '更改延长时段颜色',
  'change pre market color': '更改盘前市场颜色',
  'change post market color': '更改盘后市场颜色',
  'change price line color': '更改价格线颜色',
  'change price line width': '更改价格线宽度',
  'change previous close price line color': '更改前一根收盘价线颜色',
  'change previous close price line width': '更改前一根收盘价线宽度',
  'change pre/post market price lines visibility': '更改盘前/盘后市场价格线的可见性',
  'change pre market line color': '更改盘前市场线条颜色',
  'change post market line color': '更改盘后市场线条颜色',
  'change bid line color': '更改bid线颜色',
  'change ask line color': '更改ask线颜色',
  ...
  Step: '阶梯',
  Default: '系统预设',
  'change {title} base line visibility': '更改{title}基准线可见性',
  'change {title} base line color': '更改{title}基准线颜色',
  'change {title} base line width': '更改{title}基准线宽度',
  'change {title} base line style': '更改{title}基准线样式',
  'change {title} up line visibility': '更改{title}向上线条可见性',
  'change {title} up line color': '更改{title}向上线条颜色',
  'change {title} up line width': '更改{title}向上线条宽度',
  'change {title} up line style': '更改{title}向上线条样式',
  'change {title} down line visibility': '更改{title}向下线条可见性',
  'change {title} down line color': '更改{title}向下线条颜色',
  'change {title} down line width': '更改{title}向下线条宽度',
  'change {title} down line style': '更改{title}向下线条样式',
  "change {title} show pearson's r": "更改{title}显示pearson's r",
  Base: '基准线',
  Up: '上',
  Down: '下',
  "Pearson's R": '相关系数',
  '#{count} (bar)_linetool point': '#{count}（K线）',
  'change study overlay style': '更改研究覆盖样式',
  'change study overlay min tick': '更改研究覆盖最小tick',
  'Override min tick': '覆盖最小tick',
  Horizontal: '横式',
  Vertical: '竖式',
  'Text alignment': '文字对齐',
  'Text orientation': '文字方向',
  'change {propertyName} property': '更改{propertyName}属性',
  Offset: '偏移',
  ...
  ohlc4: '(o+h+l+c)/4',
  Outputs: '输出',
  'change thickness': '更改厚度',
  'change color': '更改颜色',
  'change opacity': '更改不透明度',
  'change font size': '更改字体大小',
  'change line style': '更改线条样式',
  'change min tick': '更改最小tick',
  'change precision': '更改精度',
  'Above bar': '列上',
  'Below bar': 'Bar下方',
  'change value': '更改数值',
  'change char': '更改字符',
  ...
  'change values visibility': '更改值的可见性',
  'Width (% of the box)': '宽度(Box的%)',
  Placement: '配置',
  'Trades on chart': '图表上的交易',
  'Signal labels': '信号标签',
  Quantity: '数量',
  'change plot type': '更改绘图类型',
  'Labels font': '标签字体',
  'change shape': '更改形状',
  'Volume profile': '成交量分布图(VP)',
  'Developing VA': '发展数值区(VA)',
  'Values in status line': '状态行中的值',
  'Labels on price scale': '价格坐标上的标签',
  Forecast: '预测',
  'Script name': '脚本名称',
  ...
  'less than 1 minute': '少于1分钟',
  '{days} and {hours}': '{days}和{hours}',
  '{hours} and {minutes}': '{hours}和{minutes}',
  'Market opens in {remainingTime}.': '市场在{remainingTime}后开盘。',
  'Market closes in {remainingTime}.': '市场在{remainingTime}后收盘。',
  "It'll go to post-market trading in {remainingTime}.": '它将在{remainingTime}后进入盘后交易。',
  "It'll open for pre-market trading in {remainingTime}.": '它将在{remainingTime}开市进行盘前交易。',
  'Replay mode': '回放模式',
  "You're in Replay mode. You're in Replay mode. You're in Replay mode.":
    '您处于回放模式。您处于回放模式。您处于回放模式。',
  ...
  'insert {title} after {target}': '在{target}之后插入{title}',
  'insert {title} before {target}': '在{target}之前插入{title}',
  'cut {title}': '剪切{title}',
  'cut sources': '剪切源',
  'remove {title}': '移除{title}',
  'remove drawings group': '移除绘图集',
  'move scale': '移动坐标',
  'stop syncing line tool(s)': '停止同步线条工具',
  'zoom out': '缩小',
  'zoom in': '放大',
  'move drawing(s)': '移动绘图（多图形）',
  'load default drawing template': '加载默认绘图模板',
  ...
  'unmerge up': '取消向上合并',
  'unmerge down': '取消向下合并',
  'unmerge to new bottom pane': '取消合并到新的底部窗格',
  'move {title} to new right scale': '移动{title}到新的右坐标',
  'move {title} to new left scale': '移动{title}到新的左坐标',
  'make {title} no scale (Full screen)': '使{title}无坐标（全屏）',
  'scroll time': '滚动时间',
  'scale time': '缩放时间',
  'reset time scale': '重置时间坐标',
  'reset scales': '重置坐标',
  'create {tool}': '创建{tool}',
  'change {pointIndex} point': '更改{pointIndex}点',
  'paste {title}': '粘贴{title}',
  'insert {title}': '插入{title}',
  'remove all studies': '删除所有的研究',
  'remove drawings': '移除绘图',
  'remove all studies and drawing tools': '删除所有的研究及绘图工具',
  'turn line tools sharing off': '关闭线条工具分享',
  'share line tools in layout': '在布局中分享线条工具',
  'share line tools globally': '全局分享线条工具',
  'apply all chart properties': '应用所有图表属性',
  ...
  'removing line tools group {name}': '删除线条工具组{name}',
  'add line tool {lineTool} to group {name}': '将划线工具{lineTool}添加到组{name}',
  'make group {group} visible': '使组{group}可见',
  'make group {group} invisible': '使{group} 组隐藏',
  'lock group {group}': '锁定组{group}',
  'unlock group {group}': '解锁组{group}',
  'rename group {group} to {newName}': '更改组{group} 至{newName}',
  'change {sourceTitle} title to {newSourceTitle}': '将{sourceTitle}标题更改为{newSourceTitle}',
  'insert source(s) after': '插入源到后面',
  'mirror bars pattern': '镜像K线形态',
  'flip bars pattern': '翻转K线形态',
  'change Elliott degree': '更改艾略特角度',
  ...
  'Ghost Feed': '模拟K线',
  '{status} P&L: {pnl}': '{status} 盈利&亏损: {pnl}',
  Open_line_tool_position: '开仓',
  Closed_line_tool_position: '已平仓',
  'Risk/Reward Ratio: {ratio}': '盈亏比: {ratio}',
  ...
  'Triangle Up': '上升三角形',
  'X Cross': 'X 交叉',
  Premarket_sessions: '盘前',
  Postmarket_sessions: '盘后',
  'Regular trading hours_sessions': '常规交易时间',
  'Extended trading hours_sessions': '延长交易时段',
  'Electronic trading hours_sessions': '电子交易时间',
  PRE_sessions: '前',
  POST_sessions: '后',
  RTH_sessions: 'RTH',
  ETH_sessions: 'ETH',
  'add line tool(s) to group {group}': '添加线条工具到组{group}',
  'apply study template {template}': '申请应用模板{template}',
  'change pane height': '更改窗格高度',
  'change date range': '更改日期范围',
  'apply toolbars theme': '应用工具栏主题',
  ...
  'paste drawing': '粘贴绘图',
  'paste indicator': '粘贴指标',
  'scale price': '坐标价格',
  'rearrange panes': '重新排列窗格',
  'remove line data sources': '删除线条数据源',
  'restore defaults': '恢复默认值',
  'change chart layout to {title}': '将图表布局更改为{title}',
  'stop syncing drawing': '停止同步绘图',
  zoom: '缩放',
  'bring {title} to front': '把{title}放在前面',
  'send {title} to back': '把{title}放在后面',
  'insert {title} after {targetTitle}': '在{targetTitle}之后插入{title}',
  'insert {title} before {targetTitle}': '在{targetTitle}之前插入{title}',
  'send group {title} backward': '向后发送组{title}',
  'bring group {title} forward': '向前发送组{title}',
  ...
  'Hide positions & orders': '隐藏仓位和订单',
  'Show all positions & orders': '显示所有仓位和订单',
  'Hide all positions & orders': '隐藏所有仓位和订单',
  'Hide all': '隐藏所有',
  'Show all drawings, indicators, positions & orders': '显示所有绘图、指标、仓位和订单',
  'Show all drawings and indicators': '显示所有绘图和指标',
  'Hide all drawings, indicators, positions & orders': '隐藏所有绘图、指标、仓位和订单',
  'Hide all drawings and indicators': '隐藏所有绘图和指标',
  'remove all line tools for {symbol}': '移除{symbol}的所有线条工具',
  ...
  'Object tree': '对象树',
  'Create a group of drawings': '建立一组绘图',
  'Clone, Copy': '克隆，复制',
  ...
  'Set the "{inputInline}" time and price for "{studyShortDescription}"':
    '为{studyShortDescription}设置{inputInline}时间和价格',
  'Set the time and price for "{studyShortDescription}"': '设置“{studyShortDescription}”的时间和价格',
  'Set the "{inputTitle}" time for "{studyShortDescription}"': '为{studyShortDescription}设置{inputTitle}时间',
  'Set the time for "{studyShortDescription}"': '设置“{studyShortDescription}”的时间',
  'Set the "{inputTitle}" price for "{studyShortDescription}"': '为{studyShortDescription}设置{inputTitle}价格',
  'Set the price for "{studyShortDescription}"': '设置“{studyShortDescription}”的价格',
  'Add Symbol': '添加品种',
  'Confirm Inputs': '确认参数',
  'Reset settings': '重置设置',
  ...
  'Apply defaults': '应用默认',
  'Apply Defaults': '应用默认',
  'apply factory defaults to selected sources': '将出厂默认设置应用于选定的源',
  'Selected Drawings': '已选绘图',
  Gradient: '渐变',
  'No results found': '未搜寻结果',
  'Add custom color_Color Picker': '添加自定义颜色',
