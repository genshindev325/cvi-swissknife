...
_tv_languages.th = {
  ...
  Comment: 'ความคิดเห็น',
  "Editors' picks": 'คัดสรรโดยบรรณาธิการ',
  ...
  'Double-click any edge to reset layout grid': 'คลิกสองครั้งที่ขอบใดก็ได้เพื่อรีเซ็ตเส้นตารางเลย์เอาต์',
  ...
  Ticker: 'ทิกเกอร์',
  Vol: 'ปริมาณ',
  'No symbols match your criteria': 'ไม่มีสัญลักษณ์ที่ตรงกับการค้นหาของคุณ',
  Close: 'ปิด',
  Time: 'เวลา',
  '{number} minute_0': '{number} นาที',
  m_interval_short: 'นาที',
  '{number} hour_0': '{number} ชั่วโมง',
  h_interval_short: 'h',
  '{number} day_0': '{number} วัน',
  D_interval_short: 'D',
  W_interval_short: 'W',
  M_interval_short: 'M',
  Rename: 'เปลี่ยนชื่อ',
  ...
  'Specified value is more than the instrument maximum of {max}.': 'ค่าที่ระบุมากกว่าค่าสูงสุดของเครื่องมือ {max}',
  'Specified value is less than the instrument minimum of {min}.': 'ค่าที่ระบุน้อยกว่าค่าต่ำสุดของเครื่องมือ {min}',
  Risk: 'ความเสี่ยง',
  Body: 'บอดี้',
  Wick: 'ไส้เทียน',
  Right: 'ขวา',
  ...
  "The data vendor doesn't provide volume data for this symbol.":
    'ผู้จำหน่ายข้อมูลไม่ได้ให้ข้อมูลปริมาณสำหรับสัญลักษณ์นี้',
  ...
  CCI_input: 'ซีซีไอ',
  'Smoothing Line_input': 'เส้นเรียบ',
  'Smoothing Length_input': 'ความยาวเรียบ',
  ...
  'Custom range': 'ระยะบาร์แบบกำหนดเอง',
  'Go to': 'ไปที่',
  ...
  'Open image in new tab': 'เปิดรูปภาพในแท็บใหม่',
  'Tweet chart image': 'ทวีตภาพชาร์ต',
  'adjust data for dividends': 'ปรับเปลี่ยนข้อมูลเนื่องจากเงินปันผล',
  'adjust for contract changes': 'ปรับตามการเปลี่ยนแปลงสัญญา',
  'toggle auto scale': 'สลับเป็นสเกลอัตโนมัติ',
  'toggle log scale': 'สลับเป็นมาตราส่วนล็อก',
  'toggle percentage scale': 'สลับเป็นหน่วยเปอร์เซ็นต์',
  'Take a snapshot': 'บันทึกภาพ',
  'use settlement as close on daily interval': 'ใช้การชำระราคาที่ใกล้เคียงกันในแต่ละวัน',
  ext: 'ต่อ',
  'Extended Hours is available only for intraday charts':
    'ชั่วโมงที่เพิ่มเติมขึ้นมาใช้ได้สำหรับกราฟแบบระหว่างวันเท่านั้น',
  ...
  adj_adjustments: 'adj',
  'Adjust data for dividends': 'ปรับเปลี่ยนข้อมูลเนื่องจากเงินปันผล',
  'Main symbol data is adjusted for dividends only': 'ข้อมูลสัญลักษณ์หลักถูกปรับเป็นเงินปันผลเท่านั้น',
  'Main symbol data is adjusted for splits only': 'ข้อมูลสัญลักษณ์หลักถูกปรับสำหรับการแยกเท่านั้น',
  'b-adj_adjustments': 'b-adj',
  'Adjust for contract changes': 'ปรับตามการเปลี่ยนแปลงสัญญา',
  set_adjustments: 'set',
  'Use settlement as close on daily interval': 'ใช้การชำระราคาที่ใกล้เคียงกันในแต่ละวัน',
  'Date Range': 'ช่วงวันที่',
  'change session': 'เปลี่ยนเซสชั่น',
  Session: 'โซนเวลา',
  Sessions: 'เซสชั่น',
  ...
  'Sync in layout': 'ซิงค์ไปทุกชาร์ต',
  ...
  'show alert label lines': 'แสดงเส้นป้ายเตือน',
  ...
  'pin to right scale': 'ปักหมุดไปยังสเกลทางขวา',
  'pin to left scale': 'ปักหมุดไปยังสเกลทางซ้าย',
  'change earnings visibility': 'เปลี่ยนการมองเห็นรายได้',
  'change dividends visibility': 'เปลี่ยนการมองเห็นเงินปันผล',
  'change splits visibility': 'เปลี่ยนตัวแบ่งการมองเห็น',
  'change continuous contract switch visibility': 'เปลี่ยนการมองเห็นสวิตช์สัญญาต่อเนื่อง',
  'show all ideas': 'แสดงไอเดียทั้งหมด',
  'show ideas of followed users': 'แสดงไอเดียของผู้ใช้งานที่ติดตาม',
  'show my ideas only': 'แสดงเฉพาะไอเดียของฉันเท่านั้น',
  'change events visibility on chart': 'เปลี่ยนการมองเห็นเหตุการณ์บนชาร์ต',
  ...
  'apply drawing template': 'ใช้เทมเพลตการวาดภาพ',
  'lock objects': 'ล็อคออบเจ็กต์',
  'unlock objects': 'ปลดล็อคออบเจ็กต์',
  ...
  'Pinned to right scale (hidden)': 'ปักหมุดไปยังสเกลขวา (แบบซ่อน)',
  ...
  'Show continuous contract switch': 'แสดงสวิตช์สัญญาต่อเนื่อง',
  'Show all ideas': 'แสดงไอเดียทั้งหมด',
  ...
  'Sync globally': 'เชื่อมต่อกันทั่วโลก',
  'Symbol info': 'ข้อมูลสัญลักษณ์',
  Paste: 'วาง',
  'Copy price': 'คัดลอกราคา',
  ...
  'change price to bar ratio': 'เปลี่ยนอัตราส่วนราคาต่อบาร์',
  'toggle lock scale': 'สลับสเกลล็อค',
  'change series style': 'เปลี่ยนสไตล์ซีรีส์',
  'hide {title}': 'ซ่อน {title}',
  'Invalid symbol': 'ชื่อย่อสินทรัพย์ไม่ถูกต้อง',
  'No data here': 'ไม่มีข้อมูลที่นี่',
  'apply indicators to entire layout': 'ใช้อินดิเคเตอร์กับเลย์เอาต์ทั้งหมด',
  'sync time': 'ซิงค์เวลา',
  'resize layout': 'ปรับขนาดเค้าโครง',
  'reset layout sizes': 'รีเซ็ตขนาดเลย์เอาต์',
  'apply chart theme': 'ใช้ชุดรูปแบบชาร์ต',
  ...
  "Couldn't copy": 'ไม่สามารถคัดลอกได้',
  "Couldn't cut": 'ไม่สามารถตัดได้',
  "Couldn't paste": 'ไม่สามารถวางได้',
  '{userName} published on {customer}, {date}': '{userName} เผยแพร่เมื่อ {customer}, {date}',
  'Published on {customer}, {date}': 'เผยแพร่เมื่อ {customer}, {date}',
  'change symbol last value visibility': 'เปลี่ยนสัญลักษณ์การมองเห็นค่าสุดท้าย',
  'change symbol previous close value visibility': 'เปลี่ยนสัญลักษณ์การมองเห็นมูลค่าปิดก่อนหน้า',
  'change previous close price line visibility': 'เปลี่ยนการมองเห็นเส้นราคาปิดก่อนหน้า',
  'change symbol labels visibility': 'เปลี่ยนการมองเห็นป้ายสัญลักษณ์',
  'change indicators and financials name labels visibility': 'เปลี่ยนอินดิเคเตอร์และการมองเห็นป้ายชื่อการเงิน',
  'change indicators name labels visibility': 'เปลี่ยนการมองเห็นป้ายชื่ออินดิเคเตอร์',
  'change indicators and financials value labels visibility': 'เปลี่ยนอินดิเคเตอร์และการมองเห็นฉลากมูลค่าทางการเงิน',
  'change indicators value labels visibility': 'เปลี่ยนอินดิเคเตอร์และการมองเห็นฉลาก',
  'change bid and ask labels visibility': 'เปลี่ยนการมองเห็นป้าย bid และ ask',
  'change bid and ask lines visibility': 'เปลี่ยนการมองเห็นเส้น bid และ ask',
  'change pre/post market price label visibility': 'เปลี่ยนการมองเห็นป้ายราคาตลาดก่อน/หลัง',
  'change high and low price lines visibility': 'เปลี่ยนการมองเห็นเส้นราคาสูง ต่ำ และเฉลี่ย',
  'change high and low price labels visibility': 'เปลี่ยนการมองเห็นป้ายราคาสูง ต่ำ และเฉลี่ย',
  'change countdown to bar close visibility': 'เปลี่ยนการนับถอยหลังเป็นบาร์ปิดการมองเห็น',
  'change plus button visibility': 'เปลี่ยนการมองเห็นปุ่มบวก',
  'change price line visibility': 'เปลี่ยนเส้นราคา',
  'unlock {title}': 'ปลดล็อก {title}',
  'lock {title}': 'ล็อค {title}',
  ...
  'Symbol previous day close price label': 'ป้ายค่าราคาปิดวันก่อนหน้าของตัวย่อ',
  'Previous day close price line': 'เส้นราคาปิดวันก่อนหน้า',
  'Symbol name label': 'ป้ายชื่อตัวย่อ',
  'Indicators and financials value labels': 'อินดิเคเตอร์และฉลากมูลค่าทางการเงิน',
  'Indicators value labels': 'อิดิเคเตอร์ฉลากมูลค่า',
  'Indicators and financials name labels': 'ป้ายชื่ออินดิเคเตอร์และการเงิน',
  'Indicators name labels': 'ป้ายชื่ออินดิเคเตอร์',
  ...
  'High and low price lines': 'เส้นราคาสูง ต่ำ และกลาง',
  ...
  'Exchange timezone': 'เขตเวลาตลาดหลักทรัพย์',
  Image: 'รูปภาพ',
  Transparency: 'โปร่งแสง',
  'change symbol description visibility': 'เปลี่ยนการมองเห็นคำอธิบายสัญลักษณ์',
  'change open market status visibility': 'เปลี่ยนการมองเห็นสถานะตลาดเปิด',
  'change OHLC values visibility': 'เปลี่ยนการมองเห็นค่า OHLC',
  'change bar change visibility': 'เปลี่ยนการมองเห็นการเปลี่ยนบาร์',
  'change indicator titles visibility': 'เปลี่ยนการมองเห็นชื่ออินดิเคเตอร์',
  'change indicator arguments visibility': 'เปลี่ยนการมองเห็นอาร์กิวเมนต์อินดิเคเตอร์',
  'change indicator values visibility': 'เปลี่ยนการมองเห็นค่าอินดิเคเตอร์',
  'change volume values visibility': 'เปลี่ยนการมองเห็นค่าวอลุ่ม',
  'Open market status': 'สถานะตลาดเปิด',
  ...
  'Show interval settings': 'แสดงการตั้งค่าช่วงเวลา',
  'Flag Symbol': 'ปักธงสัญลักษณ์',
  'Unflag Symbol': 'ยกเลิกปักธงสัญลักษณ์',
  'change line tool(s) font size': 'เปลี่ยนขนาดตัวอักษรของเครื่องมือเส้น',
  'change line tool(s) line style': 'เปลี่ยนรูปแบบเส้นของเครื่องมือเส้น',
  ...
  'Collapse pane': 'ยุบบานหน้าต่าง',
  'Manage panes': 'จัดการหน้าต่าง',
  scroll: 'เลื่อน',
  'Lock vertical cursor line by time': 'ล็อคเส้นเคอร์เซอร์แนวตั้งตามเวลา',
  'change no overlapping labels': 'เปลี่ยนป้ายไม่ทับซ้อนกัน',
  ...
  'change chart background color': 'เปลี่ยนสีพื้นหลังชาร์ต',
  'change chart background type': 'เปลี่ยนประเภทพื้นหลังของชาร์ต',
  'change vert grid lines color': 'เปลี่ยนสีเส้นกริดแนวตั้ง',
  'change vert grid lines style': 'เปลี่ยนรูปแบบเส้นกริดแนวตั้ง',
  'change horz grid lines color': 'เปลี่ยนสีเส้นกริดแนวนอน',
  'change horz grid lines style': 'เปลี่ยนรูปแบบเส้นกริดแนวนอน',
  'change sessions breaks visibility': 'เปลี่ยนการมองเห็นตัวแบ่งเซสชั่น',
  'change sessions breaks color': 'เปลี่ยนสีตัวแบ่งเซสชั่น',
  'change sessions breaks width': 'เปลี่ยนความกว้างตัวแบ่งเซสชั่น',
  'change sessions breaks style': 'เปลี่ยนรูปแบบตัวแบ่งเซสชั่น',
  'change scales text color': 'เปลี่ยนสีสเกลข้อความ',
  'change scales font size': 'เปลี่ยนขนาดสเกลตัวอักษร',
  'change scales lines color': 'เปลี่ยนสีสเกลเส้น',
  'change pane separators color': 'เปลี่ยนสีตัวคั่นบานหน้าต่าง',
  'change crosshair color': 'เปลี่ยนสีเส้นเส้นตัด',
  'change crosshair width': 'เปลี่ยนความกว้างเส้นตัด',
  'change crosshair style': 'เปลี่ยนรูปแบบเส้นตัด',
  'change symbol watermark visibility': 'เปลี่ยนการมองเห็นสัญลักษณ์ลายน้ำ',
  'change symbol watermark color': 'เปลี่ยนสีสัญลักษณ์ลายน้ำ',
  'change navigation buttons visibility': 'เปลี่ยนการมองเห็นปุ่มนำทาง',
  'change pane buttons visibility': 'เปลี่ยนการมองเห็นปุ่มหน้าต่างเสริม',
  'change top margin': 'เปลี่ยนระยะขอบด้านบน',
  'change bottom margin': 'เปลี่ยนระยะขอบด้านล่าง',
  'change right margin': 'เปลี่ยนระยะขอบด้านขวา',
  'Vert grid lines': 'เส้นกริดแนวตั้ง',
  'Horz grid lines': 'เส้นกริดแนวนอน',
  'Scales text': 'ตัวหนังสือของสเกล',
  'Scales lines': 'เส้นของสเกล',
  'Pane separators': 'ตัวแยกบานหน้าต่าง',
  Watermark: 'ลายน้ำ',
  'Top margin': 'ระยะขอบด้านบน',
  'Navigation buttons': 'ปุ่มนำทาง',
  'Pane buttons': 'ปุ่มหน้าต่างเสริม',
  'Bottom margin': 'ระยะขอบด้านล่าง',
  'Right margin': 'ระยะขอบด้านขวา',
  bars_unit: 'แท่ง',
  'change price Y coordinate': 'เปลี่ยนราคาพิกัด Y',
  'change bar X coordinate': 'เปลี่ยนแถบพิกัด X',
  'change {title} visibility on ticks': 'เปลี่ยนการมองเห็น {title} บนทิค',
  'change {title} visibility on seconds': 'เปลี่ยนการมองเห็น {title} เป็นวินาที',
  'change {title} seconds from': 'เปลี่ยน {title} วินาทีจาก',
  'change {title} seconds to': 'เปลี่ยน {title} วินาทีเป็น',
  'change {title} visibility on minutes': 'เปลี่ยนการมองเห็น {title} เป็นนาที',
  'change {title} minutes from': 'เปลี่ยน {title} นาทีจาก',
  'change {title} minutes to': 'เปลี่ยน {title} นาทีเป็น',
  'change {title} visibility on hours': 'เปลี่ยนการมองเห็น {title} เป็นชั่วโมง',
  'change {title} hours from': 'เปลี่ยน {title} ชั่วโมงจาก',
  'change {title} hours to': 'เปลี่ยน {title} ชั่วโมงเป็น',
  'change {title} visibility on days': 'เปลี่ยนการมองเห็น {title} เป็นวัน',
  'change {title} days from': 'เปลี่ยน {title} วันจาก',
  'change {title} days to': 'เปลี่ยน {title} วันเป็น',
  'change {title} visibility on weeks': 'เปลี่ยนการมองเห็น {title} เป็นสัปดาห์',
  'change {title} weeks from': 'เปลี่ยน {title} สัปดาห์จาก',
  'change {title} weeks to': 'เปลี่ยน {title} สัปดาห์เป็น',
  'change {title} visibility on months': 'เปลี่ยนการมองเห็น {title} เป็นเดือน',
  'change {title} months from': 'เปลี่ยน {title} เดือนจาก',
  'change {title} months to': 'เปลี่ยน {title} เดือนเป็น',
  'change {title} visibility on ranges': 'เปลี่ยน {title} การมองเห็นในช่วง',
  Seconds: 'วินาที',
  Minutes: 'นาที',
  Hours: 'ชั่วโมง',
  Days: 'วัน',
  ...
  Ranges: 'เรนจ์',
  seconds: 'วินาที',
  'seconds from': 'วินาทีจาก',
  'seconds to': 'วินาทีเป็น',
  minutes: 'นาที',
  'minutes from': 'นาทีจาก',
  'minutes to': 'นาทีเป็น',
  hours: 'ชั่วโมง',
  'hours from': 'ชั่วโมงจาก',
  'hours to': 'ชั่วโมงเป็น',
  days: 'วัน',
  'days from': 'วันจาก',
  'days to': 'วันเป็น',
  weeks: 'สัปดาห์',
  'weeks from': 'สัปดาห์จาก',
  'weeks to': 'สัปดาห์เป็น',
  months: 'เดือน',
  'months from': 'เดือนจาก',
  'months to': 'เดือนเป็น',
  ranges: 'เรนจ์',
  'change symbol legend format': 'เปลี่ยนรูปแบบคำอธิบายสัญลักษณ์',
  'change legend background visibility': 'เปลี่ยนการมองเห็นพื้นหลังคำอธิบาย',
  'change legend background transparency': 'เปลี่ยนความโปร่งใสพื้นหลังคำอธิบาย',
  'change {title} price label visibility': 'เปลี่ยน {title} การมองเห็นป้ายราคา',
  'change {title} extension': 'เปลี่ยน {title} ส่วนขยาย',
  'change {title} time label visibility': 'เปลี่ยนการมองเห็น {title} ป้ายเวลา',
  'Price label': 'ป้ายราคา',
  'Time label': 'ป้ายเวลา',
  Extend: 'ยืดออก',
  'change symbol last value mode': 'เปลี่ยนโหมดสัญลักษณ์ค่าสุดท้าย',
  'change currency label visibility': 'เปลี่ยนการมองเห็นป้ายสกุลเงิน',
  'change unit label visibility': 'เปลี่ยนการมองเห็นป้ายหน่วย',
  'change currency and unit labels visibility': 'เปลี่ยนสกุลเงินและการมองเห็นป้ายหน่วย',
  'change date format': 'เปลี่ยนรูปแบบวันที่',
  Unit: 'หน่วย',
  'Currency and Unit': 'สกุลเงินและหน่วย',
  ...
  'lines width': 'ความกว้างเส้น',
  'lines style': 'รูปแบบเส้น',
  'lines color': 'สีเส้น',
  'backgrounds color': 'สีพื้นหลัง',
  'backgrounds filled': 'เติมพื้นหลัง',
  'text color': 'สีตัวอักษร',
  Text: 'ตัวอักษร',
  'change {inputName} property': 'เปลี่ยนคุณสมบัติ {inputName}',
  'change color bars based on previous close': 'เปลี่ยนสีแท่งของราคาปิดในวันก่อนหน้า',
  'change HLC bars': 'เปลี่ยนแท่ง HLC',
  'change bar up color': 'เปลี่ยนสีแท่งขาขึ้น',
  'change bar down color': 'เปลี่ยนสีแท่งขาลง',
  'change thin bars': 'เปลี่ยนแท่งบาง',
  'change line price source': 'เปลี่ยนเส้นแหล่งราคา',
  'change line type': 'เปลี่ยนชนิดเส้น',
  'change line color': 'เปลี่ยนสีเส้น',
  'change line width': 'เปลี่ยนความกว้างเส้น',
  'change area price source': 'เปลี่ยนพื้นที่แหล่งราคา',
  'change area line color': 'เปลี่ยนสีพื้นที่ใต้เส้นกราฟ',
  'change area line width': 'เปลี่ยนความกว้างพื้นที่ใต้เส้นกราฟ',
  'change area fill color': 'เปลี่ยนสีพื้นที่ด้านใน',
  'change baseline price source': 'เปลี่ยนแหล่งราคาพื้นฐาน',
  'change baseline top line color': 'เปลี่ยนสีเส้นฐานด้านบน',
  'change baseline top line width': 'เปลี่ยนความกว้างของเส้นฐานด้านบน',
  'change baseline bottom line color': 'เปลี่ยนสีเส้นฐานด้านล่าง',
  'change baseline bottom line width': 'เปลี่ยนความกว้างของเส้นฐานด้านล่าง',
  'change baseline fill top area color': 'เปลี่ยนสีพื้นที่ใต้เส้นฐานด้านบน',
  'change baseline fill bottom area color': 'เปลี่ยนสีพื้นที่ใต้เส้นฐานด้านล่าง',
  'change base level': 'ปรับระดับฐาน',
  'change high-low body visibility': 'เปลี่ยนการมองเห็นพื้นค่าสูง-ต่ำ',
  'change high-low body color': 'เปลี่ยนสีพื้นค่าสูง-ต่ำ',
  'change high-low borders visibility': 'เปลี่ยนการมองเห็นเส้นขอบค่าสูง-ต่ำ',
  'change high-low border color': 'เปลี่ยนสีเส้นขอบค่าสูง-ต่ำ',
  'change high-low labels visibility': 'เปลี่ยนการมองเห็นป้ายค่าสูง-ต่ำ',
  'change high-low labels color': 'เปลี่ยนสีป้ายค่าสูง-ต่ำ',
  'change high-low labels font size': 'เปลี่ยนขนาดตัวอักษรป้ายค่าสูง-ค่ำ',
  'change renko wick visibility': 'เปลี่ยนการมองเห็นไส้เทียน renko',
  'change renko wick up color': 'เปลี่ยนสีไส้เทียน renko ขาขึ้น',
  'change renko wick down color': 'เปลี่ยนไส้เทียน renko ขาลง',
  ...
  'change range thin bars': 'เปลี่ยนช่วงระยะแท่งบาง',
  'change {candleType} body visibility': 'เปลี่ยนการมองเห็นพื้น {candleType}',
  'change {candleType} up color': 'เปลี่ยนสี {candleType} ขาขึ้น',
  'change {candleType} down color': 'เปลี่ยนสี {candleType} ขาลง',
  'change {candleType} border visibility': 'เปลี่ยนการมองเห็นเส้นขอบ {candleType}',
  'change {candleType} up border color': 'เปลี่ยนสีเส้นขอบ {candleType} ขาขึ้น',
  'change {candleType} down border color': 'เปลี่ยนสีเส้นขอบ {candleType} ขาลง',
  'change {candleType} wick visibility': 'เปลี่ยนการมองเห็นไส้เทียน {candleType}',
  'change {candleType} wick up color': 'เปลี่ยนสีไส้เทียน {candleType} ขาขึ้น',
  'change {candleType} wick down color': 'เปลี่ยนสีไส้เทียน {candleType} ขาลง',
  'change {chartType} up color': 'เปลี่ยนสี {chartType} ขาขึ้น',
  'change {chartType} down color': 'เปลี่ยนสี {chartType} ขาลง',
  'change {chartType} projection bar up color': 'เปลี่ยนสี {chartType} แท่งคาดคะเนขาขึ้น',
  'change {chartType} projection bar down color': 'เปลี่ยนสี {chartType} แท่งคาดคะเนขาลง',
  'change {chartType} border bar up color': 'เปลี่ยนสีเส้นขอบ {chartType} แท่งขาขึ้น',
  'change {chartType} border bar down color': 'เปลี่ยนสีเส้นขอบ {chartType} แท่งขาลง',
  'change {chartType} projection border bar up color': 'เปลี่ยนสีเส้นขอบ {chartType} แท่งคาดคะเนขาขึ้น',
  'change column up color': 'เปลี่ยนสีคอลัมน์ขึ้น',
  'change column down color': 'เปลี่ยนสีคอลัมน์ลง',
  'change column price source': 'เปลี่ยนแหล่งที่มาของราคาคอลัมน์',
  'Thin bars': 'แท่งบาง',
  'Top line': 'เส้นด้านบน',
  'Bottom line': 'เส้นด้านล่าง',
  'Fill top area': 'เติมพื้นที่ด้านบน',
  'Fill bottom area': 'เติมพื้นที่ด้านล่าง',
  'Real prices on price scale (instead of Heikin-Ashi price)': 'ราคาจริงในระดับราคา (แทนที่ราคา Heikin-Ashi)',
  'Base level': 'ระดับฐาน',
  candle: 'แท่งเทียน',
  range_0: 'ช่วง',
  'hollow candles': 'แท่งเทียนแบบกลวง',
  Center: 'ตรงกลาง',
  'change {title} middle point visibility': 'เปลี่ยนการมองเห็น {title} จุดกึ่งกลาง',
  'change {title} price labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายราคา',
  'change {title} price range visibility': 'เปลี่ยนการมองเห็น {title} ช่วงราคา',
  'change {title} bars range visibility': 'เปลี่ยนการมองเห็น {title} ช่วงระยะแท่ง',
  'change {title} date/time range visibility': 'เปลี่ยนการมองเห็น {title} ช่วงวัน/เวลา',
  'change {title} distance visibility': 'เปลี่ยนการมองเห็น {title} ระยะห่าง',
  'change {title} angle visibility': 'เปลี่ยนการมองเห็น {title} มุม',
  'change {title} always show stats': 'เปลี่ยน {title} แสดงสถิติเสมอ',
  'change {title} stats position': 'เปลี่ยน {title} ตำแหน่งสถิติ',
  'Middle point': 'จุดกลาง',
  'Price labels': 'ป้ายราคา',
  'Stats position': 'ตำแหน่งสถิติ',
  'Price range': 'ช่วงราคา',
  'Bars range': 'ช่วงบาร์',
  'Date/time range': 'วันที่/ช่วงเวลา',
  Distance: 'ระยะ',
  Angle: 'มุม',
  'Always show stats': 'แสดงสถิติเสมอ',
  Stats: 'สถิติ',
  'change {toolName} line visibility': 'เปลี่ยน {toolName} การมองเห็นเส้น',
  'change {toolName} line width': 'เปลี่ยน {toolName} ความกว้างเส้น',
  'change {toolName} line style': 'เปลี่ยน {toolName} รูปแบบเส้น',
  'change {toolName} line color': 'เปลี่ยนสี {toolName} เส้น',
  'change {toolName} line extending left': 'ขยายเส้น {toolName} ไปทางซ้าย',
  'change {toolName} line left end': 'เปลี่ยน {toolName} เส้นซ้ายสุด',
  'change {toolName} line extending right': 'เปลี่ยน {toolName} ขยายเส้นทางขวา',
  'change {toolName} line right end': 'เปลี่ยน {toolName} เส้นนขวาสุด',
  'Extend left line': 'ยืดเส้นด้านซ้าย',
  'Extend right line': 'ยืดเส้นด้านขวา',
  'change {toolName} text visibility': 'เปลี่ยน {toolName} การมองเห็นข้อความ',
  'change {toolName} text color': 'เปลี่ยน {toolName} สีข้อความ',
  'change {toolName} text font size': 'เปลี่ยน {toolName} ขนาดตัวอักษร',
  'change {toolName} text font bold': 'เปลี่ยน {toolName} อักษรตัวหนา',
  'change {toolName} text font italic': 'เปลี่ยน {toolName} อักษรตัวเอียง',
  'change {toolName} text': 'เปลี่ยน {toolName} ข้อความ',
  'change {toolName} labels alignment vertical': 'เปลี่ยน {toolName} แนวป้ายกำกับแนวตั้ง',
  'change {toolName} labels alignment horizontal': 'เปลี่ยน {toolName} แนวป้ายกำกับแนวนอน',
  'change {toolName} labels direction': 'เปลี่ยน {toolName} ทิศทางป้ายกำกับ',
  'change {toolName} text background visibility': 'เปลี่ยน {toolName} การมองเห็นพื้นหลังข้อความ',
  'change {toolName} text background color': 'เปลี่ยน {toolName} สีพื้นหลังข้อความ',
  'change {toolName} text border visibility': 'เปลี่ยน {toolName} การมองเห็นเส้นขอบข้อความ',
  'change {toolName} text border width': 'เปลี่ยน {toolName} ความกว้างเส้นขอบข้อความ',
  'change {toolName} text border color': 'เปลี่ยน {toolName} สีเส้นขอบข้อความ',
  'change {toolName} text wrap': 'เปลี่ยน {toolName} การตัดข้อความ',
  'Text wrap': 'บังคับให้ตัวหนังสืออยู่ในขอบเขตที่กำหนด',
  'change arrow color': 'เปลี่ยนสีลูกศร',
  'change {title} color': 'เปลี่ยนสี {title}',
  'change {title} mode': 'เปลี่ยนโหมด {title}',
  'change {title} mirrored': 'เปลี่ยนการสะท้อน {title}',
  'change {title} flipped': 'เปลี่ยนการพลิก {title}',
  Mode: 'โหมด',
  Mirrored: 'กระจกเงา',
  Flipped: 'กลับด้าน',
  'HL bars': 'บาร์ HL',
  ...
  'change {title} background visibility': 'เปลี่ยนการมองเห็น {title} พื้นหลัง',
  'change {title} background color': 'เปลี่ยนสีพื้นหลัง {title}',
  'change {title} degree': 'เปลี่ยนองศามุม {title}',
  Wave: 'เวฟ',
  Degree: 'องศา',
  'change {title} level {index} line visibility': 'เปลี่ยน {title} เลเวล {index} การมองเห็นเส้น',
  'change {title} levels visibility': 'เปลี่ยนระดับการมองเห็น {title}',
  'change {title} level {index} line color': 'เปลี่ยนสีเส้น {title} ระดับ {index}',
  'change {title} level {index} line width': 'เปลี่ยนความกว้างเส้น {title} ระดับ {index}',
  'change {title} level {index} line coeff': 'เปลี่ยนค่าสัมประสิทธิ์เส้น {title} ระดับ {index}',
  'change {title} all lines color': 'เปลี่ยนสีเส้น {title} ทั้งหมด',
  'change {title} background transparency': 'เปลี่ยนความโปร่งใสพื้นหลัง {title}',
  'change {title} coeffs as percents visibility': 'เปลี่ยนการมองเห็นค่าสัมประสิทธิ์ {title} เป็นเปอร์เซ็นต์',
  'Trend line': 'เส้นแนวโน้ม',
  'Use one color': 'ใช้สีเดียว',
  Levels: 'ระดับ',
  'Coeffs as percents': 'ค่าสัมประสิทธิ์แบบเปอร์เซ็นต์',
  'change {title} reverse': 'เปลี่ยน {title} ย้อนกลับ',
  'change {title} prices visibility': 'เปลี่ยนการมองเห็น {title} ราคา',
  'change {title} labels alignment': 'เปลี่ยนการจัดตำแหน่ง {title} ป้ายกำกับ',
  'change {title} labels font size': 'เปลี่ยนขนาดตัวอักษรของป้ายกำกับ {title}',
  'change {title} style': 'เปลี่ยนรูปแบบ {title}',
  'change {title} fib levels based on log scale': 'เปลี่ยน {title} ระดับฟีโบนัชชีบนล็อกสเกล',
  ...
  Middle: 'ตรงกลาง',
  Bottom: 'ข้างล่าง',
  'change {title} full circles visibility': 'เปลี่ยนการมองเห็น {title} วงกลมเต็ม',
  'Full circles': 'เต็มวงกลม',
  'change {title} left labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านซ้าย',
  'change {title} right labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านขวา',
  'change {title} top labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านบน',
  'change {title} bottom labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายกำกับด้านล่าง',
  'change {title} grid visibility': 'เปลี่ยนการมองเห็น {title} เส้นกริด',
  'change {title} grid line color': 'เปลี่ยนสี {title} เส้นกริด',
  'change {title} grid line width': 'เปลี่ยนความกว้าง {title} เส้นกริด',
  'change {title} grid line style': 'เปลี่ยนรูปแบบ {title} เส้นกริด',
  ...
  'change {title} line color': 'เปลี่ยนสี {title} เส้น',
  'change {title} line width': 'เปลี่ยนความกว้าง {title} เส้น',
  'change {title} line style': 'เปลี่ยนรูปแบบ {title} เส้น',
  'change {title} counterclockwise': 'เปลี่ยน {title} ทวนเข็มนาฬิกา',
  Counterclockwise: 'ทวนเข็มนาฬิกา',
  'change {title} level {index} line style': 'เปลี่ยนรูปแบบเส้น {title} ระดับ {index}',
  'change {title} labels visibility': 'เปลี่ยนการมองเห็น {title} ป้ายกำกับ',
  'change flag color': 'เปลี่ยนสี flag',
  'change {title} fan {index} line visibility': 'เปลี่ยนการมองเห็น {title} เส้นแฟน {index}',
  'change {title} fan {index} line color': 'เปลี่ยนสี {title} เส้นแฟน {index}',
  'change {title} fan {index} line width': 'เปลี่ยนความกว้าง {title} เส้นแฟน {index}',
  'change {title} arcs {index} line visibility': 'เปลี่ยนการมองเห็น {title} เส้นอาร์ค {index}',
  'change {title} arcs {index} line color': 'เปลี่ยนสี {title} เส้นอาร์ค {index}',
  'change {title} arcs {index} line width': 'เปลี่ยนความกว้าง {title} เส้นอาร์ค {index}',
  'Price/bar ratio': 'อัตราส่วน ราคา/แท่ง',
  Fans: 'แฟน',
  Arcs: 'เส้นโค้ง',
  'change {title} fans visibility': 'เปลี่ยนการมองเห็น {title} แฟน',
  'change {title} fans line color': 'เปลี่ยนสี {title} เส้นแฟน',
  Angles: 'มุม',
  'change {title} extend top': 'ขยาย {title} ด้านบน',
  'change {title} extend bottom': 'ขยาย {title} ด้านล่าง',
  'change {title} extend left': 'ขยาย {title} ด้านล่าง',
  'Extend top': 'ยืดส่วนบนออก',
  'Extend bottom': 'ยืดส่วนล่างออก',
  Label: 'ป้ายชื่อ',
  'Label background': 'พื้นหลังป้ายชื่อ',
  'change {title} candle up color': 'เปลี่ยนสี {title} แท่งเทียนขาขึ้น',
  'change {title} candle down color': 'เปลี่ยนสี {title} แท่งเทียนขาลง',
  'change {title} candle border visibility': 'เปลี่ยนการมองเห็น {title} เส้นขอบแท่งเทียน',
  'change {title} candle border up color': 'เปลี่ยนสีเส้นขอบ {title} แท่งเทียนขาขึ้น',
  'change {title} candle border down color': 'เปลี่ยนสีเส้นขอบ {title} แท่งเทียนขาลง',
  'change {title} candle wick visibility': 'เปลี่ยนการมองเห็น {title} ไส้เทียน',
  'change {title} candle wick color': 'เปลี่ยนสี {title} ไส้เทียน',
  'change {title} transparency': 'เปลี่ยนความโปร่งใส {title}',
  'change {title} average HL value': 'เปลี่ยน {title} ค่าเฉลี่ย HL',
  'change {title} variance value': 'เปลี่ยน {title} ค่าความแปรปรวน',
  'Avg HL in minticks': 'ค่าเฉลี่ย HL ในมินติ๊ก',
  Variance: 'ความแปรปรวน',
  '#1 (price)_linetool point': '#1 (ราคา)',
  '#{count} (price, bar)_linetool point': '#{count} (ราคา, แท่ง)',
  'change {title} extending left': 'ขยาย {title} ไปทางซ้าย',
  'change {title} extending right': 'ขยาย {title} ไปทางขวา',
  Channel: 'ช่อง',
  'change {title} extend lines': 'เปลี่ยน {title} การขยายเส้น',
  Median: 'ค่าเฉลี่ย',
  ...
  Inside: 'ภายใน',
  'change {title} source text color': 'เปลี่ยนสี {title} ข้อความต้นฉบับ',
  'change {title} source background color': 'เปลี่ยนสีพื้นหลัง {title} ต้นฉบับ',
  'change {title} source border color': 'เปลี่ยนสีเส้นขอบ {title} ต้นฉบับ',
  'change {title} target text color': 'เปลี่ยนสี {title} ข้อความเป้าหมาย',
  'change {title} target background color': 'เปลี่ยนสีพื้นหลัง {title} เป้าหมาย',
  'change {title} target border color': 'เปลี่ยนสีเส้นขอบ {title} เป้าหมาย',
  'change {title} success text color': 'เปลี่ยนสี {title} ข้อความที่สำเร็จ',
  'change {title} success background color': 'เปลี่ยนสีพื้นหลัง {title} ที่สำเร็จ',
  'change {title} failure text color': 'เปลี่ยนสี {title} ข้อความที่ล้มเหลว',
  'change {title} failure background color': 'เปลี่ยนสีพื้นหลัง {title} ที่ล้มเหลว',
  'Label text': 'ตัวหนังสือของป้าย',
  'Line color': 'สีเส้น',
  'Label border': 'ขอบของป้าย',
  'change {title} background color 1': 'เปลี่ยนสีพื้นหลัง {title} 1',
  'change {title} background color 2': 'เปลี่ยนสีพื้นหลัง {title} 2',
  'change {title} stop color': 'เปลี่ยนสี {title} สต็อป',
  'change {title} target color': 'เปลี่ยนสี {title} เป้าหมาย',
  'change {title} compact stats mode': 'เปลี่ยน {title} โหมดสถิติแบบ compact',
  'change {title} account size': 'เปลี่ยน {title} ขนาดบัญชี',
  'change {title} lot size': 'เปลี่ยน {title} ขนาดล็อต',
  'change {title} risk': 'เปลี่ยน {title} ความเสี่ยง',
  'change {title} risk display mode': 'เปลี่ยน {title} โหมดการแสดงความเสี่ยง',
  'change {title} entry price': 'เปลี่ยน {title} ราคาเข้าซื้อ',
  'change {title} profit level': 'เปลี่ยน {title} ระดับทำกำไร',
  'change {title} profit price': 'เปลี่ยน {title} ราคาทำกำไร',
  'change {title} stop level': 'เปลี่ยน {title} ระดับการหยุด',
  'change {title} stop price': 'เปลี่ยน {title} ราคาหยุดขาดทุน',
  ...
  '%': 'เปอร์เซ็นต์',
  Cash: 'เงินสด',
  'change vertical position Y coordinate': 'เปลี่ยนพิกัดตำแหน่งแนวตั้ง Y',
  'change {title} emoji visibility': 'เปลี่ยนการมองเห็น {title} อีโมจิ',
  'change {title} image background color': 'เปลี่ยนสี {title} ภาพพื้นหลัง',
  'change {title} emoji': 'เปลี่ยน {title} อีโมจิ',
  '#1 (vertical position %, bar)_linetool point': '#1 (ตำแหน่งในแนวตั้ง %, แท่ง)',
  'Emoji pin': 'หมุดอีโมจิ',
  'change angle': 'เปลี่ยนมุม',
  '#1 (price, bar)_linetool point': '#1 (ราคา, แท่ง)',
  '#1 (bar)_linetool point': '#1 (แท่ง)',
  'change decimal places': 'เปลี่ยนตำแหน่งทศนิยม',
  'change extended hours color': 'เปลี่ยนสีการขยายชั่วโมง',
  'change pre market color': 'เปลี่ยนสีก่อนตลาดเปิด',
  'change post market color': 'เปลี่ยนสีหลังตลาดปิด',
  'change price line color': 'เปลี่ยนสีเส้นราคา',
  'change price line width': 'เปลี่ยนความกว้างเส้นราคา',
  'change previous close price line color': 'เปลี่ยนสีเส้นราคาปิดก่อนหน้า',
  'change previous close price line width': 'เปลี่ยนความกว้างเส้นราคาปิดก่อนหน้า',
  'change pre/post market price lines visibility': 'เปลี่ยนการมองเห็นเส้นราคาตลาดก่อน/หลัง',
  'change pre market line color': 'เปลี่ยนสีเส้นก่อนตลาดเปิด',
  'change post market line color': 'เปลี่ยนสีเส้นหลังตลาดปิด',
  'change bid line color': 'เปลี่ยนสีเส้น bid',
  'change ask line color': 'เปลี่ยนสีเส้น ask',
  ...
  Step: 'ขั้นบันได',
  Default: 'ค่าเริ่มต้น',
  'change {title} base line visibility': 'เปลี่ยนการมองเห็น {title} เส้นพื้นฐาน',
  'change {title} base line color': 'เปลี่ยนสี {title} เส้นพื้นฐาน',
  'change {title} base line width': 'เปลี่ยนความกว้าง {title} เส้นพื้นฐาน',
  'change {title} base line style': 'เปลี่ยนรูปแบบ {title} เส้นพื้นฐาน',
  'change {title} up line visibility': 'เปลี่ยนการมองเห็น {title} เส้นขาขึ้น',
  'change {title} up line color': 'เปลี่ยนสี {title} เส้นขาขึ้น',
  'change {title} up line width': 'เปลี่ยนความกว้าง {title} เส้นขาขึ้น',
  'change {title} up line style': 'เปลี่ยนรูปแบบ {title} เส้นขาขึ้น',
  'change {title} down line visibility': 'เปลี่ยนการมองเห็น {title} เส้นขาลง',
  'change {title} down line color': 'เปลี่ยนสี {title} เส้นขาลง',
  'change {title} down line width': 'เปลี่ยนความกว้าง {title} เส้นขาลง',
  'change {title} down line style': 'เปลี่ยนรูปแบบ {title} เส้นขาลง',
  "change {title} show pearson's r": 'เปลี่ยน {title} การแสดงผลเพียร์สัน อาร์',
  Base: 'ฐาน',
  Up: 'บน',
  Down: 'ทิศลง',
  "Pearson's R": 'เพียร์สัน อาร์',
  '#{count} (bar)_linetool point': '#{count} (แท่ง)',
  'change study overlay style': 'เปลี่ยนรูปแบบ study overlay',
  'change study overlay min tick': 'เปลี่ยน min tick ของ study overlay',
  'Override min tick': 'เขียนทับ Min Tick',
  Horizontal: 'แนวนอน',
  Vertical: 'แนวตั้ง',
  'Text alignment': 'การจัดตำแหน่งตัวอักษร',
  'Text orientation': 'การเรียงตัวของตัวอักษร',
  'change {propertyName} property': 'เปลี่ยนคุณสมบัติ {propertyName}',
  Offset: 'สิ่งชดเชย',
  ...
  'change values visibility': 'เปลี่ยนค่าการมองเห็น',
  ...
  'Labels font': 'ป้ายกำกับอักษร',
  'change shape': 'เปลี่ยนรูปร่าง',
  'Volume profile': 'โปรไฟล์ปริมาณการซื้อ-ขาย',
  'Developing VA': 'VA ที่กำลังพัฒนา',
  'Values in status line': 'ค่าในบรรทัดสถานะ',
  'Labels on price scale': 'ป้ายกำกับระดับราคา',
  Forecast: 'คาดการณ์',
  ...
  '{title} copy_ex: AAPL chart copy': '{title} สำเนา',
  ...
  'less than 1 minute': 'น้อยกว่า 1 นาที',
  '{days} and {hours}': '{days} และ {hours}',
  '{hours} and {minutes}': '{hours} และ {minutes}',
  'Market opens in {remainingTime}.': 'ตลาดจะเปิดใน {remainingTime}',
  'Market closes in {remainingTime}.': 'ตลาดจะปิดใน {remainingTime}',
  "It'll go to post-market trading in {remainingTime}.": 'จะเข้าสู่การซื้อขายหลังเวลาทำการใน {remainingTime}',
  "It'll open for pre-market trading in {remainingTime}.": 'จะเปิดให้ซื้อขายล่วงหน้าใน {remainingTime}',
  'Replay mode': 'โหมดเล่นซ้ำ',
  "You're in Replay mode. You're in Replay mode. You're in Replay mode.":
    'ชาร์ตอยู่ในโหมดเล่นซ้ำ ชาร์ตอยู่ในโหมดเล่นซ้ำ ชาร์ตอยู่ในโหมดเล่นซ้ำ',
  ...
  'cut {title}': 'ตัด {title}',
  'cut sources': 'ตัดแหล่งที่มา',
  'remove {title}': 'ลบ {title}',
  'remove drawings group': 'ลบกลุ่มภาพวาด',
  'move scale': 'ย้ายสเกล',
  'stop syncing line tool(s)': 'หยุดการซิงค์เครื่องมือเส้น',
  'zoom out': 'ขยายออก',
  'zoom in': 'ขยายเข้า',
  'move drawing(s)': 'ย้ายการวาด',
  'load default drawing template': 'โหลดเทมเพลตการวาดเริ่มต้น',
  'change currency': 'เปลี่ยนสกุลเงิน',
  'change unit': 'เปลี่ยนหน่วย',
  'clone line tools': 'คัดลอกเส้นเครื่องมือ',
  'merge up': 'รวมขึ้น',
  'merge down': 'รวมลง',
  'merge to pane': 'ผสานเข้ากับหน้าต่าง',
  'unmerge up': 'เลิกรวมขึ้น',
  'unmerge down': 'เลิกรวมลง',
  'unmerge to new bottom pane': 'เลิกผสานเข้ากับหน้าต่างใหม่ด้านล่าง',
  'move {title} to new right scale': 'ย้าย {title} ไปที่มาตราส่วนด้านขวาใหม่',
  'move {title} to new left scale': 'ย้าย {title} ไปยังสเกลทางซ้ายอันใหม่',
  'make {title} no scale (Full screen)': 'ทำ {title} ไม่มีสเกล (เต็มหน้าจอ)',
  'scroll time': 'ปรับเปลี่ยนเวลา',
  'scale time': 'ขนาดเวลา',
  'reset time scale': 'รีเซ็ตสเกลเวลา',
  'reset scales': 'รีเซ็ตสเกล',
  'create {tool}': 'สร้าง {tool}',
  'change {pointIndex} point': 'เปลี่ยน {pointIndex} จุด',
  'paste {title}': 'วาง {title}',
  'insert {title}': 'ใส่ {title}',
  'remove all studies': 'เอา studies ออกทั้งหมด',
  'remove drawings': 'ลบการวาดต่างๆ ออกไป',
  'remove all studies and drawing tools': 'ลบการศึกษาและเครื่องมือวาดภาพทั้งหมด',
  'turn line tools sharing off': 'ปิดการแชร์เครื่องมือไลน์',
  'share line tools in layout': 'แชร์เครื่องมือไลน์ในเลย์เอาต์',
  'share line tools globally': 'แชร์เครื่องมือไลน์ทั่วโลก',
  'apply all chart properties': 'ใช้คุณสมบัติชาร์ตทั้งหมด',
  ...
  'removing line tools group {name}': 'การลบกลุ่มเครื่องมือเส้น {name}',
  ...
  'lock group {group}': 'ล็อคกลุ่ม {group}',
  'unlock group {group}': 'ปลดล็อคกรุ๊ป {group}',
  'rename group {group} to {newName}': 'เปลี่ยนชื่อกรุ๊ปจาก {group} เป็น {newName}',
  'change {sourceTitle} title to {newSourceTitle}': 'เปลี่ยนชื่อ {sourceTitle} ไปเป็น {newSourceTitle}',
  'insert source(s) after': 'แทรกแหล่งที่มาหลังจาก',
  'mirror bars pattern': 'กลับด้านรูปแบบแท่ง',
  'flip bars pattern': 'พลิกรูปแบบแท่ง',
  'change Elliott degree': 'เปลี่ยนองศาเอลเลียต',
  ...
  Ellipse: 'วงรี',
  'Fib Channel': 'ช่องฟิโบนัชชี่',
  'Fib Circles': 'รอบฟิโบนัชชี่',
  ...
  'Volume Profile Fixed Range': 'ช่วงวอลลุ่มโปรไฟล์คงที่',
  'Ghost Feed': 'ฟีดผี',
  '{status} P&L: {pnl}': '{status} กำไร&ขาดทุน: {pnl}',
  Open_line_tool_position: 'เปิด',
  Closed_line_tool_position: 'ปิด',
  'Risk/Reward Ratio: {ratio}': 'ความเสี่ยง/ผลตอบแทน : {ratio}',
  ...
  Square: 'สี่เหลี่ยม',
  'X Cross': 'ตัดกัน',
  Premarket_sessions: 'การซื้อขายล่วงหน้าในตลาด',
  Postmarket_sessions: 'โพสต์มาร์เก็ต',
  'Regular trading hours_sessions': 'เวลาซื้อขายปกติ',
  'Extended trading hours_sessions': 'ยืดชั่วโมงการเทรด',
  'Electronic trading hours_sessions': 'ชั่วโมงการซื้อขายทางอิเล็กทรอนิกส์',
  PRE_sessions: 'ก่อน',
  POST_sessions: 'หลัง',
  RTH_sessions: 'RTH',
  ETH_sessions: 'ETH',
  'add line tool(s) to group {group}': 'เพิ่มเครื่องมือเส้นในกลุ่ม {group}',
  'apply study template {template}': 'ใช้งานเทมเพลต study {template}',
  'change pane height': 'เปลี่ยนความสูงของบานหน้าต่าง',
  'change date range': 'เปลี่ยนช่วงวันที่',
  'apply toolbars theme': 'ใช้ชุดรูปแบบแถบเครื่องมือ',
  ...
  'paste drawing': 'วางภาพวาด',
  'paste indicator': 'วางอินดิเคเตอร์',
  'scale price': 'สเกลราคา',
  'rearrange panes': 'จัดเรียงหน้าต่างใหม่',
  'remove line data sources': 'ลบเส้นแหล่งข้อมูล',
  'restore defaults': 'คืนค่าเริ่มต้น',
  'change chart layout to {title}': 'เปลี่ยนเค้าโครงชาร์ตเป็น {title}',
  'stop syncing drawing': 'หยุดการซิงค์ภาพวาด',
  zoom: 'ขยาย',
  'bring {title} to front': 'นำ {title} มาไว้ข้างหน้า',
  'send {title} to back': 'ส่ง {title} ไปด้านหลัง',
  'insert {title} after {targetTitle}': 'แทรก {title} หลัง {targetTitle}',
  'insert {title} before {targetTitle}': 'ใส่ {title} ก่อน {targetTitle}',
  'send group {title} backward': 'ส่งกลุ่ม {title} ถอยหลัง',
  'bring group {title} forward': 'นำกลุ่ม {title} ไว้ข้างหน้า',
  ...
  "Color Theme '{themeName}' already exists. Do you really want to replace it?":
    'ธีมสี {themeName} มีอยู่แล้ว คุณต้องการที่จะแทนที่มันหรือไม่',
  ...
  'Step line': 'เส้นลำดับ',
  'Step line with diamonds': 'สเต็ปเส้นเป็นรูปเพชร',
  Histogram: 'แท่ง',
  ...
  'Hide positions & orders': 'ซ่อนโพสิชั่นและคำสั่งซื้อ',
  'Show all positions & orders': 'แสดงโพสิชั่นและคำสั่งซื้อทั้งหมด',
  'Hide all positions & orders': 'ซ่อนโพสิชั่นและคำสั่งซื้อทั้งหมด',
  'Hide all': 'ซ่อนทั้งหมด',
  'Show all drawings, indicators, positions & orders': 'แสดงภาพวาด อินดิเคเตอร์ โพสิชั่น & คำสั่งทั้งหมด',
  'Show all drawings and indicators': 'แสดงการวาดและอินดิเคเตอร์ทั้งหมด',
  'Hide all drawings, indicators, positions & orders': 'ซ่อนภาพวาด อินดิเคเตอร์ โพสิชั่น & คำสั่งทั้งหมด',
  'Hide all drawings and indicators': 'ซ่อนการวาดและอินดิเคเตอร์ทั้งหมด',
  'remove all line tools for {symbol}': 'ลบเครื่องมือเส้นทั้งหมดสำหรับ {symbol}',
  ...
  'show objects': 'แสดงออบเจ็กต์',
  'hide objects': 'ซ่อนออบเจ็กต์',
  'remove objects': 'ลบออบเจ็กต์',
  'Set the "{inputInline}" time and price for "{studyShortDescription}"':
    'กำหนดเวลาและราคา {inputInline} สำหรับ {studyShortDescription}',
  'Set the time and price for "{studyShortDescription}"': 'ตั้งเวลาและราคาสำหรับ "{studyShortDescription}"',
  'Set the "{inputTitle}" time for "{studyShortDescription}"': 'กำหนดเวลา {inputTitle} สำหรับ {studyShortDescription}',
  'Set the time for "{studyShortDescription}"': 'ตั้งเวลาสำหรับ "{studyShortDescription}"',
  'Set the "{inputTitle}" price for "{studyShortDescription}"': 'กำหนดราคา {inputTitle} สำหรับ {studyShortDescription}',
  'Set the price for "{studyShortDescription}"': 'กำหนดราคาสำหรับ "{studyShortDescription}"',
  ...
  'Apply Defaults': 'ตั้งให้เป็นค่าเบื้องต้น',
  'apply factory defaults to selected sources': 'ใช้ค่าเริ่มต้นจากโรงงานกับแหล่งที่เลือก',
  'Selected Drawings': 'ภาพวาดที่เลือก',
  Solid: 'สีเดียว',
  Gradient: 'ไล่เฉดสี',
