...
_tv_languages.zh_TW = {
  ...
  'Double-click any edge to reset layout grid': '在任意邊緣點擊兩下以重置版面網格',
  ...
  "The data vendor doesn't provide volume data for this symbol.": '數據供應商不提供此商品的成交量數據。',
  'Accumulation/Distribution_study': '累積/派發指標',
  'Accumulative Swing Index_study': '振動升降指標(ASI)',
  'Advance/Decline_study': 'Advance/Decline',
  'Arnaud Legoux Moving Average_study': '阿諾勒古移動均線',
  Aroon_study: '阿隆指標',
  ...
  'Session Volume_study': '時段成交量',
  'Session Volume HD_study': '時段成交量HD',
  ...
  'Lower Band_input': '下軌',
  CCI_input: 'CCI',
  'Smoothing Line_input': '平滑線',
  'Smoothing Length_input': '平滑長度',
  ...
  'adjust for contract changes': '調整合約變更',
  'toggle auto scale': '切換自動刻度',
  'toggle log scale': '切換對數刻度',
  'toggle percentage scale': '切換百分比刻度',
  'Take a snapshot': '快照',
  'use settlement as close on daily interval': '使用結算價做為日圖的收盤價',
  ext: '延時',
  ...
  adj_adjustments: '調整',
  'Adjust data for dividends': '調整股息數據',
  'Main symbol data is adjusted for dividends only': '主要商品數據僅針對股息進行調整',
  'Main symbol data is adjusted for splits only': '主要商品數據僅針對拆分進行調整',
  'b-adj_adjustments': 'b-調整',
  'Adjust for contract changes': '調整合約變更',
  set_adjustments: '清算價',
  'Use settlement as close on daily interval': '使用結算價做為日圖的收盤價',
  'Date Range': '日期範圍',
  'change session': '更改交易時段',
  Session: 'session',
  Sessions: '交易時段',
  'Weak Magnet': '弱磁鐵',
  'Strong Magnet': '強磁鐵',
  ...
  'You have no Favorites Indicators yet': '您尚未有收藏的指標',
  ...
  'change earnings visibility': '改變收益可見性',
  'change dividends visibility': '改變股息可見性',
  'change splits visibility': '改變拆分可見性',
  'change continuous contract switch visibility': '更改連續契約轉換的可見性',
  'show all ideas': '顯示所有想法',
  'show ideas of followed users': '顯示關注用戶的想法',
  'show my ideas only': '僅顯示我自己的想法',
  'change events visibility on chart': '改變圖表上的事件可見性',
  ...
  'Show dividends': '顯示股息',
  'Show splits': '顯示分割',
  'Show continuous contract switch': '顯示連續契約轉換',
  'Show all ideas': '顯示所有想法',
  'Show ideas of followed users': '顯示關注用戶的想法',
  'Show my ideas only': '僅顯示我自己的想法',
  ...
  'move left': '向左移動',
  'move right': '向右移動',
  'change price to bar ratio': '更改價格K線比',
  'toggle lock scale': '切換鎖定刻度',
  'change series style': '更改系列樣式',
  'hide {title}': '隱藏{title}',
  'Invalid symbol': '無效的商品代碼',
  'No data here': '這裡沒有數據',
  'apply indicators to entire layout': '將指標套用於整個版面',
  'sync time': '同步時間',
  'resize layout': '調整版面',
  'reset layout sizes': '重製版面大小',
  'apply chart theme': '套用圖表主題',
  'Please give us a clipboard writing permission in your browser or press {keystroke}':
    '請在您的瀏覽器中向我們提供剪貼板寫入權限，或按{keystroke}',
  "Couldn't copy": '無法複製',
  "Couldn't cut": '無法剪下',
  "Couldn't paste": '無法貼上',
  '{userName} published on {customer}, {date}': '{userName}發表於{customer}，{date}',
  'Published on {customer}, {date}': '發表於{customer}，{date}',
  'change symbol last value visibility': '改變商品最後一個值的可見性',
  'change symbol previous close value visibility': '改變商品前一個收盤價的可見性',
  'change previous close price line visibility': '改變前一個收價線的可見性',
  'change symbol labels visibility': '更改商品標籤可見性',
  'change indicators and financials name labels visibility': '更改指標和財務名稱標籤可見性',
  'change indicators name labels visibility': '更改指標名稱標籤可見性',
  'change indicators and financials value labels visibility': '更改指標和財務值標籤可見性',
  'change indicators value labels visibility': '更改指標值標籤可見性',
  'change bid and ask labels visibility': '改變bid和ask標籤的可見性',
  'change bid and ask lines visibility': '改變bid和ask線的可見性',
  'change pre/post market price label visibility': '改變盤前/盤後市場價格標籤的可見性',
  'change high and low price lines visibility': '更改高低價線的可見性',
  'change high and low price labels visibility': '更改高低價標籤的可見性',
  'change countdown to bar close visibility': '更改倒計時到K線關閉的可見性',
  'change plus button visibility': '更改加號按鈕的可見性',
  'change price line visibility': '改變價格線',
  'unlock {title}': '解鎖{title}',
  'lock {title}': '鎖定{title}',
  'Auto (fits data to screen)': '自動(調整數據適於螢幕)',
  'Lock price to bar ratio': '鎖定價格對K線比例',
  'Change interval': '變更週期',
  'Symbol last price label': '最新價格標籤',
  'Symbol previous day close price label': '前一日收盤價標籤',
  'Previous day close price line': '前一日收盤價線',
  'Symbol name label': '商品名稱標籤',
  'Indicators and financials value labels': '指標和財務值標籤',
  'Indicators value labels': '指標值標籤',
  'Indicators and financials name labels': '指標和財務名稱標籤',
  'Indicators name labels': '指標名稱標籤',
  ...
  'Post-market': '盤後時段',
  'Market closed': '休市',
  'Exchange timezone': '交易所時區',
  Image: '圖片',
  Transparency: '透明度',
  'change symbol description visibility': '更改商品描述可見性',
  'change open market status visibility': '更改開盤狀態可見性',
  'change OHLC values visibility': '更改開高低收值可見性',
  'change bar change visibility': '更改K線漲跌可見性',
  'change indicator titles visibility': '更改指標標題可見性',
  'change indicator arguments visibility': '更改指標參數可見性',
  'change indicator values visibility': '更改指標值可見性',
  'change volume values visibility': '更改成交量值可見性',
  'Open market status': '開市狀態',
  'OHLC values': '開高低收值',
  ...
  'Show interval settings': '顯示周期設定',
  'Flag Symbol': '標記商品',
  'Unflag Symbol': '取消標記商品',
  'change line tool(s) font size': '更改線條工具字體大小',
  'change line tool(s) line style': '更改線條工具的線條樣式',
  'Font size': '字體大小',
  'Template name': '範本名稱',
  ...
  'Manage panes': '管理窗格',
  scroll: '滾動',
  'Lock vertical cursor line by time': '按時間鎖定垂直游標線',
  'change no overlapping labels': '更改不重疊的標籤',
  ...
  'change chart background color': '更改圖表背景顏色',
  'change chart background type': '更改圖表背景類型',
  'change vert grid lines color': '更改垂直網格線顏色',
  'change vert grid lines style': '更改垂直網格線樣式',
  'change horz grid lines color': '更改水平網格線顏色',
  'change horz grid lines style': '更改水平網格線樣式',
  'change sessions breaks visibility': '更改交易時段分隔可見性',
  'change sessions breaks color': '更改交易時段分隔顏色',
  'change sessions breaks width': '更改交易時段分隔寬度',
  'change sessions breaks style': '更改交易時段分隔樣式',
  'change scales text color': '更改刻度文字顏色',
  'change scales font size': '更改刻度字體大小',
  'change scales lines color': '更改刻度線條顏色',
  'change pane separators color': '改變窗格分隔符號顏色',
  'change crosshair color': '更改十字準線顏色',
  'change crosshair width': '更改十字準線寬度',
  'change crosshair style': '更改十字準線樣式',
  'change symbol watermark visibility': '更改商品浮水印可見性',
  'change symbol watermark color': '更改商品浮水印顏色',
  'change navigation buttons visibility': '更改導航按鈕可見性',
  'change pane buttons visibility': '更改窗格按鈕可見性',
  'change top margin': '更改上邊距',
  'change bottom margin': '更改下邊距',
  'change right margin': '更改右邊距',
  'Vert grid lines': '垂直網格線',
  'Horz grid lines': '水平網格線',
  'Scales text': '刻度文字',
  'Scales lines': '刻度線',
  'Pane separators': '窗格分隔符號',
  Watermark: '浮水印',
  'Top margin': '上邊距',
  ...
  'Right margin': '右邊距',
  bars_unit: '根K棒',
  'change price Y coordinate': '更改價格Y坐標',
  'change bar X coordinate': '更改K線X坐標',
  'change {title} visibility on ticks': '更改{title}在tick圖上的可見性',
  'change {title} visibility on seconds': '更改{title}在秒圖上的可見性',
  'change {title} seconds from': '更改{title}秒圖從',
  'change {title} seconds to': '更改{title}秒圖到',
  'change {title} visibility on minutes': '更改{title}在分鐘圖上的可見性',
  'change {title} minutes from': '更改{title}分鐘圖從',
  'change {title} minutes to': '更改{title}分鐘圖到',
  'change {title} visibility on hours': '更改{title}在小時圖上的可見性',
  'change {title} hours from': '更改{title}小時圖從',
  'change {title} hours to': '更改{title}小時圖到',
  'change {title} visibility on days': '更改{title}在日圖上的可見性',
  'change {title} days from': '更改{title}日圖從',
  'change {title} days to': '更改{title}日圖到',
  'change {title} visibility on weeks': '更改{title}周圖的可見性',
  'change {title} weeks from': '更改{title}周圖從',
  'change {title} weeks to': '更改{title}周圖到',
  'change {title} visibility on months': '更改{title}月圖的可見性',
  'change {title} months from': '更改{title}月圖從',
  'change {title} months to': '更改{title}月圖到',
  'change {title} visibility on ranges': '更改{title}在範圍圖上的可見性',
  Seconds: '秒',
  Minutes: '分鐘',
  Hours: '小時',
  Days: '日',
  ...
  'months to': '月圖到',
  ranges: 'Ranges',
  'change symbol legend format': '更改商品圖例格式',
  'change legend background visibility': '更改圖例背景可見性',
  'change legend background transparency': '更改圖例背景透明度',
  'change {title} price label visibility': '更改{title}價格標籤可見性',
  'change {title} extension': '更改{title}擴展名',
  'change {title} time label visibility': '更改{title}時間標籤可見性',
  'Price label': '價格標籤',
  'Time label': '時間標籤',
  Extend: '延伸',
  'change symbol last value mode': '更改商品最新值模式',
  'change currency label visibility': '更改貨幣標籤可見性',
  'change unit label visibility': '更改單位標籤可見性',
  'change currency and unit labels visibility': '更改貨幣和單位標籤的可見性',
  'change date format': '更改日期格式',
  Unit: '單位',
  'Currency and Unit': '貨幣和單位',
  ...
  'lines style': '線條樣式',
  'lines color': '線條顏色',
  'backgrounds color': '背景顏色',
  'backgrounds filled': '背景填充',
  'text color': '文字顏色',
  Text: '文字',
  'change {inputName} property': '更改{inputName}屬性',
  'change color bars based on previous close': '根據前一個收盤價更改K線顏色',
  'change HLC bars': '更改美國線',
  'change bar up color': '更改上漲K線顏色',
  'change bar down color': '更改下跌K線顏色',
  'change thin bars': '更改K線寬度',
  'change line price source': '更改線條價格來源',
  'change line type': '更改線條類型',
  'change line color': '更改線條顏色',
  'change line width': '更改線條寬度',
  'change area price source': '更改面積價格來源',
  'change area line color': '更改面積線條顏色',
  'change area line width': '更改面積線條寬度',
  'change area fill color': '更改面積填充顏色',
  'change baseline price source': '更改基準線價格來源',
  'change baseline top line color': '更改基準線頂線顏色',
  'change baseline top line width': '更改基準線頂線寬度',
  'change baseline bottom line color': '更改基準線底線顏色',
  'change baseline bottom line width': '更改基準線底線寬度',
  'change baseline fill top area color': '更改基準線填充頂部區域顏色',
  'change baseline fill bottom area color': '更改基準線填充底部區域顏色',
  'change base level': '更改基礎水平',
  'change high-low body visibility': '更改高-低實體可見性',
  'change high-low body color': '更改高-低實體顏色',
  'change high-low borders visibility': '更改高-低邊框可見性',
  'change high-low border color': '更改高-低邊框顏色',
  'change high-low labels visibility': '更改高-低標籤可見性',
  'change high-low labels color': '更改高-低標籤顏色',
  'change high-low labels font size': '更改高-低標籤字體大小',
  'change renko wick visibility': '更改磚形圖影線可見性',
  'change renko wick up color': '更改磚形圖上影線顏色',
  'change renko wick down color': '更改磚形圖下影線顏色',
  'change the display of real prices on price scale (instead of Heiken-Ashi price)':
    '更改價格坐標上的實際價格顯示(而不是Heiken-Ashi價格)',
  'change range thin bars': '更改範圍K線寬度',
  'change {candleType} body visibility': '更改{candleType}實體可見性',
  'change {candleType} up color': '更改{candleType}上漲顏色',
  'change {candleType} down color': '更改{candleType}下跌顏色',
  'change {candleType} border visibility': '更改{candleType}邊框可見性',
  'change {candleType} up border color': '更改{candleType}上漲邊框顏色',
  'change {candleType} down border color': '更改{candleType}下跌邊框顏色',
  'change {candleType} wick visibility': '更改{candleType}影線可見性',
  'change {candleType} wick up color': '更改{candleType}上影線顏色',
  'change {candleType} wick down color': '更改{candleType}下影線顏色',
  'change {chartType} up color': '更改{chartType}上漲顏色',
  'change {chartType} down color': '更改{chartType}下跌顏色',
  'change {chartType} projection bar up color': '更改{chartType}投影K線上漲顏色',
  'change {chartType} projection bar down color': '更改{chartType}投影K線下跌顏色',
  'change {chartType} border bar up color': '更改{chartType}邊框上漲顏色',
  'change {chartType} border bar down color': '更改{chartType}邊框下跌顏色',
  'change {chartType} projection border bar up color': '更改{chartType}投影邊框上漲顏色',
  'change column up color': '更改向上列的顏色',
  'change column down color': '更改向下列的顏色',
  'change column price source': '更改列價格來源',
  'Thin bars': '自動調整K棒寬度',
  'Top line': '上邊框線',
  'Bottom line': '下邊框線',
  'Fill top area': '上填充色',
  'Fill bottom area': '下填充色',
  'Real prices on price scale (instead of Heikin-Ashi price)': '價格刻度上的實際價格（而不是平均K線價格）',
  'Base level': '基準水位',
  candle: '燭線',
  range_0: '範圍',
  'hollow candles': '空心K線',
  Center: '中心',
  'change {title} middle point visibility': '更改{title}中點可見性',
  'change {title} price labels visibility': '更改{title}價格標籤可見性',
  'change {title} price range visibility': '更改{title}價格範圍可見性',
  'change {title} bars range visibility': '更改{title}K線範圍可見性',
  'change {title} date/time range visibility': '更改{title}日期/時間範圍可見性',
  'change {title} distance visibility': '更改{title}距離可見性',
  'change {title} angle visibility': '更改{title}角度可見性',
  'change {title} always show stats': '更改{title}總是顯示統計資訊',
  'change {title} stats position': '更改{title}統計位置',
  'Middle point': '中點',
  'Price labels': '價格標籤',
  'Stats position': '統計位置',
  'Price range': '價格範圍',
  'Bars range': 'K線範圍',
  'Date/time range': '日期/時間範圍',
  Distance: '距離',
  Angle: '角度',
  'Always show stats': '總是顯示統計',
  Stats: '統計數據',
  'change {toolName} line visibility': '更改{toolName}線條可見性',
  'change {toolName} line width': '更改{toolName}線條寬度',
  'change {toolName} line style': '更改{toolName}線條樣式',
  'change {toolName} line color': '更改{toolName}線條顏色',
  'change {toolName} line extending left': '更改{toolName}線條向左延伸',
  'change {toolName} line left end': '更改{toolName}線條左端',
  'change {toolName} line extending right': '更改{toolName}線條向右延伸',
  'change {toolName} line right end': '更改{toolName}線條右端',
  'Extend left line': '延伸左邊線條',
  'Extend right line': '延伸右邊線條',
  'change {toolName} text visibility': '更改{toolName}文字可見性',
  'change {toolName} text color': '更改{toolName}文字顏色',
  'change {toolName} text font size': '更改{toolName}文字字體大小',
  'change {toolName} text font bold': '更改{toolName}文字字體加粗',
  'change {toolName} text font italic': '更改{toolName}文字字體斜體',
  'change {toolName} text': '更改{toolName}文字',
  'change {toolName} labels alignment vertical': '更改{toolName}標籤垂直對齊',
  'change {toolName} labels alignment horizontal': '更改{toolName}標籤水平對齊',
  'change {toolName} labels direction': '更改{toolName}標籤方向',
  'change {toolName} text background visibility': '更改{toolName}文字背景可見性',
  'change {toolName} text background color': '更改{toolName}文字背景顏色',
  'change {toolName} text border visibility': '更改{toolName}文字邊框可見性',
  'change {toolName} text border width': '更改{toolName}文字邊框寬度',
  'change {toolName} text border color': '更改{toolName}文字邊框顏色',
  'change {toolName} text wrap': '更改{toolName}文字換行',
  'Text wrap': '自動換行',
  'change arrow color': '更改箭頭顏色',
  'change {title} color': '更改{title}顏色',
  'change {title} mode': '更改{title}模式',
  'change {title} mirrored': '更改{title}鏡像',
  'change {title} flipped': '更改{title}翻轉',
  Mode: '模式',
  Mirrored: '鏡像',
  Flipped: '水平翻轉',
  'HL bars': 'HL K線',
  ...
  'Line - low': '線 - 最低價',
  'Line - HL/2': '線 - HL/2',
  'change {title} background visibility': '更改{title}背景可見性',
  'change {title} background color': '更改{title}背景顏色',
  'change {title} degree': '更改{title}角度',
  Wave: '波浪',
  Degree: '級別',
  'change {title} level {index} line visibility': '更改{title}水平{index}線可見性',
  'change {title} levels visibility': '更改{title}水平可見性',
  'change {title} level {index} line color': '更改{title}水平{index}線顏色',
  'change {title} level {index} line width': '更改{title}水平{index}線寬度',
  'change {title} level {index} line coeff': '更改{title}水平{index}線系數',
  'change {title} all lines color': '更改{title}所有線條顏色',
  'change {title} background transparency': '更改{title}背景透明度',
  'change {title} coeffs as percents visibility': '更改{title}係數為百分比可見性',
  'Trend line': '趨勢線',
  'Use one color': '使用一個顏色',
  Levels: '水平',
  'Coeffs as percents': '以百分比表示的係數',
  'change {title} reverse': '更改{title}翻轉',
  'change {title} prices visibility': '更改{title}價格可見性',
  'change {title} labels alignment': '更改{title}標籤對齊方式',
  'change {title} labels font size': '更改{title}標籤字體大小',
  'change {title} style': '更改{title}樣式',
  'change {title} fib levels based on log scale': '在對數刻度上更改{title}斐波那契水平',
  'Levels line': '水平線',
  'Extend right': '向右延伸',
  'Extend left': '向左延伸',
  ...
  Middle: '中間',
  Bottom: '底部',
  'change {title} full circles visibility': '更改{title}完整圓圈的可見性',
  'Full circles': '完整圓圈',
  'change {title} left labels visibility': '更改{title}左側標籤可見性',
  'change {title} right labels visibility': '更改{title}右側標籤可見性',
  'change {title} top labels visibility': '更改{title}頂部標籤可見性',
  'change {title} bottom labels visibility': '更改{title}底部標籤可見性',
  'change {title} grid visibility': '更改{title}網格可見性',
  'change {title} grid line color': '更改{title}網格線顏色',
  'change {title} grid line width': '更改{title}網格線寬度',
  'change {title} grid line style': '更改{title}網格線樣式',
  'Price levels': '價格水平',
  'Time levels': '時間水平',
  'Left labels': '左標籤',
  'Right labels': '右邊標籤',
  'Top labels': '熱門標籤',
  'Bottom labels': '底部標籤',
  'change {title} line color': '更改{title}線條顏色',
  'change {title} line width': '更改{title}線條寬度',
  'change {title} line style': '更改{title}線條樣式',
  'change {title} counterclockwise': '更改{title}逆時針',
  'change {title} level {index} line style': '更改{title}水平{index}線樣式',
  'change {title} labels visibility': '更改{title}標籤可見性',
  'change flag color': '更改旗標顏色',
  'change {title} fan {index} line visibility': '改變{title}扇形{index}線條可見性',
  'change {title} fan {index} line color': '更改{title}扇形{index}線條顏色',
  'change {title} fan {index} line width': '更改{title}扇形{index}線條寬度',
  'change {title} arcs {index} line visibility': '更改{title}弧形{index}線條可見性',
  'change {title} arcs {index} line color': '更改{title}弧形{index}線條顏色',
  'change {title} arcs {index} line width': '更改{title}弧形{index}線條寬度',
  'Price/bar ratio': '價格/K線比',
  'Ranges and ratio': '範圍和比例',
  Fans: '扇形',
  Arcs: '弧形',
  'change {title} fans visibility': '更改{title}扇形可見性',
  'change {title} fans line color': '更改{title}扇形線條顏色',
  Angles: '角度',
  'change {title} extend top': '更改{title}延長頂部',
  'change {title} extend bottom': '更改{title}延長底部',
  'change {title} extend left': '更改{title}延長左邊',
  'Extend top': '延伸頂部',
  'Extend bottom': '延伸底部',
  Label: '標籤',
  'Label background': '標籤背景顏色',
  'change {title} candle up color': '更改{title}K線上漲顏色',
  'change {title} candle down color': '更改{title}K線下跌顏色',
  'change {title} candle border visibility': '更改{title}K線邊框可見性',
  'change {title} candle border up color': '更改{title}K線邊框上漲顏色',
  'change {title} candle border down color': '更改{title}K線邊框下跌顏色',
  'change {title} candle wick visibility': '更改{title}K線影線可見性',
  'change {title} candle wick color': '更改{title}K線影線顏色',
  ...
  Channel: '管道',
  'change {title} extend lines': '更改{title}延長線',
  Median: '中線',
  'Extend lines': '延長線',
  Original: '原型',
  Schiff: '希夫',
  ...
  Inside: '内部',
  'change {title} source text color': '更改{title}源文字顏色',
  'change {title} source background color': '更改{title}源背景顏色',
  'change {title} source border color': '更改{title}源邊框顏色',
  'change {title} target text color': '更改{title}目標文字顏色',
  'change {title} target background color': '更改{title}目標背景顏色',
  'change {title} target border color': '更改{title}目標邊框顏色',
  'change {title} success text color': '更改{title}成功文字顏色',
  'change {title} success background color': '更改{title}成功背景顏色',
  'change {title} failure text color': '更改{title}失敗文本顏色',
  'change {title} failure background color': '更改{title}失敗背景顏色',
  'Source text': '來源文本',
  ...
  'Line color': '線條顏色',
  'Label border': '標籤邊框',
  'change {title} background color 1': '更改{title}背景顏色1',
  'change {title} background color 2': '更改{title}背景顏色2',
  'change {title} stop color': '更改{title}停損顏色',
  'change {title} target color': '更改{title}目標顏色',
  'change {title} compact stats mode': '更改{title}緊湊統計模式',
  'change {title} account size': '更改{title}帳戶大小',
  'change {title} lot size': '更改{title}手數大小',
  'change {title} risk': '更改{title}風險',
  'change {title} risk display mode': '更改{title}風險顯示模式',
  'change {title} entry price': '更改{title}入場價格',
  'change {title} profit level': '更改{title}停利水平',
  'change {title} profit price': '更改{title}停利價格',
  'change {title} stop level': '更改{title}停損水平',
  'change {title} stop price': '更改{title}停損價格',
  'Stop color': '停損顏色：',
  'Target color': '獲利顏色：',
  ...
  'Lot size': '手數',
  Cash: '現金',
  'change vertical position Y coordinate': '更改垂直位置Y坐標',
  'change {title} emoji visibility': '更改{title}表情符號可見性',
  'change {title} image background color': '更改{title}圖片背景顏色',
  'change {title} emoji': '更改{title}表情符號',
  '#1 (vertical position %, bar)_linetool point': '#1 (垂直位置%，K線)',
  'Emoji pin': '表情貼',
  'change angle': '更改角度',
  '#1 (price, bar)_linetool point': '#1(價格,K棒)',
  '#1 (bar)_linetool point': '#1 (K棒)',
  'change decimal places': '更改小數位',
  'change extended hours color': '更改延長時段顏色',
  'change pre market color': '更改盤前市場顏色',
  'change post market color': '更改盤後市場顏色',
  'change price line color': '更改價格線顏色',
  'change price line width': '更改價格線寬度',
  'change previous close price line color': '更改前一根收盤價線顏色',
  'change previous close price line width': '更改前一根收盤價線寬度',
  'change pre/post market price lines visibility': '更改盤前/盤後市場價格線的可見性',
  'change pre market line color': '更改盤前市場線條顏色',
  'change post market line color': '更改盤後市場線條顏色',
  'change bid line color': '更改bid線顏色',
  'change ask line color': '更改ask線顏色',
  ...
  Step: '階梯',
  Default: '系統預設',
  'change {title} base line visibility': '更改{title}基準線可見性',
  'change {title} base line color': '更改{title}基準線顏色',
  'change {title} base line width': '更改{title}基準線寬度',
  'change {title} base line style': '更改{title}基準線樣式',
  'change {title} up line visibility': '更改{title}向上線條可見性',
  'change {title} up line color': '更改{title}向上線條顏色',
  'change {title} up line width': '更改{title}向上線條寬度',
  'change {title} up line style': '更改{title}向上線條樣式',
  'change {title} down line visibility': '更改{title}向下線條可見性',
  'change {title} down line color': '更改{title}向下線條顏色',
  'change {title} down line width': '更改{title}向下線條寬度',
  'change {title} down line style': '更改{title}向下線條樣式',
  "change {title} show pearson's r": "更改{title}顯示pearson's r",
  Base: '基準線',
  Up: '上',
  Down: '下',
  "Pearson's R": "皮爾遜相關係數(Pearson's R)",
  '#{count} (bar)_linetool point': '#{count}（K棒）',
  'change study overlay style': '改變研究覆蓋樣式',
  'change study overlay min tick': '更改研究覆蓋最小tick',
  'Override min tick': '顯示最小刻度',
  Horizontal: '橫式',
  Vertical: '直式',
  'Text alignment': '文字對齊',
  'Text orientation': '文字方向',
  'change {propertyName} property': '更改{propertyName}屬性',
  Offset: '偏移',
  ...
  'change values visibility': '更改值的可見性',
  ...
  'Values in status line': '狀態行中的值',
  'Labels on price scale': '價格刻度上的標籤',
  Forecast: '預測',
  'Script name': '腳本名稱',
  ...
  'less than 1 minute': '少於一分鐘',
  '{days} and {hours}': '{days}和{hours}',
  '{hours} and {minutes}': '{hours}和{minutes}',
  'Market opens in {remainingTime}.': '市場在{remainingTime}後開盤。',
  'Market closes in {remainingTime}.': '市場在{remainingTime}後收盤。',
  "It'll go to post-market trading in {remainingTime}.": '它將在{remainingTime}後進入盤後交易。',
  "It'll open for pre-market trading in {remainingTime}.": '盤前交易將在{remainingTime}後開盤。',
  'Replay mode': '重播模式',
  "You're in Replay mode. You're in Replay mode. You're in Replay mode.":
    '您處於重播模式。您處於重播模式。您處於重播模式。',
  ...
  'remove drawings group': '移除繪圖集',
  'move scale': '移動坐標',
  'stop syncing line tool(s)': '停止同步線條工具',
  'zoom out': '縮小',
  'zoom in': '放大',
  'move drawing(s)': '移動繪圖(多圖形)',
  'load default drawing template': '加載預設繪圖模板',
  ...
  'unmerge up': '取消向上合併',
  'unmerge down': '取消向下合併',
  'unmerge to new bottom pane': '取消合併到新的底部窗格',
  'move {title} to new right scale': '移動{title}到新的右刻度',
  'move {title} to new left scale': '移動{title}到新的左側刻度',
  'make {title} no scale (Full screen)': '使{title}無刻度(全螢幕)',
  'scroll time': '滾動時間',
  'scale time': '縮放時間',
  'reset time scale': '重設時間刻度',
  'reset scales': '重設刻度',
  'create {tool}': '建立{tool}',
  'change {pointIndex} point': '更改{pointIndex}點',
  'paste {title}': '粘貼{title}',
  'insert {title}': '插入{title}',
  'remove all studies': '移除所有研究',
  'remove drawings': '移除繪圖',
  'remove all studies and drawing tools': '移除所有研究和繪圖工具',
  'turn line tools sharing off': '關閉畫線工具分享',
  'share line tools in layout': '在版面中分享畫線工具',
  'share line tools globally': '全局分享畫線工具',
  'apply all chart properties': '應用所有圖表屬性',
  ...
  'removing line tools group {name}': '刪除線條工具組{name}',
  'add line tool {lineTool} to group {name}': '將畫線工具{lineTool}增加到{name}組',
  'make group {group} visible': '使組{group}可見',
  'make group {group} invisible': '隱藏{group}工具組',
  'lock group {group}': '鎖定組{group}',
  'unlock group {group}': '解鎖組{group}',
  'rename group {group} to {newName}': '將工具組{group}重命名為{newName}',
  'change {sourceTitle} title to {newSourceTitle}': '將{sourceTitle}標題更改為{newSourceTitle}',
  'insert source(s) after': '插入源到後面',
  'mirror bars pattern': '鏡像K線形態',
  'flip bars pattern': '翻轉K線形態',
  ...
  'Elliott Double Combo Wave (WXY)': '艾略特雙組合波浪(WXY)',
  ...
  'Ghost Feed': '模擬K線',
  '{status} P&L: {pnl}': '{status}損益表：{pnl}',
  Open_line_tool_position: '未平倉',
  Closed_line_tool_position: '已平倉',
  'Risk/Reward Ratio: {ratio}': '風險/報酬比：{ratio}',
  ...
  'Triangle Up': '上升三角形',
  'X Cross': 'X 交叉',
  Premarket_sessions: '盤前',
  Postmarket_sessions: '盤後',
  'Regular trading hours_sessions': '常規交易時間',
  'Extended trading hours_sessions': '延長交易時段',
  'Electronic trading hours_sessions': '電子交易時間',
  PRE_sessions: '前',
  POST_sessions: '後',
  RTH_sessions: 'RTH',
  ETH_sessions: 'ETH',
  'add line tool(s) to group {group}': '增加線條工具到組{group}',
  'apply study template {template}': '套用研究模板{template}',
  'change pane height': '更改窗格高度',
  'change date range': '更改日期範圍',
  'apply toolbars theme': '應用工具條主題',
  ...
  'paste drawing': '粘貼繪圖',
  'paste indicator': '粘貼指標',
  'scale price': '刻度價格',
  'rearrange panes': '重新排列窗格',
  'remove line data sources': '刪除線條數據源',
  'restore defaults': '恢復預設值',
  'change chart layout to {title}': '將圖表版面更改為{title}',
  'stop syncing drawing': '停止同步繪圖',
  zoom: '縮放',
  'bring {title} to front': '把{title}放在前面',
  'send {title} to back': '把{title}放在後面',
  'insert {title} after {targetTitle}': '在{targetTitle}之後插入{title}',
  'insert {title} before {targetTitle}': '在{targetTitle}前插入{title}',
  'send group {title} backward': '向後發送組{title}',
  'bring group {title} forward': '向前發送組{title}',
  ...
  'Hide positions & orders': '隱藏倉位&訂單',
  'Show all positions & orders': '顯示所有倉位&訂單',
  'Hide all positions & orders': '隱藏所有倉位&訂單',
  'Hide all': '全部隱藏',
  'Show all drawings, indicators, positions & orders': '顯示所有繪圖、指標、倉位&訂單',
  'Show all drawings and indicators': '顯示所有圖形和指標',
  'Hide all drawings, indicators, positions & orders': '隱藏所有繪圖、指標、倉位&訂單',
  'Hide all drawings and indicators': '隱藏所有圖形和指標',
  'remove all line tools for {symbol}': '移除{symbol}的所有線條工具',
  ...
  'Object tree': '物件樹',
  'Create a group of drawings': '建立一組繪圖',
  'Clone, Copy': '克隆，複製',
  ...
  'Set the "{inputInline}" time and price for "{studyShortDescription}"':
    '為{studyShortDescription}設定{inputInline}時間和價格',
  'Set the time and price for "{studyShortDescription}"': '設定“{studyShortDescription}”的時間和價格',
  'Set the "{inputTitle}" time for "{studyShortDescription}"': '為{studyShortDescription}設定{inputTitle}時間',
  'Set the time for "{studyShortDescription}"': '設定“{studyShortDescription}”的時間',
  'Set the "{inputTitle}" price for "{studyShortDescription}"': '為{studyShortDescription}設定{inputTitle}價格',
  'Set the price for "{studyShortDescription}"': '設定“{studyShortDescription}”的價格',
  'Add Symbol': '新增商品',
  'Confirm Inputs': '確認參數',
  'Reset settings': '重設設定',
  ...
  'Apply Defaults': '套用預設值',
  'apply factory defaults to selected sources': '將出廠預設設定應用於選定的源',
  'Selected Drawings': '選定的繪圖',
  Gradient: '漸層',
