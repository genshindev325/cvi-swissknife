...
import styles from './CviTermOfUse.module.scss'
  ...
  return (
    <div className="m-auto px-6 pt-6">
      <span className="flex flex-col gap-3 bg-dark-600 lg:max-w-[1200px] text-white p-12 rounded-2xl">
        <h1 className={`${styles.title} font-sans`}>Terms of Use</h1>
        <ol id={styles.l1}>
          <li data-list-text="1.">
            ...
            <ol id={styles.l2}>
              <li data-list-text="1.1.">
                <p className="text-md">
                  Welcome to the CVI platform, available at{' '}
                  <a href="http://www.cvi.finance/" className={styles.a} target="_blank" rel="noreferrer">
                    www.cvi.finance
                  </a>{' '}
                  (the “Website” or the “Platform”), developed by and on behalf of COTI (the “Company” and/or “Our”
                  and/or ”We” and/or “Us”). The Company is a non-custodial provider of software services, meaning the
                  Company does not have custody of, control or manage user funds in any manner whatsoever. The Services
                  (as defined in section 3) are deployed in a public environment wherein users can autonomously and
                  directly access the Service without any involvement or actions taken by the Company.
                </p>
              </li>
                ...
                <ol id={styles.l4}>
                  <li data-list-text="(i)">
                    <p className="text-md">
                      ...
                      <span className={styles.lowerRoman}>(ii)</span> the United States of America (and its territories,
                      including Puerto Rico), British Virgin Islands, Canada, Gibraltar, Israel, Iran, North Korea,
                      Sudan, Syria, Lebanon, Russia and the Crimea, Donetsk or Luhansk regions of Ukraine; and{' '}
                      <span className={styles.lowerRoman}>(ii)</span> any other jurisdiction which prohibits or requires
                      any supervision oversight licensing regulatory compliance legal compliance and/or prior approval
                      from any regulatory (or similar) authority or body or form any monetary or securities body.
                      “Forbidden Persons” refers to any individual, natural person, firm, company, partnership, trust,
                      corporation, entity, government, state or agency of a state or any other incorporated or
                      unincorporated body or association, association or partnership (whether or not having separate
                      legal personality) that is <span className={styles.lowerRoman}>(i)</span> established and/or
                      lawfully existing under the laws of a Forbidden Territory;{' '}
                      <span className={styles.lowerRoman}>(ii)</span> citizen, resident (tax or otherwise), green card
                      holder, or located of other jurisdictions that are included from time to time in international
                      lists of countries at risk of money laundering; <span className={styles.lowerRoman}>(iii)</span>{' '}
                      listed under any sanction list administered by the United States of America, the United Nations
                      Security Council, the European Union, the United Kingdom, Israel or the respective governmental
                      institutions of any of the foregoing; <span className={styles.lowerRoman}>(iv)</span> politicly
                      exposed person.
                    </p>
                  </li>
                </ol>
          ...
          <li data-list-text="3.">
            ...
            <ol id={styles.l5}>
              <li data-list-text="3.1.">
                <p className="text-md">
                  As part of the Website (and as may change from time to time), You are allowed to (a) review the CVI
                  Index (as defined below) and assess the volatility in Bitcoin and Ethereum for the upcoming 30 days,
                  which allows Users to hedge themselves against market volatility or the lack thereof. The CVI Index is
                  created by computing a decentralized volatility index from cryptocurrency option prices together with
                  analyzing the market’s expectation of future volatility. “CVI Index” means, future volatility
                  expressed largely from the intraday fluctuations of the crypto market; (b) open positions against the
                  CVI Index; (c) provide liquidity; (d) use, mint and burn volatility tokens (“CVI”); (e) use the
                  staking program; (f) use the impermanent loss protection system (“ILP”); (h) use, mint and burn GOVI
                  tokens (“GOVI”); <span className={styles.lowerRoman}>(i)</span> perform other ancillary activities and
                  receive other services to be updated from time to time (together, the “Services”). For detailed and
                  updated information on the Services and the Platform, please carefully read and review the Website
                  (including the documents in it and the whitepapers).
                </p>
              </li>
              ...
              <li data-list-text="3.4.">
                <p className="text-md">
                  ...
                  evolution and/or movements of the CVI Index, any data included therein or any other data contained in
                  the Website; (b) shall not bear any responsibility for damages, costs or expenses that will be caused
                  due to reliance thereof; and (c) makes no warranty, express or implied, as to results to be obtained
                  by owners of any securities, or by any other person or entity from the use of the Services or any
              ...
              <li data-list-text="3.5.">
                ...
                <p className={styles.s2}>Staking Program</p>
              </li>
              <li data-list-text="3.6.">
                <p className="text-md">
                  We provide you the option to on-chain stake crypto-assets to contribute and support the community and
                  earn rewards.
                </p>
              </li>
              <li data-list-text="3.7.">
                <p className="text-md">
                  You may earn rewards on staked assets. Rewards are not guaranteed and the rates and timing of rewards
                  may vary. Reward rates will be determined at our sole discretion based on the type of staked asset,
                  market conditions and risk factors. Such rates have no relationship to and may not be competitive with
                  benchmark interest rates observed in the market for bank deposit accounts.
                </p>
              </li>
              <li data-list-text="3.8.">
                <p className="text-md">
                  We may make available anticipated reward rates and payment schedules from time to time on or through
                  the Services (the “Anticipated Rates”). Anticipated Rates are forward-looking statements that reflect
                  current expectations regarding future events, involve significant risks and uncertainties, should not
                  be read as guarantees of future performance or results, and will not necessarily be accurate
                  indications of whether or not such performance or results will be achieved. Forward-looking statements
                  are in no way a form of advice, solicitation, or offering of or for the staking program and should not
                  be interpreted as such.
                </p>
              </li>
              <li data-list-text="3.9.">
                <p className="text-md">
                  Therefore, the User shall not rely on the staking return estimations, and using them as a tool when
                  making a decision regarding the staking program or their withdrawal from the Platform is made at the
                  User’s sole risk. The Company will not bear any responsibility in connection with inaccuracies of the
                  staking return estimations and the User undertakes not to raise any claim against the Company for any
                  damage and/or loss and/or expense it incurs as a result of relying on or using the Staking Program.
                </p>
              </li>
              <li data-list-text="3.10.">
                <p className="text-md">
                  The on-chain staking program is not a depository, custody, or bank program. Your staked assets are not
                  covered by any governmental insurance protection against losses and are not being held in custody or
                  trust by Us.
                </p>
                <p className={styles.s2}>CVI Governance</p>
              </li>
              <li data-list-text="3.11.">
                <p className="text-md">
                  As an open-source protocol, some of the elements of the CVI protocol is or may be governed by GOVI
                  token holders. This allows the community to propose, vote, and implement changes through the
                  administrative functions of the GOVI token. Proposals can modify system parameters, tradable assets,
                  leverage used, deposit amounts, and platform fees, or add entirely new functionality to the protocol.
                </p>
                <p className={styles.s2}>Your Wallet</p>
              </li>
              <li data-list-text="3.12.">
                <p className="text-md">
                  All the Services require you to link your non-custodial wallet with the Platform. The Platform is a
                  purely on-chain non-custodial application, meaning you are solely responsible for the custody of the
                  cryptographic private keys to the digital asset wallets you hold. This Term is not intended to, and
                  does not, create or impose any fiduciary duties on Us. We draw to your attention that the wallet (as
                  MetaMask) is a third party and advise you to read its terms of use.
                </p>
              </li>
              ...
              <li data-list-text="3.14.">
                ...
                <p className={styles.s2}>General</p>
              </li>
              ...
              <li data-list-text="3.17.">
                <p className="text-md">
                  ...
                  Our requirements; (e) pending litigation, investigation, or government proceeding
                </p>
                <p className="text-md">
                  related to You or Your Wallet; and/or (f) in case We perceive a heightened risk of legal or regulatory
                  non-compliance associated with Your Wallet&#39;s activity, We may, at Our sole discretion and without
            ...
            <ol id={styles.l10}>
              ...
              <li data-list-text="5.3.">
                <p className="text-md">
                  ...
                  general, any digital currency that appears on the Website, and GOVI and CVI in particular, and
                  acknowledge that the GOVI and CVI may fluctuate in their value.
                </p>
              </li>
              <li data-list-text="5.4.">
                <p className="text-md">
                  You are aware that crypto assets (including GOVI and CVI) are not insured by any public or private
                  insurer, including against cyber theft or theft by other means, and that cryptocurrency activity is
                  not regulated activity in many states. Accordingly, You acknowledge that the value of crypto assets
                  can be extremely volatile and unpredictable, which can result in significant losses in a short time,
                  including possibly a loss of total value and that the price and liquidity of crypto assets has been
                  subject to large fluctuations in the past and may be subject to large fluctuations in the future.
                </p>
              </li>
              <li data-list-text="5.5.">
                <p className="text-md">
                  You are aware and understand the uncertain nature of virtual currencies and that the Services, the
                  Platform, GOVI, CVI Index, ILP, and CVI are not regulated by any central bank or other government
                  authority, does not have any permit or licenses (not insurance licenses), and does not constitute
                  investment, insurance, securities or financial instrument/product.
                </p>
              </li>
              ...
              <li data-list-text="5.9.">
                <p className="text-md">
                  ...
                  Taxes”). You are also solely responsible for collecting, withholding, reporting, and remitting correct
                  Taxes to the appropriate tax authority. We are not obligated to, nor will We, determine whether Taxes
          ...
          <li data-list-text="6.">
            ...
            <ol id={styles.l11}>
              ...
              <li data-list-text="6.3.">
                <p className="text-md">
                  Virtual currencies in general, and ILP, GOVI and CVI in particular, are not legal tender and are not
                  backed by any sovereign government. In addition, the legislative and regulatory landscape around
                  virtual currencies is constantly changing and may affect Your ability to use, transfer, or exchange
                  virtual currencies.
                </p>
              </li>
            ...
            <ol id={styles.l12}>
              <li data-list-text="7.1.">
                <p className="text-md">
                  ...
                  including intellectual property rights, protection of privacy rights or any other right;
                </p>
                <p className="text-md">
                  (b) information or other material that is prohibited for publication or use because it constitutes
                </p>
                <p className="text-md">
                  threat, harm, insult, slander, defamation, racism or inappropriate content; (c) information or other
                  material that includes a virus or other software that may damage the computer systems of the Company
                  or any third parties or in a manner that may restrict or prevent others from using the Services; (d)
        ...
        <p className={styles.s2}>LEGAL CONSIDERATIONS, RISKS, AND DISCLAIMERS</p>
        <p className="text-md">
        ...
        <p className="text-md">
          ...
          <span className={styles.lowerRoman}>(i)</span> using the Services and any and all information available on the
          Website (all the information available on the Website, the whitepapers and the documents, hereinafter referred
          to as the “Available Information”); and <span className={styles.lowerRoman}>(ii)</span> using the Services.
          The contents of this “Legal Considerations, Risks and Disclaimers” paper outlines the terms and conditions
          applicable to you in connection with <span className={styles.lowerRoman}>(i)</span> your use of any and all
          Available Information on the Website; and <span className={styles.lowerRoman}>(ii)</span> using the Services,
          in each case in addition to any other terms and conditions that we may publish from time to time relating to
          Services at the Available Information and over the Website (such terms hereinafter referred to as the
          “Terms”). This “Legal Considerations, Risks and Disclaimers” paper may be updated from time to time and will
          be published on the Website. You shall be obliged to read in full the latest available version of this paper
          as well as of the Available Information and all other information available on the Website prior to using the
          Services.
        </p>
        <p className="text-md">
        ...
        <p className={styles.s2}>LEGAL CONSIDERATIONS</p>
        <p className="text-md">
        ...
        <p className={styles.s2}>REGIONAL RESTRICTIONS</p>
        <p className="text-md">
        ...
        <p className={styles.s2}>NO ADVICE</p>
        <p className="text-md">
        ...
        <p className={styles.s2}>CAUTIONARY NOTE ON FORWARD-LOOKING STATEMENTS</p>
        <p className="text-md">
        ...
        <p className={styles.s2}>RISK FACTORS</p>
        <p className="text-md">
        ...
        <p className={styles.s2}>DISCLAIMER</p>
        <p className="text-md">
