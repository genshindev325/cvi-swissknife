...
export interface CVOLUSDTLiquidationInterface extends utils.Interface {
  ...
  functions: {
    ...
    "setMinLiquidationThreshold(uint16)": FunctionFragment;
    "setMinLiquidationReward(uint16)": FunctionFragment;
    "setMaxLiquidationReward(uint16)": FunctionFragment;
    "isLiquidationCandidate(uint256,bool,uint256)": FunctionFragment;
    "getLiquidationReward(uint256,bool,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "setMinLiquidationThreshold",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setMinLiquidationReward",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CVOLUSDTLiquidation extends BaseContract {
  ...
  functions: {
    ...
    setMinLiquidationThreshold(
      _newMinThreshold: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setMinLiquidationReward(
      _newMinRewardAmount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setMaxLiquidationReward(
      _newMaxRewardAmount: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
