...
export interface RHEGIC2ETHStakingRewardsInterface extends utils.Interface {
  contractName: "RHEGIC2ETHStakingRewards";
  functions: {
...
export interface RHEGIC2ETHStakingRewards extends BaseContract {
  contractName: "RHEGIC2ETHStakingRewards";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RHEGIC2ETHStakingRewardsInterface;
