...
export interface ETHVOLUSDCPositionRewardsInterface extends utils.Interface {
  contractName: "ETHVOLUSDCPositionRewards";
  functions: {
...
export interface ETHVOLUSDCPositionRewards extends BaseContract {
  contractName: "ETHVOLUSDCPositionRewards";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOLUSDCPositionRewardsInterface;
