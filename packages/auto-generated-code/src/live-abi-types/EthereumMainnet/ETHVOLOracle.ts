...
export interface ETHVOLOracleInterface extends utils.Interface {
  contractName: "ETHVOLOracle";
  functions: {
...
export interface ETHVOLOracle extends BaseContract {
  contractName: "ETHVOLOracle";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOLOracleInterface;
