...
export interface ETHVOLUSDCLPStakingRewardsInterface extends utils.Interface {
...
export interface ETHVOLUSDCLPStakingRewards extends BaseContract {
  contractName: "ETHVOLUSDCLPStakingRewards";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOLUSDCLPStakingRewardsInterface;
