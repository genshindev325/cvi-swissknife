...
export interface CVOLOracleETHInterface extends utils.Interface {
  contractName: "CVOLOracleETH";
  functions: {
...
export interface CVOLOracleETH extends BaseContract {
  contractName: "CVOLOracleETH";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVOLOracleETHInterface;
