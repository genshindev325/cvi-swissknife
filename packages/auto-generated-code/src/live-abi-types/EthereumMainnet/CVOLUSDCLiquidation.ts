...
export interface CVOLUSDCLiquidationInterface extends utils.Interface {
  contractName: "CVOLUSDCLiquidation";
  functions: {
...
export interface CVOLUSDCLiquidation extends BaseContract {
  contractName: "CVOLUSDCLiquidation";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVOLUSDCLiquidationInterface;
