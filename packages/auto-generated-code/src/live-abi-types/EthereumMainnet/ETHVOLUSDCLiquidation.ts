...
export interface ETHVOLUSDCLiquidationInterface extends utils.Interface {
  contractName: "ETHVOLUSDCLiquidation";
  functions: {
...
export interface ETHVOLUSDCLiquidation extends BaseContract {
  contractName: "ETHVOLUSDCLiquidation";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOLUSDCLiquidationInterface;
