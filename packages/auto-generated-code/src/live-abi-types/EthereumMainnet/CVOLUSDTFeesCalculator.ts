...
export interface CVOLUSDTFeesCalculatorInterface extends utils.Interface {
  ...
  functions: {
    ...
    "calculateBuyingPremiumFeeWithTurbulence(uint256,uint256,uint16)": FunctionFragment;
...
export interface CVOLUSDTFeesCalculator extends BaseContract {
  ...
  functions: {
    ...
    "updateTurbulenceIndicatorPercent(uint256,uint256)"(
      totalHours: BigNumberish,
      newRounds: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "updateTurbulenceIndicatorPercent(uint256[])"(
