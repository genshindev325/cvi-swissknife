...
export interface ETHVOLUSDCPlatformImplementationInterface
  extends utils.Interface {
  contractName: "ETHVOLUSDCPlatformImplementation";
  functions: {
    ...
    "closePosition(uint168,uint16,uint16)": FunctionFragment;
    "closePositionWithoutVolumeFee(uint168,uint16)": FunctionFragment;
    ...
    "initialize(address,string,string,uint256,uint16,address,address,address)": FunctionFragment;
    ...
    "noPremiumFeeAllowedAddresses(address)": FunctionFragment;
    "openPosition(uint168,uint16,uint16,uint8)": FunctionFragment;
    "openPositionWithoutPremiumFee(uint168,uint16,uint8)": FunctionFragment;
    "openPositionWithoutVolumeFee(uint168,uint16,uint16,uint8)": FunctionFragment;
    "owner()": FunctionFragment;
    "positions(address)": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "revertLockedTransfered(address)": FunctionFragment;
    "rewards()": FunctionFragment;
    "setAddressSpecificParameters(address,bool,bool,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "closePositionWithoutVolumeFee",
  ...
  encodeFunctionData(
    functionFragment: "noPremiumFeeAllowedAddresses",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "openPositionWithoutPremiumFee",
    values: [BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "openPositionWithoutVolumeFee",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
...
export interface ETHVOLUSDCPlatformImplementation extends BaseContract {
  contractName: "ETHVOLUSDCPlatformImplementation";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOLUSDCPlatformImplementationInterface;
  ...
  functions: {
    ...
    closePosition(
      ...
      _maxClosingPremiumFeePercentage: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    closePositionWithoutVolumeFee(
      _positionUnitsAmount: BigNumberish,
      _minCVI: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
