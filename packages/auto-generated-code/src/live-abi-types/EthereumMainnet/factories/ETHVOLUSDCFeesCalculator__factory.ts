...
import type {
  ETHVOLUSDCFeesCalculator,
  ETHVOLUSDCFeesCalculatorInterface,
} from "../ETHVOLUSDCFeesCalculator";
...
export class ETHVOLUSDCFeesCalculator__factory {
  static readonly abi = _abi;
  static createInterface(): ETHVOLUSDCFeesCalculatorInterface {
    return new utils.Interface(_abi) as ETHVOLUSDCFeesCalculatorInterface;
  }
  static connect(
    address: string,
