...
export class ETHVOLUSDCLONG__factory {
  static readonly abi = _abi;
  static createInterface(): ETHVOLUSDCLONGInterface {
    return new utils.Interface(_abi) as ETHVOLUSDCLONGInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ETHVOLUSDCLONG {
    return new Contract(address, _abi, signerOrProvider) as ETHVOLUSDCLONG;
  }
}
