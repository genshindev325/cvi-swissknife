...
import type {
  ETHVOLUSDCLiquidation,
  ETHVOLUSDCLiquidationInterface,
} from "../ETHVOLUSDCLiquidation";
...
export class ETHVOLUSDCLiquidation__factory {
  static readonly abi = _abi;
  static createInterface(): ETHVOLUSDCLiquidationInterface {
    return new utils.Interface(_abi) as ETHVOLUSDCLiquidationInterface;
  }
  static connect(
    address: string,
