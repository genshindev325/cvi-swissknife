...
export interface CVOLUSDCRebaserInterface extends utils.Interface {
  contractName: "CVOLUSDCRebaser";
  functions: {
...
export interface CVOLUSDCRebaser extends BaseContract {
  contractName: "CVOLUSDCRebaser";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVOLUSDCRebaserInterface;
