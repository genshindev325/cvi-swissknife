...
import type {
  CVOLUSDCRequestFeesCalculator,
  CVOLUSDCRequestFeesCalculatorInterface,
} from "../CVOLUSDCRequestFeesCalculator";
...
export class CVOLUSDCRequestFeesCalculator__factory {
  static readonly abi = _abi;
  static createInterface(): CVOLUSDCRequestFeesCalculatorInterface {
    return new utils.Interface(_abi) as CVOLUSDCRequestFeesCalculatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as CVOLUSDCRequestFeesCalculator;
  }
}
