...
import type {
  CVOLUSDCFeesCalculator,
  CVOLUSDCFeesCalculatorInterface,
} from "../CVOLUSDCFeesCalculator";
...
export class CVOLUSDCFeesCalculator__factory {
  static readonly abi = _abi;
  static createInterface(): CVOLUSDCFeesCalculatorInterface {
    return new utils.Interface(_abi) as CVOLUSDCFeesCalculatorInterface;
  }
  static connect(
    address: string,
