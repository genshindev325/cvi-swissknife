...
import type {
  CVOLUSDCLiquidation,
  CVOLUSDCLiquidationInterface,
} from "../CVOLUSDCLiquidation";
...
export class CVOLUSDCLiquidation__factory {
  static readonly abi = _abi;
  static createInterface(): CVOLUSDCLiquidationInterface {
    return new utils.Interface(_abi) as CVOLUSDCLiquidationInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CVOLUSDCLiquidation {
    return new Contract(address, _abi, signerOrProvider) as CVOLUSDCLiquidation;
  }
}
