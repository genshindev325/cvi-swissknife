...
import type {
  CVOLUSDCPlatform,
  CVOLUSDCPlatformInterface,
} from "../CVOLUSDCPlatform";
...
export class CVOLUSDCPlatform__factory {
  static readonly abi = _abi;
  static createInterface(): CVOLUSDCPlatformInterface {
    return new utils.Interface(_abi) as CVOLUSDCPlatformInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CVOLUSDCPlatform {
    return new Contract(address, _abi, signerOrProvider) as CVOLUSDCPlatform;
  }
}
