...
export interface FakePriceProviderInterface extends utils.Interface {
  functions: {
...
export interface FakePriceProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FakePriceProviderInterface;
