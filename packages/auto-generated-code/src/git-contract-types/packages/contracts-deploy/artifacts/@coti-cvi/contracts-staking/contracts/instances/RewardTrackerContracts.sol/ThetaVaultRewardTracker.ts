...
export interface ThetaVaultRewardTrackerInterface extends utils.Interface {
  functions: {
...
export interface ThetaVaultRewardTracker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThetaVaultRewardTrackerInterface;
