...
export interface ETHVOL_USDCLPStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface ETHVOL_USDCLPStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHVOL_USDCLPStakingRewardsInterface;
