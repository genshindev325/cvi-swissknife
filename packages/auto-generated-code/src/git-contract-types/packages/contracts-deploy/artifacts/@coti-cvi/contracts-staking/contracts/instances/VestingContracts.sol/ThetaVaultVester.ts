...
export interface ThetaVaultVesterInterface extends utils.Interface {
  functions: {
...
export interface ThetaVaultVester extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThetaVaultVesterInterface;
