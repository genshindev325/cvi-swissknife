...
export interface ThetaVaultRequestFulfillerInterface extends utils.Interface {
  functions: {
...
export interface ThetaVaultRequestFulfiller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThetaVaultRequestFulfillerInterface;
