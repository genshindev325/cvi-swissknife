...
export interface GOVIRewardTrackerDistributorInterface extends utils.Interface {
  functions: {
...
export interface GOVIRewardTrackerDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GOVIRewardTrackerDistributorInterface;
