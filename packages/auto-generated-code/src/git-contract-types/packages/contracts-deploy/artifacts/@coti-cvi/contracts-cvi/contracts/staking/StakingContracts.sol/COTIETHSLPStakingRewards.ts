...
export interface COTIETHSLPStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface COTIETHSLPStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: COTIETHSLPStakingRewardsInterface;
