...
export interface FakeCVIUSDCThetaVaultInterface extends utils.Interface {
  functions: {
...
export interface FakeCVIUSDCThetaVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FakeCVIUSDCThetaVaultInterface;
