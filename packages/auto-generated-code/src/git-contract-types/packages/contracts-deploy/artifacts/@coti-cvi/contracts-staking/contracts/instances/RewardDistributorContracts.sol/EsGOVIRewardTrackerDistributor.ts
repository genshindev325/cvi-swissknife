...
export interface EsGOVIRewardTrackerDistributorInterface
...
export interface EsGOVIRewardTrackerDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EsGOVIRewardTrackerDistributorInterface;
