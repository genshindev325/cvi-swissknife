...
export interface ETHLPStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface ETHLPStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ETHLPStakingRewardsInterface;
