...
export interface ThetaVaultRewardTrackerDistributorInterface
...
export interface ThetaVaultRewardTrackerDistributor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ThetaVaultRewardTrackerDistributorInterface;
