...
export interface PositionRewardsInterface extends utils.Interface {
  functions: {
...
export interface PositionRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PositionRewardsInterface;
