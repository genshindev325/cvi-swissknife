...
export interface GOVIRewardTrackerInterface extends utils.Interface {
  functions: {
...
export interface GOVIRewardTracker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GOVIRewardTrackerInterface;
