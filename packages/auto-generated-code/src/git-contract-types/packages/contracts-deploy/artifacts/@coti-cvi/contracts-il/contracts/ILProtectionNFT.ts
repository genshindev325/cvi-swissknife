...
export interface ILProtectionNFTInterface extends utils.Interface {
  functions: {
...
export interface ILProtectionNFT extends BaseContract {
  ...
  estimateGas: {
    ...
    protectionMetadataCID(overrides?: CallOverrides): Promise<BigNumber>;
