...
export interface USDCLPStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface USDCLPStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDCLPStakingRewardsInterface;
