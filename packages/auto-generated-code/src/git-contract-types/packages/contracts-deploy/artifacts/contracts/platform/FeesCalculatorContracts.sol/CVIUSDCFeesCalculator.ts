...
export interface CVIUSDCFeesCalculatorInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCFeesCalculator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCFeesCalculatorInterface;
