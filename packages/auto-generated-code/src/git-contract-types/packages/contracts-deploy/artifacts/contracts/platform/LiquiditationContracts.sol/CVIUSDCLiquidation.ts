...
export interface CVIUSDCLiquidationInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCLiquidation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCLiquidationInterface;
