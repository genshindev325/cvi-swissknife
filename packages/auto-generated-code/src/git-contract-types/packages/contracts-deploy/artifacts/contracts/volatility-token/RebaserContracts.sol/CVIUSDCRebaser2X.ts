...
export interface CVIUSDCRebaser2XInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCRebaser2X extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCRebaser2XInterface;
