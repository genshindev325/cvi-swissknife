...
export interface CVIFakeFeedOracleInterface extends utils.Interface {
  functions: {
...
export interface CVIFakeFeedOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIFakeFeedOracleInterface;
