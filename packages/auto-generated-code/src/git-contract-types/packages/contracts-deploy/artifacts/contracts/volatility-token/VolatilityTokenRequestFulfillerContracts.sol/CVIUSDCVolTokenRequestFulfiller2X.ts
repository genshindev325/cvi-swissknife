...
export interface CVIUSDCVolTokenRequestFulfiller2XInterface
...
export interface CVIUSDCVolTokenRequestFulfiller2X extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCVolTokenRequestFulfiller2XInterface;
