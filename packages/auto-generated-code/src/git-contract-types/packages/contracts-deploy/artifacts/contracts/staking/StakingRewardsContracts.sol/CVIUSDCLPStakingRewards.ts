...
export interface CVIUSDCLPStakingRewardsInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCLPStakingRewards extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCLPStakingRewardsInterface;
