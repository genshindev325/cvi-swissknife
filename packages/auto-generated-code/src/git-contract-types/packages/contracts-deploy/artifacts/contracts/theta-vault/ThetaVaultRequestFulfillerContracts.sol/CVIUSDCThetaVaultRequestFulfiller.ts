...
export interface CVIUSDCThetaVaultRequestFulfillerInterface
...
export interface CVIUSDCThetaVaultRequestFulfiller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCThetaVaultRequestFulfillerInterface;
