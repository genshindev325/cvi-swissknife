...
export interface CVIUSDCThetaVaultRequestFulfiller2XInterface
...
export interface CVIUSDCThetaVaultRequestFulfiller2X extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCThetaVaultRequestFulfiller2XInterface;
