...
export interface CVIUSDCVolatilityTokenInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCVolatilityToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCVolatilityTokenInterface;
