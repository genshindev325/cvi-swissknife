...
export interface CVIUSDCPlatformInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCPlatform extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCPlatformInterface;
