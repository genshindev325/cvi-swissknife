...
export interface CVIUSDCVolatilityToken2XInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCVolatilityToken2X extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCVolatilityToken2XInterface;
