...
export interface CVIDeviationOracleInterface extends utils.Interface {
  functions: {
...
export interface CVIDeviationOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIDeviationOracleInterface;
