...
export interface CVIUSDCThetaVaultInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCThetaVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCThetaVaultInterface;
