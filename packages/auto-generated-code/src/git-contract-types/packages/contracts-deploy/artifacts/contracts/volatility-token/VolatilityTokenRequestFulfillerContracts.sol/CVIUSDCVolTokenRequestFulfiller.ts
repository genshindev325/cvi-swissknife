...
export interface CVIUSDCVolTokenRequestFulfillerInterface
...
export interface CVIUSDCVolTokenRequestFulfiller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCVolTokenRequestFulfillerInterface;
