...
export interface CVIUSDCFeesCalculator2XInterface extends utils.Interface {
  functions: {
...
export interface CVIUSDCFeesCalculator2X extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CVIUSDCFeesCalculator2XInterface;
