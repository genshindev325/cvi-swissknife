...
} from "../../../../../node_modules/@uniswap/v2-periphery/build/UniswapV2Migrator";
...
export class UniswapV2Migrator__factory extends ContractFactory {
  ...
  override attach(address: string): UniswapV2Migrator {
    return super.attach(address) as UniswapV2Migrator;
  }
  override connect(signer: Signer): UniswapV2Migrator__factory {
