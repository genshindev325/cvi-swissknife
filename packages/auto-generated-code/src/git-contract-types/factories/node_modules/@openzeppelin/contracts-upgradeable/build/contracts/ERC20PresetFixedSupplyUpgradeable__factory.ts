...
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/ERC20PresetFixedSupplyUpgradeable";
...
type ERC20PresetFixedSupplyUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC20PresetFixedSupplyUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC20PresetFixedSupplyUpgradeable__factory extends ContractFactory {
  constructor(...args: ERC20PresetFixedSupplyUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<ERC20PresetFixedSupplyUpgradeable> {
    return super.deploy(
      overrides || {}
    ) as Promise<ERC20PresetFixedSupplyUpgradeable>;
  }
  ...
  override attach(address: string): ERC20PresetFixedSupplyUpgradeable {
    return super.attach(address) as ERC20PresetFixedSupplyUpgradeable;
  }
  override connect(signer: Signer): ERC20PresetFixedSupplyUpgradeable__factory {
  ...
  static createInterface(): ERC20PresetFixedSupplyUpgradeableInterface {
    return new utils.Interface(
      _abi
    ) as ERC20PresetFixedSupplyUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as ERC20PresetFixedSupplyUpgradeable;
  }
}
