...
import type {
  ...
  ERC777PresetFixedSupplyUpgradeableInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/ERC777PresetFixedSupplyUpgradeable";
...
type ERC777PresetFixedSupplyUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC777PresetFixedSupplyUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC777PresetFixedSupplyUpgradeable__factory extends ContractFactory {
  constructor(...args: ERC777PresetFixedSupplyUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<ERC777PresetFixedSupplyUpgradeable> {
    return super.deploy(
      overrides || {}
    ) as Promise<ERC777PresetFixedSupplyUpgradeable>;
  }
  ...
  override attach(address: string): ERC777PresetFixedSupplyUpgradeable {
    return super.attach(address) as ERC777PresetFixedSupplyUpgradeable;
  }
  override connect(
    signer: Signer
  ): ERC777PresetFixedSupplyUpgradeable__factory {
    return super.connect(signer) as ERC777PresetFixedSupplyUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ERC777PresetFixedSupplyUpgradeableInterface {
    return new utils.Interface(
      _abi
    ) as ERC777PresetFixedSupplyUpgradeableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as ERC777PresetFixedSupplyUpgradeable;
  }
}
