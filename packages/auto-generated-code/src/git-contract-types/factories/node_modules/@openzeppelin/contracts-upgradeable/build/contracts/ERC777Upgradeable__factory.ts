...
import type {
  ERC777Upgradeable,
  ERC777UpgradeableInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/ERC777Upgradeable";
...
type ERC777UpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC777UpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC777Upgradeable__factory extends ContractFactory {
  constructor(...args: ERC777UpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<ERC777Upgradeable> {
    return super.deploy(overrides || {}) as Promise<ERC777Upgradeable>;
  }
  ...
  override attach(address: string): ERC777Upgradeable {
    return super.attach(address) as ERC777Upgradeable;
  }
  override connect(signer: Signer): ERC777Upgradeable__factory {
    return super.connect(signer) as ERC777Upgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ERC777UpgradeableInterface {
    return new utils.Interface(_abi) as ERC777UpgradeableInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ERC777Upgradeable {
    return new Contract(address, _abi, signerOrProvider) as ERC777Upgradeable;
  }
}
