...
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/ERC20PresetMinterPauserUpgradeable";
...
type ERC20PresetMinterPauserUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ERC20PresetMinterPauserUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ERC20PresetMinterPauserUpgradeable__factory extends ContractFactory {
  constructor(...args: ERC20PresetMinterPauserUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): ERC20PresetMinterPauserUpgradeable {
