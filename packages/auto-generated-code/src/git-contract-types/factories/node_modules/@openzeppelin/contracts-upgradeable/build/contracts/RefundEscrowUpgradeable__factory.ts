...
import type {
  ...
  RefundEscrowUpgradeableInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/RefundEscrowUpgradeable";
...
type RefundEscrowUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: RefundEscrowUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class RefundEscrowUpgradeable__factory extends ContractFactory {
  constructor(...args: RefundEscrowUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<RefundEscrowUpgradeable> {
    return super.deploy(overrides || {}) as Promise<RefundEscrowUpgradeable>;
  }
  ...
  override attach(address: string): RefundEscrowUpgradeable {
    return super.attach(address) as RefundEscrowUpgradeable;
  }
  override connect(signer: Signer): RefundEscrowUpgradeable__factory {
    return super.connect(signer) as RefundEscrowUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RefundEscrowUpgradeableInterface {
    return new utils.Interface(_abi) as RefundEscrowUpgradeableInterface;
  }
  static connect(
    address: string,
