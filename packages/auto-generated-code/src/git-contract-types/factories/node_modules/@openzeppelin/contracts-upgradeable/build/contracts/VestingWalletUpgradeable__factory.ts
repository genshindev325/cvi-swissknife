...
import type {
  ...
  VestingWalletUpgradeableInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/VestingWalletUpgradeable";
...
type VestingWalletUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: VestingWalletUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class VestingWalletUpgradeable__factory extends ContractFactory {
  constructor(...args: VestingWalletUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<VestingWalletUpgradeable> {
    return super.deploy(overrides || {}) as Promise<VestingWalletUpgradeable>;
  }
  ...
  override attach(address: string): VestingWalletUpgradeable {
    return super.attach(address) as VestingWalletUpgradeable;
  }
  override connect(signer: Signer): VestingWalletUpgradeable__factory {
    return super.connect(signer) as VestingWalletUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): VestingWalletUpgradeableInterface {
    return new utils.Interface(_abi) as VestingWalletUpgradeableInterface;
  }
  static connect(
    address: string,
