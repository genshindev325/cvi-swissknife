...
import type {
  ...
  TokenTimelockUpgradeableInterface,
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/TokenTimelockUpgradeable";
...
type TokenTimelockUpgradeableConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: TokenTimelockUpgradeableConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class TokenTimelockUpgradeable__factory extends ContractFactory {
  constructor(...args: TokenTimelockUpgradeableConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<TokenTimelockUpgradeable> {
  ...
  override attach(address: string): TokenTimelockUpgradeable {
    return super.attach(address) as TokenTimelockUpgradeable;
  }
  override connect(signer: Signer): TokenTimelockUpgradeable__factory {
    return super.connect(signer) as TokenTimelockUpgradeable__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TokenTimelockUpgradeableInterface {
    return new utils.Interface(_abi) as TokenTimelockUpgradeableInterface;
  }
  static connect(
    address: string,
