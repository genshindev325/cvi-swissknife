...
} from "../../../../../../node_modules/@openzeppelin/contracts-upgradeable/build/contracts/MinimalForwarderUpgradeable";
...
export class MinimalForwarderUpgradeable__factory extends ContractFactory {
  ...
  override attach(address: string): MinimalForwarderUpgradeable {
    return super.attach(address) as MinimalForwarderUpgradeable;
  }
  override connect(signer: Signer): MinimalForwarderUpgradeable__factory {
