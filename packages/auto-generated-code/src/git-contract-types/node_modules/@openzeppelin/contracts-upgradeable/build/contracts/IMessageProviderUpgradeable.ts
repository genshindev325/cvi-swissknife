...
export interface IMessageProviderUpgradeableInterface extends utils.Interface {
  functions: {};
...
export interface IMessageProviderUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMessageProviderUpgradeableInterface;
