...
export interface IERC777UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IERC777Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC777UpgradeableInterface;
