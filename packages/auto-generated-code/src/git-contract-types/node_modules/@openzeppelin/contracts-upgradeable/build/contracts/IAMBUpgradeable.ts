...
export interface IAMBUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IAMBUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAMBUpgradeableInterface;
