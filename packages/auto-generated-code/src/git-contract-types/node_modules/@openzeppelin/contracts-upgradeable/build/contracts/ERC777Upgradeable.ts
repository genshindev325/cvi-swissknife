...
export interface ERC777UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC777Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC777UpgradeableInterface;
