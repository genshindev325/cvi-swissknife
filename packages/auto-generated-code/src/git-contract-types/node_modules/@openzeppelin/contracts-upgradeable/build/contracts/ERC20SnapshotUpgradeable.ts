...
export interface ERC20SnapshotUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC20SnapshotUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20SnapshotUpgradeableInterface;
