...
export interface ICompoundTimelockUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ICompoundTimelockUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICompoundTimelockUpgradeableInterface;
