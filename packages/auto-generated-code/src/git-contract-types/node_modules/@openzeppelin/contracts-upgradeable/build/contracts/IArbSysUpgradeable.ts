...
export interface IArbSysUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IArbSysUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IArbSysUpgradeableInterface;
