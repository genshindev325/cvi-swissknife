...
export interface IFxMessageProcessorUpgradeableInterface
...
export interface IFxMessageProcessorUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFxMessageProcessorUpgradeableInterface;
