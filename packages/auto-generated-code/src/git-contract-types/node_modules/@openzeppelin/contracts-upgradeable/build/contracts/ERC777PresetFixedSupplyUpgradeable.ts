...
export interface ERC777PresetFixedSupplyUpgradeableInterface
...
export interface ERC777PresetFixedSupplyUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC777PresetFixedSupplyUpgradeableInterface;
