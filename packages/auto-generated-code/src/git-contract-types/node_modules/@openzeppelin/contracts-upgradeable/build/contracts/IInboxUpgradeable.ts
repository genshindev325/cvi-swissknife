...
export interface IInboxUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IInboxUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IInboxUpgradeableInterface;
