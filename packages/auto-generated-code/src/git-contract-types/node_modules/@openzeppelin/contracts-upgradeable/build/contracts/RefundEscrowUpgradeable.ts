...
export interface RefundEscrowUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface RefundEscrowUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RefundEscrowUpgradeableInterface;
