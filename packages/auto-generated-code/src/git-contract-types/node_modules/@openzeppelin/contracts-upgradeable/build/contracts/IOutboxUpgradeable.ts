...
export interface IOutboxUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface IOutboxUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOutboxUpgradeableInterface;
