...
export interface ERC20VotesCompUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC20VotesCompUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20VotesCompUpgradeableInterface;
