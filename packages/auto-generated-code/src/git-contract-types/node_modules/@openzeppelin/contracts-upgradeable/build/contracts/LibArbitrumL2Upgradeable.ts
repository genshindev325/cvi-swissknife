...
export interface LibArbitrumL2UpgradeableInterface extends utils.Interface {
  functions: {
...
export interface LibArbitrumL2Upgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LibArbitrumL2UpgradeableInterface;
