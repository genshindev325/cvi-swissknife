...
export interface GmxPositionRouterInterface extends utils.Interface {
  functions: {
...
export interface GmxPositionRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GmxPositionRouterInterface;
