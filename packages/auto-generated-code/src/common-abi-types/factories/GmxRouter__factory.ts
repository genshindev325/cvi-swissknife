...
import type { GmxRouter, GmxRouterInterface } from "../GmxRouter";
...
export class GmxRouter__factory {
  static readonly abi = _abi;
  static createInterface(): GmxRouterInterface {
    return new utils.Interface(_abi) as GmxRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GmxRouter {
    return new Contract(address, _abi, signerOrProvider) as GmxRouter;
  }
}
