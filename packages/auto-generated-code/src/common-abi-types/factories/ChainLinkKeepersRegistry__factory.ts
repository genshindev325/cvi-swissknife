...
import type {
  ...
  ChainLinkKeepersRegistryInterface,
  ConfigStruct,
} from "../ChainLinkKeepersRegistry";

const _abi = [
  {
    inputs: [
      {
        internalType: "contract KeeperRegistryLogic1_3",
        name: "keeperRegistryLogic",
        type: "address",
      },
      {
        components: [
  ...
  {
    inputs: [],
    name: "OPTIMISM_ORACLE",
    outputs: [
      {
        internalType: "contract OVM_GasPriceOracle",
        name: "",
        type: "address",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum KeeperRegistryBase.PaymentModel",
        name: "",
        type: "uint8",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum KeeperRegistryBase.MigrationPermission",
        name: "",
        type: "uint8",
      },
    ],
...
export class ChainLinkKeepersRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): ChainLinkKeepersRegistryInterface {
    return new utils.Interface(_abi) as ChainLinkKeepersRegistryInterface;
  }
  static connect(
    address: string,
