...
import type {
  GmxPositionRouter,
  GmxPositionRouterInterface,
} from "../GmxPositionRouter";
...
export class GmxPositionRouter__factory {
  static readonly abi = _abi;
  static createInterface(): GmxPositionRouterInterface {
    return new utils.Interface(_abi) as GmxPositionRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GmxPositionRouter {
    return new Contract(address, _abi, signerOrProvider) as GmxPositionRouter;
  }
}
