...
import type {
  GmxPositionManager,
  GmxPositionManagerInterface,
} from "../GmxPositionManager";
...
export class GmxPositionManager__factory {
  static readonly abi = _abi;
  static createInterface(): GmxPositionManagerInterface {
    return new utils.Interface(_abi) as GmxPositionManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GmxPositionManager {
    return new Contract(address, _abi, signerOrProvider) as GmxPositionManager;
  }
}
