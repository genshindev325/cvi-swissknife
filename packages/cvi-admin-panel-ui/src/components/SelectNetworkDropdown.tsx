import { CHAIN_IDS_INFO, TV_SUPPORTED_CHAIN_IDS } from '@coti-cvi/lw-sdk/src'
...
export const SelectNetworkDropdown: FC<Props> = ({ setShowNetwork, setCviBackend }) => {
  ...
  return (
    <div className="relative max-w-[380px] pl-2 mb-1" ref={modalRef}>
      ...
      {open && (
        ...
        >
          {TV_SUPPORTED_CHAIN_IDS.map(c => CHAIN_IDS_INFO[c])
