...
import { thetaLPTokensPerInterval } from '../../state'
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await helper.deployProxy('ThetaVaultRewardTrackerDistributor', {
    args: [owner, esGovi.address, thetaLPTokensPerInterval],
  })
}
