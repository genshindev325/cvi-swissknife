...
export function convertPremiumValues(options: {
  from: 'number'
  to: 'string'
  tokenUSDC: Token<IERC20, TokenName.USDC>
  values: PremiumValues<number>
...
export function convertPremiumValues(options: {
  ...
  tokenUSDC: Token<IERC20, TokenName.USDC>
  values: PremiumValues<number>
}): PremiumValues<BigNumber>

export function convertPremiumValues(options: {
  from: 'string'
  to: 'number'
  tokenUSDC: Token<IERC20, TokenName.USDC>
  values: PremiumValues<string>
...
export function convertPremiumValues(options: {
  ...
  to: 'number'
  tokenUSDC: Token<IERC20, TokenName.USDC>
  values: PremiumValues<BigNumber>
}): PremiumValues<number>
...
export function convertPremiumValues(options: {
  ...
  tokenUSDC: Token<IERC20, TokenName.USDC>
  values: PremiumValues<number> | PremiumValues<string> | PremiumValues<BigNumber>
}): PremiumValues<number> | PremiumValues<string> | PremiumValues<BigNumber> {
  switch (options.from) {
    case 'number':
      switch (options.to) {
        case 'string': {
          const values = options.values as PremiumValues<number>
          return {
            ...
            premiumParams: {
              A: values.premiumParams.A.toFixed(10),
              X0: values.premiumParams.X0.toFixed(4),
              C: values.premiumParams.C.toFixed(10),
            },
          }
        }
        case 'BigNumber': {
          ...
          return {
            ...
            premiumParams: {
              A: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'A',
                propertyValue: values.premiumParams.A.toFixed(10),
              }),
              X0: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'X0',
                propertyValue: values.premiumParams.X0.toFixed(4),
              }),
              C: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'C',
                propertyValue: values.premiumParams.C.toFixed(10),
              }),
            },
          }
        }
    ...
    case 'string':
      switch (options.to) {
        case 'number': {
          const values = options.values as PremiumValues<string>
          return {
            ...
            premiumParams: {
              A: Number(Number(values.premiumParams.A).toFixed(10)),
              X0: Number(Number(values.premiumParams.X0).toFixed(4)),
              C: Number(Number(values.premiumParams.C).toFixed(10)),
            },
          }
        }
        case 'BigNumber': {
          ...
          return {
            ...
            premiumParams: {
              A: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'A',
                propertyValue: values.premiumParams.A,
              }),
              X0: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'X0',
                propertyValue: values.premiumParams.X0,
              }),
              C: transformCalculateCustomPremiumUsdcParamsPropertyValueToBigNumber({
                tokenUSDC: options.tokenUSDC,
                propertyName: 'C',
                propertyValue: values.premiumParams.C,
              }),
            },
          }
        }
    ...
    case 'BigNumber':
      switch (options.to) {
        case 'number': {
          const values = options.values as PremiumValues<BigNumber>
          return {
